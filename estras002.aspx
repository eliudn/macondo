<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras002.aspx.cs" Inherits="estras002" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
	...
	<script>
	    ...
	    $(function () {
	        ...
	        /*//////////////////////////////////////////////////////////////////////////////////////////////////////*/
	        $.ajax({
	            url: 'estras002.aspx/cargarDepartamentoMagdalena',
	            type: 'POST',
	        ...
	        $("#departamento").on('change', function () {
	            ...
	            $.ajax({
	                url: 'estras002.aspx/cargarMunicipios',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#municipio").on('change', function () {
	            ...
	            $.ajax({
	                url: 'estras002.aspx/cargarInstituciones',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#instituciones").on('change', function () {
	            ...
	            $.ajax({
	                url: 'estras002.aspx/cargarSedesInstitucion',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#sedes").on("change", function () {
	            ...
	            $.ajax({
	                url: 'estras002.aspx/cargarLineaInvestigacion',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#grupoInvestigacion").on("change", function () {
	            $.ajax({
	                url: 'estras002.aspx/cargarAsesores2',
	                type: 'POST',
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	                success: function (response) {
	            ...
	            $.ajax({
	                ...
	                success: function (response) {
	                    ...
	                    if (resp[0] == "true")
	                    {
	                        ...
	                        $.ajax({
	                            type: 'POST',
	                            url: 'estras002.aspx/deleteactividadess002',
	                            data: jsondata,
	                            contentType: 'application/json; charset=utf-8',
	                            dataType: 'JSON',
	                            success: function (response) {
	                        ...
	                        $.ajax({
	                            type: 'POST',
	                            url: 'estras002.aspx/deletecompromisoss002',
	                            data: jsondata,
	                            contentType: 'application/json; charset=utf-8',
	                            dataType: 'JSON',
	                            success: function (response) {
	    ...
	    function guardarDocentes(codestras002, codgradodocente) {
	        var jsonData = '{ "codestras002": "' + codestras002 + '", "codgradodocente": "' + codgradodocente + '"}';
	        $.ajax({
	            type: 'POST',
	            url: 'estras002.aspx/matricularDocentes',
	            contentType: "application/json; charset=utf-8",
	            data: jsonData,
	            dataType: "json",
	            success: function (json) {
    ...
    <script>
        ...
        function listarInstrumentos002() {
            total = 5;
            total1 = 1;
            $("#form").hide();
            ...
            $.ajax({
                type: 'POST',
                url: 'estras002.aspx/listarInstrumentos002',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function loadSelectInstrumentos002(codProyecto) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras002.aspx/loadSelectInstrumentos002',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function cargarInstrumentos002(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras002.aspx/cargarInstrumentos002',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function cargarDocentesMatriculados(codestra2instrumento_s002, codanio, codsede) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras002.aspx/listardocentesmatriculados',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data: jsonData,
                success: function (response) {
        ...
        function listaractividadess002(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras002.aspx/listaractividadess002',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function listarcompromisoss002(codigo) {
            ...
            var jsondata = "{'codigo':'" + codigo + "'}";
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras002.aspx/listarcompromisoss002',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        /* 2016-10-28 3:49 pm */
            function btnActualizar() {
                ...
                $.ajax({
                    url: 'estras002.aspx/actualizarEncabezados002',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            function actualizarMatriculaDocente(codinstrumento, codchkdoc) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras002.aspx/deletematriculaDocente',
                    data: jsonData,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
            ...
            function cargarAnio() {
                $.ajax({
                    type: 'POST',
                    url: 'estras002.aspx/cargaranios',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
                    success: function (json) {
            ...
            function btncargardoc() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras002.aspx/cargarDocentes',
                    contentType: "application/json; charset=utf-8",
                    data: jsonData,
                    dataType: "json",
                    success: function (json) {
    ...
    <script type="text/javascript">
        ...
        function deleteInstrumentos002(codigoestrategia) {
            if (confirm('¿Estás seguro de eliminar este Registro? Recuerde que perderá toda las evidencias cargadas')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras002.aspx/deleteestras002',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
...
<h2 >Estrategia Nro. <asp:label runat="server" ID="lblEstrategia" Visible="true"></asp:label> - S002: Registro de la asesoría</h2>
      ...
      <div id="table">
     <a href="#" class="btn btn-primary" style="float:right;" onclick="nuevaasesoria();">Nuevo registro asesoría</a>
...
<br/>
    ...
    <br />
	<center>
        <input type="button" id="btn-guardar" class="btn btn-success" value="Guardar" onclick="btnGuardar_Click('insert');" />
