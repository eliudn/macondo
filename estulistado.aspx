<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estulistado.aspx.cs" Inherits="estulistado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br /><br /><br />
    <fieldset>
        <legend>Listado completo de Estudiantes registrados en el sistema.</legend>
        <fieldset>
                     ...
                     <div style="margin: 0 auto; text-align: center; padding: 5px" id="Div1" runat="server">
                        ...
                        <table class="cajafiltroCentrado">
                            ...
                            <tr>
                                ...
                                <td><asp:DropDownList ID="dropAnio" runat="server" CssClass="TextBox"></asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td><asp:DropDownList ID="dropTipoGrupo" runat="server" CssClass="TextBox">
         ...
         <div style="margin: 0 auto; text-align: center; padding: 5px" visible="false" id="botones" runat="server">
            ...
            <asp:Panel ID="PanelImpresion" runat="server">
                <div id="muestra">
                    ...
                    <asp:GridView ID="GridClientes" runat="server" CellPadding="4" DataKeyNames="cod" CssClass="mGridTesoreria" UseAccessibleHeader="true" ClientIDMode="Static"
                        EmptyDataText="No se encontraron Estudiantes con este filtro" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-ForeColor="Red"
                        ForeColor="#333333" AutoGenerateColumns="false" Style="margin: 0 auto" OnSorting="GridClientes_Sorting" AllowSorting="true"
                        GridLines="None" OnPageIndexChanging="GridClientes_PageIndexChanging">
                        <Columns>
                            ...
                            <asp:BoundField DataField="identificacion" HeaderText="ID. Estudiante">
                                <ItemStyle HorizontalAlign="Center" Width="120px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="nombrecompleto" SortExpression="nombrecompleto" HeaderText="Nombre Estudiante" >
                            ...
                            <asp:BoundField DataField="dane" HeaderText="DANE">
                              ...
                              <asp:BoundField DataField="tipogrupo" HeaderText="Tipo Grupo">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                           <%-- <asp:TemplateField>
                                <ItemTemplate>
