<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="ticclimonitor.aspx.cs" Inherits="ticclimonitor" %>
      ...
      <fieldset>
            ...
            <asp:GridView ID="GridTickets" runat="server" CellPadding="4" DataKeyNames="cod" CssClass="mGridTesoreria"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="cod" HeaderText="Codigo Ticket" >
