...
public partial class estra2sesionesformacion : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra2sesionesformacion_()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2sesionesformacion = est.estra2SesionesFormacion("", "", "", "", HttpContext.Current.Session["m"].ToString(), HttpContext.Current.Session["s"].ToString());


        if (estra2sesionesformacion != null && estra2sesionesformacion.Rows.Count > 0)
        {
            int total = estra2sesionesformacion.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra2sesionesformacion.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra2sesionesformacion.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra2sesionesformacion.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra2sesionesformacion.Rows[i]["dane"].ToString() + " - " + estra2sesionesformacion.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + estra2sesionesformacion.Rows[i]["danesede"].ToString() + " - " + estra2sesionesformacion.Rows[i]["nombresede"].ToString() + " </td>";
                ca += "<td>" + estra2sesionesformacion.Rows[i]["nombrearchivo"].ToString() + " </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra2sesionesformacion_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2sesionesformacion = est.estra2SesionesFormacion(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["m"].ToString(), HttpContext.Current.Session["s"].ToString());
