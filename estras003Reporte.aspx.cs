...
public partial class estras003Reporte : System.Web.UI.Page
{
    ...
    public static string cargarListadoS003(string page, string rows)
    {
        ...
        if (datos != null && datos.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < datos.Rows.Count; i++)
            {
                ...
                ca += "<td align=\"center\"><br /><a class='btn btn-success' onclick=\"$('#lista').hide(), $('#form').fadeIn(500), loadInstrumento(" + datos.Rows[i]["codigo"].ToString() + ")\">Ver</a><br/ ><br /></td>";
                ca += "</tr>";
            }
            ca += "@S3p4";
            for (int j = 0; j < val; j++)
        ...
        {
            ca += "<tr><td colspan='11' align='center'>No se encontraron S003 registradas por parte de este asesor.</td></tr>";
        }
