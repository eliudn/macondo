...
public partial class climasivo : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (FileUpload1.HasFile)
        {
            if (ChecarExtension(FileUpload1.FileName))
            {
                ...
                FileUpload1.SaveAs(Server.MapPath("CSV_Clientes/" + fileNameSave));


                Label1.Text = FileUpload1.FileName + " cargado exitosamente";

                lblOculto.Text = Server.MapPath("CSV_Clientes/" + fileNameSave);
            }
            else
            {
    ...
    private void CargarDatos(string strm)
    {
        ...
        {
            lblNroEnTabla.Text ="<b>Numero de clientes <b/>"+ GridView1.Rows.Count.ToString();
    ...
    private void recorrerListado()
    {
         int buenos = 0;
         int malos = 0;
         string[] reporteMalos = new string[Convert.ToInt64(lblNumero.Text)];
