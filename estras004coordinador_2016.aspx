<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras004coordinador_2016.aspx.cs" Inherits="estras004coordinador_2016" ValidateRequest="false" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#asesor").on("change", function () {
                ...
                cargarListadoMemorias($("#asesor").val(), "1", $("#anio option:selected").html());
            });
            ...
            $("#sede").change(function () {
                reset();
                var jsonData = '{ "codsede":"' + $("#sede").val() + '", "codasesorcoordinador":"' + $("#asesor").val() + '"}';
                $.ajax({
                    type: 'POST',
        ...
        function cargarAsesores() {
            $.ajax({
                url: 'estras004coordinador_2016.aspx/cargarAsesores',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
        ...
        function cargarAnios() {
            $.ajax({
                url: 'estras004coordinador_2016.aspx/cargarAnios',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarListadoMemorias(asesor,page,anio) {
            ...
            var datajson = "{'codAsesor':'" + asesor + "','page':'" + page + "','anio':'" + anio + "'}";
            //alert(datajson);
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador_2016.aspx/cargarListadoMemoriaAsesor',
                data: datajson,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function loadInstrumento(codigo) {
            var jsonData = "{ 'codigoestra':'" + codigo + "'}";
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador_2016.aspx/loadestras004',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    if (resp[0] === "datosintrumento") {
                        ...
                        floadSelects004(codigoestrategia);
        ...
        function floadPreguntaas(codigoestrategia) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador_2016.aspx/loadPreguntass004',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function floadSelects004(codigoestrategia) {
            var jsondata = "{'codigo':'" + codigoestrategia + "'}";
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador_2016.aspx/loadSelectInstrumento',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <br />
    <h2 >Estrategia No. <asp:Label runat="server" ID="lblEstrategia" Visible="true"></asp:Label> -  S004: Memoria de los espacios de formación o apropiación social - 2016</h2>
    ...
    <div id="listTable">
        ...
        <%--<a class="btn btn-primary" style="float:right" onclick="$('#listTable').hide(), $('#formTable').fadeIn(500), $('#btn-guardar').attr('value', 'Guardar todo'), $('#btn-guardar').attr('onclick', 'enviarestras004(\'update\')'), reset();">Nueva memoria</a>--%>
        ...
        <fieldset>
            <table>
                <tr>
                    ...
                    <td><select id="anio" class="TextBox"></select></td>
                    <td>Seleccione asesor</td>
    ...
    <br>
     ...
     <legend>Listado de evidencias</legend>
      <asp:GridView ID="GridEvidencias" runat="server" CellPadding="4" DataKeyNames="cod" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
        ...
        <div class="button">
        <a class="btn btn-primary" onclick="$('#listTable').fadeIn(500), $('#formTable').hide(), reset();">Regresar</a>
