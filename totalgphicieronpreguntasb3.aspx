<%@ Page Title="Grupos investigación Bitácora 03" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesdesarrollo.aspx.cs" Inherits="detallesdesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/totalGPHicieronPreguntasB3',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/realizarBusquedatotalGPHicieronPreguntasB3',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4>Total grupos de investigación con problemas de investigación planteados en la convocatoria de CiclónTotal grupos de investigación con problemas de investigación planteados en la convocatoria de Ciclón</h4>
    <p>Miden el número de grupos de investigación infantiles y juveniles que plantean problemas de investigación y diligenciaron la bitácora 03 en la convocatoria de  Ciclón</p>
    <br />
