<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciasferias.aspx.cs" Inherits="estraunoevidenciasferias" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 1 - Inscripción de grupos de investigación y maestros a las ferias <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
                     ...
                     <tr>
                         ...
                         <td>
                               ...
                               <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                 <ContentTemplate>
                                     <asp:DropDownList runat="server" ID="dropSedes" CssClass="TextBox" AutoPostBack="true" OnSelectedIndexChanged="dropSede_SelectedIndexChanged" ></asp:DropDownList>
