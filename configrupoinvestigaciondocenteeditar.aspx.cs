...
public partial class configrupoinvestigaciondocenteeditar : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Session["codgrupoinvestigacion"] != null)
            {
                    ...
                    DataRow dat = est.buscarGrupoInvestigacionSedexCod(Session["codgrupoinvestigacion"].ToString());
                    ...
                    if (dat != null)
                    {
                        ...
                        ddSedes(dropSedes);
                        //ddGruposInvestigacionSedes(dropGrupoInvestigacion);
                        ...
                        //dropGrupoInvestigacion.SelectedValue = dat["codgrupoinvestigaciondocentes"].ToString();
                        ...
                        lblCodProyectoSede.Text = dat["codgrupoinvestigaciondocentes"].ToString();
    ...
    private void ddGruposInvestigacionSedes(DropDownList drop)
    {
        DataTable datos = est.cargarTodoGrupoInvestigacionSedes();
        drop.DataSource = datos;
    ...
    private void gvcargarDocentesAcompañantes(string codgrupoinvestigacion)
    {
        DataTable datos = est.cargarDocentesxSedexGrupoInvestigacion(codgrupoinvestigacion);
    ...
    private void gvcargarAsesoresxGrupoInvestigacion(string codgrupoinvestigacion)
    {
        GridAsesor.DataSource = est.cargarAsesorxGrupoInvestigacionxSede(codgrupoinvestigacion);
        GridAsesor.DataBind();
    }
    ...
    protected void btnGuardarDocenteLineaInvestigacion_Click(object sender, EventArgs e)
    {
        ...
        foreach (GridViewRow row2 in GridDocentesBuscados.Rows)
        {
            ...
            if (rb == true)
            {
                ...
                if (est.agregarDocentexSedexGrupoInvestigacion(codgradodocente, lblCodGrupoInvestigacion.Text))
                {
                    valDoc++;
                }
            }
    ...
    protected void btnRegresar_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("configrupoinvestigacionDocentes.aspx");
    }

    protected void btnEditar_Click(object sender, EventArgs e)
    {
        if (est.editargrupoinvestigaciondocente(dropGrupoInvestigacion.Text, lblCodProyectoSede.Text))
        {
            string script = @"<script type='text/javascript'>
