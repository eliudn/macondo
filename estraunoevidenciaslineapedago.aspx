<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciaslineapedago.aspx.cs" Inherits="estraunoevidenciaslineapedago" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 1 - Lineamientos pedagógicos de los espacios de apropiación <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
...
<asp:Panel runat="server" ID="PanelMostrarEvidencias" Visible="true">
    ...
    <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="50">Lineamientos pedagógicos de los espacios de apropiación</asp:ListItem>
                        <asp:ListItem Value="51">Actas de Aprobación Comité Técnico</asp:ListItem>
                     </asp:RadioButtonList>
 ...
 <fieldset>
     ...
     <%-- <asp:RadioButtonList runat="server" ID="rbtActividadesBuscar" AutoPostBack="true" OnSelectedIndexChanged="rbtActividadesBuscar_OnSelectedIndexChanged">
                        <asp:ListItem Value="50">Lineamientos pedagógicos de los espacios de apropiación</asp:ListItem>
                        <asp:ListItem Value="51">Actas de Aprobación Comité Técnicos</asp:ListItem>
                     </asp:RadioButtonList>--%>
