<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidencias.aspx.cs" Inherits="estraunoevidencias" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 1 <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
     ...
     <fieldset>
         ...
         <asp:Panel runat="server" ID="PanelMomento0" Visible="false">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem Value="1">1. Lineamientos de la estrategia  acompañamiento y formación de los grupos de investigación</asp:ListItem>
                    <asp:ListItem Value="2">2. Ruta metodológica de investigación e innovación del Proyecto Ciclón</asp:ListItem>
                    <asp:ListItem Value="3">3. Jornadas de formación dirigidas a los estudiantes</asp:ListItem>
                    <asp:ListItem Value="4">4. Lineamientos pedagógicos y logisticos de las ferias institucionales </asp:ListItem>
                    <asp:ListItem Value="5">5. Cronograma de trabajo conjunto para organizar la llegada a las instituciones educativas</asp:ListItem>
                </asp:RadioButtonList>
         </asp:Panel>
          ...
          <asp:Panel runat="server" ID="PanelMomento4" Visible="false">
              <asp:RadioButtonList runat="server" ID="rbtMomento4">
                    <asp:ListItem Value="1">Asistencia de eventos</asp:ListItem>
