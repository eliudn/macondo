...
public partial class estraunoevidenciasplanoperativo : System.Web.UI.Page
{
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            //{
                ...
                if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), "0", "0", rbtActividades.SelectedValue, "1"))
                {
                    //gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEstrategiaxMomentoxSesionxActividad("1", "0", "0",rbtActividadesBuscar.SelectedValue);
    ...
    {
        Response.Redirect("estramomentosdos.aspx?m=0");
    }
