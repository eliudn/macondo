...
public partial class estrag006Reporte : System.Web.UI.Page
{
    ...
    public static string cargarListadoAsesoresxCoordinador()
    {
       ...
       Estrategias inst = new Estrategias();
        ...
        DataTable datos = inst.listarAsesores("2");
    ...
    public static string cargarListadoMaterialesAsesor(string page, string rows, string codasesorcoordinador)
    {
        ...
        DataTable datosmateriales = inst.cargarListadoMaterialesxAsesor(codasesorcoordinador, Convert.ToString(offset), rows);
