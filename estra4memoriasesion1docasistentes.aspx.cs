...
public partial class estra4memoriasesion1docasistentes : System.Web.UI.Page
{
    ...
    public static string estra4memoriassesio1_docente()
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_docentes("", "", "", "", "1");
    ...
    public static string realizarBusquedaestra4memoriasesion1_docente(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_docentes(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString());
