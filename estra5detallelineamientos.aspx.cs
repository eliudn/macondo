...
public partial class estra5detallelineamientos : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5lineamientos()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable lienamientos = est.est_lineamientosFormacion("", "", "", "", "5", "Diseño de lineamientos de la estrategia formación");
