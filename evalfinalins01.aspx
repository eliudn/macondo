<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="evalfinalins01.aspx.cs" Inherits="evalfinalins01" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function cargarinfoinstitucion() {
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst_intermedia.aspx/cargarinfoinstitucion',
                ...
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        $("#web").val(resp[6]);
                        codinstitucion = resp[7];
                        buscarasesor(resp[7]);
                        buscarrector();

                        $("#txtActivas").val(resp[8]);
                        $("#is16").val(resp[9]);
                        $("#is17").val(resp[10]);
                        $("#is18").val(resp[11]);
                        $("#is16s").val(resp[12]);
        ...
        function buscarasesor(codinstitucion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst_intermedia.aspx/buscarasesor',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst_intermedia.aspx/cargarasesores',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    var resp = json.d.split("&");
        ...
        function buscarrector() {
            $.ajax({
                type: 'POST',
                url: 'evalfinalins01.aspx/buscarrector',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    var resp = json.d.split("&_");
                    if (resp[0] === "true") {
                        $("#nrector").val(resp[1]);
                        $("#arector").val(resp[2]);
                        $("#crector").val(resp[3]);
        ...
        function enviar(event) {
            if ($.trim($("#asesor").val()) == '' || $.trim($("#asesor").val()) == '0') {
                ...
                alert("Por favor, digite el nombre de la institución sede");
                $("#nombre").focus();
            } else if ($.trim($("#direccion").val()) == '') {
                alert("Por favor, digite la dirección de la institución");
                $("#direccion").focus();
            } else if ($.trim($("#telefono").val()) == '') {
                alert("Por favor, digite el teléfono de la institución");
                $("#telefono").focus();
            } else if ($.trim($("#fax").val()) == '') {
                alert("Por favor, digite el fax de la institución");
                $("#fax").focus();
            } else if ($.trim($("#web").val()) == '') {
                alert("Por favor, digite la página web de la institución");
                $("#web").focus();
            } else if ($.trim($("#email").val()) == '') {
                alert("Por favor, digite el correo electrónico de la institución");
                $("#email").focus();
            } else if ($.trim($("#txtActivas").val()) == '') {
                alert("Por favor, digite el Nro. beneficiadas con el Programa Ciclón");
                $("#txtActivas").focus();
            } else if ($.trim($("#is16").val()) == '') {
                alert("Por favor, digite el ISCE PRIMARIA 2016");
                $("#is16").focus();
            } else if ($.trim($("#is17").val()) == '') {
                alert("Por favor, digite el ISCE PRIMARIA 2017");
                $("#is17").focus();
            } else if ($.trim($("#is18").val()) == '') {
                alert("Por favor, digite el ISCE PRIMARIA 2018");
                $("#is18").focus();
            } else if ($.trim($("#is16s").val()) == '') {
                alert("Por favor, digite el ISCE SECUNDARIA 2016");
                $("#is16s").focus();
            } else if ($.trim($("#is17s").val()) == '') {
                alert("Por favor, digite el ISCE SECUNDARIA 2017");
                $("#is17s").focus();
            } else if ($.trim($("#is18s").val()) == '') {
                alert("Por favor, digite el ISCE SECUNDARIA 2018");
                $("#is18s").focus();
            } else if ($.trim($("#is16m").val()) == '') {
                alert("Por favor, digite el ISCE MEDIA 2016");
                $("#is16m").focus();
            } else if ($.trim($("#is17m").val()) == '') {
                alert("Por favor, digite el ISCE MEDIA 2017");
                $("#is17m").focus();
            } else if ($.trim($("#is18m").val()) == '') {
                alert("Por favor, digite el ISCE MEDIA 2018");
                $("#is18m").focus();
            } else if ($.trim($("#nrector").val()) == '') {
                alert("Por favor, digite el nombre del rector");
                $("#nrector").focus();
            } else if ($.trim($("#arector").val()) == '') {
                alert("Por favor, digite el apellido del rector");
                $("#arector").focus();
            } else if ($.trim($("#crector").val()) == '') {
                alert("Por favor, digite el No de celular del rector");
                $("#crector").focus();
            } else if ($.trim($("#cerector").val()) == '') {
                alert("Por favor, digite el correo electrónico del rector");
                $("#cerector").focus();
            } else {
                
                var jsonData = '{ "nombre":"' + $('#nombre').val() + '", "telefono": "' + $('#telefono').val() + '", "fax": "' + $('#fax').val() + '", "email": "' + $('#email').val() + '", "direccion": "' + $('#direccion').val() + '", "web": "' + $('#web').val() + '", "asesores": "' + $('#asesor').val() + '", "codinstitucion": "' + codinstitucion + '", "txtactivas": "' + $('#txtActivas').val() + '", "is16": "' + $('#is16').val() + '", "is17": "' + $('#is17').val() + '", "is18": "' + $('#is18').val() + '", "is16s": "' + $('#is16s').val() + '", "is17s": "' + $('#is17s').val() + '", "is18s": "' + $('#is18s').val() + '", "is16m": "' + $('#is16m').val() + '", "is17m": "' + $('#is17m').val() + '", "is18m": "' + $('#is18m').val() + '", "nrector": "' + $('#nrector').val() + '", "arector": "' + $('#arector').val() + '", "crector": "' + $('#crector').val() + '", "cerector": "' + $('#cerector').val() + '"}';
                $.ajax({
                    type: 'POST',
                    url: 'evalfinalins01.aspx/updateinstrumento',
                    data: jsonData,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <h2>
            ...
            <br />
            <br />
            Información de contacto de las instituciones educativas del sector oficial
        ...
        <p>
            ...
            A través del presente instrumento sólo se complementarán o actualizarán los datos de contacto de las instituciones educativas beneficiarias de Ciclón y del rector, teniendo en cuenta que el resto de información básica no ha variado desde que se levantó la línea de base del Programa. 
            <br />
            <br />
            FUNTICS al iniciar el 2017, actualizó la información básica de las sedes educativas beneficiadas.
            <br /><br />
            <b>Propósito: </b>
            <br /><br />
            Actualizar la información de contacto de las sedes educativas beneficiadas para que pueda ser consultada por los usuarios del SIEP- Macondo.
            <br /><br />
            <b>Metodología: </b>
            <br /><br />
            Los profesionales de FUNTICS preguntarán esta información directamente a los réctores y/o coordinadores académicos.
        ...
        <fieldset>
            ...
            <table style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
                <tr>
                    <td>Nombre institución educativa</td>
                    <td><input type="text" class="TextBox" id="nombre" name="nombre" /></td>
                    <td>Dirección sede principal</td>
                    <td><input type="text" class="TextBox" id="direccion" name="direccion" /></td>
                    <td>Teléfono</td>
                    <td><input type="text" class="TextBox" id="telefono" name="telefono" /></td>
                    
                </tr>
                <tr>
                    <td>FAX</td>
                    <td><input type="text" class="TextBox" id="fax" name="fax" /></td>
                    <td>Página Web</td>
                    <td><input type="text" class="TextBox" id="web" name="web" /></td>
                    <td>Correo electrónico</td>
                    <td><input type="text" class="TextBox" id="email" name="email" /></td>
                </tr>
                
            </table>
        </fieldset>
    <fieldset>
        <legend>Sedes beneficiadas</legend>
        <table>
        <tr>
            <td>Nro. beneficiadas con el Programa Ciclón:
           <input type="text" class="TextBox" id="txtActivas" name="is16" style="width:50px" />
            </td>
                </tr>
    ...
    <fieldset>
                <legend>INDICE SINTETICO DE CALIDAD EDUCATIVA</legend>
                <table>
                <tr>
                    <td>
                        <b>PRIMARIA</b>
                ...
                <tr>
                  <td>ISCE 2016</td>
                    <td><input type="text" class="TextBox" id="is16" name="is16" style="width:50px" /></td>
                  <td>ISCE 2017</td>
                    <td><input type="text" class="TextBox" id="is17" name="is16" style="width:50px" /></td>
                  <td>ISCE 2018</td>
                    <td><input type="text" class="TextBox" id="is18" name="is16" style="width:50px" /></td>
                  </tr>
                    </table>
             ...
             <table> 
                 <br> <br>
                     ...
                     <tr>
                       <td>ISCE 2016</td>
                         <td><input type="text" class="TextBox" id="is16s" name="is16" style="width:50px" /></td>
                       <td>ISCE 2017</td>
                         <td><input type="text" class="TextBox" id="is17s" name="is16" style="width:50px" /></td>
                       <td>ISCE 2018</td>
                         <td><input type="text" class="TextBox" id="is18s" name="is16" style="width:50px" /></td>
                       </tr>
                         </table>
               ...
               <table>
                   <br> <br>
                        ...
                        <tr>
                          <td>ISCE 2016</td>
                            <td><input type="text" class="TextBox" id="is16m" name="is16" style="width:50px" /></td>
                          <td>ISCE 2017</td>
                            <td><input type="text" class="TextBox" id="is17m" name="is16" style="width:50px" /></td>
                          <td>ISCE 2018</td>
                            <td><input type="text" class="TextBox" id="is18m" name="is16" style="width:50px" /></td>
                          </tr>
                            </table>
            </fieldset>
    
           <fieldset>
                <legend>Datos del rector</legend>
                <table>
                    <tr>
                        <td>Nombre</td>
                        <td><input type="text" class="TextBox" id="nrector" name="nrector" /></td>
                        <td>Apellido</td>
                        <td><input type="text" class="TextBox" id="arector" name="arector" /></td>
                        <td>Celular</td>
                        <td><input type="text" class="TextBox" id="crector" name="crector"/></td>
                        <td>Correo electronico</td>
                        <td><input type="text" class="TextBox" id="cerector" name="cerector"/></td>
                    </tr>
                    <tr>
                    <td colspan="6"  >
                        <br />
                        
                         <input  type="button" id="btn-guardar" value="Actualizar" onclick="enviar('actualizar')" class="btn btn-success" />
              ...
              <table align="center" style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
                ...
                <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender7" runat="server" TargetControlID="RFVdropZona"
                  ...
                  <tr>
                      <td>
                          Nro. Total de Sedes:
                              Activas  <asp:TextBox ID="txtActivass" runat="server" CssClass="TextBox" Width="50"></asp:TextBox>
