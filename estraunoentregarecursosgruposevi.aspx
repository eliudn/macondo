<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoentregarecursosgruposevi.aspx.cs" Inherits="estraunoentregarecursosgruposevi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 1, Entrega de recursos - Cargar Evidencias</h2>
    ...
    <asp:Label ID="lblCodInstrumento" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                  <asp:ListItem>Primer Desembolso</asp:ListItem>
                  <asp:ListItem>Segundo Desembolso</asp:ListItem>
                  <asp:ListItem>Tercer Desembolso</asp:ListItem>
                </asp:RadioButtonList>
