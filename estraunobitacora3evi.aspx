<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunobitacora3evi.aspx.cs" Inherits="estraunobitacoradosevi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
  <h2>Estrategia No 1: Cargue de bitácoras - Trazabilidad </h2>
     
        <asp:Label runat="server" Visible="false" ID="lblCodUsuario"></asp:Label>
     <asp:Label runat="server" Visible="false" ID="lblCodestrabitacora2"></asp:Label>
        ...
        <asp:RequiredFieldValidator runat="server" ID="rbtValideActividades" Display="Dynamic" ControlToValidate="rbtActividades" ValidationGroup="addEvidencia">
         ...
         <fieldset>
            ...
            <asp:Panel runat="server" ID="PanelMomento0" Visible="true">
             <asp:RadioButtonList runat="server" ID="rbtActividades">
                <asp:ListItem>Bitácora 3 El Centrifugado Ciclónico (Benkos y Magda)</asp:ListItem>
                <asp:ListItem>Bitácora 4  La Evolución del Ciclón (Belnkos y Magda)</asp:ListItem>  
             </asp:RadioButtonList>
             </asp:Panel>
