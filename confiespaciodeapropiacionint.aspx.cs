...
public partial class confiespaciodeapropiacion : System.Web.UI.Page
{
    ...
    protected void lnkEvidenciasIns_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionintevidenciasinsc.aspx?cod=" + codredtematica + "&coddep=" + coddepartamento);
    }
    ...
    protected void lnkEvidencias_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionintevidencias.aspx?cod=" + codredtematica);
    }
    ...
    protected void btnAgregarEstudiantes_Click(object sender, EventArgs e)
    {
            ...
            int val = 0;
            int val2 = 0;
            DataRow feriam = est.agregarFeriaMunicipalxInternacional(dropDepartamento.SelectedValue, nombreferiamunicipal.Text, numeroasistentes.Text, numerogrupos.Text, numerodocentes.Text, fechaelaboracion.Text, horaferia.SelectedValue, horaferiafinal.SelectedValue, fechaelaboracioncierre.Text, horaferiacierre.SelectedValue, horaferiafinalcierre.SelectedValue, lugarferia.Text);
            ...
            if (val > 0 && val2 > 0)
            {
                ...
                string script = @"<script type='text/javascript'>$('#CrearRed').hide(),$('#VerRed').fadeIn(500), alert('Feria Internacional creada exitosamente');
                     </script>";
            ...
            else if (val == 0 && val2 > 0)
            {
                ...
                string script = @"<script type='text/javascript'>$('#CrearRed').hide(),$('#VerRed').fadeIn(500),alert('Feria Internacional creada exitosamente, pero no se agregaron los municipios');
                     </script>";
    ...
    private void cargarFeriasMunicipales()
    {
        ...
        DataTable datos = estr.cargarFeriasInternacionalesMaferpi();
    ...
    protected void lnkEliminarRedTematica_Click(object sender, EventArgs e)
    {
        ...
        est.eliminarferiainternacional(codferiamunicipal);
    ...
    protected void lnkEditarRed_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacioneditarint.aspx");
    }
    ...
    protected void lnkApropiacionMaestros_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiapropiaciondptal.aspx?tipo=i" + cod);
    }
}