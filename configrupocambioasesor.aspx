<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="configrupocambioasesor.aspx.cs" Inherits="configrupocambioasesor" %>
...
<h2 >Cambio de asesores en los Grupos de investigación</h2><br />
         ...
         <asp:GridView ID="GridGrupos" runat="server" CellPadding="4" DataKeyNames="codigo" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="asesor"  HeaderText="Asesor" >
                             ...
                             <asp:BoundField DataField="identificacion" HeaderText="identificacion" HeaderStyle-CssClass="ocultarcell">
                            <ItemStyle HorizontalAlign="Center" CssClass="ocultarcell" />
                            </asp:BoundField>
