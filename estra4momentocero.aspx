<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra4momentocero.aspx.cs" Inherits="estra4momentocero" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4momentocero.aspx/loadReport',
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4memorias004.aspx/realizarbusqueda',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "estra2convocatoriaacompanamiento",
                filename: "estra2convocatoriaacompanamiento",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 > Diseño de lineamientos de la estrategia de conformación de la comunidad de práctica, aprendizaje, saber conocimiento y transformación del proyecto Ciclón </h2>
