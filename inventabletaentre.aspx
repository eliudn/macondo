<%@ Page Title="Iventario de las tabletas" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="inventabletaentre.aspx.cs" Inherits="inventabletaentre" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'inventabletaentre.aspx/actualizacionpei_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'inventabletaentre.aspx/realizarBusquedaactualizacionpei_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
