<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="lineabaseregistroinst2_intermedia.aspx.cs" Inherits="lineabaseregistroinst2_intermedia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function buscarasesor(codinstitucion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/buscarasesor',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/cargarasesores',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    var resp = json.d.split("&");
        ...
        function cargarrespuestascerradasyabiertas(codasesor, codinsitucion) {
            var jsonData = "{ 'codasesor':'" + codasesor + "', 'codinstitucion':'" + codinstitucion + "'}";
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/cargarrespuestascerradasyabiertas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    $("#fechapei").val(resp[0]);
                    $("#txtpracinnova").val(resp[1]);
                    $("#txtcurritic_pedago").val(resp[2]);
                    $("#txtcurritic_tecno").val(resp[3]);
                    $("#txtcurritic_inves").val(resp[4]);
                    $("#txtcurritic_comu").val(resp[5]);
                    $("#txtcurritic_gest").val(resp[6]);

                    if (resp[7] == "si")
                        $("#pracinst_1si").attr('checked', true);
                    else if (resp[7] == "no")
                        $("#pracinst_1no").attr('checked', true);

                    if (resp[8] == "si")
                        $("#pracinst_2si").attr('checked', true);
                    else if (resp[8] == "no")
                        $("#pracinst_2no").attr('checked', true);

                    if (resp[9] == "si")
                        $("#pracinst_3si").attr('checked', true);
                    else if (resp[9] == "no")
                        $("#pracinst_3no").attr('checked', true);

                    if (resp[10] == "si")
                        $("#pracinst_4si").attr('checked', true);
                    else if (resp[10] == "no")
                        $("#pracinst_4no").attr('checked', true);

                    if (resp[11] == "si")
                        $("#rbaprotic_si").attr('checked', true);
                    else if (resp[11] == "no")
                        $("#rbaprotic_no").attr('checked', true);

                    $("#txtmodeducativo").val(resp[12]);

                }
            });
        }

        function cargarrespuestascerradaschk(codasesor, codinsitucion) {
            var jsonData = "{ 'codasesor':'" + codasesor + "', 'codinstitucion':'" + codinstitucion + "', 'codpregunta':'2', 'codsubpregunta':'0'}";

            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/cargarrespuestascerradaschk',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        $("input[name=enfasispei]").each(function (index) {
                            if (resp[i] == "Ciencia")
                                $("#enfasispei_ciencia").attr('checked', true);

                            if (resp[i] == "Tecnología")
                                $("#enfasispei_tecnologia").attr('checked', true);

                            if (resp[i] == "Innovación")
                                $("#enfasispei_innovacion").attr('checked', true);

                            if (resp[i] == "Investigación")
                                $("#enfasispei_investigacion").attr('checked', true);

                            if (resp[i] == "TIC")
                                $("#enfasispei_tic").attr('checked', true);

                            if (resp[i] == "N/A")
                                $("#enfasispei_na").attr('checked', true);
            ...
            var jsonData2 = "{ 'codasesor':'" + codasesor + "', 'codinstitucion':'" + codinstitucion + "', 'codpregunta':'3', 'codsubpregunta':'0'}";
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        var i = 1;
                        $("input[name=modeducativo]").each(function (index) {
                            if (resp[i] == "Aceleración")
                                $("#modeducativo_aceleracion").attr('checked', true);

                            if (resp[i] == "Escuela")
                                $("#modeducativo_escuela").attr('checked', true);

                            if (resp[i] == "Post")
                                $("#modeducativo_post").attr('checked', true);

                            if (resp[i] == "Telesecundaria")
                                $("#modeducativo_tele").attr('checked', true);

                            if (resp[i] == "SER")
                                $("#modeducativo_ser").attr('checked', true);

                            if (resp[i] == "CAFAM")
                                $("#modeducativo_cafam").attr('checked', true);

                            if (resp[i] == "SAT")
                                $("#modeducativo_sat").attr('checked', true);

                            if (resp[i] == "Crecer")
                                $("#modeducativo_crecer").attr('checked', true);

                            if (resp[i] == "Otro")
                                $("#modeducativo_otro").attr('checked', true);
            ...
            var jsonData3 = "{ 'codasesor':'" + codasesor + "', 'codinstitucion':'" + codinstitucion + "', 'codpregunta':'5', 'codsubpregunta':'0'}";
            ...
            var jsonData4 = "{ 'codasesor':'" + codasesor + "', 'codinstitucion':'" + codinstitucion + "', 'codpregunta':'8', 'codsubpregunta':'0'}";
                    ...
                    if (resp[0] === "true") {
                        ...
                        $("input[name=curritic]").each(function (index) {
                            if (resp[i] == "Pedagógica")
                                $("#curritic_pedago").attr('checked', true);

                            if (resp[i] == "Tecnológica")
                                $("#curritic_tecno").attr('checked', true);

                            if (resp[i] == "Investigativa")
                                $("#curritic_inves").attr('checked', true);

                            if (resp[i] == "Comunicativa")
                                $("#curritic_comu").attr('checked', true);

                            if (resp[i] == "Gestión")
                                $("#curritic_gest").attr('checked', true);
        ...
        function enviar() {
            if ($.trim($("#asesor").val()) == '' || $.trim($("#asesor").val()) == '0') {
                    ...
                    $("#asesor").focus();
            } else if ($.trim($("#fechapei").val()) == '' ) {
                alert("Por favor, digite la fecha de la pregunta No. 1");
                $("#fechapei").focus();
            } else if (!$("input[name=enfasispei]:checked").val()) {
                ...
                alert("Por favor, seleccione una opción de la pregunta No. 4, item 1");
                //$("#telefono").focus();
            } else if (!$("input[name=pracinst_2]:checked").val()) {
                alert("Por favor, seleccione una opción de la pregunta No. 4, item 2");
                //$("#telefono").focus();
            } else if (!$("input[name=pracinst_3]:checked").val()) {
                alert("Por favor, seleccione una opción de la pregunta No. 4, item 3");
                //$("#telefono").focus();
            } else if (!$("input[name=pracinst_4]:checked").val()) {
                alert("Por favor, seleccione una opción de la pregunta No. 4, item 4");
                //$("#telefono").focus();
            } else if (!$("input[name=usotics]:checked").val()) {
        ...
        function guardarpreguntascerradas() {
            var jsonData = '{"codasesor":"' + $("#asesor").val() + '", "codinstitucion":" ' + codinstitucion + ' ", "preg4_1":"' + $('input:radio[name=pracinst_1]:checked').val() + '", "preg4_2":"' + $('input:radio[name=pracinst_2]:checked').val() + '", "preg4_3":"' + $('input:radio[name=pracinst_3]:checked').val() + '", "preg4_4":"' + $('input:radio[name=pracinst_4]:checked').val() + '", "preg7":"' + $('input:radio[name=rbaprotic]:checked').val() + '"}';
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/guardardatoscerradas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData
            });
        ...
        function guardarpreguntasabiertas() {
            var jsonData = '{ "codasesor":"' + $("#asesor").val() + '", "codinstitucion":" ' + codinstitucion + ' ", "fechapei":"' + $("#fechapei").val() + '", "preg6":"' + $("#txtpracinnova").val() + '", "pedagogica":"' + $("#txtcurritic_pedago").val() + '", "tecnologica":"' + $("#txtcurritic_tecno").val() + '", "investigacion":"' + $("#txtcurritic_inves").val() + '", "comunicativa":"' + $("#txtcurritic_comu").val() + '", "gestion":"' + $("#txtcurritic_gest").val() + '", "txtmodeducativo":"' + $("#txtmodeducativo").val() + '"}';
            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/guardardatosabiertas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData
            });
        ...
        function guardarpreguntascerradaschk() {
            ...
            var jsonData = "{ 'codasesor':'" + $("#asesor").val() + "', 'codinstitucion':'" + codinstitucion + "'}";

            $.ajax({
                type: 'POST',
                url: 'lineabaseregistroinst2_intermedia.aspx/eliminarchk',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=enfasispei]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            var jsonData2 = "{ 'chck':'" + $(this).val() + "', 'codasesor':'" + $("#asesor").val() + "', 'codinstitucion':'" + codinstitucion + "', 'pregunta':'2'}";

                            $.ajax({
                                type: 'POST',
                                url: 'lineabaseregistroinst2_intermedia.aspx/guardardatoschk',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
                    ...
                    $("input[name=modeducativo]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            var jsonData3 = "{ 'chck':'" + $(this).val() + "', 'codasesor':'" + $("#asesor").val() + "', 'codinstitucion':'" + codinstitucion + "', 'pregunta':'3'}";
                    ...
                    $("input[name=usotics]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            var jsonData4 = "{ 'chck':'" + $(this).val() + "', 'codasesor':'" + $("#asesor").val() + "', 'codinstitucion':'" + codinstitucion + "', 'pregunta':'5'}";
                    ...
                    $("input[name=curritic]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            var jsonData5 = "{ 'chck':'" + $(this).val() + "', 'codasesor':'" + $("#asesor").val() + "', 'codinstitucion':'" + codinstitucion + "', 'pregunta':'8'}";
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        ...
        <p>
            ...
            En la evaluación intermedia del programa CICLÓN es necesario revisar la caracterización de los currículos de las sedes educativas beneficiadas para poder hacer visible en la evaluación de impacto las posibles modificaciones realizadas a los mismos en el marco del desarrollo de la estrategia No. 2 “Estrategia de autoformación, formación de saber y conocimiento y apropiación para maestros(as) acompañantes  coinvestigadores e investigadores en los lineamientos del IEP apoya de TIC y su propuesta metodológica”, para valorar sus alcances en términos de resultados, efectos e impactos. 
           
            <br /><br />
            <b>Objetivo: </b>
            <br /><br />
           Recoger información básica de las modificaciones realizadas al Currículo de las instituciones educativas beneficiadas durante la ejecución del proyecto: Fortalecimiento de la cultura ciudadana y democrática en CT+I a través de la IEP apoyada en TIC en el dpto del Magdalena.
            <br /><br />
            <b>Metodología: </b>
            <br /><br />
        ...
        <fieldset>
            ...
            <table style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
               <tr>
                   <td class="bold">
                       1.	Señale la fecha de la última actualización del Proyecto Educativo Institucional (DD/MM/AAAA)
                   </td>
               </tr>
                <tr>
                    <td>
                        <input type="text" id="fechapei" name="fechaelaboracion" class="width-100 TextBox datepicker" />
                    </td>
                </tr>
                <tr>
                     <td class="bold">
                        ...
                        <table align="center" class="mGridTesoreria">
                            ...
                            <tbody align="center">
                                <tr>
                                    <td>1.</td>
                                    <td>Ciencia</td>
                                    <td><input type="checkbox" name="enfasispei" id="enfasispei_ciencia" value="Ciencia" /></td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    <td>Tecnología</td>
                                    <td><input type="checkbox" name="enfasispei" id="enfasispei_tecnologia" value="Tecnología" /></td>
                                </tr>
                                <tr>
                                    <td>3.</td>
                                    <td>Innovación</td>
                                    <td><input type="checkbox" name="enfasispei" id="enfasispei_innovacion" value="Innovación" /></td>
                                </tr>
                                 <tr>
                                    <td>4.</td>
                                    <td>Investigación</td>
                                    <td><input type="checkbox" name="enfasispei" id="enfasispei_investigacion" value="Investigación" /></td>
                                </tr>
                                <tr>
                                    <td>5.</td>
                                    <td>TIC</td>
                                    <td><input type="checkbox" name="enfasispei" id="enfasispei_tic" value="TIC" /></td>
                                </tr>
                                 <tr>
                                    <td>6.</td>
                                    <td>No aplica</td>
                                    <td><input type="checkbox" name="enfasispei" id="enfasispei_na" value="N/A" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
                        ...
                        <table align="center" class="mGridTesoreria">
                            ...
                            <tbody align="center" class="mGridTesoreria">
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_aceleracion" value="Aceleración" /></td>
                                </tr>
                                 <tr>
                                    <td>2. </td>
                                    <td>Escuela Nueva</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_escuela" value="Escuela" /></td>
                                </tr>
                                 <tr>
                                    <td>3. </td>
                                    <td>Post primaria</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_post" value="Post" /></td>
                                </tr>
                                <tr>
                                    <td>4. </td>
                                    <td>Telesecundaria</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_tele" value="Telesecundaria" /></td>
                                </tr>
                                <tr>
                                    <td>5. </td>
                                    <td>Servicio de educación rural –SER-</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_ser" value="SER" /></td>
                                </tr>
                                 <tr>
                                    <td>6. </td>
                                    <td>Programa de educación continuada de CAFAM</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_cafam" value="CAFAM" /></td>
                                </tr>
                                 <tr>
                                    <td>7. </td>
                                    <td>Sistema De Educación Tutorial SAT</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_sat" value="SAT" /></td>
                                </tr>
                                <tr>
                                    <td>8. </td>
                                    <td>Propuesta educativa para jóvenes y adultos A CRECER</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_crecer" value="Crecer" /></td>
                                </tr>
                                <tr>
                                    <td>9. </td>
                                    <td>Otro</td>
                                    <td><input type="checkbox" name="modeducativo" id="modeducativo_otro" value="Otro" /></td>
                                </tr>
                            </tbody>
                        </table>
                        <center>
               ...
               <tr>
                   <td>
                       <table align="center" class="mGridTesoreria">
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="pracinst_1" id="pracinst_1si" value="si" /></td>
                            <td><input type="radio" name="pracinst_1" id="pracinst_1no" value="no" /></td>
                        </tr>
                        <tr>
                            <td>2.</td>
                            <td>La investigación de los estudiantes</td>
                            <td><input type="radio" name="pracinst_2" id="pracinst_2si" value="si" /></td>
                            <td><input type="radio" name="pracinst_2" id="pracinst_2no" value="no" /></td>
                        </tr>
                        <tr>
                            <td>3.</td>
                            <td>Uso de Las TIC de los Docentes</td>
                            <td><input type="radio" name="pracinst_3" id="pracinst_3si" value="si" /></td>
                            <td><input type="radio" name="pracinst_3" id="pracinst_3no" value="no" /></td>
                        </tr>
                        <tr>
                            <td>4.</td>
                            <td>Uso de TIC con los estudiantes</td>
                            <td><input type="radio" name="pracinst_4" id="pracinst_4si" value="si" /></td>
                            <td><input type="radio" name="pracinst_4" id="pracinst_4no" value="no" /></td>
                        </tr>
                    </table>
                   </td>
               </tr>
                ...
                <tr>
                    <td>
                        ...
                        <tr>
                            <td>1.</td>
                            <td>PC</td>
                            <td><input type="checkbox" name="usotics" id="usoticspc" value="PC" /></td>
                        </tr>
                        <tr>
                            <td>2.</td>
                            <td>Portátil</td>
                            <td><input type="checkbox" name="usotics" id="usoticsportatil" value="Portátil" /></td>
                        </tr>
                        <tr>
                            <td>3.</td>
                            <td>Tableta</td>
                            <td><input type="checkbox" name="usotics" id="usoticstableta" value="Tableta" /></td>
                        </tr>
                        <tr>
                            <td>4.</td>
                            <td>Correo electrónico</td>
                            <td><input type="checkbox" name="usotics" id="usoticscorreo" value="Correo electrónico" /></td>
                        </tr>
                        <tr>
                            <td>5.</td>
                            <td>Tablero inteligente</td>
                            <td><input type="checkbox" name="usotics" id="usoticstablero" value="Tablero inteligente" /></td>
                        </tr>
                        <tr>
                            <td>6.</td>
                            <td>Software educativo</td>
                            <td><input type="checkbox" name="usotics" id="usoticssoftware" value="Software educativo" /></td>
                        </tr>
                        <tr>
                            <td>7.</td>
                            <td>Wikis</td>
                            <td><input type="checkbox" name="usotics" id="usoticswikis" value="Wikis" /></td>
                        </tr>
                        <tr>
                            <td>8.</td>
                            <td>Blog</td>
                            <td><input type="checkbox" name="usotics" id="usoticsblog" value="Blog" /></td>
                        </tr>
                        <tr>
                            <td>9.</td>
                            <td>Foros</td>
                            <td><input type="checkbox" name="usotics" id="usoticsforos" value="Foros" /></td>
                        </tr>
                        <tr>
                            <td>10.</td>
                            <td>Otras</td>
                            <td><input type="checkbox" name="usotics" id="usoticsotras" value="Otras" /></td>
                        </tr>
                    </table>
                    </td>
                </tr>
                <tr>
                    <td>
                        <br />
                        6.	Cuales son las prácticas de innovación educativa que se proponen en el PEI. 
                    </td>
                </tr>
                <tr>
                    <td>
                        <textarea cols="80" rows="5" id="txtpracinnova" class="TextBox"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                        <br />
                        7.	El PEI pretende formar en competencias para el uso y apropiación de las TIC
                    </td>
                </tr>
                <tr>
                    <td>
                        Si<input type="radio" name="rbaprotic" id="rbaprotic_si" value="si" />No<input type="radio" name="rbaprotic" id="rbaprotic_no" value="no" />
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <table align="center" class="mGridTesoreria">
                            ...
                            <tbody align="center">
                                <tr>
                                    <td>1. </td>
                                    <td>Pedagógica</td>
                                    <td><input type="checkbox" name="curritic" id="curritic_pedago" value="Pedagógica" /></td>
                                    <td><input type="text" name="txtcurritic" id="txtcurritic_pedago" class="TextBox" /></td>
                                </tr>
                                <tr>
                                    <td>2. </td>
                                    <td>Tecnológica</td>
                                    <td><input type="checkbox" name="curritic" id="curritic_tecno" value="Tecnológica" /></td>
                                    <td><input type="text" name="txtcurritic" id="txtcurritic_tecno" class="TextBox" /></td>
                                </tr>
                                 <tr>
                                    <td>3. </td>
                                    <td>Investigativa</td>
                                    <td><input type="checkbox" name="curritic" id="curritic_inves" value="Investigativa" /></td>
                                    <td><input type="text" name="txtcurritic" id="txtcurritic_inves" class="TextBox" /></td>
                                </tr>
                                 <tr>
                                    <td>4. </td>
                                    <td>Comunicativa</td>
                                    <td><input type="checkbox" name="curritic" id="curritic_comu" value="Comunicativa" /></td>
                                    <td><input type="text" name="txtcurritic" id="txtcurritic_comu" class="TextBox" /></td>
                                </tr>
                                 <tr>
                                    <td>5. </td>
                                    <td>Gestión</td>
                                    <td><input type="checkbox" name="curritic" id="curritic_gest" value="Gestión" /></td>
                                    <td><input type="text" name="txtcurritic" id="txtcurritic_gest" class="TextBox" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
