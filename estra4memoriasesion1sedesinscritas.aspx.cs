...
public partial class estra4memoriasesion1sedesinscritas : System.Web.UI.Page
{
    ...
    public static string estra4memoriassesio1_sedesinscritas()
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_docentes_estudiantes("", "", "", "", "1");
    ...
    public static string realizarBusquedaestra4memoriasesion1_sedesinscritas(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_docentes_estudiantes(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString());
