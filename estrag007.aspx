<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag007.aspx.cs" Inherits="estrag007" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script>
        ...
        function listadobitacora4() {
            $.ajax({
                type: 'POST',
                url: 'estrag007.aspx/listadobitacora4',
    ...
    <script>
        ...
        function btnGuardar_Click(event) {
            ...
            if (event == "insert") {
                ...
                $.ajax({
                    url: 'estrag007.aspx/updateRubros',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
...
<div id="mensaje" runat="server"></div><br /><br />
    ...
    <asp:Label runat="server" ID="lblCodActividad" Visible="false"></asp:Label>
      ...
      <div id="table">
     <a href="#" id="nuevopresupuesto" class="btn btn-primary" style="float:right;" onclick="nuevopresupuesto();">Nuevo Presupuesto</a>
      <br />
      <br />
     <fieldset >
