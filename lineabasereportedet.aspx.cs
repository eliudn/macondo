...
public partial class lineabasereportedet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            obtenerGET();
            cargarDetalleLineaBase02();
        }
    }
    public void obtenerGET()
    {
       lblCodInstrumento.Text = HttpUtility.UrlDecode(HttpContext.Current.Request.QueryString["cins"]);
       lblCodIndicador.Text = HttpUtility.UrlDecode(HttpContext.Current.Request.QueryString["cind"]);
    }
    ...
    private void cargarDetalleLineaBase02()
    {
        string co = "";
        co += "<h2 style='text-decoration: underline;'>Detalle Indicadores 02 - Currículo</h2><br/>";
        co += "<table class='mGridTesoreria'>";
       

        if(lblCodInstrumento.Text == "2" && lblCodIndicador.Text == "1")
        {
            co += "<thead>";
            co += "<tr>";
            co += "<th>DANE</th>";
            co += "<th >CÓDIGO SEDE</th>";
            co += "</tr>";
            co += "<thead>";

            co += NumSedesConCurriculos();
        }
   ...
   private string NumSedesConCurriculos()
    {
        ...
        DataTable dato = lb.cargarSedesConCurriculo();
       ...
       if(dato != null && dato.Rows.Count > 0)
       {
           ...
           {
               co += "<tr>";
               co += "<td>" + dato.Rows[i]["dane"].ToString() + "</td>";
               co += "<td>" + dato.Rows[i]["nombre"].ToString() + "</td>";
               co += "</tr>";
