<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="jornadasformacion.aspx.cs" Inherits="jornadasformacion" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'jornadasformacion.aspx/loadReport',
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "jornadasformacion",
                filename: "jornadasformacion",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
