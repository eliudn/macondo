<%@ Page Title="Grupos de investigación con recursos aprobados por ciclón" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesedesgpbitacora4.aspx.cs" Inherits="detallesedesgpbitacora4" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesedesgpbitacora4.aspx/gruposInvestigacionRecursosB4',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesedesgpbitacora4.aspx/realizarBusquedagruposInvestigacionRecursosB4',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Grupos de investigación con recursos aportados por en Ciclón</h4>
    <p>Mide la proporción de grupos de investigación infantiles y juveniles que han recibido los recursos económicos para desarrollar su proyecto de investigación </p>
