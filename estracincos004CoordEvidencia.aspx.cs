...
public partial class estracincos004CoordEvidencia : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["codrol"] != null)
            {
                ...
                if (Session["codrol"].ToString() != "12")//Coordinador Funtics
                {
                    Panel.Visible = false;
                }
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (usu.agregarArchivoRespositorioEstra5_S004(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblCodInstrumento.Text, rbtActividades.SelectedValue))
                {
                    gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEstra5_S004(lblCodInstrumento.Text);
    ...
    {
        Estrategias usu = new Estrategias();
        DataRow dato = usu.buscarEvidenciaEstra5_S004(cod);
        if (usu.borrarEvidenciaEstra5_S004(cod))
        {
    ...
    {
        if (Session["codrol"].ToString() == "12" )//Coordinador funtics
            Response.Redirect("estracincos004Coord.aspx?e=" + Session["e"].ToString() + "&s=" + Session["s"].ToString());
    }
