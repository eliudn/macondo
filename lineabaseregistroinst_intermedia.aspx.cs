...
public partial class lineabaseregistroinst_intermedia : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string cargarinfoinstitucion()
    {
        ...
        if (datoie != null)
        {
            ...
            ca += datoie["codigo"].ToString() + "&";
			 ...
			 ca += datoie["sedesbeneficidas"].ToString() + "&";
            ca += datoie["isce16"].ToString()  + "&";
            ca += datoie["isce17"].ToString()  + "&";
            ca += datoie["isce18"].ToString()  + "&";
            ca += datoie["isce16s"].ToString() + "&";
            ca += datoie["isce17s"].ToString() + "&";
            ca += datoie["isce18s"].ToString() + "&";
            ca += datoie["isce16m"].ToString() + "&";
            ca += datoie["isce17m"].ToString() + "&";
            ca += datoie["isce18m"].ToString();
        }
