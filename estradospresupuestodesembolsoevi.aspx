<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradospresupuestodesembolsoevi.aspx.cs" Inherits="estradospresupuestodesembolsoevi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 2, Presupuestos grupos de investigación y soporte de desembolso - Cargar Evidencias</h2>
    ...
    <asp:Label ID="lblCodInstrumento" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                  <asp:ListItem>B04 presupuesto</asp:ListItem>
                  <asp:ListItem>Soporte desembolso</asp:ListItem>
                </asp:RadioButtonList>
