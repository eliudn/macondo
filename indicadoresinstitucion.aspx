<%@ Page Title="Indicadores de Institucionales " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="indicadoresinstitucion.aspx.cs" Inherits="indicadoresinstitucion" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //Cargar departamento
            //$("#tableList tbody").html("<tr><td colspan=\"4\" style=\"text-align:center;\">Cargando...</td></tr>");
            $.ajax({
                type: 'POST',
                url: 'indicadoresinstitucion.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresinstitucion.aspx/cargarInsMun',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
                            ...
                            if (resp[0] == "inst") {
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: 'indicadoresinstitucion.aspx/cargarSedesxInstitucion',
                                    data: jsondata,
                                    contentType: "application/json; charset=utf-8",
                                    dataType: "json",
                                ...
                                if ($.get("tipo")  == "est") {
                                    $("#title-report").html("Indicadores estudiantes de la institución educativa: " + $("#institucion option:selected").text());

                                } else {
                                    $("#title-report").html("Indicadores Maestros(as) de la institución educativa: " + $("#institucion option:selected").text());
            ...
            $("#departamento").on("change", function () {
                ...
                //$.ajax({
                //    type: 'POST',
                //    url: 'indicadoresinstitucion.aspx/cargarMunicipios',
                //    data: jsondata,
                //    contentType: 'application/json; charset=utf-8',
                //    dataType: 'JSON',
                //    success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                var jsondata = "{'codDepartamento': '" + $.get("dep") + "', 'codMunicipio':'" + codMunicipio + "','codInstitucion':''}";
                $.ajax({
                    type: 'POST',
                    url: 'indicadoresinstitucion.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                loadsedes(codInstitucion);
            });
            function loadsedes(codInstitucion) {
                var jsondata = "{'codInstitucion':'" + codInstitucion + "', 'codSede':''}";
                $.ajax({
                    type: 'POST',
                    url: 'indicadoresinstitucion.aspx/cargarSedesxInstitucion',
                    data: jsondata,
        ...
        function floadDetalles() {
            //$.ajax({
            //    type: 'POST',
            //    url: 'indicadoresinstitucion.aspx/loadreport',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'JSON',
            //    success: function (response) {
            //        //var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            if (codSede != null) {
                if (codSede != "0") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresinstitucion.aspx/realizarBusquedaloadreport',
                        data: jsondata,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (json) {
                            ...
                            if (resp[0] === "lleno") {
                                ...
                                Highcharts.chart('container', {
                                    ...
                                    title: {
                                        text: 'Porcentaje de ejecución ' + por.toFixed(1) + '%'
                                    },
                                    tooltip: {
    ...
    <fieldset>
         ...
         <table>
                ...
                <tr>
                    ...
                    <td>
                        <select class="TextBox width-100" name="institucion" id="institucion" style="width: 300px">
                        </select>
                    </td>
                    <td>
                        <select class="TextBox width-100" name="sede" id="sede" style="width: 300px">
                        </select>
                    </td>
 ...
 <fieldset>
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
                <th>No.</th>
		        <th>Indicador Sede Educativa</th>
                <th>Peso</th>
