<%@ Page Title=" Sesiones de formación evaluadas y subidas a la plataforma de Ciclón " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra5sesionesrelatos.aspx.cs" Inherits="estra5sesionesrelatos" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra5sesionesrelatos.aspx/estra5relatos',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
