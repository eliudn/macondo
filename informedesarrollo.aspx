<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="informedesarrollo.aspx.cs" Inherits="informedesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'informedesarrollo.aspx/loadReport',
        ...
        function exportExcel() {
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "informedesarrollo",
                filename: "informedesarrollo",
                fileext: ".xls"
            });
        }
    </script>
