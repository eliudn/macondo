<%@ Page Title="Acceso de las redes temáticas a las tabletas entregadas por el Proyecto a las sedes educativas beneficiadas" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="usoconectividadformacionmaestros.aspx.cs" Inherits="usoconectividadformacionmaestros" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'usoconectividadformacionmaestros.aspx/usoconectividadformacionmaestros_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
