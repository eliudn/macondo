<%@ Page Title="Docentes que participaron en la evaluación intermedia según último nivel educativo aprobado" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detalleDocenteImpacto.aspx.cs" Inherits="detalleDocenteImpacto" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detalleDocenteImpacto.aspx/docentesEvaluacionintermedia_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        // realizar busqueda
         function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detalleDocenteImpacto.aspx/realizarBusquedadocentesEvaluacionintermedia_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    ...
                    <td>
                        <select class="TextBox width-100" name="respuesta" id="instrumento" style="width: 250px">
                            ...
                            <option value="Si_5">  Realizaron el instrumento 5</option>
                             ...
                             <option value="Si_4">  Realizaron el instrumento 4</option>
