<%@ Page Title=" Ejemplares de la caja de herramientas  que soporta la formación de maestros(as)" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra2ejemplarescajaherramientas.aspx.cs" Inherits="estra2ejemplarescajaherramientas" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2ejemplarescajaherramientas.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estra2ejemplarescajaherramientas.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra2ejemplarescajaherramientas.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra2ejemplarescajaherramientas.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2ejemplarescajaherramientas.aspx/estra2EjemplaresCajaHerramientas_',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2ejemplarescajaherramientas.aspx/realizarBusquedaestra2EjemplaresCajaHerramientas_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Impresión de materiales pedagógicos para el apoyo a la estrategia de autoformación </h2>
    ...
    <h4 >Ejemplares de la caja de herramientas  que soporta la formación de maestros(as)  del Proyecto Ciclón impresos y distribuidos </h4>
    <p>Caja de herramientas del Proyecto Ciclón <br />
        G006: Entrega de material pedagógico </p>    
    <br />
