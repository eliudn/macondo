...
public partial class estra5detallediseno : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        titulo.Text = "Diseño de lineamientos de la estrategia formación en los lineamientos del programa Ondas y su propuesta metodológica dirigida a los funcionarios";
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5diseno()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable lienamientos = est.est_EvidenciasEstras5Coordinador("", "", "", "", "5", "Diseño de lineamientos de la estrategia formación");
