<%@ Page Title="sedes con grupos de investigación" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesdesarrollo.aspx.cs" Inherits="detallesdesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/totalSedesGrupoInvestigacion',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/realizarBusquedaTotalSedesGrupoInvestigacion',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
