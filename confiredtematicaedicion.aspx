<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confiredtematicaedicion.aspx.cs" Inherits="confiredtematicaedicion" %>
...
<h2 >Reestructurar Redes Temáticas</h2><br />
     <asp:UpdatePanel ID="UpdatePanel4" runat="server">
   <ContentTemplate>
<fieldset>
<legend>Reds Temáticas</legend>
                         ...
                         <td>
                              <asp:UpdatePanel runat="server" ID="UpdatePanel3" UpdateMode="Conditional">
                                <ContentTemplate>
                                    ...
                                    <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender4" runat="server" Enabled="True" TargetControlID="RFVdropAnio"
                     ...
                     <asp:GridView ID="GridEstudiante" runat="server" CellPadding="4" DataKeyNames="rt_codproyectomatricula" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="No.">
                             ...
                             <asp:BoundField DataField="rt_codproyectomatricula" HeaderText="rt_codproyectomatricula" HeaderStyle-CssClass="ocultarcell">
