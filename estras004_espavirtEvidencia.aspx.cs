...
public partial class estras004_espavirtEvidencia : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["codrol"] != null)
            {
                ...
                if (Session["codrol"].ToString() == "12" || Session["codrol"].ToString() == "9" || Session["codrol"].ToString() == "18" || Session["codrol"].ToString() == "20")//Coordinador y Supervisor Funtics
                {
                    Panel.Visible = false;
                    GridEvidencias.Columns[9].Visible = false;
                }
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (usu.agregarArchivoRespositorioEstrategiaS004_EspVirtuales(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblCodInstrumento.Text, rbtActividades.SelectedValue))
                {
                    gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEstrategiaS004_EspVirtuales(lblCodInstrumento.Text);
    ...
    {
        Estrategias usu = new Estrategias();
        DataRow dato = usu.buscarEvidenciaEstrategiaS004_EspVirtuales(cod);
        if (usu.borrarEvidenciaEstrategiaS004_EspVirtuales(cod))
        {
    ...
    protected void btnRegresar_Click(object sender, EventArgs e)
    {
        if(Session["codrol"].ToString()=="13")
            ...
            Response.Redirect("estras004_espavirt_coordinador.aspx?e=" + Session["e"].ToString() + "&m=" + Session["m"].ToString() + "&s=" + Session["s"].ToString());
    }
