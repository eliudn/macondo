<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoplanesdetrabajo.aspx.cs" Inherits="estraunoplanesdetrabajo" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Plan de trabajo de la asesoría <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
...
<asp:Panel runat="server" ID="PanelMostrarEvidencias" Visible="true">
     ...
     <fieldset>
         ...
         <asp:Panel runat="server" ID="PanelPlan0" Visible="false">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem Value="1">Momento pedagógico 3: Acompañamiento para el desarrollo de las etapas, diseño y recorrido de las trayectorias de indagación. </asp:ListItem>
                    <asp:ListItem Value="2">Momento pedagógico 4: Acompañamiento para la reflexión de Ciclón. </asp:ListItem>
                    <asp:ListItem Value="3">Momento pedagógico 5: Acompañamiento para la propagación de Ciclón. </asp:ListItem>
                </asp:RadioButtonList>
         </asp:Panel>
