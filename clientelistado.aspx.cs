...
public partial class clientelistado : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ddDepartamento(dropDepartamentos);
    ...
    protected void dropProyectos_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (dropProyectos.SelectedIndex > 0)
        {
            ...
            GridClientes.DataSource = cli.cargarClientesxCodProyecto(dropProyectos.SelectedValue);
    ...
    protected void dropDepartamentos_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (dropDepartamentos.SelectedIndex > 0)
        {
            ...
            ddMunicipio(dropMunicipio, dropDepartamentos.SelectedValue);
    ...
    {
        return cli.cargarClientesWhere(llenarWhere());
    }
    ...
    protected void GridClientes_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        ...
        if (dropProyectos.SelectedIndex > 0 && dropDepartamentos.SelectedIndex == 0)
        {
            GridClientes.DataSource = cli.cargarClientesxCodProyecto(dropProyectos.SelectedValue);
            GridClientes.DataBind();
        }
    ...
    private string llenarWhere()
    {
        ...
        cond[2] = string.Empty;  //busqueda individual 
        ...
        if (dropDepartamentos.SelectedIndex > 0)
        {
            ...
            {
                cond[0] = string.Empty;
                cond[1] = "s.`codmunicipio`='" + dropMunicipio.SelectedValue + "'";
                cond[2] = string.Empty;
            }
            else
            {
                cond[0] = "m.`coddepartamento`='" + dropDepartamentos.SelectedValue + "'";
                cond[1] = string.Empty;
                cond[2] = string.Empty;
            } 
        ...
        else if (txtBusqueda.Text != "")
        {
            cond[0] = string.Empty;
            cond[1] = string.Empty;
            cond[2] = "CONCAT_WS(' ',c.`nit`,s.`nombre`)='"+txtBusqueda.Text+"'";
        }
