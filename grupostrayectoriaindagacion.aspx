<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="grupostrayectoriaindagacion.aspx.cs" Inherits="grupostrayectoriaindagacion" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'grupostrayectoriaindagacion.aspx/loadReport',
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'grupostrayectoriaindagacion.aspx/realizarbusqueda',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "grupostrayectoriaindagacion",
                filename: "grupostrayectoriaindagacion",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2>Grupos de investigación que elaboran el presupuesto y diseñan las trayectorias de indagación en CICLÓN</h2>
