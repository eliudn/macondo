<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag001_estrategia4_2016.aspx.cs" Inherits="estrag001_estrategia4_2016" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script>
        $(function () {
            ...
            /*//////////////////////////////////////////////////////////////////////////////////////////////////////
            $.ajax({
                url: 'estrag001_estrategia4_2016.aspx/cargarInstituciones',
                type: 'POST',
            ...
            $("#instituciones").on('change', function () {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_2016.aspx/cargarSedesInstitucion',
                    type: 'POST',
                    data: data,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#sedes").on("change", function () {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_2016.aspx/cargarRedTematica',
                    type: 'POST',
                    data: data,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#redtematica").on("change", function () {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_2016.aspx/cargarEstudiantes',
                    type: 'POST',
                    data: data,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
        ...
        function cargarEncabezados() {
            $.ajax({
                type: 'POST',
                url: 'estrag001_estrategia4_2016.aspx/cargarEncabezados',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function btnGuardar_Click() {
            ...
            if ($.trim($("#fecha").val()) == '' || $.trim($("#fecha").val()) == null) {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_2016.aspx/encabezado',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
                        ...
                        for (var i = 0; i < dataTabla.length; i++) {
                            ...
                            $.ajax({
                                url: 'estrag001_estrategia4_2016.aspx/estudianteInasistente',
                                type: 'POST',
                                data: jsonData,
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'JSON',
        ...
        function updateEstudiante(cod) {
            ...
            if ($.trim($("#nombreEst").val()) == '' || $.trim($("#nombreEst").val()) == null) {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_2016.aspx/actualizarEstudiante',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#dialog-confirm").dialog({
                ...
                buttons: {
                    Eliminar: function () {
                        ...
                        $.ajax({
                            url: 'estrag001_estrategia4_2016.aspx/eliminarEstudiante',
                            type: 'POST',
                            data: data,
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'JSON',
