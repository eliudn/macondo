<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="verestudiantesxsede_sindpto.aspx.cs" Inherits="verestudiantesxsede_sindpto" %>
     ...
     <link rel="stylesheet" href="//code.jquery.com/ui/1.12.0/themes/base/jquery-ui.css"/>
      ...
      <script language="javascript" type="text/javascript">
          ...
          function buscar() {
              ...
              $(function () {
                  $('#dropInstituciones').filterByText($('#textbox'), false);
                  $("#dropInstituciones option").click(function () {
                      alert(1);
                  });
              });
          }
        ...
        <legend>Datos institucionales</legend>
              ...
              <td>
                  ...
                  <tr>
                        <td>Filtrar</td>
                        <td>
                            <input id="textbox" type="text" class="TextBox" style="width: 200px" placeholder="Digita Nombre o NIT" onkeyup="buscar()" /></td>
                    </tr>   
                     ...
                     <tr>
                        ...
                        <td>
                             <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DropDownList ClientIDMode="Static" runat="server" ID="dropInstituciones" CssClass="TextBox" AutoPostBack="true" OnSelectedIndexChanged="dropInstituciones_SelectedIndexChanged" ></asp:DropDownList>
         ...
         <asp:GridView ID="GridEstudiante" runat="server" CellPadding="4" DataKeyNames="codestumatricula" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="nombre"  HeaderText="Nombre" >
                             ...
                             <asp:BoundField DataField="fecha_matricula" HeaderText="Fecha de carga">
                                <ItemStyle HorizontalAlign="center" />
                            </asp:BoundField>  
                              ...
                              <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:ImageButton ID="lnkEliminarMatricula" runat="server" ImageUrl="~/Imagenes/delete.png" Height="20px" Width="20px" OnClick="lnkEliminarMatricula_Click" OnClientClick="if(!confirm('¿Está Seguro en realizar esta acción?')){ return false; };" />
