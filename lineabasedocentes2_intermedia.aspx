<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="lineabasedocentes2_intermedia.aspx.cs" Inherits="lineabasedocentes2_intermedia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function buscarasesor() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/buscarasesor',
                ...
                success: function (json) {
                    ...
                    if (resp[1] === "true") {
                        $("#asesor").html(resp[0]);
                        cargarrespuestaspregunta($("#asesor").val(), "2",  "1");
                        cargarrespuestaspregunta($("#asesor").val(), "2", "2");
                        cargarrespuestaspregunta($("#asesor").val(), "2", "3");
                        cargarrespuestaspregunta($("#asesor").val(), "2", "4");
                        ...
                        cargarrespuestaspregunta($("#asesor").val(), "5", "");
                        cargarrespuestaspregunta($("#asesor").val(), "6", "");
                        cargarrespuestaspregunta($("#asesor").val(), "8", "");
                        cargarrespuestaspregunta($("#asesor").val(), "10", "");

                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "1", "tipo", "1");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "2", "modalidad", "1");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "3", "tipo", "2");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "4", "modalidad", "2");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "5", "tipo", "3");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "6", "modalidad", "3");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "7", "tipo", "4");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "2", "8", "modalidad", "4");

                        cargarrespuestaspreguntacerrada_radio($("#asesor").val(), "3", "0", "rbpedago", "");
                        cargarrespuestaspreguntacerrada_radio($("#asesor").val(), "4", "0", "rbpromueve", "");
                        cargarrespuestaspreguntacerrada_radio($("#asesor").val(), "5", "0", "rbparticipado", "");
                        ...
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "1", "preg7tipo", "1");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "2", "preg7modalidad", "1");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "3", "preg7tipo", "2");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "4", "preg7modalidad", "2");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "5", "preg7tipo", "3");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "6", "preg7modalidad", "3");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "7", "preg7tipo", "4");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "7", "8", "preg7modalidad", "4");

                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "1", "preg9tipo", "1");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "2", "preg9modalidad", "1");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "3", "preg9tipo", "2");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "4", "preg9modalidad", "2");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "5", "preg9tipo", "3");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "6", "preg9modalidad", "3");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "7", "preg9tipo", "4");
                        cargarrespuestaspreguntacerrada_2($("#asesor").val(), "9", "8", "preg9modalidad", "4");

                        cargarrespuestaspregunta($("#asesor").val(), "11.1", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.2", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.3", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.4", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.5", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.6", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.7", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.8", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.9", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.10", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.11", "");
                        cargarrespuestaspregunta($("#asesor").val(), "11.12", "");
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarasesores',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    var resp = json.d.split("&");
        ...
        function cargarrespuestaspregunta(codasesor,pregunta,numero) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestaspregunta',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        switch (pregunta) {
                            case "2":
                                $("#nombre_" + numero).val(resp[1]);
                                $("#duracion_" + numero).val(resp[2]);
                                $("#anio_" + numero).val(resp[3]);
                                break;
                            case "3":
                                $("#txtpedago").val(resp[1]);
                                break;
                            case "4":
                                $("#txtpromueve").val(resp[1]);
                                break;
                            case "5":
                                $("#txtparticipado").val(resp[1]);
                                break;
                            case "6":
                                $("#txtinvestiga").val(resp[1]);
                                break;
                            case "7":
                                $("#preg7nombre_" + numero).val(resp[1]);
                                $("#preg7duracion_" + numero).val(resp[2]);
                                $("#preg7anio_" + numero).val(resp[3]);
                                break;
                            case "8":
                                $("#preg8rbforma").val(resp[1]);
                                break;
                            case "9":
                                $("#preg9nombre_" + numero).val(resp[1]);
                                $("#preg9duracion_" + numero).val(resp[2]);
                                $("#preg9anio_" + numero).val(resp[3]);
                                break;
                            case "10":
                                $("#preg10rbforma").val(resp[1]);
                                break;
                            case "11.1":
                                $("#txtnivel_bachillerato").val(resp[1]);
                              
                                break;
                            case "11.2":
                               
                                $("#txtnivel_normalista").val(resp[1]);
                                
                                break;
                            case "11.3":
                               
                                $("#txtnivel_otrobachillerato").val(resp[1]);
                               
                                break;
                            case "11.4":
                               
                                $("#txtnivel_tecnico").val(resp[1]);
                               
                                break;
                            case "11.5":
                              
                                $("#txtnivel_otrotecnico").val(resp[1]);
                               
                                break;
                            case "11.6":
                               
                                $("#txtnivel_profesional").val(resp[1]);
                                
                                break;
                            case "11.7":
                              
                                $("#txtnivel_otroprofesional").val(resp[1]);
                               
                                break;
                            case "11.8":
                              
                                $("#txtnivel_especializacion").val(resp[1]);
                               
                                break;
                            case "11.9":
                              
                                $("#txtnivel_maestria").val(resp[1]);
                              
                                break;
                            case "11.10":
                              
                                $("#txtnivel_otromaestria").val(resp[1]);
                              
                                break;
                            case "11.11":
                                $("#txtnivel_doctorado").val(resp[1]);
                                break;
                            case "11.12":
                                $("#txtnivel_otrodoctorado").val(resp[1]);
                                break;
                        }
        ...
        function cargarrespuestaspreguntacerrada_2(codasesor, pregunta, subpregunta, nombre, numero) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestaspreguntacerrada_2',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk1(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestascerradaschk1',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        $("input[name=clasefuncionario]").each(function (index) {
                            if (resp[i] == "Directivo docente")
                                $("#directivodocente").attr('checked', true);

                            if (resp[i] == "Docentes")
                                $("#docente").attr('checked', true);

                            if (resp[i] == "Docentes de educación especial")
                                $("#docenteeduesp").attr('checked', true);

                            if (resp[i] == "Docentes de etnoeducación")
                                $("#docenteetno").attr('checked', true);

                            if (resp[i] == "Consejeros escolares")
        ...
        function cargarrespuestascerradaschk4(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestascerradaschk4',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk5(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestascerradaschk5',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk6(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestascerradaschk6',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk11(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestascerradaschk11',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        var i = 1;
                        $("input[name=ultimonivel]").each(function (index) {
                            if (resp[i] == "Bachillerato pedagógico")
                                $("#rbnivel_bachillerato").attr('checked', true);

                            if (resp[i] == "Normalista Superior")
                                $("#rbnivel_normalista").attr('checked', true);

                            if (resp[i] == "Otro bachillerato")
                                $("#rbnivel_otrobachillerato").attr('checked', true);

                            if (resp[i] == "Técnico o tecnológico")
                                $("#rbnivel_tecnico").attr('checked', true);

                            if (resp[i] == "Otro Técnico o tecnológico")
                                $("#rbnivel_otrotecnico").attr('checked', true);

                            if (resp[i] == "Profesional pedagógico")
                                $("#rbnivel_profesional").attr('checked', true);

                            if (resp[i] == "Otro profesional")
                                $("#rbnivel_otroprofesional").attr('checked', true);

                            if (resp[i] == "Especialización")
                                $("#rbnivel_especializacion").attr('checked', true);

                            if (resp[i] == "Maestría en educación o pedagogía")
                                $("#rbnivel_maestria").attr('checked', true);
        ...
        function enviar() {
            if ($.trim($("#asesor").val()) == '' || $.trim($("#asesor").val()) == '0') {
                ...
                //$("#direccion").focus();
            } else if (!$("input[name=rbpromueve]:checked").val()) {
                alert("Por favor, seleccione una opción de la pregunta No. 4");
                //$("#telefono").focus();
            } else if (!$("input[name=rbparticipado]:checked").val()) {
                ...
                //$("#telefono").focus();
            } else if (!$("input[name=preg8rbforma]:checked").val()) {
                alert("Por favor, seleccione una opción de la pregunta No. 8");
                //$("#telefono").focus();
            } else if (!$("input[name=preg10rbforma]:checked").val()) {
        ...
        function guardarpreguntas() {
            ...
            guardarpreguntascerradas_radio($("#asesor").val(), $('input:radio[name=rbpromueve]:checked').val(), "4", "0", "");
            guardarpreguntascerradas_radio($("#asesor").val(), $('input:radio[name=rbparticipado]:checked').val(), "5", "0", "");
            guardarpreguntascerradas_radio($("#asesor").val(), $('input:radio[name=rbinvestiga]:checked').val(), "6", "0", "");
            guardarpreguntascerradas_radio($("#asesor").val(), $('input:radio[name=preg8rbforma]:checked').val(), "8", "0", "");
            guardarpreguntascerradas_radio($("#asesor").val(), $('input:radio[name=preg10rbforma]:checked').val(), "10", "0", "");

            //Preguntas abiertas
            //Pregunta 2 los text
            guardarpreguntasabiertas_preg2($("#asesor").val(), "nombre", "duracion", "anio", "1", "2.1", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "nombre", "duracion", "anio", "2", "2.2", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "nombre", "duracion", "anio", "3", "2.3", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "nombre", "duracion", "anio", "4", "2.4", "delete");

            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg7nombre", "preg7duracion", "preg7anio", "1", "7.1", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg7nombre", "preg7duracion", "preg7anio", "2", "7.2", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg7nombre", "preg7duracion", "preg7anio", "3", "7.3", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg7nombre", "preg7duracion", "preg7anio", "4", "7.4", "delete");

            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg9nombre", "preg9duracion", "preg9anio", "1", "9.1", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg9nombre", "preg9duracion", "preg9anio", "2", "9.2", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg9nombre", "preg9duracion", "preg9anio", "3", "9.3", "delete");
            guardarpreguntasabiertas_preg2($("#asesor").val(), "preg9nombre", "preg9duracion", "preg9anio", "4", "9.4", "delete");

            //Pregunta 3, 4, 5, 6, 8, 10 text
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtpedago", "3", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtpromueve", "4", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtparticipado", "5", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtinvestiga", "6", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "preg8rbforma", "8", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "preg10rbforma", "10", "delete");

            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_bachillerato", "11.1", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_normalista", "11.2", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_otrobachillerato", "11.3", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_tecnico", "11.4", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_otrotecnico", "11.5", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_profesional", "11.6", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_otroprofesional", "11.7", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_especializacion", "11.8", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_maestria", "11.9", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_otromaestria", "11.10", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_doctorado", "11.11", "delete");
            guardarpreguntasabiertas_preg3($("#asesor").val(), "txtnivel_otrodoctorado", "11.12", "delete");
        ...
        function guardarpreguntasabiertas_preg2(codasesor, nombre, duracion, anio, numero, pregunta, accion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/guardarpreguntasabiertas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
        ...
        function guardarpreguntascerradas_radio(codasesor, nombre, pregunta, subpregunta, accion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/guardarpreguntascerradas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
        ...
        function guardarpreguntascerradaschk1() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/eliminarchk1',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=clasefuncionario]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'lineabasedocentes2_intermedia.aspx/guardardatoschk1',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk4() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/eliminarchk4',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=modalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'lineabasedocentes2_intermedia.aspx/guardardatoschk4',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk5() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/eliminarchk5',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=partimodalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'lineabasedocentes2_intermedia.aspx/guardardatoschk5',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk6() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/eliminarchk6',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=investigamodalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'lineabasedocentes2_intermedia.aspx/guardardatoschk6',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
                ...
                success: function () {
                    ...
                    $("input[name=ultimonivel]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'lineabasedocentes2_intermedia.aspx/guardardatoschk11',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <h2>
            Instrumento No. 05, Formación y experiencia de los/las docentes vinculados al proyecto  en TIC, CTeI e investigación

            <br />(Cambios en el Perfil)<br /><br />Fuente información primaria
        </h2>
        ...
        <fieldset>
            ...
            <table style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
               <tr>
                   <td class="bold">
                       1.	Clase de funcionario
                   </td>
               </tr>
                <tr>
                    <td>
                        01. <input type="checkbox" id="directivodocente" name="clasefuncionario" value="Directivo docente" />Directivo docente<br />
                        02. <input type="checkbox" id="docente" name="clasefuncionario" value="Docentes" />Docentes (no incluya educadores especiales ni etnoeducadores) <br />
                        03. <input type="checkbox" id="docenteeduesp" name="clasefuncionario" value="Docentes de educación especial" />Docentes de educación especial.<br />
                        04. <input type="checkbox" id="docenteetno" name="clasefuncionario" value="Docentes de etnoeducación" />Docentes de etnoeducación.<br />

                        <br /><b>Otros</b><br />

                        05. <input type="checkbox" id="consejero" name="clasefuncionario" value="Consejeros escolares" />Consejeros escolares, capellanes, orientadores, sicólogos y trabajadores sociales.<br />
                        06. <input type="checkbox" id="medico" name="clasefuncionario" value="Médicos" />Médicos, odontólogos, nutricionistas, terapeutas y enfermeros.  <br />
                        07. <input type="checkbox" id="admin" name="clasefuncionario" value="Administrativos" />Administrativos (de apoyo y personal de servicios generales)<br />
                        08. <input type="checkbox" id="profesionales" name="clasefuncionario" value="Profesionales" />Profesionales de apoyo en el aula para estudiantes con discapacidad o capacidades excepcionales (intérpretes, tiflólogos, etc.)<br />
                        09. <input type="checkbox" id="tutores" name="clasefuncionario" value="Tutores" />Tutores<br />
                        10. <input type="checkbox" id="directivos" name="clasefuncionario" value="Directivos" />Directivos (rectores, directores, coordinadores, supervisores, secretarios académicos).<br />
                        11. <input type="checkbox" id="auxiliar" name="clasefuncionario" value="Auxiliar de aula" />Auxiliar de aula.<br />
                    </td>
                </tr>
                <tr>
                     <td class="bold">
                         <br />
                         2.	Ha recibido formación específica en Investigación
                    </td>
                </tr>
                <tr>
                    <td>
                        <table align="center" class="mGridTesoreria">
                           <thead>
                            ...
                            <tbody>
                                <tr>
                                   <td><select id="tipo_1" class="TextBox">
                                    ...
                                    <td><input type="text" class="TextBox" id="nombre_1" /></td>
                                    <td><input type="text" class="TextBox" id="duracion_1" /></td>
                                    <td><input type="text" class="TextBox" id="anio_1" /></td>
                                    <td><select id="modalidad_1" class="TextBox">
                                        <option value="N/A">N/A</option>
                                ...
                                <tr>
                                  <td><select id="tipo_2" class="TextBox">
                                      <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="nombre_2" /></td>
                                    <td><input type="text" class="TextBox" id="duracion_2" /></td>
                                    <td><input type="text" class="TextBox" id="anio_2" /></td>
                                    <td><select id="modalidad_2" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                ...
                                <tr>
                                   <td><select id="tipo_3" class="TextBox">
                                       <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="nombre_3" /></td>
                                    <td><input type="text" class="TextBox" id="duracion_3" /></td>
                                    <td><input type="text" class="TextBox" id="anio_3" /></td>
                                    <td><select id="modalidad_3" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                 ...
                                 <tr>
                                   <td><select id="tipo_4" class="TextBox">
                                       <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="nombre_4" /></td>
                                    <td><input type="text" class="TextBox" id="duracion_4" /></td>
                                    <td><input type="text" class="TextBox" id="anio_4" /></td>
                                    <td><select id="modalidad_4" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                ...
                <tr>
                     <td class="bold">
                         <br />
                        3.	Esta formación contribuyó a cambiar sus prácticas pedagógicas. 
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                     <td class="bold">
                         <br />
                         4.	Ha participado en proyecto de investigación dentro de la Institución Educativa</td>
                </tr>
               <tr>
                    <td>
                        <input id="rbpromueve_si" name="rbpromueve" type="radio" value="si" />Si <input id="rbpromueve_no" type="radio" name="rbpromueve" value="no" />No
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                         <textarea id="txtpromueve" class="TextBox" cols="50" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="bold">
                ...
                <tr>
                    <td class="bold"><br />
                        5.	Ha participado en proyecto de investigación Fuera de la Institución Educativa
                    </td>
                </tr>
                <tr>
                    <td>
                        <input id="rbparticipado_si" name="rbparticipado" type="radio" value="si" />Si <input id="rbparticipado_no" type="radio" name="rbparticipado" value="no" />No
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                          <textarea id="txtparticipado" class="TextBox" cols="50" rows="5"></textarea>
                    </td>
                </tr>
                 <tr>
                    <td class="bold">
                ...
                <tr>
                     <td class="bold">
                         <br />
                        6.	Ha realizado proyecto e investigación con niños, Niñas y  Jóvenes como práctica pedagógica
                    </td>
                </tr>
                 <tr>
                    <td>
                        <input id="rbinvestiga_si" name="rbinvestiga" type="radio" value="si" />Si <input id="rbinvestiga_no" type="radio" name="rbinvestiga" value="no" />No
                    </td>
                </tr>
                 <tr>
                    <td>
                ...
                <tr>
                    <td>
                          <textarea id="txtinvestiga" class="TextBox" cols="50" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="bold">
                ...
                <tr>
                 ...
                 <tr>
                    <td class="bold">
                        <br />
                        7.	Ha recibido formación específica en Ciencia, Tecnología e Innovación:
                    </td>
                </tr>
                <tr>
                    <td>
                        <table align="center" class="mGridTesoreria">
                           <thead>
                            ...
                            <tbody>
                                <tr>
                                   <td><select id="preg7tipo_1" class="TextBox">
                                       <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg7nombre_1" /></td>
                                    <td><input type="text" class="TextBox" id="preg7duracion_1" /></td>
                                    <td><input type="text" class="TextBox" id="preg7anio_1" /></td>
                                    <td><select id="preg7modalidad_1" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                ...
                                <tr>
                                   <td><select id="preg7tipo_2" class="TextBox">
                                       <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg7nombre_2" /></td>
                                    <td><input type="text" class="TextBox" id="preg7duracion_2" /></td>
                                    <td><input type="text" class="TextBox" id="preg7anio_2" /></td>
                                    <td><select id="preg7modalidad_2" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                ...
                                <tr>
                                   <td><select id="preg7tipo_3" class="TextBox">
                                       <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg7nombre_3" /></td>
                                    <td><input type="text" class="TextBox" id="preg7duracion_3" /></td>
                                    <td><input type="text" class="TextBox" id="preg7anio_3" /></td>
                                    <td><select id="preg7modalidad_3" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                 ...
                                 <tr>
                                  <td><select id="preg7tipo_4" class="TextBox">
                                      <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg7nombre_4" /></td>
                                    <td><input type="text" class="TextBox" id="preg7duracion_4" /></td>
                                    <td><input type="text" class="TextBox" id="preg7anio_4" /></td>
                                    <td><select id="preg7modalidad_4" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                ...
                <tr>
                    <td class="bold">
                        <br />
                        8.	Esta formación contribuyó a cambiar sus prácticas pedagógicas
                    </td>
                </tr>
                <tr>
                    <td>
                        <input id="preg8rbforma_si" name="preg8rbforma" type="radio" value="si" />Si <input id="preg8rbforma_no" type="radio" name="preg8rbforma" value="no" />No
                    </td>
                </tr>
                 <tr>
                    <td>
                ...
                <tr>
                    <td>
                          <textarea id="preg8rbforma" class="TextBox" cols="50" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="bold">
                        <br />
                       9.	Ha recibido formación específica en TIC
                    </td>
                </tr>
                <tr>
                    <td>
                        <table align="center" class="mGridTesoreria">
                           <thead>
                            ...
                            <tbody>
                                <tr>
                                  <td><select id="preg9tipo_1" class="TextBox">
                                      <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg9nombre_1" /></td>
                                    <td><input type="text" class="TextBox" id="preg9duracion_1" /></td>
                                    <td><input type="text" class="TextBox" id="preg9anio_1" /></td>
                                    <td><select id="preg9modalidad_1" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                ...
                                <tr>
                                   <td><select id="preg9tipo_2" class="TextBox">
                                      <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg9nombre_2" /></td>
                                    <td><input type="text" class="TextBox" id="preg9duracion_2" /></td>
                                    <td><input type="text" class="TextBox" id="preg9anio_2" /></td>
                                    <td><select id="preg9modalidad_2" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                ...
                                <tr>
                                   <td><select id="preg9tipo_3" class="TextBox">
                                      <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg9nombre_3" /></td>
                                    <td><input type="text" class="TextBox" id="preg9duracion_3" /></td>
                                    <td><input type="text" class="TextBox" id="preg9anio_3" /></td>
                                    <td><select id="preg9modalidad_3" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                                 ...
                                 <tr>
                                  <td><select id="preg9tipo_4" class="TextBox">
                                      <option value="N/A">N/A</option>
                                        <option value="Curso  corto">Curso  corto</option>
                                        <option value="Pregrado">Pregrado</option>
                                       <option value="Especialización">Especialización</option>
                                    ...
                                    <td><input type="text" class="TextBox" id="preg9nombre_4" /></td>
                                    <td><input type="text" class="TextBox" id="preg9duracion_4" /></td>
                                    <td><input type="text" class="TextBox" id="preg9anio_4" /></td>
                                    <td><select id="preg9modalidad_4" class="TextBox">
                                        <option value="N/A">N/A</option>
                                        <option value="Presencial">Presencial</option>
                                        <option value="Virtual">Virtual</option>
                                        </select></td>
                 ...
                 <tr>
                    <td class="bold">
                        <br />
                       10.	Esta formación contribuyó a cambiar sus prácticas pedagógicas  
                    </td>
                </tr>
                <tr>
                    <td>
                        <input id="preg10rbforma_si" name="preg10rbforma" type="radio" value="si" />Si <input id="preg10rbforma_no" type="radio" name="preg10rbforma" value="no" />No
                    </td>
                </tr>
                 <tr>
                    <td>
                ...
                <tr>
                    <td>
                          <textarea id="preg10rbforma" class="TextBox" cols="50" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="bold">
                       11. Ultimo nivel de formación obtenido
                    </td>
                </tr>
                <tr>
                    <td align="center">
                        <table class="mGridTesoreria">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Bachillerato pedagógico</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_bachillerato" type="checkbox" value="Bachillerato pedagógico" /></td>
                                    <td><input id="txtnivel_bachillerato" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                 <tr>
                                    <td>2</td>
                                    <td>Normalista Superior</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_normalista" type="checkbox" value="Normalista Superior" /></td>
                                    <td><input id="txtnivel_normalista" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Otro bachillerato</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_otrobachillerato" type="checkbox" value="Otro bachillerato" /></td>
                                    <td><input id="txtnivel_otrobachillerato" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                 <tr>
                                    <td>4</td>
                                    <td>Técnico o tecnológico</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_tecnico" type="checkbox" value="Técnico o tecnológico" /></td>
                                    <td><input id="txtnivel_tecnico" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>Otro Técnico o tecnológico</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_otrotecnico" type="checkbox" value="Otro Técnico o tecnológico" /></td>
                                    <td><input id="txtnivel_otrotecnico" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>Profesional pedagógico</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_profesional" type="checkbox" value="Profesional pedagógico" /></td>
                                    <td><input id="txtnivel_profesional" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                <tr>
                                    <td>7</td>
                                    <td>Otro profesional</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_otroprofesional" type="checkbox" value="Otro profesional" /></td>
                                    <td><input id="txtnivel_otroprofesional" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                 <tr>
                                    <td>8</td>
                                    <td>Especialización</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_especializacion" type="checkbox" value="Especialización" /></td>
                                    <td><input id="txtnivel_especializacion" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                <tr>
                                    <td>9</td>
                                    <td>Maestría en educación o pedagogía</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_maestria" type="checkbox" value="Maestría en educación o pedagogía" /></td>
                                    <td><input id="txtnivel_maestria" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                 <tr>
                                    <td>10</td>
                                    <td>Otra Maestría</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_otromaestria" type="checkbox" value="Otra Maestría" /></td>
                                    <td><input id="txtnivel_otromaestria" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                 <tr>
                                    <td>11</td>
                                    <td>Doctorado en educación o pedagogía</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_doctorado" type="checkbox" value="Doctorado en educación o pedagogía" /></td>
                                    <td><input id="txtnivel_doctorado" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                                 <tr>
                                    <td>12</td>
                                    <td>Otro Doctorado</td>
                                    <td align="center"><input name="ultimonivel" id="rbnivel_otrodoctorado" type="checkbox" value="Otro Doctorado" /></td>
                                    <td><input id="txtnivel_otrodoctorado" type="text" class="TextBox" style="width:50px;" /></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
