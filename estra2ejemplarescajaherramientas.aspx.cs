...
public partial class estra2ejemplarescajaherramientas : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra2EjemplaresCajaHerramientas_()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = estra2EjemplaresCajaHerramientas.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra2EjemplaresCajaHerramientas.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra2EjemplaresCajaHerramientas.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra2EjemplaresCajaHerramientas.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra2EjemplaresCajaHerramientas.Rows[i]["dane"].ToString() + " - " + estra2EjemplaresCajaHerramientas.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + estra2EjemplaresCajaHerramientas.Rows[i]["danesede"].ToString() + " - " + estra2EjemplaresCajaHerramientas.Rows[i]["nombresede"].ToString() + " </td>";
                ca += "<td>" + estra2EjemplaresCajaHerramientas.Rows[i]["nombrequienrecibe"].ToString() + " </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra2EjemplaresCajaHerramientas_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2EjemplaresCajaHerramientas = est.estra2EjemplaresCajaHerramientas(coddepartamento, codmuncipio, codinstitucion, codsede);
