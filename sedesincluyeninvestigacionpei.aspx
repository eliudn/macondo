<%@ Page Title="Sedes educativas que incluyen investigación en los énfasis formativos de sus PEI" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="sedesincluyeninvestigacionpei.aspx.cs" Inherits="sedesincluyeninvestigacionpei" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
             ...
             $("#opc").val(Url._utf8_decode($.get('opc')));
            ...
            $.ajax({
                type: 'POST',
                url: 'sedesincluyeninvestigacionpei.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'sedesincluyeninvestigacionpei.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'sedesincluyeninvestigacionpei.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
        ...
        function floadDetalles() {
            ...
            var opc = $("#opc").val();
            var jsondata = "{'respuesta' : '"+Url._utf8_decode($.get('resp'))+"', 'opc' : '"+opc+"'}";
            $.ajax({
                type: 'POST',
                url: 'sedesincluyeninvestigacionpei.aspx/sedesincluyeninvestigacionpei_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            var opc = $("#opc").val();
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmunicipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "', 'respuesta' : '"+Url._utf8_decode($.get('resp'))+"', 'opc' : '"+opc+"'}";
            $.ajax({
                type: 'POST',
                url: 'sedesincluyeninvestigacionpei.aspx/realizarBusquedasedesincluyeninvestigacionpei_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                ...
                <tr>
                    ...
                    <td>
                        <select class="TextBox width-100" name="institucion" id="institucion" style="width: 250px">
                                        ...
                                        <td>
                        <select class="TextBox width-100" name="opc" id="opc" style="width: 250px">
