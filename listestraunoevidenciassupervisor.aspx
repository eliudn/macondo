<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="listestraunoevidenciassupervisor.aspx.cs" Inherits="listestraunoevidenciassupervisor" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
         $(document).ready(function () {
            ...
            //    $.ajax({
            //        type: 'POST',
            //        url: 'listestraunoevidenciassupervisor.aspx/gvCargarTodosListEvidencias',
            //        data: data,
