<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="lineabaseregistroinst_intermedia.aspx.cs" Inherits="lineabaseregistroinst_intermedia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <h2>
            Instrumento No. 01, Información de contacto de las IE del sector oficial 
        </h2>
    </center>
        ...
        <p>
            ...
            En el presente documento sólo se complementará o actualizarán los datos de contacto de las sedes educativas seleccionadas como beneficiarias de CICLÓN, teniendo en cuenta que el resto de información básica no ha variado desde que se levantó la línea de base del Programa. 
            <br />
            FUNTICS al iniciar el 2017, actualizó la información básica de las sedes educativas beneficiadas 
            <br /><br />
            <b>Propósito: </b>
            <br /><br />
            Actualizar la información de contacto de las sedes educativas beneficiadas para que pueda ser consultada por los usuarios del SIEP.
            <br /><br />
            <b>Metodología: </b>
            <br /><br />
            Los profesionales de FUNTICS preguntarán esta información directamente a los réctores y/o coordinadores académicos. La información básica restante se cargará de manera automática en el instrumento de cada sede en el momento de su creación.
