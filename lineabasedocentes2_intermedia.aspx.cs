...
public partial class lineabasedocentes2_intermedia : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardarpreguntascerradas(string codasesor, string respuesta, string pregunta, string subpregunta, string accion)
    {
        string ca = "";
        ...
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, respuesta, "5", "intermedia");
        ...
        else//Asesor es cambio o nuevo para ingresar
        {
            ...
            if (docente != null)
            {
                ...
                {
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), pregunta, subpregunta, "5", "intermedia");
                    lb.AgregarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), pregunta, subpregunta, respuesta, "5", "intermedia");
                ...
                else
                {
                    ...
                    if (coddocenteasesor2 != null)
                    {
                        ...
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, subpregunta, respuesta, "5", "intermedia");
                    }
                }
            }
        }
    ...
    public static string guardardatoscerradas(string codasesor, string preg2_1, string preg2_2, string preg2_3, string preg2_4, string preg2_5, string preg2_6, string preg2_7, string preg2_8, string preg3, string preg4, string preg5, string preg6, string preg8, string preg10, string preg7_1, string preg7_2, string preg7_3, string preg7_4, string preg7_5, string preg7_6, string preg7_7, string preg7_8, string preg9_1, string preg9_2, string preg9_3, string preg9_4, string preg9_5, string preg9_6, string preg9_7, string preg9_8)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "1", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "2", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "3", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "4", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "5", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "6", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "7", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "8", "5", "intermedia");

            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "1", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "2", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "3", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "4", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "5", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "6", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "7", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "8", "5", "intermedia");

            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "1", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "2", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "3", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "4", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "5", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "6", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "7", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "8", "5", "intermedia");

            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "3", "0", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "0", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "0", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "8", "0", "5", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "10", "0", "5", "intermedia");

            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "1", preg2_1, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "2", preg2_2, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "3", preg2_3, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "4", preg2_4, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "5", preg2_5, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "6", preg2_6, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "7", preg2_7, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "8", preg2_8, "5", "intermedia");

            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "3", "0", preg3, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", preg4, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "0", preg5, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "0", preg6, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "8", "0", preg8, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "10", "0", preg10, "5", "intermedia");

            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "1", preg7_1, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "2", preg7_2, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "3", preg7_3, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "4", preg7_4, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "5", preg7_5, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "6", preg7_6, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "7", preg7_7, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "8", preg7_8, "5", "intermedia");

            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "1", preg9_1, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "2", preg9_2, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "3", preg9_3, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "4", preg9_4, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "5", preg9_5, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "6", preg9_6, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "7", preg9_7, "5", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "9", "8", preg9_8, "5", "intermedia");
        }
        else//Asesor es cambio o nuevo para ingresar
        {
            DataRow docente = doc.buscarDocenteMatriculadoxID(HttpContext.Current.Session["identificacion"].ToString());
            ...
            if (docente != null)
            {
                ...
                if (docenteasesor != null)
                {
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "1", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "2", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "3", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "4", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "5", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "6", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "7", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "8", "5", "intermedia");

                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "1", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "2", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "3", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "4", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "5", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "6", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "7", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "7", "8", "5", "intermedia");

                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "1", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "2", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "3", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "4", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "5", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "6", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "7", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "9", "8", "5", "intermedia");

                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "3", "0", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "4", "0", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "5", "0", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "6", "0", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "8", "0", "5", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "10", "0", "5", "intermedia");

                    DataRow coddocenteasesor2 = lb.AgregarDatoDocenteAsesorLineaBase(codasesor, docente["cod"].ToString());
                    if (coddocenteasesor2 != null)
                    {

                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "1", preg2_1, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "2", preg2_2, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "3", preg2_3, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "4", preg2_4, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "5", preg2_5, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "6", preg2_6, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "7", preg2_7, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "8", preg2_8, "5", "intermedia");

                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "3", "0", preg3, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "4", "0", preg4, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "5", "0", preg5, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "6", "0", preg6, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "8", "0", preg8, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "10", "0", preg10, "5", "intermedia");

                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "1", preg7_1, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "2", preg7_2, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "3", preg7_3, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "4", preg7_4, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "5", preg7_5, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "6", preg7_6, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "7", preg7_7, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "8", preg7_8, "5", "intermedia");

                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "1", preg9_1, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "2", preg9_2, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "3", preg9_3, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "4", preg9_4, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "5", preg9_5, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "6", preg9_6, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "7", preg9_7, "5", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "9", "8", preg9_8, "5", "intermedia");
                    }
                }
                else
                {
    ...
    public static string guardardatosabiertas(string codasesor, string preg2_nombre_1, string preg2_duracion_1, string preg2_anio_1, string preg2_nombre_2, string preg2_duracion_2, string preg2_anio_2, string preg2_nombre_3, string preg2_duracion_3, string preg2_anio_3, string preg2_nombre_4, string preg2_duracion_4, string preg2_anio_4, string txtpedago, string txtpromueve, string txtparticipado, string txtinvestiga, string preg7nombre_1, string preg7duracion_1, string preg7anio_1, string preg7nombre_2, string preg7duracion_2, string preg7anio_2, string preg7nombre_3, string preg7duracion_3, string preg7anio_3, string preg7nombre_4, string preg7duracion_4, string preg7anio_4, string preg9nombre_1, string preg9duracion_1, string preg9anio_1, string preg9nombre_2, string preg9duracion_2, string preg9anio_2, string preg9nombre_3, string preg9duracion_3, string preg9anio_3, string preg9nombre_4, string preg9duracion_4, string preg9anio_4, string preg8rbforma, string preg10rbforma, string preg11_1, string preg11_2, string preg11_3, string preg11_4, string preg11_5, string preg11_6, string preg11_7, string preg11_8, string preg11_9, string preg11_10, string preg11_11, string preg11_12)
    {
        ...
        Docentes doc = new Docentes();
         ...
         if (coddocenteasesor != null)
         {
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.1", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.2", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.3", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.4", "5", "intermedia");

             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.1", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.2", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.3", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.4", "5", "intermedia");

             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.1", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.2", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.3", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.4", "5", "intermedia");

             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "3", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "4", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "5", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "6", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "8", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "10", "5", "intermedia");

             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.1", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.2", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.3", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.4", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.5", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.6", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.7", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.8", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.9", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.10", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.11", "5", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.12", "5", "intermedia");

             if (preg2_nombre_1 == "") { preg2_nombre_1 = ""; }
             if (preg2_duracion_1 == "") { preg2_duracion_1 = ""; }
             if (preg2_anio_1 == "") { preg2_anio_1 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.1", preg2_nombre_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.1", preg2_duracion_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.1", preg2_anio_1, "5", "intermedia");

             if (preg2_nombre_2 == "") { preg2_nombre_2 = ""; }
             if (preg2_duracion_2 == "") { preg2_duracion_2 = ""; }
             if (preg2_anio_2 == "") { preg2_anio_2 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.2", preg2_nombre_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.2", preg2_duracion_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.2", preg2_anio_2, "5", "intermedia");

             if (preg2_nombre_3 == "") { preg2_nombre_3 = ""; }
             if (preg2_duracion_3 == "") { preg2_duracion_3 = ""; }
             if (preg2_anio_3 == "") { preg2_anio_3 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.3", preg2_nombre_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.3", preg2_duracion_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.3", preg2_anio_3, "5", "intermedia");

             if (preg2_nombre_4 == "") { preg2_nombre_4 = ""; }
             if (preg2_duracion_4 == "") { preg2_duracion_4 = ""; }
             if (preg2_anio_4 == "") { preg2_anio_4 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.4", preg2_nombre_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.4", preg2_duracion_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2.4", preg2_anio_4, "5", "intermedia");

             //preg 7
             if (preg7nombre_1 == "") { preg7nombre_1 = ""; }
             if (preg7duracion_1 == "") { preg7duracion_1 = ""; }
             if (preg7anio_1 == "") { preg7anio_1 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.1", preg7nombre_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.1", preg7duracion_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.1", preg7anio_1, "5", "intermedia");

             if (preg7nombre_2 == "") { preg7nombre_2 = ""; }
             if (preg7duracion_2 == "") { preg7duracion_2 = ""; }
             if (preg7anio_2 == "") { preg7anio_2 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.2", preg7nombre_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.2", preg7duracion_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.2", preg7anio_2, "5", "intermedia");

             if (preg7nombre_3 == "") { preg7nombre_3 = ""; }
             if (preg7duracion_3 == "") { preg7duracion_3 = ""; }
             if (preg7anio_3 == "") { preg7anio_3 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.3", preg7nombre_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.3", preg7duracion_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.3", preg7anio_3, "5", "intermedia");

             if (preg7nombre_4 == "") { preg7nombre_4 = ""; }
             if (preg7duracion_4 == "") { preg7duracion_4 = ""; }
             if (preg7anio_4 == "") { preg7anio_4 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.4", preg7nombre_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.4", preg7duracion_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "7.4", preg7anio_4, "5", "intermedia");

             //Preg 9
             if (preg9nombre_1 == "") { preg9nombre_1 = ""; }
             if (preg9duracion_1 == "") { preg9duracion_1 = ""; }
             if (preg9anio_1 == "") { preg9anio_1 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.1", preg9nombre_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.1", preg9duracion_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.1", preg9anio_1, "5", "intermedia");

             if (preg9nombre_2 == "") { preg9nombre_2 = ""; }
             if (preg9duracion_2 == "") { preg9duracion_2 = ""; }
             if (preg9anio_2 == "") { preg9anio_2 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.2", preg9nombre_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.2", preg9duracion_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.2", preg9anio_2, "5", "intermedia");

             if (preg9nombre_3 == "") { preg9nombre_3 = ""; }
             if (preg9duracion_3 == "") { preg9duracion_3 = ""; }
             if (preg9anio_3 == "") { preg9anio_3 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.3", preg9nombre_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.3", preg9duracion_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.3", preg9anio_3, "5", "intermedia");

             if (preg9nombre_4 == "") { preg9nombre_4 = ""; }
             if (preg9duracion_4 == "") { preg9duracion_4 = ""; }
             if (preg9anio_4 == "") { preg9anio_4 = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.4", preg9nombre_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.4", preg9duracion_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "9.4", preg9anio_4, "5", "intermedia");

             if (txtpedago == "") { txtpedago = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "3", txtpedago, "5", "intermedia");

             if (txtpromueve == "") { txtpromueve = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "4", txtpromueve, "5", "intermedia");

             if (txtparticipado == "") { txtparticipado = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "5", txtparticipado, "5", "intermedia");

             if (txtinvestiga == "") { txtinvestiga = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "6", txtinvestiga, "5", "intermedia");

             if (preg8rbforma == "") { preg8rbforma = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "8", preg8rbforma, "5", "intermedia");

             if (preg10rbforma == "") { preg10rbforma = ""; }
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "10", preg10rbforma, "5", "intermedia");
             ...
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.1", preg11_1, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.2", preg11_2, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.3", preg11_3, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.4", preg11_4, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.5", preg11_5, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.6", preg11_6, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.7", preg11_7, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.8", preg11_8, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.9", preg11_9, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.10", preg11_10, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.11", preg11_11, "5", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "11.12", preg11_12, "5", "intermedia");
         }
         else//Asesor es cambio o nuevo para ingresar
         {
             DataRow docente = doc.buscarDocenteMatriculadoxID(HttpContext.Current.Session["identificacion"].ToString());
             ...
             if (docente != null)
             {
                 ...
                 if (docenteasesor != null)
                 {
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.1", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.2", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.3", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.4", "5", "intermedia");

                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "7.1", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "7.2", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "7.3", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "7.4", "5", "intermedia");

                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "9.1", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "9.2", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "9.3", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "9.4", "5", "intermedia");

                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "3", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "4", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "5", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "6", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "8", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "10", "5", "intermedia");

                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.1", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.2", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.3", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.4", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.5", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.6", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.7", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.8", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.9", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.10", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.11", "5", "intermedia");
                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "11.12", "5", "intermedia");
                 }
                 else
                 {
                     DataRow coddocenteasesor2 = lb.AgregarDatoDocenteAsesorLineaBase(codasesor, docente["cod"].ToString());
                     if (coddocenteasesor2 != null)
                     {
                         ...
                         if (preg2_duracion_1 == "") { preg2_duracion_1 = ""; }
                         if (preg2_anio_1 == "") { preg2_anio_1 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.1", preg2_nombre_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.1", preg2_duracion_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.1", preg2_anio_1, "5", "intermedia");

                         if (preg2_nombre_2 == "") { preg2_nombre_2 = ""; }
                         if (preg2_duracion_2 == "") { preg2_duracion_2 = ""; }
                         if (preg2_anio_2 == "") { preg2_anio_2 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.2", preg2_nombre_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.2", preg2_duracion_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.2", preg2_anio_2, "5", "intermedia");

                         if (preg2_nombre_3 == "") { preg2_nombre_3 = ""; }
                         if (preg2_duracion_3 == "") { preg2_duracion_3 = ""; }
                         if (preg2_anio_3 == "") { preg2_anio_3 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.3", preg2_nombre_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.3", preg2_duracion_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.3", preg2_anio_3, "5", "intermedia");

                         if (preg2_nombre_4 == "") { preg2_nombre_4 = ""; }
                         if (preg2_duracion_4 == "") { preg2_duracion_4 = ""; }
                         if (preg2_anio_4 == "") { preg2_anio_4 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.4", preg2_nombre_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.4", preg2_duracion_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.4", preg2_anio_4, "5", "intermedia");

                         //preg 7
                         if (preg7nombre_1 == "") { preg7nombre_1 = ""; }
                         if (preg7duracion_1 == "") { preg7duracion_1 = ""; }
                         if (preg7anio_1 == "") { preg7anio_1 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.1", preg7nombre_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.1", preg7duracion_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.1", preg7anio_1, "5", "intermedia");

                         if (preg7nombre_2 == "") { preg7nombre_2 = ""; }
                         if (preg7duracion_2 == "") { preg7duracion_2 = ""; }
                         if (preg7anio_2 == "") { preg7anio_2 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.2", preg7nombre_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.2", preg7duracion_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.2", preg7anio_2, "5", "intermedia");

                         if (preg7nombre_3 == "") { preg7nombre_3 = ""; }
                         if (preg7duracion_3 == "") { preg7duracion_3 = ""; }
                         if (preg7anio_3 == "") { preg7anio_3 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.3", preg7nombre_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.3", preg7duracion_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.3", preg7anio_3, "5", "intermedia");

                         if (preg7nombre_4 == "") { preg7nombre_4 = ""; }
                         if (preg7duracion_4 == "") { preg7duracion_4 = ""; }
                         if (preg7anio_4 == "") { preg7anio_4 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.4", preg7nombre_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.4", preg7duracion_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "7.4", preg7anio_4, "5", "intermedia");

                         //Preg 9
                         if (preg9nombre_1 == "") { preg9nombre_1 = ""; }
                         if (preg9duracion_1 == "") { preg9duracion_1 = ""; }
                         if (preg9anio_1 == "") { preg9anio_1 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.1", preg9nombre_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.1", preg9duracion_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.1", preg9anio_1, "5", "intermedia");

                         if (preg9nombre_2 == "") { preg9nombre_2 = ""; }
                         if (preg9duracion_2 == "") { preg9duracion_2 = ""; }
                         if (preg9anio_2 == "") { preg9anio_2 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.2", preg9nombre_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.2", preg9duracion_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.2", preg9anio_2, "5", "intermedia");

                         if (preg9nombre_3 == "") { preg9nombre_3 = ""; }
                         if (preg9duracion_3 == "") { preg9duracion_3 = ""; }
                         if (preg9anio_3 == "") { preg9anio_3 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.3", preg9nombre_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.3", preg9duracion_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.3", preg9anio_3, "5", "intermedia");

                         if (preg9nombre_4 == "") { preg9nombre_4 = ""; }
                         if (preg9duracion_4 == "") { preg9duracion_4 = ""; }
                         if (preg9anio_4 == "") { preg9anio_4 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.4", preg9nombre_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.4", preg9duracion_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "9.4", preg9anio_4, "5", "intermedia");

                         if (txtpedago == "") { txtpedago = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "3", txtpedago, "5", "intermedia");

                         if (txtpromueve == "") { txtpromueve = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "4", txtpromueve, "5", "intermedia");

                         if (txtparticipado == "") { txtparticipado = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "5", txtparticipado, "5", "intermedia");

                         if (txtinvestiga == "") { txtinvestiga = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "6", txtinvestiga, "5", "intermedia");

                         if (preg8rbforma == "") { preg8rbforma = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "8", preg8rbforma, "5", "intermedia");

                         if (preg10rbforma == "") { preg10rbforma = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "10", preg10rbforma, "5", "intermedia");
                         ...
                         if (preg11_11 == "") { preg11_11 = ""; }
                         if (preg11_12 == "") { preg11_12 = ""; }
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.1", preg11_1, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.2", preg11_2, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.3", preg11_3, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.4", preg11_4, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.5", preg11_5, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.6", preg11_6, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.7", preg11_7, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.8", preg11_8, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.9", preg11_9, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.10", preg11_10, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.11", preg11_11, "5", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "11.12", preg11_12, "5", "intermedia");
    ...
    public static string eliminarchk1(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", "5", "intermedia");
        }
    ...
    public static string eliminarchk4(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "1", "5", "intermedia");
        }
    ...
    public static string eliminarchk5(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "1", "5", "intermedia");
        }
    ...
    public static string eliminarchk6(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "1", "5", "intermedia");
        }
    ...
    public static string eliminarchk11(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "11", "0", "5", "intermedia");
        }
    ...
    public static string guardardatoschk1(string chk, string codasesor)
    {
        ...
        LineaBase lb = new LineaBase();
         ...
         if (coddocenteasesor != null)
         {
             lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", chk, "5", "intermedia");
         }
         else
         {
             Docentes doc = new Docentes();
              ...
              if (docente != null)
              {
                  ...
                  if (coddocenteasesor2 != null)
                  {
                      lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "1", "0", chk, "5", "intermedia");
                  }
              }
    ...
    public static string guardardatoschk4(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "1", chk, "5", "intermedia");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "4", "1", chk, "5", "intermedia");
                }
            }
    ...
    public static string guardardatoschk5(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "1", chk, "5", "intermedia");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "5", "1", chk, "5", "intermedia");
                }
            }
    ...
    public static string guardardatoschk6(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "1", chk, "5", "intermedia");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "6", "1", chk, "5", "intermedia");
                }
            }
    ...
    public static string guardardatoschk11(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "11", "0", chk, "5", "intermedia");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "11", "0", chk, "5", "intermedia");
                }
            }
    ...
    public static string cargarrespuestaspregunta(string codasesor, string pregunta, string numero)
    {
        ...
        if (numero == "")
        {
            if (coddocenteasesor != null)
            {
                DataTable datos = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), pregunta, "5", "intermedia");
        ...
        else
        {
            if (coddocenteasesor != null)
            {
                DataTable datos = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), pregunta + "." + numero, "5", "intermedia");
    ...
    public static string cargarrespuestaspreguntacerrada_2(string codasesor, string pregunta, string subpregunta)
    {
        ...
        Asesores ase = new Asesores();
           ...
           if (coddocenteasesor != null)
           {
               DataTable dat7 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, "5", "intermedia");
    ...
    public static string cargarrespuestascerradasyabiertas(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "3", "0", "5", "intermedia");
            ...
            DataTable dat2 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", "5", "intermedia");
            if (dat2 != null && dat2.Rows.Count > 0)
            {
                ca += dat2.Rows[0]["respuesta"].ToString() + "@";//2
            }

            DataTable dat3 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "5", "0", "5", "intermedia");
            if (dat3 != null && dat3.Rows.Count > 0)
            {
                ca += dat3.Rows[0]["respuesta"].ToString() + "@";//3
            }

            DataTable dat4 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "5", "0", "5", "intermedia");
            if (dat4 != null && dat4.Rows.Count > 0)
            {
                ca += dat4.Rows[0]["respuesta"].ToString() + "@";//4
            }

            DataTable dat5 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "8", "0", "5", "intermedia");
            if (dat5 != null && dat5.Rows.Count > 0)
            {
                ca += dat5.Rows[0]["respuesta"].ToString() + "@";//5
            }

            DataTable dat6 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "10", "0", "5", "intermedia");
            if (dat6 != null && dat6.Rows.Count > 0)
            {
                ca += dat6.Rows[0]["respuesta"].ToString() + "@";//6
            }

            DataTable dat7 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "1", "5", "intermedia");
            if (dat7 != null && dat7.Rows.Count > 0)
            {
                ca += dat7.Rows[0]["respuesta"].ToString() + "@";//7
            }

            DataTable dat8 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "2", "5", "intermedia");
            if (dat8 != null && dat8.Rows.Count > 0)
            {
                ca += dat8.Rows[0]["respuesta"].ToString() + "@";//8
            }

            DataTable dat9 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "3", "5", "intermedia");
            if (dat9 != null && dat9.Rows.Count > 0)
            {
                ca += dat9.Rows[0]["respuesta"].ToString() + "@";//9
            }

            DataTable dat10 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "4", "5", "intermedia");
            if (dat10 != null && dat10.Rows.Count > 0)
            {
                ca += dat10.Rows[0]["respuesta"].ToString() + "@";//10
            }

            DataTable dat11 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "5", "5", "intermedia");
            if (dat11 != null && dat11.Rows.Count > 0)
            {
                ca += dat11.Rows[0]["respuesta"].ToString() + "@";//11
            }

            DataTable dat12 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "6", "5", "intermedia");
            if (dat12 != null && dat12.Rows.Count > 0)
            {
                ca += dat12.Rows[0]["respuesta"].ToString() + "@";//12
            }

            DataTable dat13 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "7", "5", "intermedia");
            if (dat13 != null && dat13.Rows.Count > 0)
            {
                ca += dat13.Rows[0]["respuesta"].ToString() + "@";//13
            }

            DataTable dat14 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "8", "5", "intermedia");
            if (dat14 != null && dat14.Rows.Count > 0)
            {
                ca += dat14.Rows[0]["respuesta"].ToString() + "@";//14
            }

            DataTable datos = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2.1", "5", "intermedia");
            ...
            DataTable datos2 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2.2", "5", "intermedia");
            ...
            DataTable datos3 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2.3", "5", "intermedia");
            ...
            DataTable datos4 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2.4", "5", "intermedia");
            ...
            DataTable datos5 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7.1", "5", "intermedia");
            ...
            DataTable datos6 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7.2", "5", "intermedia");
            ...
            DataTable datos7 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7.3", "5", "intermedia");
            ...
            DataTable datos8 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7.4", "5", "intermedia");
            ...
            DataTable datos9 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9.1", "5", "intermedia");
            ...
            DataTable datos10 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9.2", "5", "intermedia");
            ...
            DataTable datos11 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9.3", "5", "intermedia");
            ...
            DataTable datos12 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9.4", "5", "intermedia");
            ...
            DataTable dat15 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "1", "5", "intermedia");
            if (dat15 != null && dat15.Rows.Count > 0)
            {
                ca += dat15.Rows[0]["respuesta"].ToString() + "@";//51
            }

            DataTable dat16 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "2", "5", "intermedia");
            if (dat16 != null && dat16.Rows.Count > 0)
            {
                ca += dat16.Rows[0]["respuesta"].ToString() + "@";//52
            }

            DataTable dat17 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "3", "5", "intermedia");
            if (dat17 != null && dat17.Rows.Count > 0)
            {
                ca += dat17.Rows[0]["respuesta"].ToString() + "@";//53
            }

            DataTable dat18 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "4", "5", "intermedia");
            if (dat18 != null && dat18.Rows.Count > 0)
            {
                ca += dat18.Rows[0]["respuesta"].ToString() + "@";//54
            }

            DataTable dat19 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "5", "5", "intermedia");
            if (dat19 != null && dat19.Rows.Count > 0)
            {
                ca += dat19.Rows[0]["respuesta"].ToString() + "@";//55
            }

            DataTable dat20 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "6", "5", "intermedia");
            if (dat20 != null && dat20.Rows.Count > 0)
            {
                ca += dat20.Rows[0]["respuesta"].ToString() + "@";//56
            }

            DataTable dat21 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "7", "5", "intermedia");
            if (dat21 != null && dat21.Rows.Count > 0)
            {
                ca += dat21.Rows[0]["respuesta"].ToString() + "@";//57
            }

            DataTable dat22 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "8", "5", "intermedia");
            if (dat22 != null && dat14.Rows.Count > 0)
            {
                ca += dat22.Rows[0]["respuesta"].ToString() + "@";//58
            }

            DataTable dat23 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "1", "5", "intermedia");
            if (dat23 != null && dat23.Rows.Count > 0)
            {
                ca += dat15.Rows[0]["respuesta"].ToString() + "@";//59
            }

            DataTable dat24 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "2", "5", "intermedia");
            if (dat24 != null && dat24.Rows.Count > 0)
            {
                ca += dat24.Rows[0]["respuesta"].ToString() + "@";//60
            }

            DataTable dat25 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "3", "5", "intermedia");
            if (dat25 != null && dat25.Rows.Count > 0)
            {
                ca += dat25.Rows[0]["respuesta"].ToString() + "@";//61
            }

            DataTable dat26 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "4", "5", "intermedia");
            if (dat26 != null && dat26.Rows.Count > 0)
            {
                ca += dat26.Rows[0]["respuesta"].ToString() + "@";//62
            }

            DataTable dat27 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "5", "5", "intermedia");
            if (dat27 != null && dat27.Rows.Count > 0)
            {
                ca += dat27.Rows[0]["respuesta"].ToString() + "@";//63
            }

            DataTable dat28 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "6", "5", "intermedia");
            if (dat28 != null && dat28.Rows.Count > 0)
            {
                ca += dat28.Rows[0]["respuesta"].ToString() + "@";//64
            }

            DataTable dat29 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "7", "5", "intermedia");
            if (dat29 != null && dat29.Rows.Count > 0)
            {
                ca += dat29.Rows[0]["respuesta"].ToString() + "@";//65
            }

            DataTable dat30 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "9", "8", "5", "intermedia");
            if (dat30 != null && dat30.Rows.Count > 0)
            {
                ca += dat30.Rows[0]["respuesta"].ToString() + "@";//66
            }

            DataTable datos13 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "3", "5", "intermedia");
            ...
            DataTable datos14 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "4", "5", "intermedia");
            ...
            DataTable datos15 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "5", "5", "intermedia");
            ...
            DataTable datos16 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "6", "5", "intermedia");
            ...
            DataTable datos17 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "8", "5", "intermedia");
            ...
            DataTable datos18 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "10", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk1(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk4(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "4", "1", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk5(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "5", "1", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk6(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "6", "1", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk11(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "11", "0", "5", "intermedia");
            ...
            switch (pregunta)
            {
                case "2.1":
                    if (accion == "delete")
                    {
                        ...
                        lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), pregunta, "5", "intermedia");
                        lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), pregunta, respuesta, "5", "intermedia");
                    }
            ...
            if (docente != null)
            {
                     ...
                     //{
                         ...
                         switch (pregunta)
                         {
                             case "2.1":
                                 ...
                                 {
                                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.1", "5", "intermedia");
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.1", respuesta, "5", "intermedia");
                                 }
                                 else
                                 {
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.1", respuesta, "5", "intermedia");
                             ...
                             case "2.2":
                                 ...
                                 {
                                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.2", "5", "intermedia");
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.2", respuesta, "5", "intermedia");
                                 }
                                 else
                                 {
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.2", respuesta, "5", "intermedia");
                             ...
                             case "2.3":
                                 ...
                                 {
                                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.3", "5", "intermedia");
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.3", respuesta, "5", "intermedia");
                                 }
                                 else
                                 {
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.3", respuesta, "5", "intermedia");
                             ...
                             case "2.4":
                                 ...
                                 {
                                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.4", "5", "intermedia");
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.4", respuesta, "5", "intermedia");
                                 }
                                 else
                                 {
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), "2.4", respuesta, "5", "intermedia");
                             ...
                             case "7.1":
                                 ...
                                 {
                                     if (respuesta == "") { respuesta = ""; }
                                     lb.eliminarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), pregunta, "5", "intermedia");
                                     lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), pregunta, respuesta, "5", "intermedia");
                                 }
                                 else if (accion == "nodelete")
                                 {
                                     if (respuesta == "") { respuesta = ""; }
                ...
                else//Si no existe agrega
                {
                    ...
                    if (coddocenteasesor2 != null)
                    {
                        ...
                        {
                            case "2.1":
                                lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.1", respuesta, "5", "intermedia");
                                break;
                            case "2.2":
                                lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.2", respuesta, "5", "intermedia");
                                break;
                            case "2.3":
                                lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.3", respuesta, "5", "intermedia");
                                break;
                            case "2.4":
                                lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2.4", respuesta, "5", "intermedia");
                                break;
                            case "7.1":
                                lb.AgregarRespuestaAbierta_Fase(docenteasesor["codigo"].ToString(), pregunta, respuesta, "5", "intermedia");
                                break;
                            case "7.2":
                                lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, respuesta, "5", "intermedia");
                                break;
                            case "7.3":
                                lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, respuesta, "5", "intermedia");
                                break;
