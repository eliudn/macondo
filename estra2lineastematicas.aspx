<%@ Page Title=" Líneas temáticas, territoriales y de actores " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra2lineastematicas.aspx.cs" Inherits="estra2lineastematicas" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            $("#tableList tbody").html('<td colspan="2" style="text-align:center;">Cargando...</td>');
            $.ajax({
                type: 'POST',
                url: 'estra2lineastematicas.aspx/estra2lineastematicas_',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Inscripción de maestros y maestras en las líneas temáticas del Proyecto Ciclón </h2>
    ...
    <h4 >Líneas temáticas, territoriales y de actores </h4>
