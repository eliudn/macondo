<%@ Page Title="modificacion de curriculo" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="modificacionCorriculo.aspx.cs" Inherits="modificacionCorriculo " MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'modificacionCorriculo.aspx/modificacionCorriculo_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'modificacionCorriculo.aspx/buscarModificacionCorriculo_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
    ...
    <fieldset>
         ...
         <table>
                ...
                <tr>
                    ...
                    <td class="plataforma">Respuesta: </td>
                    <td></td>
                </tr>
                <tr>
                    <td>
