...
public partial class estracincocomiteredapoyo : System.Web.UI.Page
{
    ...
    public static string listar()
    {
        ...
        DataTable datos = inst.cargarListadoSesionComiteRedApoyo();
    ...
    public static string encabezado(string codmunicipio, string fecha, string lugar, string hora, string participantes, string entidades, string objetivo, string desarrollo)
    {
        ...
        DataRow dato = inst.insertcomiteredapoyo(codmunicipio, fecha, lugar, hora, participantes, entidades, objetivo, desarrollo, coor);
    ...
    public static string delete(string codigo)
    {
        ...
        inst.eliminarevidenciaporcodcomiteredapoyo(codigo);
    ...
    public static string load(string codigo)
    {
        ...
        DataRow dat = inst.buscarSesionComiteRedApoyo(codigo);
