...
public partial class sedeslistado : System.Web.UI.Page
{
    ...
    {
        return ins.cargarInstitucionesWhere(llenarWhere());
    }
    ...
    protected void imgEditar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        //string codproyecto = HttpUtility.HtmlDecode(gvrow.Cells[1].Text);
        string idrector = HttpUtility.HtmlDecode(gvrow.Cells[3].Text);
        Response.Redirect("verinforector.aspx?cc=" + cod + "&id=" + idrector + "", true);
    }
    ...
    private string llenarWhere()
    {
        ...
        if (txtBusqueda.Text != "")
        {
            ...
            cond[1] = string.Empty;
            cond[2] = string.Empty;
            cond[3] = "CONCAT_WS(' ',s.dane,s.nombre) ILIKE '%" + txtBusqueda.Text + "%'";
        }
    ...
    protected void btnExportExcel_Click(object sender, EventArgs e)
    {
        ...
        datosCliente.TableName = "Listado de sedes";
        hoja = libro.Worksheets.Add(datosCliente);
        hoja.Column(1).Delete();
        //hoja.Column(2).Delete();
        //hoja.Column(4).Delete();

        hoja.Cell("A1").Value = "DANE";
        hoja.Cell("B1").Value = "Nombre institución";
        hoja.Cell("C1").Value = "ID. Rector";
        hoja.Cell("D1").Value = "Municipio";
        hoja.Cell("E1").Value = "Teléfono";
        hoja.Cell("F1").Value = "Email";
        hoja.Cell("G1").Value = "Clase de Institución";
        hoja.Cell("H1").Value = "Rural/Urbana";
        ...
        Response.AddHeader("content-disposition", "attachment;filename=\"Listado_Sedes.xlsx\"");
