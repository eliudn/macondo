...
public partial class estrag007Reporte : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string listadobitacora4Regresar()
    {
        string ca = "";
        ...
        {
            DataTable datos = estra.listarBitacoraCuatroSupervision(HttpContext.Current.Session["a"].ToString());
            if (datos != null && datos.Rows.Count > 0)
            {
                for (int i = 0; i < datos.Rows.Count; i++)
                {
                    ...
                    ca += "<td>" + datos.Rows[i]["asesor"].ToString() + "</td>";
                    ca += "<td>" + datos.Rows[i]["momento"].ToString() + "</td>";
                    ca += "<td style='padding:5px;text-align:center' ><a class='btn btn-success' onclick=\"$('#table').hide(), $('#form').fadeIn(500),  loadSelectBitacoraCuatro(" + datos.Rows[i]["codigo"].ToString() + "), loadRubros(" + datos.Rows[i]["codigo"].ToString() + ") \">Ver</a><br /><br /><a href='estrag007Evidencias.aspx?codestrag007=" + datos.Rows[i]["codigo"].ToString() + "&a=" + HttpContext.Current.Session["a"].ToString() + "' class='btn btn-primary'>Evidencias</a></td>";
                    ca += "</tr>";
                }
            }
            else
