<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraevidenciasinfotecnico2.aspx.cs" Inherits="estraevidenciasinfotecnico2" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Label ID="lblEstrategia" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    ...
                    <asp:ListItem >Actas Publicaciones</asp:ListItem>
                    <asp:ListItem >Publicaciones resultados equipos pedagógicos</asp:ListItem>
                    <asp:ListItem >Publicaciones grupos investigación maestros</asp:ListItem>
                    <asp:ListItem >Certificado contrapartida</asp:ListItem>
