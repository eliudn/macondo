...
public partial class estrag006 : System.Web.UI.Page
{
    ...
    public static string cargarListadoMaterialesAsesor()
    {
        ...
        DataTable datosmateriales = inst.cargarListadoMaterialesxCoordinador(HttpContext.Current.Session["codestracoordinador"].ToString(), "0", "1000");

        if (datosmateriales != null && datosmateriales.Rows.Count > 0)
        {
            DataTable datosCount = inst.cargarListadoMaterialesxCoordinadorCount(HttpContext.Current.Session["codestracoordinador"].ToString());
