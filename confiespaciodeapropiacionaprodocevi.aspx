<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confiespaciodeapropiacionaprodocevi.aspx.cs" Inherits="confiespaciodeapropiacionaprodocevi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
  <h2>Estrategia No 1 - Cargue de evidencias Apropiación docente</h2>
  ...
  <%--  <table>
        ...
        <section class="sectionpopup">
         ...
         <asp:Panel runat="server" ID="PanelMomento0" Visible="true">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Ponencias y presentaciones</asp:ListItem>  
                    <asp:ListItem>Informe del evento</asp:ListItem>
                    <asp:ListItem>Evidencias</asp:ListItem>
    ...
    <%--</asp:Panel>--%>
     ...
     <legend>Listado de evidencias</legend>
         <i>Seleccione una opción para visualizar las evidencias</i>
         <table>
             <tr>
                 <td>
