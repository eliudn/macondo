...
public partial class intermediainstrudocentes2 : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardardatoschk4(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", chk, "5", "intermedia");
        }
    ...
    public static string guardardatoschk5(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "0", chk, "5", "intermedia");
        }
    ...
    public static string guardardatoschk6(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "0", chk, "5", "intermedia");
        }
    ...
    public static string cargarrespuestascerradaschk4(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk5(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "5", "0", "5", "intermedia");
    ...
    public static string cargarrespuestascerradaschk6(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "6", "0", "5", "intermedia");
