<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradossesionvirtual_evi.aspx.cs" Inherits="estradossesionvirtual_evi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 2: Certificación de horas de trabajo virtual - Carga de Evidencias</h2>
     ...
     <fieldset>
                <legend>Actividades</legend>
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="Certificación de horas trabajo virtual (4 horas)">Certificación de horas trabajo virtual (4 horas)</asp:ListItem>
                     </asp:RadioButtonList>
