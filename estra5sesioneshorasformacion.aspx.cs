...
public partial class estra5sesioneshorasformacion : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        if (Session["s"].ToString() != null)
        {
            ...
            {
                case "1":
                    titulo.Text = "Primera sesión: Formación en Ondas y la investigación como estrategia pedagógica  ";
                    break;
                case "2":
                    titulo.Text = "Recuperación del acumulado de la experiencia de implementación: organización y formación de la movilización social de actores y de los equipos pedagógicos que ejecutarán el proyecto y 2: La sistematización como producción de saber y conocimiento de Ciclón   ";
                    break;
            }
        }
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5horas()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable lienamientos = est.est_EvidenciasEstras004CoordinadorConMemorias("", "", "", "", "5", "G001: Registro de asistencia a eventos", HttpContext.Current.Session["s"].ToString());
