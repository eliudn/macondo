<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracincoevidencias.aspx.cs" Inherits="estracincoevidencias" MaintainScrollPositionOnPostback="true" %>
    ...
    <asp:Label ID="lblSesion" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Acta constitución del comité</asp:ListItem>
                    <asp:ListItem>Base de datos parcipantes del comité</asp:ListItem>
