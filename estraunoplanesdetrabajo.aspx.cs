...
public partial class estraunoplanesdetrabajo : System.Web.UI.Page
{
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            //if (dato == null)
            //{
            if (usu.agregarArchivoRespositorioplan(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), rbtActividades.SelectedValue, "1"))
                {
                    gvCargarEvidencias();
            ...
            //else if (lblMomento.Text == "5")
            //{
            //    //if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, rbtMomento5.SelectedValue, "1"))
            //    //{
            //    //    gvCargarEvidencias();
            //    //    //lblCodImgPerfil.Text = "1";
            //    //    trepador.PostedFile.SaveAs(variables[6]);
    ...
    private void gvCargarEvidencias()
    {
        if(lblActividad.Text == "7" || lblActividad.Text == "8")
        {
             DataTable datos = est.cargarEvidenciasEstrategiaConActividadplan("1",lblActividad.Text, lblCodUsuario.Text);
        ...
        {
            DataTable datos2 = est.cargarEvidenciasEstrategiaplan("1",lblCodUsuario.Text);
    ...
    protected void imgDescargar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ImageButton btndetails = sender as ImageButton;
        GridViewRow gvrow = (GridViewRow)btndetails.NamingContainer;
        string filepath = Server.MapPath(HttpUtility.HtmlDecode(gvrow.Cells[8].Text));
        string filename = HttpUtility.HtmlDecode(gvrow.Cells[7].Text);
