...
public partial class estramomentos : System.Web.UI.Page
{
    ...
    private string MenuCoordinadorUnimag()
    {
        ...
        ca +="<div>";
        ca += "<ul>";
        ca += "<li style='list-style-type: square;'><a href='listestraunoevidencias.aspx?m=0&s=0' >Lineamientos y rutas metodológicas</a></li>";
        ca += "<li style='list-style-type: square;'><a href='estraunoevidenciasplanoperativo.aspx' >Formato  plan operativo</a></li>";
        ca += "<li style='list-style-type: square;'><a href='procesosistematizacion.aspx?e=1&m=0' >Proceso de Sistematización</a></li>";
        ca += "</ul>";
        ca += "</div>";
