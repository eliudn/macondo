<%@ Page Title=" Sesiones de formación evaluadas y subidas a la plataforma de Ciclón " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra4memoriasesionesestuasistentesdist.aspx.cs" Inherits="estra4memoriasesionesestuasistentesdist" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2sesionesformacion.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estra2sesionesformacion.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra2sesionesformacion.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra2sesionesformacion.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4memoriasesionesestuasistentesdist.aspx/estra4memoriassesio1_estudiantes',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4memoriasesionesestuasistentesdist.aspx/realizarBusquedaestra4memoriasesion1estudiantes_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="mensaje" runat="server"></div><br /><br /><br /><br />
