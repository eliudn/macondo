<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunobitacorauno.aspx.cs" Inherits="estraunobitacorauno" %>
...
<h2 >Momento Pedagógico 1 <br />
    Estrategía Nro 1 - Bitacora Nro 1</h2><br />
...
Explique cuáles fueron los motivos que lo llevaron a participar en Ciclón y de qué forma contribuye a su práctica docente.
        ...
        <tr>
            <td>
                <asp:TextBox ID="txtRelato" runat="server" TextMode="MultiLine" Columns="145" Rows="8" ></asp:TextBox>
            </td>
        </tr>
    </table>
</fieldset>
    ...
    <center>
       ...
       <div id="tablabitacoras" >
           <a href="javascript:void(0);" class="btn btn-success" style="padding: 5px 12px;" onclick="exportarExcel('tablabitacoras','Estrategía Nro 1 - Bitacora Nro 1')">Exportar a Excel</a>
           <br /> <br />

           <asp:GridView ID="GridBitacoras" runat="server" CellPadding="4"  DataKeyNames="codbitacora" CssClass="mGridTesoreria"
                    ForeColor="#333333" AutoGenerateColumns="false" Style="margin: 0 auto"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="codbitacora" HeaderText="codbitacora" HeaderStyle-CssClass="ocultarcell">
                        ...
                        <asp:BoundField DataField="nombregrupo" HeaderText="Grupo">
                          ...
                          <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate><br />
                                <asp:LinkButton runat="server" ID="LinkButton1" CssClass="btn btn-primary" OnClick="lknVer_Click">Ver</asp:LinkButton><br /><br />
                                <asp:LinkButton runat="server" ID="lknEditar" CssClass="btn btn-success" OnClick="lknEditar_Click">Editar</asp:LinkButton><br /><br />
                                 <asp:LinkButton ID="DeleteBitacora" CssClass="btn btn-danger" runat="server" OnClientClick="if(!confirm('¿Está Seguro en eliminar este registro?')){ return false; };" OnClick="DeleteBitacora_Click" >Eliminar</asp:LinkButton><br /><br />
                            </ItemTemplate>
                        </asp:TemplateField>
