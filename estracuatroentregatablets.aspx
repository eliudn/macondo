<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracuatroentregatablets.aspx.cs" Inherits="estracuatroentregatablets" %>
    ...
    <script src="js/buttons.html5.min.js"></script>
     ...
     <script type="text/javascript">
         ...
         function cargarlista() {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'estracuatroentregatablets.aspx/cargarlista',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <br />
    <h2 >Estrategia No. 4 -  Entrega de tabletas</h2>
    ...
    <fieldset>
        ...
        <table class="mGridTesoreria" id="listado">
         ...
         <tbody>
             <tr><td colspan='6' style='padding:10px;text-align:center;'><img src='images/loader.gif'></td></tr>
         </tbody>
     </table>
