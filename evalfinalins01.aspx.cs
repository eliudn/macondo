...
public partial class evalfinalins01 : System.Web.UI.Page
{
    string codrol = "";
    ...
    [WebMethod(EnableSession = true)]
    public static string updateinstrumento(string nombre, string telefono, string fax, string email, string direccion, string web, string asesores, string codinstitucion, string txtactivas, string is16, string is17, string is18, string is16s, string is17s, string is18s, string is16m, string is17m, string is18m, string nrector, string arector, string crector, string cerector)
    {
        string ca = "";
        ...
        if (ase.editarInstitucionImpacto(nombre, telefono, fax, email, direccion, web, HttpContext.Current.Session["dane"].ToString(), txtactivas, is16, is17, is18, is16s, is17s, is18s, is16m, is17m, is18m))
        {
            ca = "true@";
            ...
            if (dato != null)
            {
                ...
                //buscar los datos del rector
                DataRow rector = ins.buscarDatosRectorConSuInstitucion(HttpContext.Current.Session["dane"].ToString());

                if (rector != null)
                {
                    //editar datos del rector
                    ins.editarDatosRector(rector["identificacion"].ToString(), nrector, arector, crector, cerector);
                }
            }
            else
            {
    ...
    [WebMethod(EnableSession = true)]
    public static string buscarrector()
    {
        string ca = "";
        ...
        {
            ca = "true&_";
            ca += rector["nrector"].ToString() + "&_";
            ca += rector["arector"].ToString() + "&_";
            ca += rector["celerector"].ToString() + "&_";
            ca += rector["cerector"].ToString();
        }
