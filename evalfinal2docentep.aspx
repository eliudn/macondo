<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="evalfinal2docentep.aspx.cs" Inherits="evalfinal2docentep" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function buscarasesor() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/asesorescarg',
                ...
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "0", "0", "xxx", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "0", "modtic", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "0", "rbejetic", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "0", "rbpedago", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "1", "preg31", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "2", "preg32", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "3", "preg33", "");
                       

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "4", "preg34", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "5", "preg35", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "6", "preg36", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "7", "preg37", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "8", "preg38", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "9", "preg39", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "10", "preg40", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "0", "preg4", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "1", "preg41", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "2", "preg42", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "3", "preg43", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "4", "preg44", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "0", "preg5", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "7", "0", "preg7", "");
                       ...
                       cargarrespuestaspregunta($("#cargaasesoa1").val(), "2", "");
                        ...
                        cargarrespuestaspregunta($("#cargaasesoa1").val(), "5", "1");
                        ...
                        cargarrespuestascerradaschk14($("#cargaasesoa1").val());
                    }
                    else {
                        cargarasesores();
                    }
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarasesores',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    var resp = json.d.split("&");
        ...
        function cargarrespuestaspregunta(codasesor,pregunta,numero) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestaspregunta',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestaspreguntacerrada_2(codasesor, pregunta, subpregunta, nombre, numero) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestaspreguntacerrada_2',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk1(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk1',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk4(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk4',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk5(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk5',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk6(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk6',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk11(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk11',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk12(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk12',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
         ...
         function cargarrespuestascerradaschk13(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/cargarrespuestascerradaschk13',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function guardarpreguntas() {
            ...
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=modtic]:checked').val(), "1", "0", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=rbejetic]:checked').val(), "2", "0", "");
            

            //Guardar preguntas 3
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=rbpedago]:checked').val(), "3", "0", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg31]:checked').val(), "3", "1", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg32]:checked').val(), "3", "2", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg33]:checked').val(), "3", "3", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg34]:checked').val(), "3", "4", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg35]:checked').val(), "3", "5", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg36]:checked').val(), "3", "6", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg37]:checked').val(), "3", "7", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg38]:checked').val(), "3", "8", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg39]:checked').val(), "3", "9", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg40]:checked').val(), "3", "10", "");

            /**Guardar pregunta 4*/
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg4]:checked').val(), "4", "0", ""); 
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg41]:checked').val(), "4", "1", ""); 
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg42]:checked').val(), "4", "2", ""); 
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg43]:checked').val(), "4", "3", ""); 
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg44]:checked').val(), "4", "4", ""); 
           
            /**Guardar pregunta 5*/
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg5]:checked').val(), "5", "0", "");           

             /**Guardar pregunta 7*/
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg7]:checked').val(), "7", "0", "");
        ...
        function guardarpreguntasabiertas_preg2(codasesor, nombre, duracion, anio, numero, pregunta, accion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/guardarpreguntasabiertas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
        ...
        function guardarpreguntascerradas_radio(codasesor2, codasesor, nombre, pregunta, subpregunta, accion) {
           ...
           {  var jsonData = '{"codasesor2":"' + codasesor2 + '","codasesor":"' + codasesor + '", "respuesta":"' + nombre + '", "pregunta":"' + pregunta + '", "subpregunta":"' + subpregunta + '", "accion":"' + accion + '"}';
               $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/guardarpreguntascerradas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
        ...
        //    $.ajax({
        //        type: 'POST',
        //        url: 'evalfinal2docentep.aspx/eliminarchk1',
        //        contentType: "application/json; charset=utf-8",
        //        dataType: "json",
        //        data: jsonData,
        //        success: function () {
        ...
        //                    $.ajax({
        //                        type: 'POST',
        //                        url: 'evalfinal2docentep.aspx/guardardatoschk1',
        //                        contentType: "application/json; charset=utf-8",
        //                        dataType: "json",
        //                        data: jsonData2
        ...
        function guardarpreguntascerradaschk4() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/eliminarchk4',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=modalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            var jsonData2 = "{ 'chk':'" + $(this).val() + "', 'codasesor':'" +asesorva + "'}";

                            $.ajax({

                                type: 'POST',
                                url: 'evalfinal2docentep.aspx/guardardatoschk4',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk5() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/eliminarchk5',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=partimodalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfinal2docentep.aspx/guardardatoschk5',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk6() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/eliminarchk6',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=investigamodalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfinal2docentep.aspx/guardardatoschk6',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk11() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/eliminarchk11docente',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=ieptics]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfinal2docentep.aspx/guardardatoschk11',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk12() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/eliminarchk12',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=preg71]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfinal2docentep.aspx/guardardatoschk12',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk13() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfinal2docentep.aspx/eliminarchk13',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=p10]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfinal2docentep.aspx/guardardatoschk13',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        $.ajax({
        type: 'POST',
        url: 'evalfinal2docentep.aspx/eliminarchk14',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        data: jsonData,
        success: function () {
       ...
       $.ajax({
           type: 'POST',
           url: 'evalfinal2docentep.aspx/guardardatoschk14',
           contentType: "application/json; charset=utf-8",
           dataType: "json",
           data: jsonData2
        ...
        function cargarAsesorActul(){
            $.ajax({
                    type: 'POST',
                    url: 'evalfinal2docentep.aspx/cargaAsesorActual1',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
                                    var resp = json.d.split("&");
