<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="intermediainstrudocentes2.aspx.cs" Inherits="intermediainstrudocentes2" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function buscarasesor() {
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if (resp[1] === "true") {
                        $("#asesor").html(resp[0]);
                        cargarrespuestascerradasyabiertas($("#asesor").val());
        ...
        function cargarrespuestascerradasyabiertas(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes2_intermedia.aspx/cargarrespuestascerradasyabiertas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        if (resp[2] == "si")
                            $("#rbpromueve_si").attr('checked', true);
                        else if (resp[2] == "no")
                            $("#rbpromueve_no").attr('checked', true);

                        if (resp[3] == "si")
                            $("#rbparticipado_si").attr('checked', true);
                        else if (resp[3] == "no")
                            $("#rbparticipado_no").attr('checked', true);

                        if (resp[4] == "si")
                            $("#rbinvestiga_si").attr('checked', true);
                        else if (resp[4] == "no")
                            $("#rbinvestiga_no").attr('checked', true);

                        if (resp[5] == "si")
                            $("#preg8rbforma_si").attr('checked', true);
                        else if (resp[5] == "no")
                            $("#preg8rbforma_no").attr('checked', true);

                        if (resp[6] == "si")
                            $("#preg10rbforma_si").attr('checked', true);
                        else if (resp[6] == "no")
                            $("#preg10rbforma_no").attr('checked', true);


                        $("#tipo_1").val(resp[7]);
                        $("#modalidad_1").val(resp[8]);

                        $("#tipo_2").val(resp[9]);
                        $("#modalidad_2").val(resp[10]);

                        $("#tipo_3").val(resp[11]);
                        $("#modalidad_3").val(resp[12]);

                        $("#tipo_4").val(resp[13]);
                        $("#modalidad_4").val(resp[14]);
                        

                        $("#nombre_1").val(resp[15]);
                        $("#duracion_1").val(resp[16]);
                        $("#anio_1").val(resp[17]);

                        $("#nombre_2").val(resp[18]);
                        $("#duracion_2").val(resp[19]);
                        $("#anio_2").val(resp[20]);

                        $("#nombre_3").val(resp[21]);
                        $("#duracion_3").val(resp[22]);
                        $("#anio_3").val(resp[23]);

                        $("#nombre_4").val(resp[24]);
                        $("#duracion_4").val(resp[25]);
                        $("#anio_4").val(resp[26]);

                        $("#preg7nombre_1").val(resp[27]);
                        $("#preg7duracion_1").val(resp[28]);
                        $("#preg7anio_1").val(resp[29]);

                        $("#preg7nombre_2").val(resp[30]);
                        $("#preg7duracion_2").val(resp[31]);
                        $("#preg7anio_2").val(resp[32]);

                        $("#preg7nombre_3").val(resp[33]);
                        $("#preg7duracion_3").val(resp[34]);
                        $("#preg7anio_3").val(resp[35]);

                        $("#preg7nombre_4").val(resp[36]);
                        $("#preg7duracion_4").val(resp[37]);
                        $("#preg7anio_4").val(resp[38]);

                        $("#preg9nombre_1").val(resp[39]);
                        $("#preg9duracion_1").val(resp[40]);
                        $("#preg9anio_1").val(resp[41]);

                        $("#preg9nombre_2").val(resp[42]);
                        $("#preg9duracion_2").val(resp[43]);
                        $("#preg9anio_2").val(resp[44]);

                        $("#preg9nombre_3").val(resp[45]);
                        $("#preg9duracion_3").val(resp[46]);
                        $("#preg9anio_3").val(resp[47]);

                        $("#preg9nombre_4").val(resp[48]);
                        $("#preg9duracion_4").val(resp[49]);
                        $("#preg9anio_4").val(resp[50]);

                        $("#preg7tipo_1").val(resp[51]);
                        $("#preg7modalidad_1").val(resp[52]);

                        $("#preg7tipo_2").val(resp[53]);
                        $("#preg7modalidad_2").val(resp[54]);

                        $("#preg7tipo_3").val(resp[55]);
                        $("#preg7modalidad_3").val(resp[56]);

                        $("#preg7tipo_4").val(resp[57]);
                        $("#preg7modalidad_4").val(resp[58]);

                        $("#preg9tipo_1").val(resp[59]);
                        $("#preg9modalidad_1").val(resp[60]);

                        $("#preg9tipo_2").val(resp[61]);
                        $("#preg9modalidad_2").val(resp[62]);

                        $("#preg9tipo_3").val(resp[63]);
                        $("#preg9modalidad_3").val(resp[64]);

                        $("#preg9tipo_4").val(resp[65]);
                        $("#preg9modalidad_4").val(resp[66]);

                        $("#txtpedago").val(resp[67]);
                        $("#txtpromueve").val(resp[68]);
                        $("#txtparticipado").val(resp[69]);
                        $("#txtinvestiga").val(resp[70]);
                        $("#preg8rbforma").val(resp[71]);
                        $("#preg10rbforma").val(resp[72]);
