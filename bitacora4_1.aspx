<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="bitacora4_1.aspx.cs" Inherits="bitacora4_1" %>
	...
	<script>
	    ...
	    $(document).ready(function () {
	        ...
	        $.ajax({
	            ...
	            type: 'POST',
	            url: 'bitacora4_1.aspx/cargarDepartamentoMagdalena',
	            ...
	            success: function (response) {
	                ...
	                $.ajax({
	                    type: 'POST',
	                    url: 'bitacora4_1.aspx/cargarMunicipios',
	                    data: jsondata,
	                    contentType: 'application/json; charset=utf-8',
	                    dataType: 'JSON',
	                    success: function (response) {
	        ...
	        $("#municipio").on("change", function () {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'bitacora4_1.aspx/cargarInstituciones',
	                data: jsondata,
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                //data:frmserialize,
	        ...
	        $("#institucion").on("change", function () {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'bitacora4_1.aspx/cargarSedesxInstitucion',
	                data: jsondata,
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: function (json) {
	        ...
	        $("#sede").on("change", function () {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'bitacora4_1.aspx/cargarGruposInvestigacionxSede',
	                data: jsondata,
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: function (json) {
	        ...
	        $("#grupoinvestigacion").change(function () {
	            ...
	            //var jsondata = "{'codGrupoinvestigacion':'" + codGrupoinvestigacion + "'}";
	            //$.ajax({
	            //    type: 'POST',
	            //    url: 'bitacora4_1.aspx/cargarLineasInvestigacionxGrupoInvestigacion',
	            //    data: jsondata,
	            //    contentType: "application/json; charset=utf-8",
	            //    dataType: "json",
	            //    success: function (json) {
	            //        var resp = json.d.split("@");
	            //        if (resp[0] === "lineainvestigacion") {
	            //            $("#lineainvestigacion").html(resp[1]);
	            //        }
	            //    }
	            //});
	            //codigo de lineas de investigacion
	            //$("#fechagasto1").val('');
	    ...
	    function enviarbitacora4_1(event) {
	        ...
	        //}
	            ...
	            if (event == 'insert' ) {
	                ...
	                $.ajax({
	                    type: 'POST',
	                    url: 'bitacora4_1.aspx/insertbitacora4_1',
	                    contentType: "application/json; charset=utf-8",
	                    dataType: "json",
	                    data: jsonData,
	                    success: function (json) {
	                        ...
	                        if (resp[0] === "true") {
	                            ...
	                            //$('#btn-guardar').attr('onclick', 'enviarbitacora4_1(\'update\')');
	                ...
	                $.ajax({
	                    type: 'POST',
	                    url: 'bitacora4_1.aspx/updatebitacora4_1',
	                    contentType: "application/json; charset=utf-8",
	                    dataType: "json",
	                    data: jsonData,
	                    success: function (json) {
	        ...
	        $.ajax({
	            ...
	            success: function (json) {
	                ...
	                if (resp[0] === "true") {
	                    ...
	                    $('#btn-guardar').attr('value', 'Actualizar');
	                    $('#btn-guardar').attr('onclick', 'enviarbitacora4_1(\'update\')');
	                    floadRubrosBitacora4_1(codigoinstrumento);
	                }
	                 else {
	    ...
	    function finsertrubros() {
	        ...
	        $.ajax({
	            type: 'POST',
	            url: 'bitacora4_1.aspx/deleteRubrosbitacora4_1',
	            data: jsonData,
	            contentType: "application/json; charset=utf-8",
	            dataType: "json",
	            success: function (data) {
	                ...
	                if (resp[0] === "true") {
	                    ...
	                    for (var i = 1; i <= total; i++) {
	                        ...
	                        $.ajax({
	                            type: 'POST',
	                            url: 'bitacora4_1.aspx/insertRubrobitacora4_1',
	                            data: jsonData,
	                            contentType: "application/json; charset=utf-8",
	                            dataType: "json",
	                            success: function (data) {
	    ...
	    function floadRubrosBitacora4_1(codigoinstrumento) {
	        total = 1;
	        var jsonData = '{"rubro": "insumos", "codigoinstrumento":"' + codigoinstrumento + '", "total":' + total + '}';
	        $.ajax({
	            type: 'POST',
	            url: 'bitacora4_1.aspx/loadRubrosBitacora4_1',
	            data: jsonData,
	            contentType: "application/json; charset=utf-8",
	            dataType: "json",
	            success: function (data) {
	    ...
	    function listarBitacora4_1() {
	        $("#form").hide();
	        $("#table").fadeIn(500);
	        $.ajax({
	            type: 'POST',
	            url: 'bitacora4_1.aspx/listarBitacora4_1',
	            contentType: 'application/json; charset=utf-8',
	            dataType: 'JSON',
	            success: function (response) {
	    ...
	    function eliminar(codigo) {
	        if (confirm('¿Estás seguro de eliminar este registro?')) {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'bitacora4_1.aspx/deletebitacora4_1',
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                data: jsonData,
	                success: function (json) {
...
<div id="table">
    ...
    <div id="form" style="display:none;">
        <input type="button" value="Regresar" class="btn btn-primary" id="btn-regresar1" onclick="listarBitacora4_1();" style="float:right">
		<fieldset>
		...
		<fieldset>
		    ...
		    <table width="100%" class="border">
		    	...
		    	<tr>
		    		<td colspan="2" align="right">
		    			<input type="button" value="Guardar" class="btn btn-success" id="btn-guardar" onclick="enviarbitacora4_1('insert');">
                        <input type="button" value="Regresar" class="btn btn-primary" id="btn-regresar" onclick="listarBitacora4_1();">
