...
public partial class estraunoespaciosaproevi : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("estraunoespaciosapro.aspx?e=1&m=5");
    }
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (usu.agregarArchivoRespositorioEstrategia1EspacioApropiacion(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), "", lblCodigo.Text))
            {
                gvCargarEvidencias();
    ...
    {
        String[] allowedExtensions = { ".gif", ".png", ".jpeg", ".jpg", ".pdf", ".doc", ".xls", ".docx", ".xlsx" };
        return allowedExtensions;
    }

    private void gvCargarEvidencias()
    {
        DataTable datos = est.cargarEvidenciasEstrategia1AsesorEspaciosApropiacion(lblCodigo.Text);
    ...
    {
        Estrategias usu = new Estrategias();
        DataRow dato = usu.buscarEvidenciaEstrategia1EspaciosApropiacion(cod);
        if (usu.borrarEvidenciaEstrategia1EspaciosApropiacion(cod))
        {
