<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="evalimpacto01.aspx.cs" Inherits="intermediainstrurectores" MaintainScrollPositionOnPostback="true" %>
    ...
    <script>
        ...
        function enviar(event) {
            if ($.trim($("#asesor").val()) == '' || $.trim($("#asesor").val()) == '0') {
                ...
                var jsonData = '{ "nombre":"' + $('#nombre').val() + '", "telefono": "' + $('#telefono').val() + '", "fax": "' + $('#fax').val() + '", "email": "' + $('#email').val() + '", "direccion": "' + $('#direccion').val() + '", "web": "' + $('#web').val() + '", "asesores": "' + $('#asesor').val() + '", "codinstitucion": "' + codinstitucion + '"}';
                $.ajax({
                    type: 'POST',
                    url: 'lineabaseregistroinst_intermedia.aspx/updateinstrumento',
                    data: jsonData,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        ...
        <fieldset>
            ...
            <fieldset>
            <legend>Sedes beneficiadas con el Programa Ciclón</legend>
              <table align="center" style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
                  <tr>
                      <td>
                          Departamento <asp:DropDownList ID="DropDownList1" runat="server" CssClass="TextBox" AutoPostBack="true" OnSelectedIndexChanged="dropCiudad_SelectedIndexChanged"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="None" ErrorMessage="Seleccione el Departamento"
                    ControlToValidate="dropDepartamento" Text="*" ValidationGroup="addUsuario" InitialValue="Seleccione"></asp:RequiredFieldValidator>
                <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender15" runat="server" TargetControlID="RFdropDepartamento"
                    ...
                    Width="250px" WarningIconImageUrl="Imagenes/error3.png" CssClass="CustomValidatorCalloutStyle">
                            ...
                            Ciudad  <asp:DropDownList ID="DropDownList2" runat="server" CssClass="TextBox"></asp:DropDownList> 
                           <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="None" ErrorMessage="Seleccione la Ciudad"
                    ControlToValidate="dropCiudad" Text="*" ValidationGroup="addUsuario" InitialValue="Seleccione"></asp:RequiredFieldValidator>
                <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender16" runat="server" TargetControlID="RFVdropCiudad"
                    HighlightCssClass="Highlight" PopupPosition="BottomLeft" Enabled="True"
                    Width="250px" WarningIconImageUrl="Imagenes/error3.png" CssClass="CustomValidatorCalloutStyle">
                </ajx:ValidatorCalloutExtender>
                            
                           Zona <asp:DropDownList ID="DropDownList3" runat="server" CssClass="TextBox"></asp:DropDownList>
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="None" ErrorMessage="Seleccione la Zona"
                    ControlToValidate="dropZona" Text="*" ValidationGroup="addUsuario" InitialValue="Seleccione"></asp:RequiredFieldValidator>
                <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender17" runat="server" TargetControlID="RFVdropZona"
                    HighlightCssClass="Highlight" PopupPosition="BottomLeft" Enabled="True"
                    Width="250px" WarningIconImageUrl="Imagenes/error3.png" CssClass="CustomValidatorCalloutStyle">
                </ajx:ValidatorCalloutExtender>
                      </td>
                  ...
                  <tr>
                      <td>
                          Nro. beneficiadas con el Programa Ciclón:
                                       <asp:TextBox ID="txtActivas" runat="server" CssClass="TextBox" Width="50"></asp:TextBox>
                                       <asp:TextBox ID="txtInactivas" runat="server" CssClass="TextBox" Width="50" Visible="false"></asp:TextBox>
                      </td>
            ...
            <fieldset>
                ...
                <tr>
                  <td>ISCE 2016</td>
                    <td><asp:TextBox type="text" runat="server" class="TextBox" id="is16" width="50" name="is16" /></td>
                  <td>ISCE 2017</td>
                    <td><asp:textbox type="text" runat="server" class="TextBox" id="is17" name="is17" width="50"/></td>
                  <td>ISCE 2018</td>
                    <td><asp:textbox type="text" runat="server" class="TextBox" id="is18" name="is18" width="50"/></td>
                  </tr>
                    </table>
            </fieldset>
            <fieldset>
              ...
              <table align="center" style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
                ...
                <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender7" runat="server" TargetControlID="RFVdropZona"
                  ...
                  <tr>
                      <td>
                          Nro. Total de Sedes:
                              Activas  <asp:TextBox ID="txtbox" runat="server" CssClass="TextBox" Width="50"></asp:TextBox>
                           Inactivas   <asp:TextBox ID="txtbox2" runat="server" CssClass="TextBox" Width="50"></asp:TextBox>
                      </td>
