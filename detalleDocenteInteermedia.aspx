<%@ Page Title="Docentes que participaron en la evaluación intermedia según último nivel educativo aprobado" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detalleDocenteInteermedia.aspx.cs" Inherits="detalleDocenteInteermedia" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'docentesEvaluacionintermedia.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'docentesEvaluacionintermedia.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'docentesEvaluacionintermedia.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'docentesEvaluacionintermedia.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detalleDocenteInteermedia.aspx/docentesEvaluacionintermedia_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        // realizar busqueda
         function filtro() {
            ...
            table.destroy();
            $("#tableList tbody").html("<tr><td  style=\"text-align:center;\">Cargando...</td></tr>");
            ...
            var intru5 = $("#intru5").val();
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmunicipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "', 'codsede':'" + codSede + "', 'instrumento' : '" + instrumento + "'}";
            alert(instrumento);
            $.ajax({
                type: 'POST',
                url: 'detalleDocenteInteermedia.aspx/realizarBusquedadocentesEvaluacionintermedia_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
    ...
    <fieldset>
         ...
         <table>
                ...
                <tr>
                 ...
                 <td>Instrumento deligenciado </td>
                ...
                <tr>
                    ...
                    <td>
                        <select class="TextBox width-100" name="respuesta" id="instrumento" style="width: 250px">
                            <option value="">Todos</option>
                            <option value="Si_2_1"> Realizaron el instrumento 2.1</option>
                            <option value="No_2_1"> No realizaron el instrumento 2.1</option>
                            <option value="Si_5">  Realizaron el instrumento 5</option>
                            <option value="No_5"> No realizaron el instrumento 5</option>
