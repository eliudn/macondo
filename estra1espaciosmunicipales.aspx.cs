...
public partial class estra1espaciosmunicipales : System.Web.UI.Page
{
    ...
    public static string loadReport()
    {
        ...
        {
            count1 = estra1NumeroFeriasMunicipales.Rows.Count;
        ...
        ca += "<tr>";
        ca += "<td><b>1.</b> Número de ferias municipales</td>";
        ca += "<td class='center'>" + count1 + " de " + total1 + "</td>";
        ca += "<td class='center'>" + meta1 + "%</td>";//?m=0&s=0&a=50
        ca += "<td class='noExl center'><a href='estra1numeroferiasmunicipales.aspx'><img src='images/detalles.png'> Ver</a></td>";//?fechaini=0&fechafin=0 <a href='detalleestra1espaciosmunicipales.aspx'><img src='images/detalles.png'></a>
        ca += "</tr>";
