<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="procesosistematizacion.aspx.cs" Inherits="procesosistematizacion" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No.: <asp:Label ID="lblEstrategia" runat="server"></asp:Label> - Momento: <asp:Label ID="lblMomento" runat="server"></asp:Label>, Proceso de Sistematización - Carga de Evidencias</h2>
    <div style="float:right;margin-top:-30px;">
        <asp:Label runat="server" ID="lblInstructivo" Visible="true"></asp:Label><a href="Proceso_Sistematizacion/G009_INFORME_PRODUCCION_DE_SISTEMATIZACION.doc" target="_blank" class="btn btn-success">Descargar formato</a>
         <asp:Button runat="server" CssClass="btn btn-primary" ID="btnRegresar" Text="Regresar" OnClick="btnRegresar_Click" />
    </div>
    <br />
    ...
    <asp:Label ID="lblCodMesaTrabajo" runat="server" Visible="false" ></asp:Label>
     ...
     <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        ...
                        <asp:ListItem Value="Actas de reunión, equipo pedagógico">2. Actas de reunión, equipo pedagógico</asp:ListItem>
                          <asp:ListItem Value="Fotos">3. Fotos</asp:ListItem>
                           <asp:ListItem Value="Informe producción de sistematización">4. Informe producción de sistematización</asp:ListItem>
                     </asp:RadioButtonList>
      ...
      <asp:GridView ID="GridEvidencias" runat="server" CellPadding="4" DataKeyNames="cod" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="tamano"  HeaderText="Tamaño" >
                              ...
                              <asp:BoundField DataField="nombre" HeaderText="Coordinador">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
