<%@ Page Title="Docentes que participaron en la evaluación intermedia según último nivel educativo aprobado" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="docentesEvaluacionintermedia.aspx.cs" Inherits="docentesEvaluacionintermedia" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'docentesEvaluacionintermedia.aspx/docentesEvaluacionintermedia_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'docentesEvaluacionintermedia.aspx/realizarBusquedadocentesEvaluacionintermedia_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                ...
                <tr>
                    ...
                    <td>
                        <select class="TextBox width-100" name="respuesta" id="respuesta" style="width: 250px">
                            ...
                            <option value="Bachillerato pedagógico">Bachillerato pedagógico</option>
