...
public partial class estra4memoriasesionesdocasistentesdist : System.Web.UI.Page
{
    ...
    public static string estra4memoriassesio1_docente()
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_docentes("", "", "", "", HttpContext.Current.Session["s"].ToString());
    ...
    public static string realizarBusquedaestra4memoriasesion1_docente(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_docentes(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString());
