<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="evalfina4p.aspx.cs" Inherits="evalfina4p" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function buscarasesor() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/asesorescarg',
                ...
                success: function (json) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        var asea = $("#cargaasesoa1").val();
                        var asea2 = $("#cargaasesoa1").val();
                        ...
                        // cargarrespuestaspregunta($("#cargaasesoa1").val(), "2", "");
                        // cargarrespuestaspregunta($("#cargaasesoa1").val(), "4", "");
                        // cargarrespuestaspregunta($("#cargaasesoa1").val(), "3", "");
                        // cargarrespuestaspregunta($("#cargaasesoa1").val(), "6", "");

                        //cargarrespuestaspregunta($("#asesor").val(), "8", "");
                        //cargarrespuestaspregunta($("#asesor").val(), "10", "");


                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "11", "preg111", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "12", "preg112", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "13", "preg113", "");


                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "21", "preg121", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "22", "preg122", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "23", "preg123", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "31", "preg131", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "32", "preg132", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "1", "33", "preg133", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "11", "preg211", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "12", "preg212", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "13", "preg213", "");


                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "21", "preg221", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "22", "preg222", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "23", "preg223", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "31", "preg231", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "32", "preg232", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "2", "33", "preg233", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "11", "preg311", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "12", "preg312", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "13", "preg313", "");
                    

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "21", "preg321", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "22", "preg322", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "23", "preg323", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "31", "preg331", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "32", "preg332", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "3", "33", "preg333", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "11", "preg411", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "12", "preg412", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "13", "preg413", "");


                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "21", "preg421", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "22", "preg422", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "23", "preg423", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "31", "preg431", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "32", "preg432", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "4", "33", "preg433", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "11", "preg511", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "12", "preg512", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "13", "preg513", "");


                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "21", "preg521", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "22", "preg522", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "23", "preg523", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "31", "preg531", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "32", "preg532", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "5", "33", "preg533", "");

                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "6", "11", "preg611", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "6", "12", "preg612", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "6", "13", "preg613", "");


                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "6", "14", "preg614", "");
                        cargarrespuestaspreguntacerrada_radio($("#cargaasesoa1").val(), "6", "15", "preg615", "");
                      
                                               
                        cargarrespuestascerradaschk1($("#cargaasesoa1").val());
                        cargarrespuestascerradaschk4($("#cargaasesoa1").val());
                        cargarrespuestascerradaschk5($("#cargaasesoa1").val());
                        cargarrespuestascerradaschk6($("#cargaasesoa1").val());
                        cargarrespuestascerradaschk11($("#cargaasesoa1").val());
                        cargarrespuestascerradaschk12($("#cargaasesoa1").val());
                        cargarrespuestascerradaschk13($("#cargaasesoa1").val());
                    }
                    else {
                        cargarasesores();
                    }
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarasesores',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    var resp = json.d.split("&");
        ...
        function cargarrespuestaspregunta(codasesor,pregunta,numero) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestaspregunta',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestaspreguntacerrada_2(codasesor, pregunta, subpregunta, nombre, numero) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestaspreguntacerrada_2',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk1(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk1',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk4(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk4',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk5(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk5',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk6(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk6',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk11(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk11',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function cargarrespuestascerradaschk12(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk12',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
         ...
         function cargarrespuestascerradaschk13(codasesor) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/cargarrespuestascerradaschk13',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function enviar() {
            ...
            //    //$("#telefono").focus();
               ...
               $(".desactivarC1").delay(20000).fadeOut(500);
        ...
        function guardarpreguntas() {
            var asesorva=$("#asesor").val();
            //pregunta 2 los radio
            //Pregunta 1
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg111]:checked').val(), "1", "11", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg112]:checked').val(), "1", "12", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg113]:checked').val(), "1", "13", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg121]:checked').val(), "1", "21", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg122]:checked').val(), "1", "22", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg123]:checked').val(), "1", "23", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg131]:checked').val(), "1", "31", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg132]:checked').val(), "1", "32", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg133]:checked').val(), "1", "33", "");

            //Pregunta 2
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg211]:checked').val(), "2", "11", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg212]:checked').val(), "2", "12", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg213]:checked').val(), "2", "13", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg221]:checked').val(), "2", "21", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg222]:checked').val(), "2", "22", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg223]:checked').val(), "2", "23", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg231]:checked').val(), "2", "31", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg232]:checked').val(), "2", "32", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg233]:checked').val(), "2", "33", "");

            //Pregunta 3
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg311]:checked').val(), "3", "11", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg312]:checked').val(), "3", "12", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg313]:checked').val(), "3", "13", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg321]:checked').val(), "3", "21", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg322]:checked').val(), "3", "22", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg323]:checked').val(), "3", "23", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg331]:checked').val(), "3", "31", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg332]:checked').val(), "3", "32", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg333]:checked').val(), "3", "33", "");

            //pregunta 4
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg411]:checked').val(), "4", "11", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg412]:checked').val(), "4", "12", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg413]:checked').val(), "4", "13", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg421]:checked').val(), "4", "21", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg422]:checked').val(), "4", "22", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg423]:checked').val(), "4", "23", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg431]:checked').val(), "4", "31", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg432]:checked').val(), "4", "32", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg433]:checked').val(), "4", "33", "");

            //pregunta 5
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg511]:checked').val(), "5", "11", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg512]:checked').val(), "5", "12", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg513]:checked').val(), "5", "13", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg521]:checked').val(), "5", "21", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg522]:checked').val(), "5", "22", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg523]:checked').val(), "5", "23", "");

            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg531]:checked').val(), "5", "31", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg532]:checked').val(), "5", "32", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg533]:checked').val(), "5", "33", "");

             //pregunta 6
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg611]:checked').val(), "6", "11", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg612]:checked').val(), "6", "12", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg613]:checked').val(), "6", "13", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg614]:checked').val(), "6", "14", "");
            guardarpreguntascerradas_radio($("#cargaasesoa1").val(),asesorva, $('input:radio[name=preg615]:checked').val(), "6", "15", "");
        ...
        function guardarpreguntasabiertas_preg2(codasesor, nombre, duracion, anio, numero, pregunta, accion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/guardarpreguntasabiertas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
        ...
        function guardarpreguntascerradas_radio(codasesor2, codasesor, nombre, pregunta, subpregunta, accion) {
           // alert(codasesor+' '+ nombre+' '+ pregunta+' '+ subpregunta+' '+ accion);
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/guardarpreguntascerradas',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
        ...
        //    $.ajax({
        //        type: 'POST',
        //        url: 'evalfina4p.aspx/eliminarchk1',
        //        contentType: "application/json; charset=utf-8",
        //        dataType: "json",
        //        data: jsonData,
        //        success: function () {
        ...
        //                    $.ajax({
        //                        type: 'POST',
        //                        url: 'evalfina4p.aspx/guardardatoschk1',
        //                        contentType: "application/json; charset=utf-8",
        //                        dataType: "json",
        //                        data: jsonData2
        ...
        function guardarpreguntascerradaschk4() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/eliminarchk4',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=modalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                url: 'evalfina4p.aspx/guardardatoschk4',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk5() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/eliminarchk5',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=partimodalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfina4p.aspx/guardardatoschk5',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function guardarpreguntascerradaschk6() {
            ...
            $.ajax({
                type: 'POST',
                url: 'evalfina4p.aspx/eliminarchk6',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function () {
                    ...
                    $("input[name=investigamodalidad]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfina4p.aspx/guardardatoschk6',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
                ...
                success: function () {
                    ...
                    $("input[name=ieptics]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfina4p.aspx/guardardatoschk11',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
                ...
                success: function () {
                    ...
                    $("input[name=ejeprograma]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfina4p.aspx/guardardatoschk12',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
                ...
                success: function () {
                    ...
                    $("input[name=participacion]").each(function (index) {
                        if ($(this).is(':checked')) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'evalfina4paspx/guardardatoschk13',
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                data: jsonData2
        ...
        function cargarAsesorActul(){
            $.ajax({
                    type: 'POST',
                    url: 'evalfina4p.aspx/cargaAsesorActual1',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
                                    var resp = json.d.split("&");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server" >
    ...
    <td >  
        ...
        <select id="cargaasesoa1" class="TextBox" style="display:none"></select>
