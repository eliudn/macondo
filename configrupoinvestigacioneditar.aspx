<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="configrupoinvestigacioneditar.aspx.cs" Inherits="configrupoinvestigacioneditar" %>
      ...
      <table>
          ...
          <tr>
            ...
            <tr>
                    ...
                    <tr>
                        <td><asp:Button ID="btnActualizar" runat="server" OnClick="btnActualizar_Onclick" CssClass="btn btn-success" Text="Actualizar" /></td>
                    </tr>
          </table>
