<%@ Page Title="Grupos de Investigación" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesdesarrollo.aspx.cs" Inherits="detallesdesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            var jsondata = "{'linea':'" + $.get("ln") + "'}";
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/totalGrupoInvestigacion',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data: jsondata,
                success: function (response) {
        ...
        function filtro() {
            ...
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmuncipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "', 'codsede':'" + codSede + "', 'linea':'" + $.get("ln") + "'}";
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/realizarBusquedatotalGrupoInvestigacion',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
        ...
        function btnregresar() {
            if ($.get("sg") === "true") {
                ...
                window.location.href = "informedesarrollo.aspx";
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Grupos de investigación infantiles y juveniles que se inscribieron en la convocatoria de Ciclón </h4>
    <p>Miden el número de grupos de investigación infantiles y juveniles que se organizaron e inscribieron en la convocatoria de Ciclón y diligenciaron la bitácora 01</p>    
    <br />
    <asp:Label ID="lblSeguimiento" runat="server" Visible="false"></asp:Label>
    <fieldset>
