<%@ Page Title="Plataformas pedagógicas de las sedes educativas" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="plataformaspedagogicassedes.aspx.cs" Inherits="plataformaspedagogicassedes" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
             ...
             //$("#respuesta").val();
             if (Url._utf8_decode($.get('resp')) == 'si') {
                 $(".plataforma").show();
             } else {
                 $(".plataforma").hide();
             }
             ...
             //Cargar plataformas pedagógicas
            $.ajax({
                type: 'POST',
                url: 'plataformaspedagogicassedes.aspx/cargarPlataformasPedagogicas',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
                    if (resp[0] === "plataformas") {
                        $("#respuesta").html(resp[1]);
                    }
                }, complete: function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'plataformaspedagogicassedes.aspx/cargarDepartamentoMagdalena',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'plataformaspedagogicassedes.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'plataformaspedagogicassedes.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'plataformaspedagogicassedes.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            var respuesta = Url._utf8_decode($.get('resp'));
            var jsondata = "{'respuesta' : '"+respuesta+"'}";
            $.ajax({
                type: 'POST',
                url: 'plataformaspedagogicassedes.aspx/plataformaspedagogicassedes_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            var opc = Url._utf8_decode($.get('resp'));
            var respuesta = $("#respuesta").val();
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmunicipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "', 'codsede':'" + codSede + "', 'respuesta' : '"+respuesta+"', 'opc' : '"+opc+"'}";
            $.ajax({
                type: 'POST',
                url: 'plataformaspedagogicassedes.aspx/realizarBusquedaplataformaspedagogicassedes_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
    ...
    <fieldset>
         ...
         <table>
                ...
                <tr>
                    ...
                    <td class="plataforma">Plataformas pedagógicas: </td>
                    <td></td>
                </tr>
                <tr>
                    <td>
