<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="intermediainstrudocentes.aspx.cs" Inherits="intermediainstrudocentes" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function buscarasesor() {
            ...
            $.ajax({
                type: 'POST',
                url: 'lineabasedocentes_intermedia.aspx/buscarasesor',
                ...
                success: function (json) {
                    ...
                    if (resp[1] === "true") {
                        ...
                        cargarrespuestascerradaschk($("#asesor").val());
                    }
                    else {
                        cargarasesores();
                    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <center>
        <h2>
            Instrumento No. 02.1, Caracterización de Currículos de las Instituciones Educativas
        ...
        <p>
            ...
            En la evaluación intermedia del programa CICLÓN es necesario revisar la caracterización de los currículos de las sedes educativas beneficiadas para hacer visible las posibles modificaciones realizadas a los mismos en el marco del desarrollo de la estrategia No. 2 “Estrategia de autoformación, formación de saber y conocimiento y apropiación para maestros(as) acompañantes  coinvestigadores e investigadores en los lineamientos del IEP apoya de TIC y su propuesta metodológica”, para valorar sus alcances en términos de resultados, efectos e impactos. 
           
            <br /><br />
            <b>Propósito: </b>
            <br /><br />
           Recoger información básica sobre la percepción que tienen los maestros y maestras de impactos que el proyecto CICLÓN ha generado sobre el PEI, el currículo de las instituciones educativas y el quehacer de los docentes, en especial en lo refereido a la apropiación de las TIC, atribuibles a la introducción de la Investigación como Estrategia Pedagógica apoyada en TIC.
            <br /><br />
            <b>Metodología: </b>
            <br /><br />
            Este instrumento será diligenciado previo a la finalización de la estrategia No. 2 “Estrategia de autoformación, formación de saber y conocimiento y apropiación para maestros(as) acompañantes  coinvestigadores e investigadores en los lineamientos del IEP apoya de TIC y su propuesta metodológica” del proyecto. Será diligenciado directamente en el  SIEP por los maestros beneficiados de la misma.  
        ...
        <fieldset>
            ...
            <table style="background-color: #ECECEC; padding: 10px; border-radius: 5px;width:100%;">
               <tr>
                   <td class="bold">
                       1.	A partir del proceso de formacion de docentes implementado por el programa Ciclón ¿se han realizado alguna modificaciones al currículo de su sede educativa dirigidas a introducir la IEP apoyada en TIC? 
                   </td>
               </tr>
                <tr>
                    <td>
                        <input id="rbmodtic_si" name="modtic" type="radio" value="si" />Si <input id="rbmodtic_no" name="modtic" type="radio" value="no" />No
                    </td>
                </tr>
                <tr>
                    <td>
                        Si la respuesta a la pregunta anterior es SI indique qué modificaciones se realizaron en el currículo que hacen evidente la Introducción de la IEP apoyada en TIC al mismo:
                    </td>
                </tr>
                <tr>
                    <td>
                        <textarea id="txtmodtic" class="TextBox" cols="50" rows="5"></textarea>
                    </td>
                </tr>
                <tr>
                     <td class="bold">
                         <br />
                        2.	A los 18 meses de ejecución del proceso de  formación sobre la Investigación como Estrategia Pedagógica apoyada e TIC, indique ¿si considera que el modelo educativo de su institución favorece la incorporación de esta propuesta pedagógica al currículo? 
                    </td>
                </tr>
                <tr>
                    <td>
                        <input id="rbejetic_si" name="rbejetic" type="radio" value="si" />Si <input id="rbejemodtic_no" name="rbejetic" type="radio" value="no" />No
                    </td>
                </tr>
                <tr>
                    <td>
                        Si la respuesta a la pregunta anterior fue SI indique cómo el modelo educativo de su institución favorece la incorporación de la IEP apoyada en TIC al currículo
                    </td>
                </tr>
                <tr>
                    <td>
                         <textarea id="txtejetic" class="TextBox" cols="50" rows="5"></textarea><br />
                ...
                <tr>
                     <td class="bold">
                         <br />
                        3.	A los 18 meses de ejecucuón del Programa Ciclón, la formación en la Investigación como Estrategia Pedagógica ¿se modificó su práctica pedagógica?
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                     <td class="bold">
                         <br />
                         4.	Si el programa Ciclón promueve el uso de las TIC, ¿Cuales de las siguientes TIC hacen parte de sus practicas pedagógicas?</td>
                </tr>
               <tr>
                   <td>
