...
public partial class estra4memoriasesionessedesinscritas : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra4memoriassesio1_sedesinscritas()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_docentes_estudiantes("", "", "", "", HttpContext.Current.Session["s"].ToString());
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra4memoriasesion1_sedesinscritas(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_docentes_estudiantes(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString());
     ...
     protected void btnRegresar_Click(object sender, EventArgs e)
     {
         ...
         //            if (Session["s"].ToString() == "1")
         //            {
         //                Response.Redirect("estra4memorias004_2016.aspx?m=1&s=" + HttpContext.Current.Session["s"].ToString() + "&e=4");
         //            }
         //        }
         //    }
         //}
