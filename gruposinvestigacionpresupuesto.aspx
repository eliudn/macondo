<%@ Page Title="Total grupos de investigación con registro de avance del presupuesto" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="asesoriasgpetapa5.aspx.cs" Inherits="asesoriasgpetapa5" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/gruposInvestigacionPresupuesto',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/realizarBusquedagruposInvestigacionPresupuesto',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
        ...
        function btnregresar() {
            if ($.get("sg") === "true") {
                ...
                window.location.href = "reporteindicadores.aspx";
            }
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Total grupos de investigación con registro de avance del presupuesto</h4>
    <p>Mide el % ejecución del presupuesto de los grupos de investigación infantiles y juveniles </p>
    <br />
