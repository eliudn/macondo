...
public partial class estra5sesionesevaluacion : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5evaluacion()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = formato.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < formato.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                //ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + formato.Rows[i]["actividad"].ToString() + " </td>";
                ca += "<td>" + formato.Rows[i]["fechacreado"].ToString() + " </td>";
                ca += "<td>" + formato.Rows[i]["nombrearchivo"].ToString() + " </td>";
                ca += "<td>" + formato.Rows[i]["ext"].ToString() + " </td>";
