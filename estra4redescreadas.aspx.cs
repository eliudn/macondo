...
public partial class estra4redescreadas : System.Web.UI.Page
{
    ...
    public static string estra4redessocentes()
    {
        ...
        DataTable estra4memoriasesion1 = est.cargarRedesTematicas("", "", "", "", HttpContext.Current.Session["anio"].ToString());
    ...
    public static string realizarBusquedaestra4redessocentes(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataTable estra4memoriasesion1 = est.cargarRedesTematicas(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["anio"].ToString());
