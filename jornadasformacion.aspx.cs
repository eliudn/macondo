...
public partial class jornadasformacion : System.Web.UI.Page
{
    ...
    public static string loadReport()
    {
        ...
        {
            count1 = jornadasformacion.Rows.Count;
        ...
        ca += "<tr>";
        ca += "<td><b>1.</b> Jornadas de formación en la pregunta como punto de partida y en la ruta metodológica del proyecto Ciclón</td>";
        ca += "<td class='center'>" + count1 + " de " + total1 + "</td>";
        ca += "<td class='center'>" + meta1 + "%</td>";
        ca += "<td class='noExl center'>Sin detalles</td>";//?fechaini=0&fechafin=0 <a href='detallejornadasformacion.aspx'><img src='images/detalles.png'></a>
        ca += "</tr>";
