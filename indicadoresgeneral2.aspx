<%@ Page Title="Indicadores generales " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="indicadoresgeneral2.aspx.cs" Inherits="indicadoresgeneral2" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresgeneral2.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    //var jsondata = "{'codDepartamento': '" + $.get("dep") + "','codMunicipio': '" + $.get("mun") + "', 'codInstitucion': '" + $.get("ins") + "'}";
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresgeneral2.aspx/cargarInsMun',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
                            ...
                            if (resp[0] == "mun") {
                                ...
                                filtro();
                                //var jsondata = "{'codInstitucion':'" + $.get("ins") + "','codSede':'" + $.get("sed") + "'}";
                                //    $.ajax({
                                //        type: 'POST',
                                //        url: 'indicadoresgeneral2.aspx/cargarSedesxInstitucion',
                                //        data: jsondata,
                                //        contentType: "application/json; charset=utf-8",
                                //        dataType: "json",
            ...
            //    $.ajax({
            //        type: 'POST',
            //        url: 'indicadoresgeneral2.aspx/cargarMunicipios',
            //        data: jsondata,
            //        contentType: 'application/json; charset=utf-8',
            //        dataType: 'JSON',
            //        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'indicadoresgeneral2.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
        ...
        function floadDetalles() {
            //$.ajax({
            //    type: 'POST',
            //    url: 'indicadoresgeneral2.aspx/loadreport',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'JSON',
            //    success: function (response) {
            //        //var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            //if (codSede != null) {
                //if (codSede != "0") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresgeneral2.aspx/realizarBusquedaloadreport',
                        data: jsondata,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (json) {
                            ...
                            if (resp[0] === "lleno") {
                                ...
                                var docen = resp[3].split(",");
                                var totaldocen = parseFloat(docen[0] + "." + docen[1]);


                                var totall = (por + totaldocen);
                            ...
                            if ($("#departamento").val() == "20" && $("#municipio").val() == "") {
                                $("#title-report").html("Magdalena");
                            }
                            else if ($("#departamento").val() == "20" && $("#municipio").val() != "" && $("#institucion").val() == "") {
                                $("#title-report").html($("#municipio option:selected").text());
                            }
                            else if ($("#departamento").val() == "20" && $("#municipio").val() != "" && $("#institucion").val() != "" && $("#sede").val() == "") {
                                $("#title-report").html($("#institucion option:selected").text());
                            }
                            else if ($("#departamento").val() == "20" && $("#municipio").val() != "" && $("#institucion").val() != "" && $("#sede").val() != "") {
                                $("#title-report").html($("#sede option:selected").text());
                            }
                            //if ($("#departamento").val() == "20" && $("#municipio").val() == "") {
                            //    $("#title-report").html("Formación y acompañamiento a los estudiantes en el departamento del Magdalena");
                            //}
                            //else if ($("#departamento").val() == "20" && $("#municipio").val() != "" && $("#institucion").val() == "") {
                            //    $("#title-report").html("Formación y acompañamiento a los estudiantes en el municipio: " + $("#municipio option:selected").text());
                            //}
                            //else if ($("#departamento").val() == "20" && $("#municipio").val() != "" && $("#institucion").val() != "" && $("#sede").val() == "") {
                            //    $("#title-report").html("Formación y acompañamiento a los estudiantes en la institución: " + $("#institucion option:selected").text());
                            //}
                            //else if ($("#departamento").val() == "20" && $("#municipio").val() != "" && $("#institucion").val() != "" && $("#sede").val() != "") {
                            //    $("#title-report").html("Formación y acompañamiento a los estudiantes en la sede: " + $("#sede option:selected").text());
                            //}
                        }
                    });
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <br />
    <center>
            <a href="indicadoresgeneral.aspx" class="btn btn-success">Ver general</a>
             <a href="indicadoresestudiantes.aspx?d=20&m=&i=null&s=null" class="btn btn-success" >Ver indicadores Estudiantes</a>
             <a href="indicadoresmaestros.aspx?d=20&m=&i=null&s=null" class="btn btn-success" >Ver indicadores Docentes</a>
     </center>
    <br />
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
		        ...
		        <th style="width: 80%;">Indicador Estudiante</th>
                <th>Meta</th>
		        <th>Ejecución</th>
                <th>% Ejecución</th>
