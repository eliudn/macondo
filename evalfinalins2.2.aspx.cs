...
public partial class lineabaseregistroinst2_intermedia : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardardatoscerradas(string codasesor, string codinstitucion, string preg4_1, string preg4_2, string preg4_3, string preg4_4, string preg7)
    {
        ...
        if (dato != null)
        {
            ...
            //Actualizar el dato del asesor con la institución
            lb.actualizarCodAsesorxInstitucion(codinstitucion, codasesor);
            ...
            lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "7", "0", preg7, "2.2", "intermedia");
        }
        else
        {
            //agrega
            ...
            if (codinstasesor != null)
            {
                ...
                lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "7", "0", preg7, "2.2", "intermedia");
            }
        }
    ...
    public static string cargarrespuestascerradasyabiertas(string codasesor, string codinstitucion)
    {
        ...
        if (dato != null)
        {
            ...
            if (resp13 != null)
            {
                ca += resp13["comentario"].ToString() + "@";//12
            }
        }
    ...
    [WebMethod(EnableSession = true)]
    public static string guardarpreguntaCerrada(string codasesor, string codinstitucion, string respuesta, string respuesta2, string pregunta)
    {
        string ca = "";
        ...
        if (dato != null)
        {
            ...
            {
                case "1":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "1", "1", "2.2", "impacto");
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "1", "2", "2.2", "impacto");

                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "1", "1", respuesta, "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "1", "2", fun.convertFechaDia(respuesta2), "2.2", "impacto");
                    break;

                case "2":

                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "2", "0", respuesta, "2.2", "impacto");
                    break;

                case "3":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "3", "0", "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "3", "0", respuesta, "2.2", "impacto");

                    lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "3", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "3", respuesta2, "2.2", "impacto");
                    break;

                case "4_1":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "1", "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "1", respuesta, "2.2", "impacto");
                    break;

                case "4_2":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "2", "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "2", respuesta, "2.2", "impacto");
                    break;

                case "4_3":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "3", "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "3", respuesta, "2.2", "impacto");
                    break;

                case "4_4":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "4", "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "4", "4", respuesta, "2.2", "impacto");
                    break;

                case "5":

                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "5", "0", respuesta, "2.2", "impacto");
                    break;

                case "6":

                    lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "6", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "6", respuesta, "2.2", "impacto");
                    break;

                case "7":

                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "7", "0", "2.2", "impacto");
                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "7", "0", respuesta, "2.2", "impacto");
                    break;

                case "8":

                    lb.AgregarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "8", "0", respuesta, "2.2", "impacto");
                    break;

                case "8_1":
                    lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.1", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.1", respuesta, "2.2", "impacto");
                    break;

                case "8_2":
                     lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.2", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.2", respuesta, "2.2", "impacto");
                    break;

                case "8_3":
                     lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.3", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.3", respuesta, "2.2", "impacto");
                    break;

                case "8_4":
                     lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.4", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.4", respuesta, "2.2", "impacto");
                    break;
                case "8_5":
                    lb.eliminarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.5", "2.2", "impacto");
                    lb.AgregarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.5", respuesta, "2.2", "impacto");
                    break;
            }
        ...
        else
        {
            ...
            if (codinstasesor != null)
            {
                ...
                {
                    case "1":
                       lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "1", "1", respuesta, "2.2", "impacto");
                       lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "1", "2", fun.convertFechaDia(respuesta2), "2.2", "impacto");
                        break;

                    case "2":
                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "2", "0", respuesta, "2.2", "impacto");
                        break;

                    case "3":
                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "3", "0", respuesta, "2.2", "impacto");
                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "3", respuesta2, "2.2", "impacto");
                        break;

                    case "4_1":
                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "4", "1", respuesta, "2.2", "impacto");
                        break;

                    case "4_2":
                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "4", "2", respuesta, "2.2", "impacto");
                        break;

                    case "4_3":
                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "4", "3", respuesta, "2.2", "impacto");
                        break;

                    case "4_4":
                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "4", "4", respuesta, "2.2", "impacto");
                        break;

                    case "5":

                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "5", "0", respuesta, "2.2", "impacto");
                        break;

                    case "6":

                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "6", respuesta, "2.2", "impacto");
                        break;

                    case "8":

                        lb.AgregarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8", "0", respuesta, "2.2", "impacto");
                        break;

                    case "8_1":
                        lb.eliminarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.1", "2.2", "impacto");
                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.1", respuesta, "2.2", "impacto");
                        break;

                    case "8_2":
                        lb.eliminarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.2", "2.2", "impacto");
                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.2", respuesta, "2.2", "impacto");
                        break;

                    case "8_3":
                        lb.eliminarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.3", "2.2", "impacto");
                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.3", respuesta, "2.2", "impacto");
                        break;

                    case "8_4":
                        lb.eliminarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.4", "2.2", "impacto");
                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.4", respuesta, "2.2", "impacto");
                        break;
                    case "8_5":
                        lb.eliminarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.5", "2.2", "impacto");
                        lb.AgregarRespuestaAbiertaInstitucional_Fase(codinstasesor["codigo"].ToString(), "8.5", respuesta, "2.2", "impacto");
                        break;
                }
    ...
    [WebMethod(EnableSession = true)]
    public static string eliminarpreguntaChk(string codasesor, string codinstitucion, string pregunta)
    {
        string ca = "";
        ...
        if (dato != null)
        {
            ...
            {
                case "2":
                     lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "2", "0", "2.2", "impacto");
                    break;
                case "5":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "5", "0", "2.2", "impacto");
                    break;
                case "8":
                    lb.eliminarRespuestaCerradaInstitucional_Fase(dato["codigo"].ToString(), "8", "0", "2.2", "impacto");
                    break;
            }
        ...
        else
        {
            ...
            if (codinstasesor != null)
            {
                ...
                {
                    case "3":
                        lb.eliminarRespuestaCerradaInstitucional_Fase(codinstasesor["codigo"].ToString(), "3", "0", "2.2", "impacto");
                        break;
                }
    ...
    [WebMethod(EnableSession = true)]
    public static string cargarrespuestas(string codasesor, string codinstitucion, string pregunta)
    {
        string ca = "";
        Asesores ase = new Asesores();
        LineaBase lb = new LineaBase();
        ...
        if (dato != null)
        {
            ...
            {
                case "1":
                   DataRow respuesta = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(),"1", "1","2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta["respuesta"].ToString() + "@";//0
                    ...
                    DataRow respuesta1 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(),"1", "2","2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta1["respuesta"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta1["respuesta"].ToString() + "@";//1
                ...
                case "3":
                    DataRow respuesta3 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(), "3", "0", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta3["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta3["respuesta"].ToString() + "@";//0
                    ...
                    DataRow respuesta3_1 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "3", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta3_1["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta3_1["comentario"].ToString() + "@";//1
                ...
                case "4_1":
                    DataRow respuesta4_1 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(), "4", "1", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta4_1["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta4_1["respuesta"].ToString() + "@";//0
                ...
                case "4_2":
                    DataRow respuesta4_2 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(), "4", "2", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta4_2["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta4_2["respuesta"].ToString() + "@";//0
                ...
                case "4_3":
                    DataRow respuesta4_3 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(), "4", "3", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta4_3["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta4_3["respuesta"].ToString() + "@";//0
                ...
                case "4_4":
                    DataRow respuesta4_4 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(), "4", "4", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta4_4["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta4_4["respuesta"].ToString() + "@";//0
                ...
                case "6":
                    ...
                    DataRow respuesta6 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "6", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta6["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta6["comentario"].ToString() + "@";//1
                ...
                case "7":
                    DataRow respuesta7 = lb.buscarRespuestaInstitucional_Fase(dato["codigo"].ToString(), "7", "0", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta7["respuesta"].ToString() + "@";//0
                    }
                    else
                    {
                        ca += respuesta7["respuesta"].ToString() + "@";//0
                ...
                case "8_1":
                    ...
                    DataRow respuesta8_1 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.1", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta8_1["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta8_1["comentario"].ToString() + "@";//1
                ...
                case "8_2":
                    ...
                    DataRow respuesta8_2 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.2", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta8_2["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta8_2["comentario"].ToString() + "@";//1
                ...
                case "8_3":
                    ...
                    DataRow respuesta8_3 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.3", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta8_3["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta8_3["comentario"].ToString() + "@";//1
                ...
                case "8_4":
                    ...
                    DataRow respuesta8_4 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.4", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta8_4["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta8_4["comentario"].ToString() + "@";//1
                ...
                case "8_5":
                    ...
                    DataRow respuesta8_5 = lb.buscarRespuestaAbiertaInstitucional_Fase(dato["codigo"].ToString(), "8.5", "2.2", "impacto");
                    if (dato != null)
                    {
                        ca += respuesta8_5["comentario"].ToString() + "@";//1
                    }
                    else
                    {
                        ca += respuesta8_5["comentario"].ToString() + "@";//1
    ...
    public static string cargarrespuestascerradaschk(string codasesor, string codinstitucion, string codpregunta, string codsubpregunta)
    {
        ...
        if (dato != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasInstitucional_Fase(dato["codigo"].ToString(), codpregunta, codsubpregunta, "2.2", "impacto");
