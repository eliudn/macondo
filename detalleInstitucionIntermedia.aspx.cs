...
public partial class detalleDocenteInteermedia : System.Web.UI.Page
{
  ...
  for (int i = 0; i < datos.Rows.Count; i++)
    ...
    [WebMethod(EnableSession = true)]
    public static string rectorEvaluacionIntermedia_(string respuesta)
    {
        ...
        DataTable instituEvaluacionInter = lb.detalleRectorIntermedia();
    ...
    public static string busquedaInstitucionIntermedia_(string coddepartamento, string codmunicipio, string codinstitucion)
    {
        string ca = "";
        var lb = new LineaBase();
        DataTable instituEvaluacionInter = lb.busquedadetalleRectorIntermedia( coddepartamento, codmunicipio,  codinstitucion);
