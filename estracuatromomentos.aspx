<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracuatromomentos.aspx.cs" Inherits="estracuatromomentos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <br /><br />
    <h2>ESTRATEGIA No. 4: Conformación de la comunidad de práctica, aprendizaje, saber, conocimiento y transformación del Programa Ciclón</h2>
    <p><b>OBJETIVO ESPECÍFICO:</b> Conformar una comunidad de práctica, aprendizaje, saber, conocimiento y transformación apoyada en TIC.</p>
