<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="configrupodocente_evi.aspx.cs" Inherits="configrupodocente_evi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 2: Grupo de investigación docente - Carga de Evidencias</h2>
     ...
     <fieldset>
                <legend>Actividades</legend>
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="Formato de asesoría y acompañamiento">Formato de asesoría y acompañamiento</asp:ListItem>
                     </asp:RadioButtonList>
