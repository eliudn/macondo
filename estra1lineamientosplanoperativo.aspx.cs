...
public partial class estra1lineamientosplanoperativo : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
       ...
       lblCodUsuario.Text = HttpUtility.UrlDecode(HttpContext.Current.Request.QueryString["cod"]);
        ...
        if (Session["a"].ToString() == "50")
        {
            actividadactual.Text = "<h2>1. Lineamientos de las ferias municipales</h2>";
        }
    }
    ...
    private void gvCargarEvidencias()
    {
        ...
        {
            DataTable datos = est.cargarEvidenciasEstrategiaConActividad_(lblMomento.Text, "0", "1", lblActividad.Text);
        ...
        {
            DataTable datos2 = est.cargarEvidenciasEstrategiaConActividad_(lblMomento.Text, lblSesion.Text, "1", HttpContext.Current.Session["a"].ToString());//(string momento, string sesion, string estrategia, string actividad, string codusuario)
    ...
    {
            Response.Redirect("estra1disenoaprobacionlineamientos.aspx?" + lblMomento.Text + "&s=" + lblSesion.Text);
    }
