...
public partial class estra4redesdocentes : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        titulo.Text = "Sedes Educativas con docentes lideres en Redes ";
    ...
    [WebMethod(EnableSession = true)]
    public static string estra4redessocentes()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_docentesSedes("", "", "", "", "1", HttpContext.Current.Session["anio"].ToString());
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra4redessocentes(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_docentesSedes(coddepartamento, codmuncipio, codinstitucion, codsede, "", HttpContext.Current.Session["anio"].ToString());
     ...
     {
         Response.Redirect("estra4memorias004.aspx?m=1&s=" + Session["s"].ToString() + "&e=4");
         //if (Session["m"].ToString() != null)
         //{
         //    if (Session["m"].ToString() == "1")
         //    {
