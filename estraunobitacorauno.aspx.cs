...
public partial class estraunobitacorauno : System.Web.UI.Page
{
    ...
    private void ddGruposInvestigacion(DropDownList drop, string codsede, string codasesorcoordinador)
    {
        DataTable datos = ins.cargarGruposInvestigacionBitacoras(codsede, codasesorcoordinador);
        drop.DataSource = datos;
    ...
    protected void lknVer_Click(object sender, EventArgs e)
    {
    ...
    protected void DeleteBitacora_Click(object sender, EventArgs e)
    {
        ...
        est.deleteBitacora1(codbitacora);
        gvcargarbitacoraunoxAsesor(Session["CodAsesorEstraCoordinador"].ToString());
    }
