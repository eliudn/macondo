<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras003_estategia1Reporte.aspx.cs" Inherits="estras003_estategia1Reporte" ValidateRequest="false" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#asesores").change(function () {
                ...
                cargarListadoS003($("#asesores").val(),"1", "10");
            });
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'estras003_estategia1Reporte.aspx/cargarasesores',
        ...
        function cargarDepartamentoMagdalena() {
            $.ajax({
                type: 'POST',
                url: 'estras003_estategia1Reporte.aspx/cargarDepartamentoMagdalena',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
        ...
        function cargarListadoS003(asesores, page, rows) {
            $("#infoListTable").html("<tr><td colspan='11' style='padding:10px;text-align:center;'><img src='images/loader.gif'></td></tr>")
            var jsondata = "{'page':'" + page + "','rows':'" + rows + "','codasesorcoordinador':'" + asesores + "'}";
            $.ajax({
                type: 'POST',
                url: 'estras003_estategia1Reporte.aspx/cargarListadoS003',
                contentType: "application/json; charset=utf-8",
                data: jsondata,
                dataType: 'JSON',
                success: function (json) {
        ...
        function borrarsesion() {
            $.ajax({
                type: 'POST',
                url: 'estras003_estategia1Reporte.aspx/borrarsesion',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function () {
        ...
        function loadSelect(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras003_estategia1Reporte.aspx/loadSelect',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function enviarestras003(event) {
            ...
            if ($("#grupoinvestigacion").val() == '') {
                ...
                if (event == 'insert') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estras003_estategia1Reporte.aspx/insertestras003',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: jsonData,
                        success: function (json) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estras003_estategia1Reporte.aspx/updateestras003',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: jsonData,
                        success: function (json) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras003_estategia1Reporte.aspx/deleteestras003',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
        ...
        function loadInstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras003_estategia1Reporte.aspx/loadestras003',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
