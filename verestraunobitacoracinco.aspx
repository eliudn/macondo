<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="verestraunobitacoracinco.aspx.cs" Inherits="verestraunobitacoracinco" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <style>
     ...
     <script type="text/javascript">
         ...
         function listadobitacora5(codasesorcoordinador) {
             var jsondata = "{'codasesorcoordinador':'" + codasesorcoordinador + "'}";
             $.ajax({
                 type: 'POST',
                 data: jsondata,
                 url: 'verestraunobitacoracinco.aspx/listadobitacora5',
                 contentType: 'application/json; charset=utf-8',
                 dataType: 'JSON',
                 success: function (response) {
         ...
         $(function () {
             ...
             $("#departamento").on('change', function () {
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/cargarMunicipios',
                     type: 'POST',
                     data: data,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
             ...
             $("#municipio").on('change', function () {
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/cargarInstituciones',
                     type: 'POST',
                     data: data,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
             ...
             $("#instituciones").on('change', function () {
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/cargarSedesInstitucion',
                     type: 'POST',
                     data: data,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
             ...
             $("#sedes").on("change", function () {
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/cargarLineaInvestigacion',
                     type: 'POST',
                     data: data,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
         ...
         function cargarDepartamentosMagdalena() {
             $.ajax({
                 url: 'verestraunobitacoracinco.aspx/cargarDepartamentoMagdalena',
                 type: 'POST',
                 contentType: "application/json; charset=utf-8",
                 dataType: 'JSON',
                 //data:frmserialize,
         ...
         function btnGuardar_Click(event) {
             ...
             if (event == 'insert')
             {
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/encabezado',
                     type: 'POST',
                     data: jsonData,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
                     success: function (response) {
                         ...
                         $.each(trayecto, function (index, element) {
                             ...
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto2do, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_2do',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto3ro, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_3ro',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto4to, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_4to',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto5to, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_5to',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto6to, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_6to',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto7mo, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_7mo',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                         ...
                         $.each(trayecto8vo, function (index, element) {
                             var jsonData = "{'codEstraBitacora':'" + codigo[0].toString() + "', 'actividad':'" + element[0].toString() + "', 'herramienta':'" + element[1].toString() + "', 'responsable':'" + element[2].toString() + "', 'duracion':'" + element[3].toString() + "', 'presupuesto':'" + element[4].toString() + "'}";
                             $.ajax({
                                 url: 'verestraunobitacoracinco.aspx/detalleBitacora5_8vo',
                                 type: 'POST',
                                 data: jsonData,
                                 contentType: 'application/json; charset=utf-8',
                                 dataType: 'JSON'
                     ...
                     complete: function () {
                         ...
                         $("#form").hide();
                         $("#table").fadeIn(500);
                         window.location.href = "verestraunobitacoracinco.aspx?e=" + codigo[1] + "&m=" + codigo[2] + "&s=" + codigo[3];
                     }
                 });
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/updateencabezado',
                     type: 'POST',
                     data: jsonData,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
         ...
         function eliminardetallesBitacora5(codigoinstrumento, nodetalle, trayecto) {
             ...
             var jsonData = "{'codigoinstrumento':'" + codigoinstrumento.toString() + "', 'nodetalle':'" + nodetalle + "'}";
                 ...
                 $.ajax({
                     url: 'verestraunobitacoracinco.aspx/deletedetalleBitacora5',
                     type: 'POST',
                     data: jsonData,
                     contentType: 'application/json; charset=utf-8',
                     dataType: 'JSON',
         ...
         function regresar() {
             ...
             $.ajax({
                 url: 'verestraunobitacoracinco.aspx/regresar',
                 type: 'POST',
                 contentType: 'application/json; charset=utf-8',
                 dataType: 'JSON',
                 success: function (response) {
                     ...
                     $("#btnGuardar").attr('value', 'Guardar');
                     $("#btnGuardar").attr('onclick', 'btnGuardar_Click(\'insert\')');
                     window.location.href = "verestraunobitacoracinco.aspx?e=" + resp[0] + "&m=" + resp[1] + "&s=" + resp[2];
        ...
        function loadSelectBitacoraCinco(codigo) {
            codigoinstrumento = codigo;
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadSelectBitacoraCinco',
                 data: jsondata,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (response) {
         ...
         function loadBitacora(codigo) {
             ...
             $.ajax({
                 url: 'verestraunobitacoracinco.aspx/loadBitacora',
                 type: 'POST',
                 data: data,
                 contentType: 'application/json; charset=utf-8',
                 dataType: 'JSON',
         ...
         function floadPrimerTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadPrimerTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
         ...
         function floadSegundoTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadSegundoTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function floadTercerTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadTercerTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function floadCuartoTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadCuartoTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function floadQuintoTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadQuintoTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function floadSextoTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadSextoTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function floadSeptimoTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadSeptimoTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function floadOctavoTrayecto(codigoinstrumento) {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'verestraunobitacoracinco.aspx/loadOctavoTrayecto',
                 data: jsonData,
                 contentType: "application/json; charset=utf-8",
                 dataType: "json",
                 success: function (data) {
         ...
         function deleteBitacoraCinco(codigo) {
             if (confirm('¿Estás seguro de eliminar este registro? Recuerde que perderá los detalles y evidencias que tenga cargadas')) {
                 ...
                 $.ajax({
                     type: 'POST',
                     url: 'verestraunobitacoracinco.aspx/deleteBitacoraCinco',
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     data: jsonData,
                     success: function (json) {
