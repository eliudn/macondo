...
public partial class indicadoresestudiantes : System.Web.UI.Page
{
    ...
    //public static string cargarInsMun(string codDepartamento)
    {
        ...
        DataTable institucion = inst.cargarInstitucion();
        if (institucion != null)
        {
            ca = "inst@";
            ca += "<option value='' selected>Todos</option>";
            ...
            {
                if (institucion.Rows[i]["codigo"].ToString() == codInstitucion)
                {
    ...
    public static string realizarBusquedaloadreport(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes participantes en las jornadas de formación en la pregunta como punto de partida y en la ruta metodológica del programa Ciclón  </td>";
        ...
        DataTable gpinscritosconvocatoriaciclon = c.cargargruposinscritos(coddepartamento,codmuncipio,codinstitucion,codsede);
        double meta28 = 0;
        int count28 = 0;
        int total28 = 638;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de investigación infantiles y juveniles que se inscribieron en la convocatoria de Ciclón</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de investigación infantiles y juveniles seleccionados en la convocatoria de Ciclón</td>";
        ca += "<td class='center'>" + total1 + "</td>";
        ca += "<td class='center'>" + count1 + "</td>";
        ca += "<td class='center'>" + meta1 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Niños, niñas y jóvenes inscritos en grupos de investigación infantiles y juveniles en la convocatoria Ciclón </td>";
        ca += "<td class='center'>" + total2 + "</td>";
        ca += "<td class='center'>" + count2 + "</td>";
        ca += "<td class='center'>" + meta2 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de investigación con preguntas y grupos preestructurados con avances</td>";
        ca += "<td class='center'>" + total3 + "</td>";
        ca += "<td class='center'>" + count3 + "</td>";
        ca += "<td class='center'>" + meta3 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de investigación con problemas y grupos preestructurados con avances</td>";
        ca += "<td class='center'>" + total4 + "</td>";
        ca += "<td class='center'>" + count4 + "</td>";
        ca += "<td class='center'>" + meta4 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de investigación infantiles y juveniles con la bitácora 04 de presupuesto diligenciada</td>";
        ca += "<td class='center'>" + total5 + "</td>";
        ca += "<td class='center'>" + count5 + "</td>";
        ca += "<td class='center'>" + meta5 + "%</td>";
        ...
        //6) Grupos de investigación con trayectorias y proyectos preestructurados con avances
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>Grupos de investigación con trayectorias y proyectos preestructurados con avances</td>";
        ca += "<td class='center'>" + total6 + "</td>";
        ca += "<td class='center'>" + count6 + "</td>";
        ca += "<td class='center'>" + meta6 + "%</td>";
        ...
        //6) Grupos de investigación con recorridos de la trayectoria y proyectos preestructurados con avances
        DataTable gruposInvestigacionBitacora6 = est.gruposInvestigacionBitacora6(coddepartamento, codmuncipio, codinstitucion, codsede);
        double meta6_1 = 0;
        int count6_1 = 0;
        int total6_1 = Convert.ToInt32(loadTotalesIndicadoresxSede["totalgrupos"].ToString());
        double peso6_1 = 2.20;
        double pesoAct6_1 = 0;

        if (gruposInvestigacionBitacora6 != null && gruposInvestigacionBitacora6.Rows.Count > 0)
        {
            count6_1 = gruposInvestigacionBitacora6.Rows.Count;
            meta6_1 = ((double)count6_1 / (double)total6_1) * 100;
            meta6_1 = Math.Round(meta6_1, 2);
            //if (meta6 > 100)
            //{
            //    meta6 = 100;
            //}
            pesoAct6_1 = ((double)count6_1 / (double)total6_1) * peso6_1;
            pesoAct6_1 = Math.Round(pesoAct6_1, 4);
            if (pesoAct6_1 > peso6_1)
            {
                pesoAct6_1 = peso6_1;
            }
            pesototal = pesototal + pesoAct6_1;
        }
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>Grupos de investigación con recorridos de la trayectoria y proyectos preestructurados con avances</td>";
        ca += "<td class='center'>" + total6_1 + "</td>";
        ca += "<td class='center'>" + count6_1 + "</td>";
        ca += "<td class='center'>" + meta6_1 + "%</td>";
        ca += "<td class='center'>" + pesoAct6_1 + " de " + peso6_1 + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de investigación con recursos aportados por Ciclón</td>";
        ...
        //num++;
        //ca += "<tr>";
        //ca += "<td><b>" + num + "</b></td><td>Grupos de investigación con registro de avance del presupuesto</td>";
        ...
        //Grupos de investigación con registro de avance  primer desembolso
        DataTable gpregistroavance = c.cargarGruposInformeFinancieroDesembolso(coddepartamento, codmuncipio, codinstitucion, codsede, "1");
        double meta30 = 0;
        int count30 = 0;
        int total30 = Convert.ToInt32(loadTotalesIndicadoresxSede["totalgrupos"].ToString());
        double peso30 = 0.733;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>Grupos de investigación con registro de avance  primer desembolso</td>";
        ca += "<td class='center'>" + total30 + "</td>";
        ca += "<td class='center'>" + count30 + "</td>";
        ca += "<td class='center'>" + meta30 + "%</td>";
        ca += "<td class='center'>" + pesoAct30 + " de " + peso30 + "</td>";
        ...
        DataTable gpregistroavance_2 = c.cargarGruposInformeFinancieroDesembolso(coddepartamento, codmuncipio, codinstitucion, codsede, "2");
        double meta30_2 = 0;
        int count30_2 = 0;
        int total30_2 = Convert.ToInt32(loadTotalesIndicadoresxSede["totalgrupos"].ToString());
        double peso30_2 = 0.733;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>Grupos de investigación con registro de avance segundo desembolso</td>";
        ca += "<td class='center'>" + total30_2 + "</td>";
        ca += "<td class='center'>" + count30_2 + "</td>";
        ca += "<td class='center'>" + meta30_2 + "%</td>";
        ca += "<td class='center'>" + pesoAct30_2 + " de " + peso30_2 + "</td>";
        ca += "</tr>";

        //Grupos de investigación con registro de avance tercer desembolso
        DataTable gpregistroavance_3 = c.cargarGruposInformeFinancieroDesembolso(coddepartamento, codmuncipio, codinstitucion, codsede, "3");
        double meta30_3 = 0;
        int count30_3 = 0;
        int total30_3 = Convert.ToInt32(loadTotalesIndicadoresxSede["totalgrupos"].ToString());
        double peso30_3 = 0.733;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>Grupos de investigación con registro de avance tercer desembolso</td>";
        ca += "<td class='center'>" + total30_3 + "</td>";
        ca += "<td class='center'>" + count30_3 + "</td>";
        ca += "<td class='center'>" + meta30_3 + "%</td>";
        ca += "<td class='center'>" + pesoAct30_3 + " de " + peso30_3 + "</td>";
        ca += "</tr>";


        //31)  Informes Finales de Pre-estructurados
        DataTable informespreestructurados = c.cargarInformePreestructurados();
        double meta31pre = 0;
        int count31pre = 0;
        int total31pre = 160;
        double peso31pre = 1.1;
        double pesoAct31pre = 0;
        if (informespreestructurados != null && informespreestructurados.Rows.Count > 0)
        {
            count31pre = informespreestructurados.Rows.Count;
            meta31pre = ((double)count31pre / (double)total31pre) * 100;
            meta31pre = Math.Round(meta31pre, 2);
            //if (meta31 > 100)
            //{
            //    meta31 = 100;
            //}
            pesoAct31pre = ((double)count31pre / (double)total31pre) * peso31pre;
            pesoAct31pre = Math.Round(pesoAct31pre, 4);
            if (pesoAct31pre > peso31pre)
            {
                pesoAct31pre = peso31pre;
            }
            pesototal = pesototal + pesoAct31pre;
        }
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Informes Finales de Pre-estructurados</td>";
        ca += "<td class='center'>" + total31pre + "</td>";
        ca += "<td class='center'>" + count31pre + "</td>";
        ca += "<td class='center'>" + meta31pre + "%</td>";
        ca += "<td class='center'>" + pesoAct31pre + " de " + peso31pre + "</td>";
        ca += "</tr>";
        ...
        double meta31 = 0;
        int count31 = 0;
        int total31 = 260; //Convert.ToInt32(loadTotalesIndicadoresxSede["totalgrupos"].ToString());
        double peso31 = 1.1;
        double pesoAct31 = 0;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Informes Finales de Grupos abiertos</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Resumenes del proyecto de investigación elaborados por los grupos infantiles y juveniles.</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Asesorias realizadas a cada uno de los grupos de investigación </td>";
        ca += "<td class='center'>" + total8 + "</td>";
        ca += "<td class='center'>" + count8 + "</td>";
        ca += "<td class='center'>" + meta8 + "%</td>";
        ...
        //10)  Estudiantes inscritos en las redes temáticas de la comunidad de práctica, saber, conocimiento y transformación de Ciclón
        DataTable esturedtematicas = est.esturedtematicasxanio(coddepartamento, codmuncipio, codinstitucion, codsede, "2018");
        double meta10 = 0;
        int count10 = 0;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos en las redes temáticas de la comunidad de práctica, saber, conocimiento y transformación de Ciclón </td>";
        ca += "<td class='center'>" + total10 + "</td>";
        ca += "<td class='center'>" + count10 + "</td>";
        ca += "<td class='center'>" + meta10 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Redes temáticas conformadas</td>";
        ca += "<td class='center'>" + total11 + "</td>";
        ca += "<td class='center'>" + count11 + "</td>";
        ca += "<td class='center'>" + meta11 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación No. 1 presencial realizadas </td>";
        ca += "<td class='center'>" + total12 + "</td>";
        ca += "<td class='center'>" + count12 + "</td>";
        ca += "<td class='center'>" + meta12 + "%</td>";
        ...
        //13) Estudiantes inscritos que participan en la primera sesión  de formación presencial/ Nivel 1 juego Gózate la ciencia.
        DataTable esturedtematicas2016 = est.est_estra2instrumento_s004_redt_2016_estudiantes("", "", "", "", "1");
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la primera sesión de formación presencial/ Nivel 1 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total13 + "</td>";
        ca += "<td class='center'>" + count13 + "</td>";
        ca += "<td class='center'>" + meta13 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación No. 1 virtual realizadas </td>";
        ca += "<td class='center'>" + total14 + "</td>";
        ca += "<td class='center'>" + count14 + "</td>";
        ca += "<td class='center'>" + meta14 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la primera sesión de formación virtual/ Nivel 1 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total15 + "</td>";
        ca += "<td class='center'>" + count15 + "</td>";
        ca += "<td class='center'>" + meta15 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>  Sesiones de formación presencial No. 2 realizadas.</td>";
        ca += "<td class='center'>" + total16 + "</td>";
        ca += "<td class='center'>" + count16 + "</td>";
        ca += "<td class='center'>" + meta16 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la segunda sesión  de formación presencial/ Nivel 2 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total17 + "</td>";
        ca += "<td class='center'>" + count17 + "</td>";
        ca += "<td class='center'>" + meta17 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual No. 2 realizadas </td>";
        ca += "<td class='center'>" + total18 + "</td>";
        ca += "<td class='center'>" + count18 + "</td>";
        ca += "<td class='center'>" + meta18 + "%</td>";
        ...
        //{
        //    count19 = estuinscritossesion_vt_s2.Rows.Count;
        //    meta19 = ((double)count19 / (doubleF)total19) * 100;
        //    meta19 = Math.Round(meta19, 2);
        //    if (meta19 > 100)
        //    {
        //        meta19 = 100;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la segunda sesión de formación virtual/ Nivel 2 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total19 + "</td>";
        ca += "<td class='center'>" + count19 + "</td>";
        ca += "<td class='center'>" + meta19 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la tercera sesión  de formación presencial/ Nivel 3 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total21 + "</td>";
        ca += "<td class='center'>" + count21 + "</td>";
        ca += "<td class='center'>" + meta21 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual  No. 3 realizadas.</td>";
        ca += "<td class='center'>" + total22 + "</td>";
        ca += "<td class='center'>" + count22 + "</td>";
        ca += "<td class='center'>" + meta22 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>  Estudiantes inscritos que participan en la tercera sesión  de formación virtual/ Nivel 3 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total23 + "</td>";
        ca += "<td class='center'>" + count23 + "</td>";
        ca += "<td class='center'>" + meta23 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la tercera sesión  de formación presencial/ Nivel 4 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total25 + "</td>";
        ca += "<td class='center'>" + count25 + "</td>";
        ca += "<td class='center'>" + meta25 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual  No.4 realizadas </td>";
        ca += "<td class='center'>" + total26 + "</td>";
        ca += "<td class='center'>" + count26 + "</td>";
        ca += "<td class='center'>" + meta26 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la tercera sesión  de formación virtual/ Nivel 4 juego Gózate la ciencia</td>";
        ca += "<td class='center'>" + total27 + "</td>";
        ca += "<td class='center'>" + count27 + "</td>";
        ca += "<td class='center'>" + meta27 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>  Estudiantes inscritos que participan en la quinta sesión  de formación presencial/ Nivel 5 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual No. 5 realizadas </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la quinta sesión  de formación virtual/ Nivel 5 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la sexta sesión  de formación presencial/ Nivel 6 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual  No. 6 realizadas </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>  Estudiantes inscritos que participan en la sexta sesión  de formación virtual/ Nivel 6 juego Gózate la ciencia </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la séptima sesión  de formación presencial/ Nivel 1 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual  No. 7 realizadas </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la séptima sesión  de formación virtual/ Nivel 7 juego Gózate la ciencia  </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la  octava sesión  de formación presencial/ Nivel 8 juego Gózate la ciencia </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual No. 8 realizadas  </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la  octava sesión  de formación virtual/ Nivel 8 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación No. 9 realizadas </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la  novena sesión  de formación presencial/ Nivel 9 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual No. 9 realizadas </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la  novena sesión  de formación virtual/ Nivel 9 juego Gózate la ciencia </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación No. 10 realizadas</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la decina sesión  de formación presencial/ Nivel 10 juego Gózate la ciencia</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Sesiones de formación virtual No. 10 realizadas </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Estudiantes inscritos que participan en la decina sesión  de formación virtual/ Nivel 10 juego Gózate la ciencia </td>";
        ...
        //num++;
        //ca += "<tr>";
        //ca += "<td><b>" + num + "</b> </td><td>Niños, niñas y jóvenes inscritos en grupos de investigación infantiles y juveniles seleccionados en la convocatoria Ciclón  </td>";
        ...
        //num++;
        //ca += "<tr>";
        //ca += "<td><b>" + num + "</b></td><td> Informes de investigación elaborados por los grupos de investigación infantiles y juveniles</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Kit preestructurados de los 4 documentos del programa Ciclón reimpresos </td>";
        ca += "<td class='center'>" + total9 + "</td>";
        ca += "<td class='center'>" + count9 + "</td>";
        ca += "<td class='center'>" + meta9 + "%</td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Publicaciones impresas y/o digitales (2  de los procesos y resultados de los grupos de investigación  y  de los resultados de la implementación del proyecto). </td>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Guías de investigación rediseñadas e impresas</td>";
        ...
        int counttables = 0;
        //int totaltables = 260;
        int totaltables = Convert.ToInt32(loadTotalesIndicadoresxSede["totaltablets"].ToString());
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> 16361 dotaciones y desarrollo del la infraestructura tecnológica y comunicacional </td>";
