<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoparticipantesferiasreporte.aspx.cs" Inherits="estraunoparticipantesferiasreporte" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#listasesores").change(function () {
                listarEspaciosApro($("#listasesores").val());
            });
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'estraunoparticipantesferiasreporte.aspx/cargarlistasesores',
        ...
        function cargartipoid() {
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/cargartipoid',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
        ...
        function cargarAnio() {
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/cargaranios',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function guardarDocentes() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/guardardocente',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                //data:frmserialize,
        ...
        function btncargardoc() {
            ...
            if ($.trim($("#sede").val()) == '' || $.trim($("#sede").val()) == null) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estraunoparticipantesferiasreporte.aspx/cargarDocentes',
                    contentType: "application/json; charset=utf-8",
                    data: jsonData,
                    dataType: "json",
                    success: function (json) {
        ...
        function matricularDocentes() {
            ...
            if ($.trim($("#departamento").val()) == '' || $.trim($("#departamento").val()) == null) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estraunoparticipantesferiasreporte.aspx/matricularDocentes',
                    contentType: "application/json; charset=utf-8",
                    data: jsonData,
                    dataType: "json",
                    success: function (json) {
        ...
        function cargarDepartamentoMagdalena() {
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/cargarDepartamentoMagdalena',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function cargarinstituciones() {
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/cargarInstituciones',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function finsertInstrumento(codsede,codanio) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/insertInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function fupdateInstrumento(codigoinstrumento) {
            ...
            //$.ajax({
            //    type: 'POST',
            //    url: 'estraunoparticipantesferiasreporte.aspx/updateInstrumento',
            //    data: jsonData,
            //    contentType: "application/json; charset=utf-8",
            //    dataType: "json",
            //    success: function (data) {
        ...
        function actualizarMatriculaDocente(codespacioapro) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/deletematriculaDocente',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function loadInstrumentosParticipantesFerias(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/loadInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function cargarDocentesMatriculados(codparticipantesferias, codanio, codsede) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/listardocentesmatriculados',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data: jsonData,
                success: function (response) {
    ...
    <script>
        ...
        function listarEspaciosApro(codasesorcoordinador) {
            $("#form").hide();
            $("#table").fadeIn(500);
            var jsonData = '{ "codasesorcoordinador":"' + codasesorcoordinador + '"}';
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/listarParticipantesFerias',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data: jsonData,
                success: function (response) {
        ...
        function loadSelectParticipantesFerias(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunoparticipantesferiasreporte.aspx/loadSelectParticipantesFerias',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estraunoparticipantesferiasreporte.aspx/eliminar',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsondata,
                    success: function (json) {
