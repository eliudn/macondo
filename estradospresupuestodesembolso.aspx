<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradospresupuestodesembolso.aspx.cs" Inherits="estradospresupuestodesembolso" %>
   ...
   <ContentTemplate>
    <div class="header">
        <div style="float: left;margin-right: 15px;">
            <h2>Presupuestos grupos de investigación y soporte de desembolso</h2>
        </div>
<br /><br /><br />
        ...
        <asp:GridView ID="GridGrupo" runat="server" CellPadding="4" 
                    ...
                    <Columns>
                       ...
                       <%--  <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate><br /><br />
                                <asp:LinkButton ID="lnkInstrumentoS003" runat="server" CssClass="btn btn-success" Text="Evidencia" OnClick="lnkInstrumentoS003_Click"></asp:LinkButton><br /><br />
