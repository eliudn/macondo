...
public partial class estrag006Reporte_estra1 : System.Web.UI.Page
{
    ...
    public static string cargarListadoAsesoresxCoordinador()
    {
        ...
        DataTable datos = inst.listarAsesores("1");
    ...
    [WebMethod(EnableSession = true)]
    public static string cargarListadoMaterialesAsesor(string page, string rows, string codasesorcoordinador)
    {
        string ca = "";
        string codusuarioasesor = "";
        Estrategias usu = new Estrategias();
        DataRow dato = usu.buscarCodUsuarioxCodAsesorCoordinador(codasesorcoordinador);
        if (dato != null)
        {
            codusuarioasesor = dato["cod"].ToString();
        ...
        DataTable datosmateriales = inst.cargarListadoMaterialesxAsesorEstra1(codasesorcoordinador, Convert.ToString(offset), rows);

        if (datosmateriales != null && datosmateriales.Rows.Count > 0)
        {
            DataTable datosCount = inst.cargarListadoMaterialesxAsesorCount(codasesorcoordinador);
