...
public partial class estumasivoredt : System.Web.UI.Page
{
             ...
             string horares = utcDateTime.ToString("yyyy-MM-dd HH:mm:ss");
              ...
              if (nit != null && nit != "")
              {
                  ...
                  if (validarGenero == 0 || validarTDoc == 0 || validarID == 0)//Carga los docentes
                  {
                      ...
                      string codredt = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[15].Text);
                                      ...
                                      if (gradoc != null)
                                      {
                                          if (datoSede != null)
                                          {
                                              ...
                                              if (est.agregarEstuMatricula(datoSede["codigo"].ToString(), codestudiante["codigo"].ToString(), codanio, horares, gradoc["codigo"].ToString(), tipogrupo, grupo))
                                              {
                                                  ...
                                                  DataRow validarEstudiante = est.buscarMatriculado(datoSede["codigo"].ToString(), codestudiante["codigo"].ToString(), codanio, gradoc["codigo"].ToString(), tipogrupo, grupo);//busca el estudiante en la tabla ins_estumatricula

                                                  if (validarEstudiante != null)
                                                  {
                                                      DataRow redtematicamatricula = est.agregarEstudiantexRedTematica(codredt, validarEstudiante["codigo"].ToString());
                                                  }
                                          ...
                                          if (datoSede != null)
                                          {
                                              ...
                                              if (validarEstudiante == null)
                                              {
                                                  if (est.agregarEstuMatricula(datoSede["codigo"].ToString(), datoestudiante["codigo"].ToString(), codanio, horares, gradoc["codigo"].ToString(), tipogrupo, grupo))
                                                  {
                                                      ...
                                                      DataRow validarEstudiante2 = est.buscarMatriculado(datoSede["codigo"].ToString(), datoestudiante["codigo"].ToString(), codanio, gradoc["codigo"].ToString(), tipogrupo, grupo);//busca el estudiante en la tabla ins_estumatricula

                                                      DataRow redtematicamatricula = est.agregarEstudiantexRedTematica(codredt, validarEstudiante2["codigo"].ToString());
                                                  }
                                                  else
                                                  {
                                                      malos++;
                  ...
                  else
                  {
                      if (validarGenero > 0){
                            ...
                            lblMensajeMalos.Text = "Un registro de género es incorrecto.";
                      }
                      else if (validarTDoc > 0)
                      {
                          lblMensajeMalos.Visible = true;
                          lblMensajeMalos.Text = "ERROR: Documentos sin tipo de indetificación.";
