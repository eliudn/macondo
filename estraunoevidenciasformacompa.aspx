<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciasformacompa.aspx.cs" Inherits="estraunoevidenciasformacompa" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 1 - Formación y acompañamiento <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
...
<asp:Panel runat="server" ID="PanelMostrarEvidencias" Visible="true">
    ...
    <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="20">Términos de referencia de la convocatoria</asp:ListItem>
                        <asp:ListItem Value="21">Planes de trabajo</asp:ListItem>
                        <asp:ListItem Value="22">Archivos digitales Kit preestructurados reimpresos</asp:ListItem>
                        <asp:ListItem Value="23">Archivo digital Guia de Investigación</asp:ListItem>
                     </asp:RadioButtonList>
 ...
 <fieldset>
     ...
     <i>Seleccione una opción para visualizar los documentos</i>
