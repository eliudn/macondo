<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradosintroiep_evi.aspx.cs" Inherits="estradosintroiep_evi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 2, Introducción de la IEP en el currículo - Cargar Evidencias</h2>
    ...
    <asp:Label ID="lblCodInstrumento" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Introducción de la IEP al currículo</asp:ListItem>
                </asp:RadioButtonList>
