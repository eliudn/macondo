<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunobitacoracincoevidencias.aspx.cs" Inherits="estraunobitacoracincoevidencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <h2>Estrategia No 1 - Cargue de evidencias Diseño de las trayectorias de indagación</h2>
     ...
     <asp:Label runat="server" Visible="false" ID="lblCodestrabitacora5"></asp:Label>
     ...
     <asp:Panel runat="server" ID="PanelMomento0" Visible="true">
          <asp:RadioButtonList runat="server" ID="rbtActividades">
                <asp:ListItem>Bitácora 5 La Predicción de recorrido Ciclónico (Benkos y Magda)</asp:ListItem>  
            </asp:RadioButtonList>
     </asp:Panel>
