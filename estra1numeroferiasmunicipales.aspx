<%@ Page Title="Número de ferias municipales " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra1numeroferiasmunicipales.aspx.cs" Inherits="estra1numeroferiasmunicipales" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra1numeroferiasmunicipales.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estra1numeroferiasmunicipales.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra1numeroferiasmunicipales.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra1numeroferiasmunicipales.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra1numeroferiasmunicipales.aspx/estra1numeroferiasmunicipales_',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra1numeroferiasmunicipales.aspx/realizarBusquedaestra1numeroferiasmunicipales_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Organizar 56 espacios municipales de de apropiación social <asp:Label Visible="true" runat="server" ID="titulo"></asp:Label></h2>
    ...
    <h4 >Número de ferias municipales<asp:Label Visible="true" runat="server" ID="subtitulo"></asp:Label>  </h4>
    <p>Un documento del plan de trabajo de campo.<asp:Label Visible="true" runat="server" ID="descripcion"></asp:Label> <br /></p>    
    <br />
