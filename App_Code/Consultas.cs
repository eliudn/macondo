...
public class Consultas
{
    ...
    {
        Conexion conector = new Conexion();
        string consulta = "select DISTINCT doc.identificacion, doc.nombre, doc.apellido, d.codgradodocente, g.codanio, s.nombre as sede, i.nombre as institucion, m.nombre  from est_inasistenciasinstrumento_g001detalle_doc d inner join est_inasistenciasinstrumento_g001_doc g001 on g001.codigo=d.codinasistenciainstrumento_g001_doc inner join  ins_gradodocente g on g.cod=d.codgradodocente inner join ins_docente doc on doc.identificacion=g.identificacion inner join ins_sede s on s.codigo=g.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio where g.codanio='2' and jornada is not null group by doc.identificacion, doc.nombre, doc.apellido, d.codgradodocente, g.codanio, s.nombre, i.nombre, m.nombre";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
    ...
    public DataTable cargarInstrmentoS003(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        string consulta = "select *, s.nombre as sede, i.nombre as institucion, m.nombre as municipio from est_estra2instrumento_s003 s003 inner join pro_grupoinvestigaciondocentes gid on gid.codigo=s003.codgrupoinvestigaciondocentes inner join ins_sede s on s.codigo=gid.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio " + where;
        conector.CrearComando(consulta);
    ...
    public DataTable cargarDocentesEstra1_Estra2Where(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        string consulta = "select distinct (codgradodocente), doc.identificacion, concat_ws(' ', doc.nombre, doc.apellido) as docente, s.nombre as sede, i.nombre as institucion, m.nombre as municipio from pro_proyectodocente d inner join ins_gradodocente g on g.cod=d.codgradodocente inner join ins_docente doc on doc.identificacion=g.identificacion inner join ins_sede s on s.codigo=g.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio " + where;
    ...
    public DataTable cargarDocentesRedestematicasWhere(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        string consulta = "SELECT  (codgradodocente), doc.identificacion, concat_ws(' ', doc.nombre, doc.apellido) as docente, s.nombre as sede, i.nombre as institucion, m.nombre as municipio FROM rt_redtematicadocente rrd INNER JOIN ins_gradodocente igd ON igd.cod=rrd.codgradodocente inner join ins_docente doc on doc.identificacion=igd.identificacion inner join ins_sede s on s.codigo=igd.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio ";
    ...
    public DataTable cargarDocentesApropiacionSocialWhere(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        string consulta = "select doc.identificacion, doc.nombre, doc.apellido, ead.codgradodocente, g.codanio, s.nombre as sede, i.nombre as institucion, m.nombre as municipio from est_estra1espacioapropiaciondocentes ead inner join  ins_gradodocente g on g.cod=ead.codgradodocente inner join ins_docente doc on doc.identificacion=g.identificacion inner join ins_sede s on s.codigo=g.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio " + where;
    ...
    public DataTable cargarEvidenciasEstrategia3(string proceso, string act)
    {
        string where ="";
        Conexion conector = new Conexion();
        if(act != ""){
              
                  where =  " and actividad ='"+ act+"'";
              
        }
          
        string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_estra3repositorio rc inner join usu_usuario u on u.cod=rc.codusuario WHERE  proceso=@proceso and u.identificacion= '7140373' "+where+" ORDER BY fechacreado ASC";
        conector.CrearComando(consulta);
    ...
    public DataTable cargarEvidenciasEstrategia3_doble2(string proceso, string proceso2)
    {
        Conexion conector = new Conexion();
        string consulta = "SELECT actividad FROM est_estra3repositorio rc inner join usu_usuario u on u.cod=rc.codusuario WHERE  proceso=@proceso or proceso=@proceso2 group by actividad";
        conector.CrearComando(consulta);
        conector.AsignarParametroCadena("@proceso", proceso);
        conector.AsignarParametroCadena("@proceso2", proceso2);
        DataTable resp = conector.traerdata();
    ...
    public DataTable cargarEvidenciasEstrategia3_doble3()
    {
        Conexion conector = new Conexion();
        string consulta = "SELECT *, concat_ws ( ' ', u.pnombre, u.papellido ) AS nombre FROM est_estra3repositorio rc INNER JOIN usu_usuario u ON u.cod = rc.codusuario WHERE proceso ='m_3' and actividad ='Informe de monitoreo' ORDER BY fechacreado ASC";
        conector.CrearComando(consulta);
     ...
     public DataTable cargarEvidenciasEstrategia3_triple(string proceso, string proceso2, string proceso3)
    {
        Conexion conector = new Conexion();
        string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_estra3repositorio rc inner join usu_usuario u on u.cod=rc.codusuario WHERE  proceso=@proceso AND proceso=@proceso2 AND proceso=@proceso3 OR actividad= 'Informe evaluación intermedia' OR rc.actividad='Informe de monitoreo' ORDER BY fechacreado ASC";
        conector.CrearComando(consulta);
        conector.AsignarParametroCadena("@proceso", proceso);
        conector.AsignarParametroCadena("@proceso2", proceso2);
        conector.AsignarParametroCadena("@proceso3", proceso3);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
        else
    ...
    public DataTable cargarGruposInvestigacionRecursosAportadosCiclón(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        string consulta = "SELECT eb1.codproyectosede, ps.nombregrupo, s.nombre as sede, i.nombre as institucion, m.nombre as municipio FROM est_estra1bitacora4punto1_evi eb1 INNER JOIN pro_proyectosede ps ON ps.codigo=eb1.codproyectosede INNER JOIN ins_sede s ON s.codigo=ps.codsede INNER JOIN ins_institucion i ON i.codigo=s.codinstitucion INNER JOIN geo_municipios m ON m.cod=i.codmunicipio  where eb1.actividad='Tercer Desembolso' group by eb1.codproyectosede, ps.nombregrupo, s.nombre, i.nombre, m.nombre";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
        {
    ...
    public DataTable totalgruposinvestigacionfinanciados(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        string consulta = "SELECT gi.*, s.nombre as sede, i.nombre as institucion, m.nombre as municipio FROM pro_grupoinvestigaciondocentes gi inner join ins_sede s on s.codigo=gi.codsede INNER JOIN ins_institucion i ON i.codigo=s.codinstitucion INNER JOIN geo_municipios m ON m.cod=i.codmunicipio " + where;
        conector.CrearComando(consulta);
        //conector.AsignarParametroCadena("@tipo", tipo);
        DataTable resp = conector.traerdata();
        if (resp != null)
    ...
    public DataTable cargarGruposInformeFinancieroDesembolso(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string desembolso)
    {
        Conexion conector = new Conexion();
        ...
        cond[0] = " b.desembolso='" + desembolso + "' ";  //todo
        cond[1] = string.Empty;
        cond[2] = string.Empty;
        cond[3] = string.Empty;
        cond[4] = string.Empty;
        ...
        string consulta = "select distinct(codproyectosede), ps.nombregrupo, i.nombre as institucion, s.nombre as sede, m.nombre as municipio from est_estra1bitacora4punto1_evi b inner join pro_proyectosede ps on ps.codigo=b.codproyectosede inner join ins_sede s on s.codigo=ps.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio " + where;
        //string consulta = "select codgradodocente from pro_grupoinvestigacionmatriculadocentes union select d.codgradodocente  from pro_proyectosede d inner join ins_gradodocente g on g.cod=d.codgradodocente inner join ins_docente doc on doc.identificacion=g.identificacion inner join ins_sede s on s.codigo=g.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio " + where + " group by doc.identificacion, doc.nombre, doc.apellido, d.codgradodocente, g.codanio, s.nombre, i.nombre, m.nombre ";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
	...
	// public DataTable cargarInformePreestructurados()
    // {
    //     Conexion conector = new Conexion();


    //     string consulta = "SELECT p.* FROM est_repositorioasesor_preestructurados e inner join est_estra1preestructurados p on p.codigo=e.codpreestructurados WHERE momento='5' AND actividad='Otras evidencias';";
    //     conector.CrearComando(consulta);
    //     DataTable resp = conector.traerdata();
    //     if (resp != null)
    //         return resp;
