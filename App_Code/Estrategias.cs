...
public class Estrategias
{
    ...
    public DataRow buscarEvidenciaEstrategia1bitacora2(string codigo)
    {
        Conexion conector = new Conexion();
    ...
    public DataTable cargarEstudianteRedesTematicas(string codredtematicasede)
    {
        Conexion conectar = new Conexion();
...
public Boolean agregarArchivoRespositorioEstrategia1Asesorbitacora2(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string actividad, string codestrabitacora2)
{
    Conexion conector = new Conexion();
    string consulta = "";


    consulta = "INSERT INTO est_repositorioasesor_bitacora5 (codusuario,nombrearchivo,nombreguardado,contentType,ext,path,tamano,fechacreado,actividad,codestrabitacora2) VALUES (@codusuario,@nombrearchivo,@nombreguardado,@contentType,@ext,@path,@tamano,@fechacreado,@actividad,@codestrabitacora2)";
    ...
    conector.AsignarParametroCadena("@fechacreado", fechacreado);
    conector.AsignarParametroCadena("@actividad", actividad);
    conector.AsignarParametroCadena("@codestrabitacora2", codestrabitacora2);
    bool resp = conector.guardadata();
    return resp;
}
...
public Boolean agregarArchivoRespositorioEstrategia1Asesorbitacora6Presupuesto(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string actividad, string codestrag007)
{
    Conexion conector = new Conexion();
    string consulta = "";


    consulta = "INSERT INTO est_repositorioasesor_bitacora5 (codusuario,nombrearchivo,nombreguardado,contentType,ext,path,tamano,fechacreado,actividad,codestrabitacora5) VALUES (@codusuario,@nombrearchivo,@nombreguardado,@contentType,@ext,@path,@tamano,@fechacreado,@actividad,@codestrag007)";
    ...
    public Boolean agregarArchivoRespositorioEstrategia1Asesorg007(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string actividad, string codestrag007)
{
	 ...
	 public DataTable cargarEvidenciasEstrategia2AsesorS002(string momento, string sesion, string estrategia, string codestras002)
    {
        ...
        //momento=@momento and sesion=@sesion and estrategia=@estrategia and
        conector.CrearComando(consulta);
        //conector.AsignarParametroCadena("@momento", momento);
        //conector.AsignarParametroCadena("@sesion", sesion);
        //conector.AsignarParametroCadena("@estrategia", estrategia);
     ...
     public DataTable cargarEvidenciasEstrategia1Asesorbitacora2(string codestrabitacora5)
     {
         Conexion conector = new Conexion();
   ...
   public Boolean agregarArchivoRespositorioEstrategiaUnoS007(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string momento, string sesion, string actividad, string estrategia)
    ...
    public DataTable cargarGruposInvestigacionDocentexSedexAnio(string codsede, string anio)
    {
        ...
        else
        {
            Conexion conector = new Conexion();
            string consulta = "select ps.codigo as codgrupo, i.nombre as nominstitucion, s.nombre as nomsede, ps.nombregrupo, ac.codigo as codasesorcoordinador, CONCAT_WS(' ',a.nombre,a.apellido) as nomasesor, m.nombre as nommunicipio, d.nombre as nomdepartamento from pro_grupoinvestigaciondocentes ps left join est_asesorcoordinador ac on ps.codasesorcoordinador=ac.codigo inner join est_asesor a on a.codigo=ac.codasesor inner join ins_sede s on s.codigo=ps.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=s.codmunicipio inner join geo_departamentos d on d.cod=m.coddepartamento where ps.codsede=@codsede order by a.apellido asc;";
            //and extract(year from ps.fechacreacion)=@anio
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@codsede", codsede);
            //conector.AsignarParametroCadena("@anio", anio);
            DataTable resp = conector.traerdata();
    ...
    public DataTable listarBitacoraSeisxAsesorxMomento(string codasesorcoordinador, string momento, string anio)
    {
        Conexion conector = new Conexion();
        string consulta = "SELECT b6.*, d.nombre as departamento,m.nombre as municipio, i.nombre as institucion, s.nombre as sede, ps.nombregrupo FROM est_estra1bitacora6 b6 inner join pro_proyectosede ps on ps.codigo=b6.codproyectosede inner join ins_sede s on s.codigo=ps.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio inner join geo_departamentos d on d.cod=m.coddepartamento WHERE ps.codasesorcoordinador=@codasesorcoordinador and b6.momento=@momento  ORDER BY b6.fechacreacion ASC";
        //and extract(year from b5.fechacreado)=@anio
        conector.CrearComando(consulta);
        conector.AsignarParametroCadena("@codasesorcoordinador", codasesorcoordinador);
        conector.AsignarParametroCadena("@momento", momento);
    ...
    //Para que se visualice en modulo gerencia2 las ferias dptales creadas
    public DataTable cargarFeriasDptalesMaferpi()
    {
        Conexion conector = new Conexion();
        string consulta = "select fm.codigo as codferiamunicipal, fm.nombreferiamunicipal as nomferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasdepa fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
    ...
    //Fin Para que se visualice en modulo gerencia2 las ferias dptales creadas
    ...
    public DataTable totalSedesGrupoInvestigacionLineaInvestigacion(string coddepartamento, string codmunicipio, string codinstitucion, string linea)
    {
        ...
        cond[0] = " ps.codlineainvestigacion='" + linea + "'";  //todo
        cond[1] = string.Empty;
        cond[2] = string.Empty;
        cond[3] = string.Empty;
        ...
        {
            cond[1] = "d.cod='" + coddepartamento + "'";
        }
        if (codmunicipio != "" && codmunicipio != null)
        {
            cond[2] = "m.cod='" + codmunicipio + "'";
        }
        if (codinstitucion != "" && codinstitucion != null)
        {
            cond[3] = "i.codigo='" + codinstitucion + "'";
        }
        ...
        string consulta = "select ps.*, a.identificacion from pro_proyectosede ps left join est_asesorcoordinador ac on ps.codasesorcoordinador=ac.codigo inner join est_asesor a on a.codigo=ac.codasesor inner join ins_sede s on s.codigo=ps.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio inner join geo_departamentos d on d.cod=m.coddepartamento " + where + " order by ps.nombregrupo asc ";
        conector.CrearComando(consulta);
    ...
    public DataTable totalGrupoInvestigacionSeg(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string linea)
    {
        int numero = 5;
        string[] cond;
        cond = new string[numero];
        ...
        {
            cond[4] = "isede.codigo='" + codinstitucion + "'";
        }
    ...
    //Número de grupos de investigación hicieron preguntas  bitacora 2
    public DataTable totalGPHicieronPreguntasTODO(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        string where = "";
        if (coddepartamento != "")
        {
    ...
    public DataTable totalGPHicieronPreguntasB3TODO(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        string where = "";
        if (coddepartamento != "")
        {
    ...
    public DataTable gruposInvestigacionBitacora4(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string codgrupoinvestigacion)
    {
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT DISTINCT pps.nombregrupo, iin.nombre as nombreins, iin.dane, isede.nombre as nombresede, isede.dane as danesede,  gmun.nombre as nombremunicipio, gdep.nombre as nombredepartamento FROM est_estra2instrumento_g007 eb4 INNER JOIN pro_proyectosede pps ON pps.codigo = eb4.codproyecto INNER JOIN ins_sede isede ON isede.codigo = pps.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento " + where;
        conector.CrearComando(consulta);
	...
	// total de grupos de investigación con bitacora 06 
    public DataTable gruposInvestigacionBitacora6(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        string where = "";
        if (coddepartamento != "")
        {
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT distinct on (pps.nombregrupo) pps.nombregrupo, iin.nombre as nombreins, iin.dane, isede.nombre as nombresede, isede.dane as danesede,  gmun.nombre as nombremunicipio, gdep.nombre as nombredepartamento FROM est_estra1bitacora6 eb5 INNER JOIN pro_proyectosede pps ON pps.codigo = eb5.codproyectosede INNER JOIN ins_sede isede ON isede.codigo = pps.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento " + where;
        conector.CrearComando(consulta);
    ...
    //Asesorías realizadas a los grupos de investigación infantiles y juveniles en el momento pedagógico 3 etapa 5
    public DataTable asesoriasGPEtapa5TodoMomentos(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string codgrupoinvestigacion)
    {
        string where = "";
        if (coddepartamento != "")
        {
    ...
    //Total grupos de investigación con registro de avance del presupuesto
    public DataTable gruposInvestigacionPresupuestoEvidencias(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        string where = "";
        if (coddepartamento != "")
        {
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT gdep.nombre as nombredepartamento, gmun.nombre as nombremunicipio, iin.dane, iin.nombre as nombreins, isede.dane as danesede, isede.nombre as nombresede, pps.nombregrupo FROM est_estra1bitacora4punto1_evi eeb INNER JOIN pro_proyectosede pps ON pps.codigo = eeb.codproyectosede INNER JOIN ins_sede isede ON isede.codigo = pps.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento " + where + " GROUP BY eeb.codproyectosede, gdep.nombre, gmun.nombre,  iin.dane, iin.nombre, isede.dane, isede.nombre, pps.nombregrupo ";
        conector.CrearComando(consulta);
    ...
    public DataTable gpSeleccionadosconvocatoria(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        Conexion conector = new Conexion();
        string consulta = " SELECT distinct(pps.codigo)  FROM  pro_proyectosede pps INNER JOIN ins_sede isede ON isede.codigo = pps.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento " + where;
        conector.CrearComando(consulta);
    ...
    public DataTable estudianesengp(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT ppm.*, e.identificacion, concat_WS(' ', e.nombre, e.apellido) as nombre , gmun.nombre as municipio, iin.nombre as institucion, isede.nombre as sede FROM pro_proyectomatricula ppm INNER JOIN pro_proyectosede pps ON pps.codigo = ppm.codproyectosede INNER JOIN ins_sede isede ON isede.codigo = pps.codsede  INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion  INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio  INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento INNER JOIN ins_estumatricula em ON em.codigo=ppm.codestumatricula INNER JOIN ins_estudiante e ON e.codigo=em.codestudiante " + where;
        conector.CrearComando(consulta);
    ...
    public DataTable estuinscritossesion_vt(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string estrategia, string sesion)
    {
                        ...
                        if (codinstitucion != "")
                        {
                            if (codinstitucion != "null")
                            {
                                ...
                                if (codsede != "")
                                {
                                    if (codsede != "null")
                                    {
                                        where = where + " AND  s.codigo = " + codsede;
                                    }
                                }
                            }
                        }
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT g001detalle.*, g001.* FROM est_inasistenciasinstrumento_g001detalle_ev g001detalle INNER JOIN est_inasistenciasinstrumento_g001_ev g001 ON g001.codigo = g001detalle.codinasistenciainstrumento_g001 INNER JOIN est_estrainstrumento_s004_redt_ev s004_ev ON g001.codinstrumentos004 = s004_ev.codigo INNER JOIN rt_redtematicasede rts ON rts.codigo=s004_ev.codredtematicasede INNER JOIN ins_sede s on s.codigo=rts.codsede INNER JOIN ins_institucion i ON i.codigo=s.codinstitucion INNER JOIN geo_municipios m ON m.cod=i.codmunicipio INNER JOIN geo_departamentos d ON d.cod=m.coddepartamento WHERE s004_ev.estrategia = " + estrategia + " AND s004_ev.sesion = " + sesion + " " + where;
        conector.CrearComando(consulta);
    ...
    public DataTable estuinscritossesion_pre(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string estrategia, string sesion)
    {
        ...
        cond[0] = " s004_pre.estrategia = '" + estrategia + "' AND s004_pre.sesion = '" + sesion + "'";  //todo
        cond[1] = string.Empty;
        cond[2] = string.Empty;
        cond[3] = string.Empty;
        cond[4] = string.Empty;
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT g001detalle.*, g001.* FROM est_inasistenciasinstrumento_g001detalle g001detalle INNER JOIN est_inasistenciasinstrumento_g001 g001 ON g001.codigo = g001detalle.codinasistenciainstrumento_g001 INNER JOIN est_estra2instrumento_s004_redt s004_pre ON g001.codinstrumentos004 = s004_pre.codigo INNER JOIN rt_redtematicasede rts ON rts.codigo=s004_pre.codredtematicasede INNER JOIN ins_sede s on s.codigo=rts.codsede INNER JOIN ins_institucion i ON i.codigo=s.codinstitucion INNER JOIN geo_municipios m ON m.cod=i.codmunicipio INNER JOIN geo_departamentos d ON d.cod=m.coddepartamento " + where;
        conector.CrearComando(consulta);
    ...
    public DataTable informesinvelavoradosgp(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT DISTINCT(s003.codproyectosede),pps.nombregrupo, iin.nombre as institucion, isede.nombre as sede, gmun.nombre as municipio FROM est_estra1instrumento_s003 s003 INNER JOIN pro_proyectosede pps ON pps.codigo = s003.codproyectosede INNER JOIN ins_sede isede ON isede.codigo = pps.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento " + where;
        conector.CrearComando(consulta);
    ...
    public DataTable maestrosmatriculadosestra2(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string codanio)
    {
        ...
        Conexion conector = new Conexion();
        string consulta = " SELECT igd.*, concat_ws(' ', d.nombre, d.apellido) as nomdocente, isede.nombre as sede, iin.nombre as institicion, gdep.nombre as departamento, gmun.nombre as municipio FROM ins_gradodocente igd INNER JOIN ins_docente d ON d.identificacion=igd.identificacion INNER JOIN ins_sede isede ON isede.codigo = igd.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento WHERE codanio = '" + codanio + "' " + where;
        conector.CrearComando(consulta);
	...
	public DataTable maestrosmatriculadosestra2Det(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string codanio)
    {
        string where = "";
        if (coddepartamento != "")
        {
        ...
        Conexion conector = new Conexion();
        string consulta = " SELECT igd.identificacion, concat_ws(' ', d.nombre, d.apellido) as nomdocente, isede.nombre as sede, iin.nombre as institicion, gdep.nombre as departamento, gmun.nombre as municipio FROM pro_grupoinvestigacionmatriculadocentes mg INNER JOIN ins_gradodocente igd ON igd.cod=mg.codgradodocente INNER JOIN ins_docente d ON d.identificacion=igd.identificacion INNER JOIN ins_sede isede ON isede.codigo = igd.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento " + where + " group by igd.identificacion, d.nombre, d.apellido, isede.nombre, iin.nombre, gdep.nombre, gmun.nombre;";
        //WHERE codanio = '" + codanio + "' 
        conector.CrearComando(consulta);
    ...
    public DataTable asistentesSesionMaestros(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string estrategia, string momento, string sesion, string jornada)
    {
        ...
        Conexion conector = new Conexion();
        string consulta = "SELECT g001dd.*,  ess.codsede, gmun.nombre as municipio, iin.nombre as institucion, isede.nombre as sede, CONCAT_WS(' ', d.nombre, d.apellido) as nomdocente, d.identificacion  FROM est_inasistenciasinstrumento_g001detalle_doc g001dd INNER JOIN est_inasistenciasinstrumento_g001_doc gdoc ON g001dd.codinasistenciainstrumento_g001_doc = gdoc.codigo INNER JOIN est_estra2instrumento_s004_sede ess ON gdoc.codinstrumento_s004_sede = ess.codigo INNER JOIN ins_sede isede ON isede.codigo = ess.codsede INNER JOIN ins_institucion iin ON iin.codigo = isede.codinstitucion INNER JOIN geo_municipios gmun ON gmun.cod = iin.codmunicipio INNER JOIN geo_departamentos gdep ON gdep.cod = gmun.coddepartamento INNER JOIN ins_gradodocente gd ON gd.cod=g001dd.codgradodocente INNER JOIN ins_docente d ON d.identificacion=gd.identificacion WHERE ess.estrategia = " + estrategia + " AND ess.momento = " + momento + " AND ess.sesion = " + sesion + " AND ess.jornada =  " + jornada + " " + where;
        conector.CrearComando(consulta);
	...
	public DataTable maestrosredestematicasIndicador5(string coddepartamento, string codmunicipio, string codinstitucion, string codsede)
    {
        string where = "";
        if (coddepartamento != "")
        {
        ...
        Conexion conector = new Conexion();
        string consulta = "select md.codgradodocente from pro_grupoinvestigacionmatriculadocentes md inner join rt_redtematicadocente pd on md.codgradodocente=pd.codgradodocente  ";
        conector.CrearComando(consulta);
    ...
    public DataTable publicacionesimpresas()
    {
     ...
     public bool updateProyectoSede(string codigo, string codlineainvestigacion, string coddropsedes)
    {
        Conexion conector = new Conexion();
        string consulta = "UPDATE pro_proyectosede SET codlineainvestigacion=@codlineainvestigacion, codsede=@coddropsedes WHERE codigo = @codigo;";
        conector.CrearComando(consulta);
        conector.AsignarParametroCadena("@coddropsedes", coddropsedes);
        conector.AsignarParametroCadena("@codlineainvestigacion", codlineainvestigacion);
        conector.AsignarParametroCadena("@codigo", codigo);
        bool resp = conector.guardadata();
        return resp;
    ...
    //Metodos agregados por Alvaro Rodriguez
        //FeriaDepartamental
        public DataTable cargarFeriasDepartamentalesMaferpi()
        {
            Conexion conector = new Conexion();
            string consulta = "select fm.codigo as codferiamunicipal, fm.nombreferiamunicipal as nomferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasdepa fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
            conector.CrearComando(consulta);
        ...
        public DataRow buscarFeriaDepartamentalxcodigo(string codferiamunicipal)
        {
            Conexion conector = new Conexion();
            string consulta = "select d.cod as coddepartamento, fm.codigo as codigo, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as numeroasistentes, fm.numerogrupos as numerogrupos, fm.numerodocentes as numerodocentes, fm.fechaelaboracion as fechaelaboracion, fm.horaferia as horaferia, fm.horaferiafinal, fm.fechaelaboracioncierre as fechaelaboracioncierre, fm.horaferiacierre as horaferiacierre, fm.horaferiafinalcierre as horaferiafinalcierre from ep_feriasdepa fm left join ep_municipiomatricula fmm on fmm.codferiamunicipal=fm.codigo inner join geo_departamentos d on d.cod=fm.coddepartamento where fm.codigo=@codferiamunicipal";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@codferiamunicipal", codferiamunicipal);
            DataRow resp = conector.traerfila();
            if (resp != null)
        ...
        public bool actualizarFeriaDepartamental(string coddepartamento, string nombreferiamunicipal, string numeroasistentes, string numerogrupos, string numerodocentes, string fechaelaboracion, string horaferia, string horaferiafinal, string fechaelaboracioncierre, string horaferiacierre, string horaferiafinalcierre, string codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "UPDATE ep_feriasdepa SET coddepartamento = @coddepartamento, nombreferiamunicipal = @nombreferiamunicipal, numeroasistentes=@numeroasistentes, numerogrupos = @numerogrupos, numerodocentes = @numerodocentes, fechaelaboracion=@fechaelaboracion, horaferia=@horaferia, horaferiafinal=@horaferiafinal, fechaelaboracioncierre=@fechaelaboracioncierre, horaferiacierre=@horaferiacierre, horaferiafinalcierre=@horaferiafinalcierre WHERE codigo = @codigo";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@coddepartamento", coddepartamento);
            conector.AsignarParametroCadena("@nombreferiamunicipal", nombreferiamunicipal);
            conector.AsignarParametroCadena("@numeroasistentes", numeroasistentes);
        ...
        public Boolean agregarArchivoRespositorioEspacioxDepartamento(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string codespacio, string actividad)
        {
            Conexion conector = new Conexion();
            string consulta = "";

            consulta = "INSERT INTO est_respositorio_espacioapro (codusuario,nombrearchivo,nombreguardado,contentType,ext,path,tamano,fechacreado,codespacio,actividad) VALUES (@codusuario,@nombrearchivo,@nombreguardado,@contentType,@ext,@path,@tamano,@fechacreado,@codespacio,@actividad)";
        ...
        public DataTable cargarEvidenciasEspacioxDepartamento(string codespacio, string actividad, string codusuario)
        {
            Conexion conector = new Conexion();
            string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_respositorio_espacioapro rc inner join usu_usuario u on u.cod=rc.codusuario WHERE codespacio=@codespacio and actividad=@actividad and codusuario=@codusuario  ORDER BY fechacreado ASC";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@codespacio", codespacio);
            conector.AsignarParametroCadena("@actividad", actividad);
            conector.AsignarParametroCadena("@codusuario", codusuario);
        ...
        public DataRow buscarEvidenciaEspacioxDepartamento(string codigo)
        {
            Conexion conector = new Conexion();
            String consulta = "SELECT * FROM est_respositorio_espacioapro WHERE cod=@codigo;";
            conector.CrearComando(consulta);
        ...
        public Boolean borrarEvidenciaEspacioxDepartamento(String codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "DELETE FROM est_respositorio_espacioapro WHERE cod=@codigo ";
            conector.CrearComando(consulta);
        ...
        //FeriaRegional
        public DataTable cargarFeriasRegionalesMaferpi()
        {
            Conexion conector = new Conexion();
            string consulta = "select fm.codigo as codferiamunicipal, fm.nombreferiamunicipal as nomferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasreg fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
            conector.CrearComando(consulta);
            DataTable resp = conector.traerdata();
            if (resp != null)
                return resp;
        ...
        public DataRow buscarFeriaRegionalxcodigo(string codferiamunicipal)
        {
            Conexion conector = new Conexion();
            string consulta = "select d.cod as coddepartamento, fm.codigo as codigo, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as numeroasistentes, fm.numerogrupos as numerogrupos, fm.numerodocentes as numerodocentes, fm.fechaelaboracion as fechaelaboracion, fm.horaferia as horaferia, fm.horaferiafinal, fm.fechaelaboracioncierre as fechaelaboracioncierre, fm.horaferiacierre as horaferiacierre, fm.horaferiafinalcierre as horaferiafinalcierre from ep_feriasreg fm left join ep_municipiomatricula fmm on fmm.codferiamunicipal=fm.codigo inner join geo_departamentos d on d.cod=fm.coddepartamento where fm.codigo=@codferiamunicipal";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@codferiamunicipal", codferiamunicipal);
            DataRow resp = conector.traerfila();
            if (resp != null)
        ...
        public bool actualizarFeriaRegional(string coddepartamento, string nombreferiamunicipal, string numeroasistentes, string numerogrupos, string numerodocentes, string fechaelaboracion, string horaferia, string horaferiafinal, string fechaelaboracioncierre, string horaferiacierre, string horaferiafinalcierre, string codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "UPDATE ep_feriasreg SET coddepartamento = @coddepartamento, nombreferiamunicipal = @nombreferiamunicipal, numeroasistentes=@numeroasistentes, numerogrupos = @numerogrupos, numerodocentes = @numerodocentes, fechaelaboracion=@fechaelaboracion, horaferia=@horaferia, horaferiafinal=@horaferiafinal, fechaelaboracioncierre=@fechaelaboracioncierre, horaferiacierre=@horaferiacierre, horaferiafinalcierre=@horaferiafinalcierre WHERE codigo = @codigo";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@coddepartamento", coddepartamento);
            conector.AsignarParametroCadena("@nombreferiamunicipal", nombreferiamunicipal);
            conector.AsignarParametroCadena("@numeroasistentes", numeroasistentes);
        ...
        public Boolean agregarArchivoRespositorioEspacioxRegion(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string codespacio, string actividad)
        {
            Conexion conector = new Conexion();
            string consulta = "";
        ...
        public DataTable cargarEvidenciasEspacioxRegion(string codespacio, string actividad, string codusuario)
        {
            Conexion conector = new Conexion();
            string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_respositorio_espacioapro rc inner join usu_usuario u on u.cod=rc.codusuario WHERE codespacio=@codespacio and actividad=@actividad and codusuario=@codusuario  ORDER BY fechacreado ASC";
            conector.CrearComando(consulta);
        ...
        public DataRow buscarEvidenciaEspacioxRegion(string codigo)
        {
            Conexion conector = new Conexion();
            String consulta = "SELECT * FROM est_respositorio_espacioapro WHERE cod=@codigo;";
            conector.CrearComando(consulta);
        ...
        public Boolean borrarEvidenciaEspacioxRegion(String codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "DELETE FROM est_respositorio_espacioapro WHERE cod=@codigo ";
            conector.CrearComando(consulta);
        ...
        //FeriaNacional
        public DataTable cargarFeriasNacionalesMaferpi()
        {
            Conexion conector = new Conexion();
            string consulta = "select fm.codigo as codferiamunicipal, fm.nombreferiamunicipal as nomferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasnac fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
            conector.CrearComando(consulta);
            DataTable resp = conector.traerdata();
            if (resp != null)
                return resp;
        ...
        public DataRow buscarFeriaNacionalxcodigo(string codferiamunicipal)
        {
            Conexion conector = new Conexion();
            string consulta = "select d.cod as coddepartamento, fm.codigo as codigo, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as numeroasistentes, fm.numerogrupos as numerogrupos, fm.numerodocentes as numerodocentes, fm.fechaelaboracion as fechaelaboracion, fm.horaferia as horaferia, fm.horaferiafinal, fm.fechaelaboracioncierre as fechaelaboracioncierre, fm.horaferiacierre as horaferiacierre, fm.horaferiafinalcierre as horaferiafinalcierre from ep_feriasnac fm left join ep_municipiomatricula fmm on fmm.codferiamunicipal=fm.codigo inner join geo_departamentos d on d.cod=fm.coddepartamento where fm.codigo=@codferiamunicipal";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@codferiamunicipal", codferiamunicipal);
            DataRow resp = conector.traerfila();
            if (resp != null)
        ...
        public bool actualizarFeriaNacional(string coddepartamento, string nombreferiamunicipal, string numeroasistentes, string numerogrupos, string numerodocentes, string fechaelaboracion, string horaferia, string horaferiafinal, string fechaelaboracioncierre, string horaferiacierre, string horaferiafinalcierre, string codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "UPDATE ep_feriasnac SET coddepartamento = @coddepartamento, nombreferiamunicipal = @nombreferiamunicipal, numeroasistentes=@numeroasistentes, numerogrupos = @numerogrupos, numerodocentes = @numerodocentes, fechaelaboracion=@fechaelaboracion, horaferia=@horaferia, horaferiafinal=@horaferiafinal, fechaelaboracioncierre=@fechaelaboracioncierre, horaferiacierre=@horaferiacierre, horaferiafinalcierre=@horaferiafinalcierre WHERE codigo = @codigo";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@coddepartamento", coddepartamento);
            conector.AsignarParametroCadena("@nombreferiamunicipal", nombreferiamunicipal);
            conector.AsignarParametroCadena("@numeroasistentes", numeroasistentes);
        ...
        public Boolean agregarArchivoRespositorioEspacioxNacion(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string codespacio, string actividad)
        {
            Conexion conector = new Conexion();
            string consulta = "";
        ...
        public DataTable cargarEvidenciasEspacioxNacion(string codespacio, string actividad, string codusuario)
        {
            Conexion conector = new Conexion();
            string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_respositorio_espacioapro rc inner join usu_usuario u on u.cod=rc.codusuario WHERE codespacio=@codespacio and actividad=@actividad and codusuario=@codusuario  ORDER BY fechacreado ASC";
            conector.CrearComando(consulta);
        ...
        public DataRow buscarEvidenciaEspacioxNacion(string codigo)
        {
            Conexion conector = new Conexion();
            String consulta = "SELECT * FROM est_respositorio_espacioapro WHERE cod=@codigo;";
            conector.CrearComando(consulta);
        ...
        public Boolean borrarEvidenciaEspacioxNacion(String codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "DELETE FROM est_respositorio_espacioapro WHERE cod=@codigo ";
            conector.CrearComando(consulta);
        ...
        //FeriaInternacional
        public DataTable cargarFeriasInternacionalesMaferpi()
        {
            Conexion conector = new Conexion();
            string consulta = "select fm.codigo as codferiamunicipal, fm.nombreferiamunicipal as nomferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, fm.lugar as nomdepartamento, fm.coddepartamento FROM ep_feriasint fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
            conector.CrearComando(consulta);
            DataTable resp = conector.traerdata();
            if (resp != null)
                return resp;
        ...
        public DataRow buscarFeriaInternacionalxcodigo(string codferiamunicipal)
        {
            Conexion conector = new Conexion();
            string consulta = "select d.cod as coddepartamento, fm.codigo as codigo, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as numeroasistentes, fm.numerogrupos as numerogrupos, fm.numerodocentes as numerodocentes, fm.fechaelaboracion as fechaelaboracion, fm.horaferia as horaferia, fm.horaferiafinal, fm.fechaelaboracioncierre as fechaelaboracioncierre, fm.horaferiacierre as horaferiacierre, fm.horaferiafinalcierre as horaferiafinalcierre, fm.lugar as lugar from ep_feriasint fm left join ep_municipiomatricula fmm on fmm.codferiamunicipal=fm.codigo inner join geo_departamentos d on d.cod=fm.coddepartamento where fm.codigo=@codferiamunicipal";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@codferiamunicipal", codferiamunicipal);
            DataRow resp = conector.traerfila();
            if (resp != null)
        ...
        public bool actualizarFeriaInternacional(string coddepartamento, string nombreferiamunicipal, string numeroasistentes, string numerogrupos, string numerodocentes, string lugar, string fechaelaboracion, string horaferia, string horaferiafinal, string fechaelaboracioncierre, string horaferiacierre, string horaferiafinalcierre, string codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "UPDATE ep_feriasint SET coddepartamento = @coddepartamento, nombreferiamunicipal = @nombreferiamunicipal, numeroasistentes=@numeroasistentes, numerogrupos = @numerogrupos, numerodocentes = @numerodocentes, lugar = @lugar, fechaelaboracion=@fechaelaboracion, horaferia=@horaferia, horaferiafinal=@horaferiafinal, fechaelaboracioncierre=@fechaelaboracioncierre, horaferiacierre=@horaferiacierre, horaferiafinalcierre=@horaferiafinalcierre WHERE codigo = @codigo";
            conector.CrearComando(consulta);
            conector.AsignarParametroCadena("@coddepartamento", coddepartamento);
            conector.AsignarParametroCadena("@nombreferiamunicipal", nombreferiamunicipal);
            conector.AsignarParametroCadena("@numeroasistentes", numeroasistentes);
        ...
        public Boolean agregarArchivoRespositorioEspacioxInternacional(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string codespacio, string actividad)
        {
            Conexion conector = new Conexion();
            string consulta = "";
        ...
        public DataTable cargarEvidenciasEspacioxInternacional(string codespacio, string actividad, string codusuario)
        {
            Conexion conector = new Conexion();
            string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_respositorio_espacioapro rc inner join usu_usuario u on u.cod=rc.codusuario WHERE codespacio=@codespacio and actividad=@actividad and codusuario=@codusuario  ORDER BY fechacreado ASC";
            conector.CrearComando(consulta);
        ...
        public DataRow buscarEvidenciaEspacioxInternacional(string codigo)
        {
            Conexion conector = new Conexion();
            String consulta = "SELECT * FROM est_respositorio_espacioapro WHERE cod=@codigo;";
            conector.CrearComando(consulta);
        ...
        public Boolean borrarEvidenciaEspacioxInternacional(String codigo)
        {
            Conexion conector = new Conexion();
            string consulta = "DELETE FROM est_respositorio_espacioapro WHERE cod=@codigo ";
            conector.CrearComando(consulta);
   ...
   //Metodo gregados por Mutis



//Para que se visualice en modulo gerencia2 las ferias regional creadas

    public DataTable FeriasRegionalesMaferpi()
    {
        Conexion conector = new Conexion();
        string consulta = "select fm.codigo as codferiaregional, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasreg fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
    ...
    //Fin Para que se visualice en modulo gerencia2 las ferias Regionales creadas


//Para que se visualice en modulo gerencia2 las ferias regional creadas
    
    public DataTable FeriasNacionalesMaferpi()
    {
        Conexion conector = new Conexion();
        string consulta = "select fm.codigo as codferianacional, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasnac fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
...
//Para que se visualice en modulo gerencia2 las ferias regional creadas
    ...
    public DataTable FeriasInternacionalMaferpi()
    {
        Conexion conector = new Conexion();
        string consulta = "select fm.codigo as codferiainternacional, fm.nombreferiamunicipal as nombreferiamunicipal, fm.numeroasistentes as asistentes, fm.fechaelaboracion as fecha, fm.horaferia as hora, df.nombre as nomdepartamento, fm.coddepartamento FROM ep_feriasint fm inner join geo_departamentos df on df.cod=fm.coddepartamento";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
...
public bool actualizarFinanciacion(string codigo, string financiado)
    {
        Conexion conector = new Conexion();
        string consulta = "UPDATE pro_grupoinvestigaciondocentes SET financiado=@financiado WHERE codigo = @codigo;";
        conector.CrearComando(consulta);
        conector.AsignarParametroCadena("@financiado", financiado);
        conector.AsignarParametroCadena("@codigo", codigo);
        bool resp = conector.guardadata();
        return resp;
    }
...
public DataTable cargardocentesformados()
    {
        Conexion conector = new Conexion();
        string consulta = "select * from maestrosf";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp !=null)
        {
...
//nuevo metodo
public Boolean agregarArchivoRespositorioEstrategias003(String codusuario, string nombrearchivo, string nombreguardado, string ext, string contentType, string path, int tamano, string fechacreado, string actividad, string codestras003)
    {
        Conexion conector = new Conexion();
        string consulta = "";


        consulta = "INSERT INTO est_repositorioasesor_bitacora5 (codusuario,nombrearchivo,nombreguardado,contentType,ext,path,tamano,fechacreado,actividad,codestras003) VALUES (@codusuario,@nombrearchivo,@nombreguardado,@contentType,@ext,@path,@tamano,@fechacreado,@actividad,@codestras003)";
        ...
        conector.AsignarParametroCadena("@fechacreado", fechacreado);
        conector.AsignarParametroCadena("@actividad", actividad);
        conector.AsignarParametroCadena("@codestras003", codestras003);
        bool resp = conector.guardadata();
        return resp;
    }

     public DataTable cargarEvidenciasEstrategias003(string codestras003)
    {
        Conexion conector = new Conexion();
        string consulta = "SELECT *, concat_ws(' ', u.pnombre,u.papellido) as nombre FROM est_repositorioasesor_bitacora5 rc inner join usu_usuario u on u.cod=rc.codusuario WHERE codestras003=@codestras003  ORDER BY fechacreado ASC";
        conector.CrearComando(consulta);
    ...
    public DataTable informeinvestipree()
    {
        Conexion conector = new Conexion();


        string consulta = "select s003.*, ps.nombregrupo, d.nombre as departamento, m.nombre as municipio, i.nombre as institucion, s.nombre as sede, ps.nombregrupo from est_estra1instrumento_s003 s003 inner join pro_proyectosede ps on ps.codigo=s003.codproyectosede inner join ins_sede s on s.codigo=ps.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio inner join geo_departamentos d on d.cod=m.coddepartamento where ps.codlineainvestigacion='3'";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
    ...
    public DataTable informeinvestiabierto()
    {
        Conexion conector = new Conexion();


        string consulta = "select s003.*, ps.nombregrupo, d.nombre as departamento, m.nombre as municipio, i.nombre as institucion, s.nombre as sede, ps.nombregrupo from est_estra1instrumento_s003 s003 inner join pro_proyectosede ps on ps.codigo=s003.codproyectosede inner join ins_sede s on s.codigo=ps.codsede inner join ins_institucion i on i.codigo=s.codinstitucion inner join geo_municipios m on m.cod=i.codmunicipio inner join geo_departamentos d on d.cod=m.coddepartamento where ps.codlineainvestigacion='2'";
        conector.CrearComando(consulta);
        DataTable resp = conector.traerdata();
        if (resp != null)
            return resp;
