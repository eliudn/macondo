...
public partial class estra1sedesgruposevaluacionferia : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra1sedesgruposevaluacionferia_()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = estra1sedesgruposevaluacionferia.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra1sedesgruposevaluacionferia.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra1sedesgruposevaluacionferia.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra1sedesgruposevaluacionferia.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra1sedesgruposevaluacionferia.Rows[i]["nombreferiamunicipal"].ToString() + " </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra1sedesgruposevaluacionferia_(string coddepartamento, string codmuncipio)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra1sedesgruposevaluacionferia = est.estra1SedesGruposEvaluacionFeria(coddepartamento, codmuncipio);
