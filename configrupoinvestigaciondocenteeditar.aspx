<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="configrupoinvestigaciondocenteeditar.aspx.cs" Inherits="configrupoinvestigaciondocenteeditar" %>
...
<h2 >Editar Grupos de investigación</h2><br />
...
<legend>Grupo de Investigación</legend>
      ...
      <table>
          ...
          <tr>
            ...
            <tr>
                    ...
                    <tr>
                         <td>Nombre del proyecto de investigación:</td>
                         <td>
                               ...
                               <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                 <ContentTemplate>
                                     ...
                                     <asp:TextBox runat="server" ID="dropGrupoInvestigacion" CssClass="TextBox" UpdateMode="Conditional" Width="400"></asp:TextBox>
                                      <asp:RequiredFieldValidator ID="RFVdropGrupoInvestigacion" runat="server" ErrorMessage="Seleccione"
                                        Text="*" Display="None" ControlToValidate="dropGrupoInvestigacion"
                                        ValidationGroup="Buscar"></asp:RequiredFieldValidator>
          ...
          <tr>
              <td><asp:Button runat="server" CssClass="btn btn-success" Text="Editar" OnClick="btnEditar_Click" /></td>
          </tr>
          </table>
 <asp:Label runat="server" id="lblCodGrupoInvestigacion" Visible="false"></asp:Label>
    ...
    <fieldset>
        ...
        <br />
                 <asp:GridView ID="GridDocentes" runat="server" CellPadding="4" DataKeyNames="codgrupoinvestigaciondocentes" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
  ...
  <asp:Panel runat="server" ID="PanelVerDocentes" Visible ="false">
    ...
    <fieldset>
        ...
        <br />
                 <asp:GridView ID="GridAsesor" runat="server" CellPadding="4" DataKeyNames="codgrupoinvestigaciondocentes" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        EmptyDataText="No se encontraron Datos" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-ForeColor="Red"
                        ForeColor="#333333"  AutoGenerateColumns="false" Style="margin: 0 auto" 
                        GridLines="None" >
                        <Columns>
