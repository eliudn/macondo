<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras004SedesEvidencia.aspx.cs" Inherits="estras004SedesEvidencia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 2 - Cargar Evidencias</h2>
    ...
    <asp:Label ID="lblCodAsesorCoordinador" runat="server" Visible="False"></asp:Label>
    <asp:Label ID="lblCodAnio" runat="server" Visible="False"></asp:Label>
