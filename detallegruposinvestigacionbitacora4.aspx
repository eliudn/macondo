<%@ Page Title="Grupos de Investigación con Bitaácora 04" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesedesgpbitacora4.aspx.cs" Inherits="detallesedesgpbitacora4" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesedesgpbitacora4.aspx/gruposInvestigacionBitacora4',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesedesgpbitacora4.aspx/realizarBusquedagruposInvestigacionBitacora4',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Grupos de investigación infantiles y juveniles con la bitácora 04 de presupuesto diligenciada </h4>
    <p>Mide la cantidad de grupos de investigación infantiles y juveniles que diligencian la bitácora 04 de presupuesto  y la han cargado en la plataforma de Ciclón</p>
