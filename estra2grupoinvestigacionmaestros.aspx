<%@ Page Title="Grupos de investigación de maestros y maestras registrados en la plataforma del Proyecto Ciclón " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra2grupoinvestigacionmaestros.aspx.cs" Inherits="estra2grupoinvestigacionmaestros" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2grupoinvestigacionmaestros.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estra2grupoinvestigacionmaestros.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra2grupoinvestigacionmaestros.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estra2grupoinvestigacionmaestros.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2grupoinvestigacionmaestros.aspx/estra2grupoinvestigacionmaestros_',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra2grupoinvestigacionmaestros.aspx/realizarBusquedaestra2grupoinvestigacionmaestros_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Mesas de trabajo en cada una de las sedes educativas beneficiarias </h2>
    ...
    <h4 >Grupos de investigación de maestros y maestras registrados en la plataforma del Proyecto Ciclón  </h4>
    <p>S001: Formato de inscripción de actores o matrícula <br /></p>    
    <br />
