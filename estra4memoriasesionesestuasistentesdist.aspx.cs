...
public partial class estra4memoriasesionesestuasistentesdist : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        subtitulo.Text = "Niños, niñas y jóvenes inscritos en la plataforma y registrados en una Red Temática de Ciclón ";
    ...
    [WebMethod(EnableSession = true)]
    public static string estra4memoriassesio1_estudiantes()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_estudiantes("", "", "", "", HttpContext.Current.Session["s"].ToString());
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra4memoriasesion1estudiantes_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_estudiantes(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString());
