...
public partial class detalleDocenteImpacto : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        titulo.Text = "Docentes beneficiados por el Proyecto que participan en la evaluación de impacto";
        subtitulo.Text = "Indicador: total de docentes que participaron en la evaluación impacto . ";
        descripcion.Text = "";
  ...
  for (int i = 0; i < datos.Rows.Count; i++)
    ...
    {
        detalleDocenteImpacto d = new detalleDocenteImpacto();
        string ca = "";
        ...
        DataTable docentesEvaluacionintermedia = lb.totalImpacto("", "", "", "");
        ...
        if (docentesEvaluacionintermedia != null && docentesEvaluacionintermedia.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < docentesEvaluacionintermedia.Rows.Count; i++)
            {
                ...
                ca += "<td>" + docentesEvaluacionintermedia.Rows[i]["identificacion"].ToString() + " </td>";
    ...
    public static string realizarBusquedadocentesEvaluacionintermedia_(string coddepartamento, string codmunicipio, string codinstitucion, string codsede, string instrumento)
    {
        ...
        {
            case "Si_2_1":
                DataTable docentesEvaluacionintermedia = lb.InstrumentoImpacto21(coddepartamento, codmunicipio, codinstitucion, codsede);
                if (docentesEvaluacionintermedia != null && docentesEvaluacionintermedia.Rows.Count > 0)
                {
                    int total = docentesEvaluacionintermedia.Rows.Count;
                    ca = "lleno@";
                ...
                break;
            case "No_2_1":
                DataTable docentesEvaluacionintermedi = lb.noInstrumentoImpacto21(coddepartamento, codmunicipio, codinstitucion, codsede);
                ...
                if (docentesEvaluacionintermedi != null && docentesEvaluacionintermedi.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < docentesEvaluacionintermedi.Rows.Count; i++)
                    {
                                ...
                                ca += "<td>" + docentesEvaluacionintermedi.Rows[i]["identificacion"].ToString() + " </td>";
                ...
                break;
            case "Si_5":
                DataTable docentesEvaluacionintermedia5 = lb.InstrumentoImpacto5(coddepartamento, codmunicipio, codinstitucion, codsede);
                if (docentesEvaluacionintermedia5 != null && docentesEvaluacionintermedia5.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < docentesEvaluacionintermedia5.Rows.Count; i++)
                    {
                        ...
                        ca += "<td>" + docentesEvaluacionintermedia5.Rows[i]["identificacion"].ToString() + " </td>";
            ...
            case "No_5":
                DataTable docentesEvaluacionintermedian5 = lb.noInstrumentoImpacto5(coddepartamento, codmunicipio, codinstitucion, codsede);
                ...
                if (docentesEvaluacionintermedian5!= null && docentesEvaluacionintermedian5.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < docentesEvaluacionintermedian5.Rows.Count; i++)
                    {
                        ...
                        ca += "<td>" + docentesEvaluacionintermedian5.Rows[i]["identificacion"].ToString() + " </td>";
                ...
                break;
            case "No_4":
                DataTable docentesEvaluacionintermedian4 = lb.noInstrumentoImpacto4(coddepartamento, codmunicipio, codinstitucion, codsede);

                if (docentesEvaluacionintermedian4 != null && docentesEvaluacionintermedian4.Rows.Count > 0)
                {
                    int total = docentesEvaluacionintermedian4.Rows.Count;
                    ca = "lleno@";
                    for (int i = 0; i < docentesEvaluacionintermedian4.Rows.Count; i++)
                    {
                        var f = i + 1;
                        ca += "<tr>";
                        ca += "<td><b>" + f + ".</b> </td>";
                        ca += "<td><b>" + docentesEvaluacionintermedian4.Rows[i]["nombredocente"].ToString() + ".</b> </td>";
                        ca += "<td>" + docentesEvaluacionintermedian4.Rows[i]["identificacion"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedian4.Rows[i]["nombredepartamento"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedian4.Rows[i]["nombremunicipio"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedian4.Rows[i]["dane"].ToString() + " - " + docentesEvaluacionintermedian4.Rows[i]["nombreins"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedian4.Rows[i]["danesede"].ToString() + " - " + docentesEvaluacionintermedian4.Rows[i]["nombresede"].ToString() + " </td>";
                ...
                break;
            case "Si_4":
                DataTable docentesEvaluacionintermedians4 = lb.InstrumentoImpacto4(coddepartamento, codmunicipio, codinstitucion, codsede);

                if (docentesEvaluacionintermedians4 != null && docentesEvaluacionintermedians4.Rows.Count > 0)
                {
                    int total = docentesEvaluacionintermedians4.Rows.Count;
                    ca = "lleno@";
                    for (int i = 0; i < docentesEvaluacionintermedians4.Rows.Count; i++)
                    {
                        var f = i + 1;
                        ca += "<tr>";
                        ca += "<td><b>" + f + ".</b> </td>";
                        ca += "<td><b>" + docentesEvaluacionintermedians4.Rows[i]["nombredocente"].ToString() + ".</b> </td>";
                        ca += "<td>" + docentesEvaluacionintermedians4.Rows[i]["identificacion"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedians4.Rows[i]["nombredepartamento"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedians4.Rows[i]["nombremunicipio"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedians4.Rows[i]["dane"].ToString() + " - " + docentesEvaluacionintermedians4.Rows[i]["nombreins"].ToString() + " </td>";
                        ca += "<td>" + docentesEvaluacionintermedians4.Rows[i]["danesede"].ToString() + " - " + docentesEvaluacionintermedians4.Rows[i]["nombresede"].ToString() + " </td>";
            ...
            case "":
                DataTable docentesEvaluacionintermediat = lb.totalImpacto(coddepartamento, codmunicipio, codinstitucion, codsede);
                ...
                if (docentesEvaluacionintermediat != null && docentesEvaluacionintermediat.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < docentesEvaluacionintermediat.Rows.Count; i++)
                    {
                        ...
                        ca += "<td>" + docentesEvaluacionintermediat.Rows[i]["identificacion"].ToString() + " </td>";
    ...
    protected void btnRegresar_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("evalImpactoGeneral.aspx");
