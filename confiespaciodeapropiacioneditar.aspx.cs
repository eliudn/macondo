        ...
        if (!IsPostBack)
        {
            ...
            if (Session["codigo"] != null)
            {
                ddMunicipios(dropMunicipiosSedes, "20");
                    DataRow dat = est.buscarFeriaMunicipalxcodigo(Session["codigo"].ToString());
            ...
            else
            {
                ...
                lblError.Text = "Error al crear o ver Feria Municipal";
            }
...
//        ScriptManager.RegisterStartupScript(this, typeof(Page), "alerta", script, false);
    ...
    protected void btnAgregarEstudiantes_Click(object sender, EventArgs e)
    {
        ...
        bool feriam = est.actualizarFeriaMunicipal(dropDepartamento.SelectedValue, nombreferiamunicipal.Text, numeroasistentes.Text, numerogrupos.Text, fechaelaboracion.Text, horaferia.SelectedValue, horaferiafinal.SelectedValue, Session["codigo"].ToString());
