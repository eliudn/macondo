<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras004Sedes.aspx.cs" Inherits="estras004Sedes" ValidateRequest="false" %>
  ...
  .pagination li.pages {
    ...
    <script>
        ...
        function cargarListadoMemorias(page) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004Sedes.aspx/cargarListadoMemoriaAsesor',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
