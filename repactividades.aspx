<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="repactividades.aspx.cs" Inherits="repactividades" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
            ...
            <table align="center" style="width:50%">
                <tr>
                    ...
                    <td rowspan="2" style="vertical-align:middle">
                        <asp:Button ID="btnBuscar" runat="server" CssClass="btn btn-primary" OnClick="btnBuscar_Click" Text="Filtrar" ValidationGroup="Filtrar" />
                    </td>
                </tr>
                <tr>
                    <td>Proyecto: </td>
    ...
    <fieldset>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnExportExcel" runat="server" Text="Exportar" CssClass="btn btn-success" OnClick="btnExportExcel_Click" Visible="false" />
