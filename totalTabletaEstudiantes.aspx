<%@ Page Title="Iventario de las tabletas" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="totalTabletaEstudiantes.aspx.cs" Inherits="inventabletaentre" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'actualizacionpei.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'actualizacionpei.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'actualizacionpei.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'totalTabletaEstudiantes.aspx/actualizacionpei_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'totalTabletaEstudiantes.aspx/realizarBusquedaactualizacionpei_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
                ...
                <th>SedeEducativa</th>
                <th>Total estudiantes por sede</th>
		    </tr>
        </thead>
         <tbody>
             <tr>
