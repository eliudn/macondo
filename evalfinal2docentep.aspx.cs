...
public partial class evalfinal2docentep : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardarpreguntascerradas(string codasesor2,string codasesor, string respuesta, string pregunta, string subpregunta, string accion)
    {
        ...
        evalfinal2docentep efd = new evalfinal2docentep();
        ...
        if (coddocenteasesor != null)
        {
            ...
            //lb.eliminarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, subpregunta, "2.1", "impacto");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, respuesta, "2.1", "impacto");
    ...
    [WebMethod(EnableSession = true)]
    public static string eliminarchk11docente(string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "1", "2.1", "impacto");
        }
    ...
    [WebMethod(EnableSession = true)]
    public static string eliminarchk12(string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "1", "2.1", "impacto");
        }
    ...
    [WebMethod(EnableSession = true)]
    public static string eliminarchk13(string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "1", "2.1", "impacto");
        }
      ...
      [WebMethod(EnableSession = true)]
    public static string eliminarchk14(string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "1", "2.1", "impacto");
        }
    ...
    public static string guardardatoschk11(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "5", "1", chk, "2.1", "impacto");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "5", "1", chk, "2.1", "impacto");
                }
            }
    ...
    public static string guardardatoschk12(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "7", "1", chk, "2.1", "impacto");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "7", "1", chk, "2.1", "impacto");
                }
            }
    ...
    public static string guardardatoschk13(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "6", "1", chk, "2.1", "impacto");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "6", "1", chk, "2.1", "impacto");
                }
            }
     ...
     [WebMethod(EnableSession = true)]
    public static string guardardatoschk14(string chk, string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "1", chk, "2.1", "impacto");
        }
        else
        {
            Docentes doc = new Docentes();
            ...
            if (docente != null)
            {
                ...
                if (coddocenteasesor2 != null)
                {
                    lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "1", chk, "2.1", "impacto");
                }
            }
    ...
    public static string cargarrespuestaspreguntacerrada_2(string codasesor, string pregunta, string subpregunta)
    {
        ...
        Asesores ase = new Asesores();
           ...
           if (coddocenteasesor != null)
           {
               DataTable dat7 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, "2.1", "impacto");
    ...
    public static string cargarrespuestascerradaschk11(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "5", "1", "2.1", "impacto");
    ...
    public static string cargarrespuestascerradaschk12(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "7", "1", "2.1", "impacto");
    ...
    public static string cargarrespuestascerradaschk13(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "6", "1", "2.1", "impacto");
    ...
    [WebMethod(EnableSession = true)]
    public static string cargarrespuestascerradaschk14(string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "1", "2.1", "impacto");
    ...
    /**metodo que carga el asesor de la tabla  lbase respuesta que tiene con el docente*/
    ...
    public static string cargaAsesorActual1()
    {
       ...
       Asesores ase = new Asesores();
        DataRow datos = ase.cargarAsesorInstrumento2(HttpContext.Current.Session["identificacion"].ToString(),"impacto","2.1");
           if (datos != null)
        {
            ca = "true&"; 
     ...
     public static string asesorescarg(){
        ...
        Asesores ase = new Asesores();
        DataTable datos = ase.cargarAsesores();
        DataRow datos2 = ase.cargarAsesorInstrumento2(HttpContext.Current.Session["identificacion"].ToString(),"impacto","2.1");
