<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confimesadetrabajoeditarReporte.aspx.cs" Inherits="confimesadetrabajoeditarReporte" %>
...
<legend>Mesa de trabajo</legend>
 ...
 <asp:Label runat="server" id="lblCodGrupoInvestigacion" Visible="false"></asp:Label>
    ...
    <fieldset>
        ...
        <br />
                 <asp:GridView ID="GridDocentes" runat="server" CellPadding="4" DataKeyNames="codmesadetrabajo" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="nombre"  HeaderText="Nombre" >
                             ...
                             <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                             <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Imagenes/carpeta.png" Height="20px" Width="20px" OnClick="UploadRepositorio_Click" />
                                 </ItemTemplate>
                            </asp:TemplateField>
