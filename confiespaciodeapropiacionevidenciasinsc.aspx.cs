...
public partial class confiespaciodeapropiacionevidenciasinsc : System.Web.UI.Page
{
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (est.agregarArchivoRespositorioEspacioxMunicipio(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblCodEspacio.Text, DropMunicipiosCargar.SelectedValue, rbtActividades.SelectedValue))
            {
                //gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEspacioxMunicipio(lblCodEspacio.Text, DropMunicipiosBuscar.SelectedValue, rbtActividadesBuscar.SelectedValue, lblCodUsuario.Text);
    ...
    private void borrarImagen(string cod)
    {
        ...
        if (usu.borrarEvidenciaEspacioxMunicipio(cod))
        {
