<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="asesoresmasivo.aspx.cs" Inherits="asesoresmasivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2>Creación de Asesores masivos</h2>
    <hr />
    <br />
    <br />
    <div style="background-color: #efefef; padding: 8px;  float:left;">
      ...
      <div style="background-color: #efefef; padding: 8px;  float:left;max-width:600px;margin-left:10px;">
        <p style="font-weight:bold;">Para tener en cuenta en el cargue masivo</p>
          <p>* El Rol debe tener estos datos a tener en cuenta: <br />Asesor UniMag: 11 <br /> Asesor FUNTICS: 13 <br /> Asesor CUC: 15 </p>
    ...
    <br />
        ...
        <table border="1" cellpadding="4" style="border-collapse: collapse; border-spacing: 5px;" align="center">
            <tr>
                <td class="obligatorio">IDENTIFICACIÓN</td>
                <td class="obligatorio">NOMBRE</td>
                <td class="obligatorio">APELLIDO</td>
                <td class="obligatorio">TELÉFONO</td>
                <td class="obligatorio">E-MAIL</td>
                 <td class="obligatorio">ID COORDINADOR</td>
                 <td class="obligatorio">ROL</td>
            </tr>
        </table>
    ...
    <asp:GridView ID="GridView1" runat="server" Height="251px" Width="420px" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDataBound="GridView1_RowDataBound">
        ...
        <Columns>
            <asp:BoundField DataField="0" HeaderText="Identificación">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
             <asp:BoundField DataField="1" HeaderText="Nombre">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="2" HeaderText="Apellido">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="3" HeaderText="Teléfono">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
           <asp:BoundField DataField="4" HeaderText="E-mail">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
              <asp:BoundField DataField="5" HeaderText="Id Coordinador">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
              <asp:BoundField DataField="6" HeaderText="Rol">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
        </Columns>
