<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras004coordinador.aspx.cs" Inherits="estras004coordinador" ValidateRequest="false" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#asesor").on("change", function () {
                ...
                cargarListadoMemorias($("#asesor").val());
            });
            ...
            $("#institucion").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras004coordinador.aspx/cargarsedes',
            ...
            $("#sede").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras004coordinador.aspx/cargarRedtematica',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
        ...
        function cargarAsesores() {
            $.ajax({
                url: 'estras004coordinador.aspx/cargarAsesores',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
        ...
        function cargarAnios() {
            $.ajax({
                url: 'estras004coordinador.aspx/cargarAnios',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarListadoMemorias(asesor) {
            var table = $('#infoListTable').DataTable();
            table.destroy();
            var datajson = "{'codAsesor':'" + asesor + "'}";
            //alert(datajson);
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador.aspx/cargarListadoMemoriaAsesor',
                data: datajson,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarinstituciones() {
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador.aspx/cargarInstituciones',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function loadInstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador.aspx/loadestras004',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function floadPreguntaas(codigoestrategia) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador.aspx/loadPreguntass004',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function floadSelects004(codigoestrategia) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004coordinador.aspx/loadSelectInstrumento',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
