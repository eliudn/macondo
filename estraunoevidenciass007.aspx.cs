...
public partial class estraunoevidenciass007 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["codrol"] != null)
            {
                ...
                //}
                //else 
                    if (lblMomento.Text == "3" ){
                    PanelMomento0.Visible = true; 
                        //lblTitulo.Text ="Diseño de las trayectorias de indagación y presupuesto";
                }
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (lblMomento.Text == "3")
            {
                if (usu.agregarArchivoRespositorioEstrategiaUnoS007(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, rbtActividades.SelectedValue, lblEstrategia.Text))
                {
                    gvCargarEvidencias();
    ...
    private void gvCargarEvidencias()
    {
        ...
        //{
             DataTable datos = est.cargarEvidenciasEstrategiaUnoS007(lblMomento.Text, lblSesion.Text, lblEstrategia.Text, lblCodUsuario.Text);
        ...
        //else
        //{
        //    DataTable datos2 = est.cargarEvidenciasEstrategia(lblMomento.Text, "0", "1");
    ...
    {
        Estrategias usu = new Estrategias();
        DataRow dato = usu.buscarEvidenciaEstrategiaUnoS007(cod);
        if (usu.borrarEvidenciaEstrategiaUnoS007(cod))
        {
