<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciasjornaforma.aspx.cs" Inherits="estraunoevidenciasjornaforma" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 1 - Jornada de formación: La pregunta como punto de partida <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
    ...
    <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="30">Asistencia a eventos</asp:ListItem>
                        <asp:ListItem Value="31">Registro de asesoría</asp:ListItem>
                        <asp:ListItem Value="32">Evaluación eventos de formación</asp:ListItem>
                     </asp:RadioButtonList>
