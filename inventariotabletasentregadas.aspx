<%@ Page Title="Inventario de las tabletas entregadas por el Proyecto a las sedes educativas" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="inventariotabletasentregadas.aspx.cs" Inherits="inventariotabletasentregadas" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'inventariotabletasentregadas.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'inventariotabletasentregadas.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'inventariotabletasentregadas.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'inventariotabletasentregadas.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            $("#tableList tbody").html('<span style=\"text-align:center;width=100%;display:block\">Cargando...</span>');
            $.ajax({
                type: 'POST',
                url: 'inventariotabletasentregadas.aspx/inventariotabletasentregadas_',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
                    if (resp[0] === "lleno") {
                        $("#tableList").html(resp[1]);
                    }
                }, complete: function () {
                }
            });
        ...
        // realizar busqueda
        function filtro() {
            $("#tableList").html("<span style=\"text-align:center;width=100%;display:block\">Cargando...</span>");
            var codDepartamento = $("#departamento").val();
            var codMunicipio = $("#municipio").val();
            var codInstitucion = $("#institucion").val();
            var codSede = $("#sede").val();
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmunicipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "', 'codsede':'" + codSede + "'}";
            $.ajax({
                type: 'POST',
                url: 'inventariotabletasentregadas.aspx/realizarBusquedainventariotabletasentregadas_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
