...
public partial class estrag006Evidencia_estra4 : System.Web.UI.Page
{
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (usu.agregarArchivoRespositorioEntregaMaterialEstra4(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblCodInstrumento.Text))
                {
                    gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEntregaMaterialEstra4(lblCodInstrumento.Text, lblCodUsuario.Text);
    ...
    {
        Estrategias usu = new Estrategias();
        DataRow dato = usu.buscarEvidenciaEntregaMaterialEstra4(cod);
        if (usu.borrarEvidenciaEntregaMaterialEstra4(cod))
        {
    ...
    protected void btnRegresar_Click(object sender, EventArgs e)
    {
        if (lblCodU.Text != "")
        {
            Response.Redirect("estrag006_estrategia4reporte.aspx");
        }
        else
        {
            Response.Redirect("estrag006_estrategia4.aspx");
        }
