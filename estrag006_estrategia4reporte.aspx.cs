...
public partial class estrag006_estrategia4reporte : System.Web.UI.Page
{
    ...
    public static string cargarListadoMaterialesAsesor()
    {
        ...
        DataTable datosmateriales = inst.cargarListadoMaterialesxAsesorEstra4TodoSin();

        if (datosmateriales != null && datosmateriales.Rows.Count > 0)
        {
            DataTable datosCount = inst.cargarListadoMaterialesxAsesorCountEstra4Sin();
