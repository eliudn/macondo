<%@ Page Title="Jornadas de Formación" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallejornadasformacion.aspx.cs" Inherits="detallejornadasformacion" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallejornadasformacion.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'detallejornadasformacion.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'detallejornadasformacion.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'detallejornadasformacion.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
            ...
            $("#sede").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'detallejornadasformacion.aspx/cargarGruposInvestigacionxSede',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            $.ajax({
                type: 'POST',
                url: 'detallejornadasformacion.aspx/jornadasformacion',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallejornadasformacion.aspx/realizarBusqueda',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Desarrollo de las jornadas de formación </h2>
    ...
    <h4 >Jornadas de formación en la pregunta como punto de partida y en la ruta metodológica del proyecto Ciclón </h4>
    <p>Mide las jornadas de formación desarrolladas para que los grupos se organicen, formulen la pregunta y planteen el problema de investigación</p>
