...
public partial class estra2maestrosmatriculados : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra2maestrosmatriculados_()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = estra2maestrosmatriculados.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra2maestrosmatriculados.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra2maestrosmatriculados.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra2maestrosmatriculados.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra2maestrosmatriculados.Rows[i]["dane"].ToString() + " - " + estra2maestrosmatriculados.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + estra2maestrosmatriculados.Rows[i]["danesede"].ToString() + " - " + estra2maestrosmatriculados.Rows[i]["nombresede"].ToString() + " </td>";
                ca += "<td>" + estra2maestrosmatriculados.Rows[i]["nombre"].ToString() + " " + estra2maestrosmatriculados.Rows[i]["apellido"].ToString() + " </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra2maestrosmatriculados_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2maestrosmatriculados = est.estra2MaestrosMatriculados(coddepartamento, codmuncipio, codinstitucion, codsede);
