<%@ Page Title="Asesorías realizadas a los grupos de investigación infantiles y juveniles en el momento pedagógico 3 etapa 5" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="asesoriasgpetapa5.aspx.cs" Inherits="asesoriasgpetapa5" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'asesoriasgpetapa5.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'asesoriasgpetapa5.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'asesoriasgpetapa5.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
            ...
            $("#sede").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'asesoriasgpetapa5.aspx/cargarGruposInvestigacionxSede',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/asesoriasGPEtapa5',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/realizarBusquedaasesoriasGPEtapa5',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
        ...
        function btnregresar() {
            if ($.get("sg") === "true") {
                ...
                window.location.href = "asesorgruposinvestigacionetapa5.aspx";
            }
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >El asesor realiza el acompañamiento a los grupos de investigación  en el desarrollo de las investigaciones.</h2>
    ...
    <h4 >Asesorías realizadas a los grupos de investigación infantiles y juveniles en el momento pedagógico 3 etapa 5</h4>
    <p>Mide la cantidad de asesorías a los grupos de investigación infantiles y juveniles registradas y cargadas en la plataforma de Ciclón en el momento pedagógico 3  etapa 5</p>
    <br />
