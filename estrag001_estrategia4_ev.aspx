<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag001_estrategia4_ev.aspx.cs" Inherits="estrag001_estrategia4_ev" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script>
        ...
        function cargarEncabezados() {
            $.ajax({
                type: 'POST',
                url: 'estrag001_estrategia4_ev.aspx/cargarEncabezados',
                ...
                success: function (json) {
                    ...
                    if (resp[0] === "datosintrumento") {
                        ...
                        $("#txttActividad").val("Formación virtual");
                    }
                }
            });
        }
        ...
        function cargarAsistencias() {
            ...
            $.ajax({
                url: 'estrag001_estrategia4_ev.aspx/cargarListadoAsistencias',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
        ...
        function validacion() {
            ...
            $.ajax({
                url: 'estrag001_estrategia4_ev.aspx/validarSesion',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function loadinstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag001_estrategia4_ev.aspx/loadinstrumento',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: data,
                success: function (json) {
        ...
        function cargarEstudiantes() {
            ...
            $.ajax({
                url: 'estrag001_estrategia4_ev.aspx/cargarEstudiantes',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function btnGuardar_Click() {
            ...
            if ($.trim($("#fecha").val()) == '' || $.trim($("#fecha").val()) == null) {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_ev.aspx/encabezado',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
                        ...
                        for (var i = 0; i < dataTabla.length; i++) {
                            ...
                            $.ajax({
                                url: 'estrag001_estrategia4_ev.aspx/estudianteInasistente',
                                type: 'POST',
                                data: jsonData,
                                contentType: 'application/json; charset=utf-8',
                                dataType: 'JSON',
        ...
        function updateEstudiante(cod) {
            ...
            if ($.trim($("#nombreEst").val()) == '' || $.trim($("#nombreEst").val()) == null) {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4_ev.aspx/actualizarEstudiante',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#dialog-confirm").dialog({
                ...
                buttons: {
                    Eliminar: function () {
                        ...
                        $.ajax({
                            url: 'estrag001_estrategia4_ev.aspx/eliminarEstudiante',
                            type: 'POST',
                            data: data,
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'JSON',
...
<div id="mensaje" runat="server"></div><br /><br />
    <h2 >Estrategía Nro. 4 - G001: Registro de Asistencia Virtuales</h2><br />
    ...
    <br />
    <center>
        <input type="button" id="btnGuardar" class="btn btn-success" value="Guardar" onclick="btnGuardar_Click();" />
    ...
    <div id="list">
        <div style="float:right"><a href="#" id="btnuevo" class="btn btn-primary" onclick="btnNuevo_click()">Nuevo registro</a></div>
        <br /><br />
        <table class="mGridTesoreria">
            <thead>
                <tr>
