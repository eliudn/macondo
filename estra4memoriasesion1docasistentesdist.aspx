<%@ Page Title=" Sesiones de formación evaluadas y subidas a la plataforma de Ciclón " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra4memoriasesion1docasistentesdist.aspx.cs" Inherits="estra4memoriasesion1docasistentesdist" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4memoriasesion1docasistentesdist.aspx/estra4memoriassesio1_docente',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4memoriasesion1docasistentesdist.aspx/realizarBusquedaestra4memoriasesion1_docente',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
