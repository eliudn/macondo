<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="asesoracompanamientom4.aspx.cs" Inherits="asesoracompanamientom4" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoracompanamientom4.aspx/loadReport',
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "asesoracompanamientom4",
                filename: "asesoracompanamientom4",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2>Acompañamiento a los Grupos de investigación </h2>
