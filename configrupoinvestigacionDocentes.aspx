<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="configrupoinvestigacionDocentes.aspx.cs" Inherits="configrupoinvestigacionDocentes" %>
        ...
        <legend>Docentes por Sede</legend>
         ...
         <asp:GridView ID="GridDocentes" runat="server" CellPadding="4" DataKeyNames="codgradodocente" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
           ...
           <asp:Panel runat="server" ID="PanelLineaIngestigacion" Visible="false">
                <table align="center">
                    <tr>
                        <td>Título del proyecto de investigación</td>
                        <td colspan="3">
                ...
                <tr>
                   ...
                   <td>
                         ...
                         <asp:GridView ID="GridSeleccionDocentes" runat="server" CellPadding="4" AutoGenerateColumns="false" style="margin:0 auto; width:100%"
                            ...
                            <Columns>
                            <asp:BoundField DataField="codgradodocente" HeaderText="Cod." ><ItemStyle  HorizontalAlign="Center" /></asp:BoundField>
                            <asp:BoundField DataField="identificacion" HeaderText="ID Docente" ><ItemStyle HorizontalAlign="Center" /></asp:BoundField>  
                        ...
                        <asp:BoundField DataField="nombregrupo" HeaderText="Grupo">
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkEvidencia" runat="server" CssClass="btn btn-primary" Text="Evidencia" OnClick="lnkEvidencia_Click"></asp:LinkButton><br /><br />
