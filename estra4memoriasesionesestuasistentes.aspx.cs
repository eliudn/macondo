...
public partial class estra4memoriasesionesestuasistentes : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        subtitulo.Text = "Niños, niñas y jóvenes que asisten a la sesión";
    ...
    public static string estra4memoriassesio1_estudiantes()
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_estudiantes("", "", "", "", HttpContext.Current.Session["s"].ToString(), "2");
    ...
    public static string realizarBusquedaestra4memoriasesion1estudiantes_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_estudiantes(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString(),"2");
