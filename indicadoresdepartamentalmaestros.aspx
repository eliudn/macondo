<%@ Page Title="Indicadores Departamentales Maestros" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="indicadoresdepartamentalmaestros.aspx.cs" Inherits="indicadoresdepartamentalmaestros" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresdepartamentalmaestros.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    //$.ajax({
                    //    type: 'POST',
                    //    url: 'indicadoresdepartamentalmaestros.aspx/cargarMunicipios',
                    //    data: jsondata,
                    //    contentType: 'application/json; charset=utf-8',
                    //    dataType: 'JSON',
                    //    success: function (response) {
                    ...
                    $("#title-report").html("Maestros y maestras participantes del Departamento del Magdalena");
            ...
            //    $.ajax({
            //        type: 'POST',
            //        url: 'indicadoresdepartamentalmaestros.aspx/cargarInstituciones',
            //        data: jsondata,
            //        contentType: "application/json; charset=utf-8",
            //        dataType: "json",
            //        //data:frmserialize,
        ...
        function floadDetalles() {
            //$.ajax({
            //    type: 'POST',
            //    url: 'indicadoresdepartamentalmaestros.aspx/loadreport',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'JSON',
            //    success: function (response) {
            //        //var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresdepartamentalmaestros.aspx/realizarBusquedaloadreport',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    ...
                    if (resp[0] == "lleno") {
                        ...
                        Highcharts.chart('container', {
                            ...
                            title: {
                                text: 'Porcentaje de ejecución '+por.toFixed(1)+'%' //<span><b>Maestros y maestras matriculados: </b> ' + resp[4] + ' <br/> <b>Maestros y maestras en formación:</b> ' + resp[3] + '</span>'
                            },
                            tooltip: {
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "indicadoresdepartamentalmaestros",
                filename: "indicadoresdepartamentalmaestros",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
                ...
                <th>Total de maestros y maestras</th>
                <th>Ejecución</th>
                <th>% Ejecución</th>
