<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracincos004CoordEvidencia.aspx.cs" Inherits="estracincos004CoordEvidencia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 5 - Cargar Evidencias</h2>
     ...
     <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem >G001: Registro de asistencia a eventos</asp:ListItem>
                        <asp:ListItem >S005: Relato individual de sistematización</asp:ListItem>
                        <asp:ListItem >G002: Formato de evaluación de eventos de formación</asp:ListItem>
                         <asp:ListItem >S006: Relatoría institucional</asp:ListItem>
                          <asp:ListItem >Evidencias fotográficas</asp:ListItem>
                        <asp:ListItem >Certificado de cumplimiento de las horas de formación</asp:ListItem>
                        <asp:ListItem >Informe de la sesión</asp:ListItem>
                        <asp:ListItem >Matriz horas cursadas por participante</asp:ListItem>
                        <asp:ListItem >Certificados</asp:ListItem>
                     </asp:RadioButtonList>
