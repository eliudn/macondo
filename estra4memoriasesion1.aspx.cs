...
public partial class estra4memoriasesion1 : System.Web.UI.Page
{
            ...
            if (Session["m"].ToString() == "1")
            {
                if (Session["s"].ToString() != null)
                {
                    if (Session["s"].ToString() == "1")
                    {
                        ...
                        subtitulo.Text = "Sesiones desarrolladas";
    ...
    public static string estra4memoriassesio1_()
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016("", "", "", "", "1");
    ...
    public static string realizarBusquedaestra4memoriasesion1_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["s"].ToString());
