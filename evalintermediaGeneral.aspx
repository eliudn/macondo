<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="evalintermediaGeneral.aspx.cs" Inherits="evalintermediaGeneral" %>
    ...
    <link rel="stylesheet" href="/resources/demos/style.css" />
     ...
     <script type="text/javascript">
         ...
         function docentesbeneficiados() {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'evalintermediaGeneral.aspx/docentesbeneficiados',
                 //data: jsondata,
         ...
         function usoconectividadformacionestudiantes() {
             $("#infoListTable").html("<tr><td></td></tr><tr><td><img src='images/loader.gif' /></td></tr>");
             $.ajax({
                 type: 'POST',
                 url: 'evalintermediaGeneral.aspx/usoconectividadformacionestudiantes',
                 //data: jsondata,
                 contentType: 'application/json; charset=utf-8',
                 dataType: 'JSON',
                 success: function (response) {
...
<h2 >Reporte General Evaluación Intermedia</h2>
