...
public partial class lineabasedocentes_intermedia : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardardatoscerradas(string codasesor, string preg1, string preg2, string preg3)
    {
        string ca = "";
        ...
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", "2.1", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "0", "2.1", "intermedia");
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "3", "0", "2.1", "intermedia");

            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", preg1, "2.1", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "2", "0", preg2, "2.1", "intermedia");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "3", "0", preg3, "2.1", "intermedia");
            ca = "true_insert@";
        }
        else//Asesor es cambio o nuevo para ingresar
        {
            ...
            if (docente != null)
            {
                ...
                if (docenteasesor != null)
                {
                    ...
                    //Aquí actualizamos los datos del asesor, por si se llega a cambiar
                    lb.actualizarCodDocenteAsesorxDocente(docenteasesor["codigo"].ToString(), codasesor);

                    //Eliminamos y agregamos
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "1", "0", "2.1", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "0", "2.1", "intermedia");
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "3", "0", "2.1", "intermedia");

                    lb.AgregarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "1", "0", preg1, "2.1", "intermedia");
                    lb.AgregarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "2", "0", preg2, "2.1", "intermedia");
                    lb.AgregarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "3", "0", preg3, "2.1", "intermedia");
                    ca = "true_insert@";
                ...
                else
                {
                    ...
                    {
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "1", "0", preg1, "2.1", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "2", "0", preg2, "2.1", "intermedia");
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "3", "0", preg3, "2.1", "intermedia");
                        ca = "true_insert@";
                    }
                }
    ...
    [WebMethod(EnableSession = true)]
    public static string guardardatosabiertas(string codasesor, string preg1, string preg2, string preg3)
    {
        string ca = "";
        ...
        Docentes doc = new Docentes();
         ...
         if (coddocenteasesor != null)
         {
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "1", "2.1", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2", "2.1", "intermedia");
             lb.eliminarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "3", "2.1", "intermedia");

             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "1", preg1, "2.1", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2", preg2, "2.1", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "3", preg3, "2.1", "intermedia");
         }
         else//Asesor es cambio o nuevo para ingresar
         {
             DataRow docente = doc.buscarDocenteMatriculadoxID(HttpContext.Current.Session["identificacion"].ToString());
             ...
             if (docente != null)
             {
                 ...
                 else
                 {
                     ...
                     if (coddocenteasesor2 != null)
                     {
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "1", preg1, "2.1", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2", preg2, "2.1", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "3", preg3, "2.1", "intermedia");
                     }
                 }
    ...
    [WebMethod(EnableSession = true)]
    public static string eliminarchk(string codasesor)
    {
        string ca = "";
        ...
        Asesores ase = new Asesores();
         ...
         if (coddocenteasesor != null)
         {
             lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", "2.1", "intermedia");
         }
    ...
    [WebMethod(EnableSession = true)]
    public static string guardardatoschk(string usotics, string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", usotics, "2.1", "intermedia");
        }
        else
        {
              DataRow docente = doc.buscarDocenteMatriculadoxID(HttpContext.Current.Session["identificacion"].ToString());
              ...
              if (docente != null)
              {
                   ...
                   if (docenteasesor != null)
                   {
                       lb.AgregarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), "4", "0", usotics, "2.1", "intermedia");
                   }
                   else
                   {
                       DataRow coddocenteasesor2 = lb.AgregarDatoDocenteAsesorLineaBase(codasesor, docente["cod"].ToString());
                       if (coddocenteasesor2 != null)
                       {
                           lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "4", "0", usotics, "2.1", "intermedia");
                       }
                   }
              }
        }
    ...
    public static string cargarrespuestascerradasyabiertas(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", "2.1", "intermedia");
            ...
            DataTable datos = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "1", "2.1", "intermedia");

            if (datos != null && datos.Rows.Count > 0)
            {
                ca += datos.Rows[0]["comentario"].ToString() + "@";//2
            }

            DataTable dat2 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "0", "2.1", "intermedia");

            if (dat2 != null && dat2.Rows.Count > 0)
            {
                ca += dat2.Rows[0]["respuesta"].ToString() + "@";//3
            }

            DataTable datos2 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "2", "2.1", "intermedia");

            if (datos2 != null && datos2.Rows.Count > 0)
            {
                ca += datos2.Rows[0]["comentario"].ToString() + "@";//4
            }

            DataTable dat3 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "3", "0", "2.1", "intermedia");

            if (dat3 != null && dat3.Rows.Count > 0)
            {
                ca += dat3.Rows[0]["respuesta"].ToString() + "@";//5
            }

            DataTable datos3 = lb.cargarRespuestasAbiertasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "3", "2.1", "intermedia");

            if (datos3 != null && datos3.Rows.Count > 0)
            {
                ca += datos3.Rows[0]["comentario"].ToString() + "@";//6
            }
        }
    ...
    [WebMethod(EnableSession = true)]
    public static string cargarrespuestascerradaschk(string codasesor)
    {
        string ca = "";
        ...
        if (coddocenteasesor != null)
        {
            DataTable dat = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), "4", "0", "2.1", "intermedia");
