...
public partial class estra5sesionesrelatos : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5relatos()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = relatos.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < relatos.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                //ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + relatos.Rows[i]["actividad"].ToString() + " </td>";
                ca += "<td>" + relatos.Rows[i]["fechacreado"].ToString() + " </td>";
                ca += "<td>" + relatos.Rows[i]["nombrearchivo"].ToString() + " </td>";
                ca += "<td>" + relatos.Rows[i]["ext"].ToString() + " </td>";
