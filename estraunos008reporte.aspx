<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunos008reporte.aspx.cs" Inherits="estraunos008reporte" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#listasesores").change(function () {
                listarBitacora($("#listasesores").val());
            });
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'estraunos008reporte.aspx/cargarlistasesores',
        ...
        function cargarDepartamentoMagdalena() {
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/cargarDepartamentoMagdalena',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
        ...
        function cargarinstituciones() {
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/cargarInstituciones',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function finsertInstrumento(codproyecto, resumen, relato, perturbacion, superposicion, sintesis, aprendizaje, conclusiones, fuentes) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/insertInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function fupdateInstrumento(resumen, relato, perturbacion, superposicion, sintesis, aprendizaje, conclusiones, fuentes, codigoinstrumento) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/updateInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function loadInstrumentosSeis(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/loadInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    <script>
        ...
        function listarBitacora(codasesorcoordinador) {
            $("#form").hide();
            $("#table").fadeIn(500);
            var jsonData = '{ "codasesorcoordinador":"' + codasesorcoordinador + '"}';
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/listarBitacora',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data: jsonData,
                success: function (response) {
        ...
        function loadSelectBitacoraSeis(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunos008reporte.aspx/loadSelectBitacoraSeis',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estraunos008reporte.aspx/eliminar',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsondata,
                    success: function (json) {
