<%@ Page Title="Indicadores de Estudiantes " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="indicadoresestudiantes.aspx.cs" Inherits="indicadoresestudiantes" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresestudiantes.aspx/cargarInsMun',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
        ...
        function floadDetalles() {
            //$.ajax({
            //    type: 'POST',
            //    url: 'indicadoresestudiantes.aspx/loadreport',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'JSON',
            //    success: function (response) {
            //        //var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            //if (codSede != null) {
                //if (codSede != "0") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresestudiantes.aspx/realizarBusquedaloadreport',
                        data: jsondata,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (json) {
