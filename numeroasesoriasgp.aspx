<%@ Page Title="Asesorias de Grupos de Investigación" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="numeroasesoriasgp.aspx.cs" Inherits="numeroasesoriasgp" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'numeroasesoriasgp.aspx/noAsesoriasGP',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'numeroasesoriasgp.aspx/realizarBusquedanoAsesoriasGP',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Asesoría desarrolladas en el momento pedagógico 1 a los grupos infantiles y juveniles</h4>
    <p>Mide la cantidad de asesorías a los grupos de investigación infantiles y juveniles registradas y cargadas en la plataforma de Ciclón en el momento pedagógico 1</p>
    <br />
