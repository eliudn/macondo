...
public partial class estra4momentocerodetalle : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        Session["sa"] = HttpUtility.UrlDecode(HttpContext.Current.Request.QueryString["sa"]);

        
        //subtitulo.Text = "Lineamientos de formación en IEP";
        ...
        {
            switch (Session["a"].ToString())
            {
                case "1":
                    titulo.Text = "Diseño de lineamientos de la estrategia de conformación de la comunidad de práctica, aprendizaje, saber conocimiento y transformación del proyecto Ciclón";
                    break;
                case "2":
                    titulo.Text = "Desarrollo de la planeación colectiva";
                    break;
            }
        }
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5evidencia()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable lienamientos = est.est_estra4RepositorioCoordinador("", "", "", "", HttpContext.Current.Session["m"].ToString(), HttpContext.Current.Session["s"].ToString(), HttpContext.Current.Session["a"].ToString(), HttpContext.Current.Session["sa"].ToString());
    ...
    public static string realizarBusquedaestra4memoriasesion1_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
     ...
     {
         Response.Redirect("estra4momentocero.aspx?s=" + Session["s"].ToString());
         //if (Session["m"].ToString() != null)
         //{
