<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunobitacoratres.aspx.cs" Inherits="estraunobitacoratres" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function updateSede(codigo, respuestapregunta1, respuestapregunta2, event) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/updateDatosSede',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function finsertInstrumento(codproyecto, respuestapregunta1,respuestapregunta2) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/insertInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function fupdateInstrumento(codproyecto, respuestapregunta1, respuestapregunta2, codigoinstrumento) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/updateInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function cargarInstrumento_b03(codigogrupo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/loadInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function finsertMaterial() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/deleteMaterial',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function floadMaterial(codigoinstrumento) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/loadMaterial',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    <script>
        ...
        function listarBitacoraTres() {
            $("#form").hide();
            $("#table").fadeIn(500);

            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/listarBitacoraTres',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
        ...
        function loadSelectBitacoraTres(codProyecto) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/loadSelectBitacoraTres',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function traerPreguntasTres(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacoratres.aspx/traerPreguntasTres',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estraunobitacoratres.aspx/eliminar',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsondata,
                    success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="table">
     <a href="#" class="btn btn-primary" style="float:right;" onclick="nuevaBitacora()">Nueva bitácora 3</a>
      <br />
      <br />
     <fieldset >
