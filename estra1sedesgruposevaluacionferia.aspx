<%@ Page Title="Número de ferias municipales " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra1sedesgruposevaluacionferia.aspx.cs" Inherits="estra1sedesgruposevaluacionferia" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra1sedesgruposevaluacionferia.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estra1sedesgruposevaluacionferia.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra1sedesgruposevaluacionferia.aspx/estra1sedesgruposevaluacionferia_',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmuncipio':'" + codMunicipio + "'}";
            $.ajax({
                type: 'POST',
                url: 'estra1sedesgruposevaluacionferia.aspx/realizarBusquedaestra1sedesgruposevaluacionferia_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Sedes educativas con grupos de investigación presentados para evaluación en feria <asp:Label Visible="true" runat="server" ID="titulo"></asp:Label></h2>
    ...
    <h4 >Sedes educativas con grupos de investigación presentados para evaluación en feria<asp:Label Visible="true" runat="server" ID="subtitulo"></asp:Label>  </h4>
    <p>S013: Inscripción de grupos de investigación y maestros(As)a ferias.<asp:Label Visible="true" runat="server" ID="descripcion"></asp:Label> <br /></p>    
    <br />
