<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="informeacompanamiento.aspx.cs" Inherits="informeacompanamiento" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'informeacompanamiento.aspx/loadReport',
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'informeacompanamiento.aspx/realizarbusqueda',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "informeacompanamiento",
                filename: "informeacompanamiento",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
