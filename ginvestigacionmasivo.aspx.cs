...
public partial class ginvestigacionmasivo : System.Web.UI.Page
{
    ...
    private void recorrerListado()
    {
        Usuario usu = new Usuario();
         ...
         {
             string asesor = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[0].Text);
             string municipio = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[1].Text);
             string institucion = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[2].Text);
             string sede = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[3].Text);
             string docentes = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[4].Text);
             string pregunta = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[5].Text);
             string estudiante = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[6].Text);
             string linea = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[7].Text);
             string area = HttpUtility.HtmlDecode(GridView1.Rows[gvr.RowIndex].Cells[8].Text);

             if (ins.agregarConvocatoriaGrupos(asesor, municipio, institucion, sede, docentes, pregunta, estudiante, linea, area))
             {
                  buenos++;
             ...
             {
                 malos++;
                 ca += "Error al cargar sede -> " + sede + "<br/>";
             }
