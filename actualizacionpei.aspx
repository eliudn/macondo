<%@ Page Title="Actualización del PEI" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="actualizacionpei.aspx.cs" Inherits="actualizacionpei" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'actualizacionpei.aspx/actualizacionpei_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'actualizacionpei.aspx/realizarBusquedaactualizacionpei_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
