...
public partial class estra4redesestudiantes : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        titulo.Text = " Sedes Educativas con niños, niñas y jóvenes en Redes Temáticas";
    ...
    [WebMethod(EnableSession = true)]
    public static string estra4redesestudiantess()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_estudiantesSedes("", "", "", "", "1", HttpContext.Current.Session["anio"].ToString());
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra4redesestudiantes(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra4memoriasesion1 = est.est_estra2instrumento_s004_redt_2016_estudiantesSedes(coddepartamento, codmuncipio, codinstitucion, codsede, "", HttpContext.Current.Session["anio"].ToString());
     ...
     protected void btnRegresar_Click(object sender, EventArgs e)
     {
         ...
         if (Session["anio"].ToString() == "2016")
         {
             Response.Redirect("estra4memorias004_2016.aspx?m=1&s=1&e=4");
         }
         else 
         {
             Response.Redirect("estra4memorias004.aspx?m=" + Session["m"].ToString() + "&s=" + Session["s"].ToString() + "&e=" + Session["e"].ToString());
         }
