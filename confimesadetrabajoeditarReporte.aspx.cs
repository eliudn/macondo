...
public partial class confimesadetrabajoeditarReporte : System.Web.UI.Page
{
            ...
            if (Session["codmesadetrabajo"] != null)
            {
                ...
                DataRow dat = est.buscarMesadeTrabajoSedexCod(Session["codmesadetrabajo"].ToString());
                    ...
                    if (dat != null)
                    {
                        ...
                        dropGrupoInvestigacion.SelectedValue = dat["codmesadetrabajo"].ToString();
    ...
    protected void DeleteDocenteActivo_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (estu.eliminarMatriculaDocenteMesadeTrabajo(codgradodocente)) { }
    ...
    protected void btnRegresar_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confimesadetrabajoReporte.aspx");
    }
    protected void UploadRepositorio_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Response.Redirect("confimesadetrabajoevidencia.aspx?codgradodocente=" + Session["codgradodocente"].ToString() + "&codmesadetrabajo=" + Session["codmesadetrabajo"].ToString() +"&coord=si");
