<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunojornadaformacionevi.aspx.cs" Inherits="estraunojornadaformacionevi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
  <h2>Estrategia No 1 - Cargue de evidencias Jornada de Formación</h2>
      <asp:Label runat="server" Visible="true" ID="lblValor"></asp:Label>
     ...
     <asp:Label runat="server" Visible="false" ID="lblCodigo"></asp:Label>
        ...
        <section class="sectionpopup">
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Asistencia a eventos</asp:ListItem>  
                    <asp:ListItem>Registro de asesoría</asp:ListItem>
                    <asp:ListItem>Evaluación eventos de formación</asp:ListItem>
                </asp:RadioButtonList>
