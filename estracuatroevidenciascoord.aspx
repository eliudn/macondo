<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracuatroevidenciascoord.aspx.cs" Inherits="estracuatroevidenciascoord" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 4 - <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
    <div style="float:right;margin-top:-30px;"><asp:Button Visible="false" runat="server" CssClass="btn btn-primary" ID="btnRegresar" Text="Regresar" OnClick="btnRegresar_Click" /></div>
    <br />
     ...
     <fieldset>
         ...
         <asp:Panel runat="server" ID="PanelMomento0" Visible="false">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem Value="1">1. Lineamientos de la estrategia</asp:ListItem>
                    <asp:ListItem Value="2">2. Acta de aprobación cómite técnico</asp:ListItem>
                    <asp:ListItem Value="3">3. Ruta metodológica</asp:ListItem>
                    <asp:ListItem Value="4">4. Plan Operativo aprobado</asp:ListItem>
          ...
          <asp:Panel runat="server" ID="PanelMomento0Actividad2" Visible="false">
              <asp:RadioButtonList runat="server" ID="rbtActividades2">
                    <asp:ListItem Value="1">1. Planes de trabajo de las sesiones presenciales/virtuales</asp:ListItem>
                  <asp:ListItem Value="2">2. Cronogramas de trabajo</asp:ListItem>
                  <asp:ListItem Value="3">3. Acta de aprobación cómite técnico</asp:ListItem>
