<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra1disenoaprobacionlineamientos.aspx.cs" Inherits="estra1disenoaprobacionlineamientos" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra1disenoaprobacionlineamientos.aspx/loadReport',
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "estra1disenoaprobacionlineamientos",
                filename: "estra1disenoaprobacionlineamientos",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Diseño y aprobación de lineamientos de las ferias municipales</h2>
