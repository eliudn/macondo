<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradoscontedigital_evi.aspx.cs" Inherits="estradoscontedigital_evi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 2, Contenidos digitales - Cargar Evidencias</h2>
    ...
    <asp:Label ID="lblCodInstrumento" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Contenido digital</asp:ListItem>
                </asp:RadioButtonList>
