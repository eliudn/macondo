...
public partial class informedeinvestigacionevi : System.Web.UI.Page
{
    ...
    {
        lblCodestras003.Text = HttpUtility.UrlDecode(HttpContext.Current.Request.QueryString["codestras003"]);
    }
    //Evidencias
    ...
    protected void btnRegresar_click(object sender, EventArgs e)
    {
        if (Session["codrol"].ToString() == "10" || Session["codrol"].ToString() == "18" || Session["codrol"].ToString() == "20")
            ...
            Response.Redirect("estras003_estategia1.aspx?e=" + Session["e"].ToString() + "&m=" + Session["m"].ToString() + "&s=" + Session["s"].ToString());
    }
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (usu.agregarArchivoRespositorioEstrategias003(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), rbtActividades.SelectedValue, lblCodestras003.Text))
            {
                gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEstrategias003(lblCodestras003.Text);
