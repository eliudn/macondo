<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="verestraunobitacorados.aspx.cs" Inherits="verestraunobitacorados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#asesores").change(function () {
                ...
                listarBitacoraDos($("#asesores").val());
            });
            ...
            $("#departamento").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'verestraunobitacorados.aspx/cargarMunicipios',
            ...
            $("#municipio").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'verestraunobitacorados.aspx/cargarInstituciones',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
            ...
            $("#institucion").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'verestraunobitacorados.aspx/cargarsedes',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
            ...
            $("#sede").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'verestraunobitacorados.aspx/grupoInvestigacion',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
        ...
        function cargarDepartamentoMagdalena() {
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/cargarDepartamentoMagdalena',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function finsertbitacora2(grupoinvestigacion, preguntainvestigacion, resumen) {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/insertbitacora2',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function fupdatebitacora2(grupoinvestigacion, preguntainvestigacion, resumen) {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/updatebitacora2',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function cargarBitacora2(codproyecto) {
        ...
        function fcargarPreguntas() {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/loadpreguntas',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function fcargarRespuestas() {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/loadRespuestas',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function finsertPreguntas() {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/deletePreguntas',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    <script>
        ...
        function listarBitacoraDos(codasesorcoordinador) {
            //$("#form").hide();
            //$("#table").fadeIn(500);
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/listarBitacoraDos',
                dataType: 'JSON',
                data:jsondata,
                contentType: 'application/json; charset=utf-8',
                success: function (response) {
        ...
        function loadSelectBitacoraDos(codProyecto) {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestraunobitacorados.aspx/loadSelectBitacoraDos',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
...
<div id="table">
     <a href="#" class="btn btn-primary" style="float:right;display:none;" onclick="nuevaBitacora()">Nueva bitácora</a>
      <br />
    <table>
        <tr>
            <td>Asesor:</td>
           ...
           <%-- <tr>
            ...
            <tr>
                <td colspan="2" align="right">
                    ...
                    <div class="btn-float">
                        <input type="button" id="btn-guardar" value="Guardar" onclick="enviarbitacora2('insert')" class="btn btn-success" style="display:none">
