<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracincoevidenciasmatricula.aspx.cs" Inherits="estracincoevidenciasmatricula" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 5 - Cargar Evidencias, Matrícula proceso de formación</h2>
     ...
     <fieldset>
         ...
         <asp:Panel runat="server" ID="PanelSesionActividadUno" Visible="true">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Base de datos de los matriculados</asp:ListItem>
                    <asp:ListItem>S001: Formato de inscripción de actores o matrícula</asp:ListItem>
                </asp:RadioButtonList>
