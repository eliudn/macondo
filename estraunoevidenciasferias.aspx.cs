...
public partial class estraunoevidenciasferias : System.Web.UI.Page
{
    ...
    protected void dropSede_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (dropSedes.SelectedIndex > 0)
            {
                ...
                if (ins.agregarArchivoRespositorioFerias(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), dropSedes.SelectedValue))
                {
                    gvCargarEvidencias();
            ...
            else
            {
                ...
                mostrarmensaje("error", "Seleccione una sede.");
    ...
    {
        DataTable datos = ins.cargarEvidenciasGruposFerias(dropSedes.SelectedValue);
    ...
    {
        DataRow dato = ins.buscarEvidenciaFerias(cod);
        if (ins.borrarEvidenciaFerias(cod))
        {
    ...
    {
        Response.Redirect("estramomentos.aspx?m=5");
    }
