<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradoscajasdeherramientasevi.aspx.cs" Inherits="estradoscajasdeherramientasevi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
  <h2>Estrategia No 2 - Cargue de evidencias Cajas de herramientas</h2>
        ...
        <section class="sectionpopup">
         ...
         <asp:Panel runat="server" ID="PanelMomento0" Visible="true">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem Value="Cartilla 1">CARTILLA 1: Lineamientos de la estrategia de autoformación, formación de saber y conocimiento y apropiación para maestros(as) acompañantes investigadores e investigadores en los lineamientos del programa ONDAS</asp:ListItem>  
                    <asp:ListItem Value="Cartilla 2">IEP: La investigación como estrategia pedagógica.</asp:ListItem>
                    <asp:ListItem Value="Cartilla 3">LAS TIC: Una estrategia para la pedagogía y la investigación.</asp:ListItem>
                    <asp:ListItem Value="Cartilla 4">Ruta metodológica para introducir la investigación como estrategia pedagógica - IEP apoyada en TIC en el currículo. </asp:ListItem>
                    <asp:ListItem Value="Cartilla 5">Fundamentos conceptuales y metodológicos de la sistematización de maestros(as) en el programa CICLÓN.</asp:ListItem>
                    <asp:ListItem Value="Cartilla 6">Apropiación social y conformación de comunidades.</asp:ListItem>
