<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="informedeinvestigacionevi.aspx.cs" Inherits="informedeinvestigacionevi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <h2>Estrategia No 1 - Cargue de evidencias Diseño de las trayectorias de indagación</h2>
     ...
     <asp:Label runat="server" Visible="false" ID="lblCodestras003"></asp:Label>
     ...
     <asp:Panel runat="server" ID="PanelMomento0" Visible="true">
          <asp:RadioButtonList runat="server" ID="rbtActividades">
                <asp:ListItem>Informe de Investigación </asp:ListItem>  
            </asp:RadioButtonList>
     </asp:Panel>
