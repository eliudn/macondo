<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciasactividad.aspx.cs" Inherits="estraunoevidenciasactividad" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <!--<h2 >Estrategía No. 1 - Lineamientos y rutas metodológicas <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>-->
    <asp:Label ID="actividadactual" runat="server" Visible="true" ></asp:Label>
      ...
      <asp:GridView ID="GridEvidencias" runat="server" CellPadding="4" DataKeyNames="cod" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        ...
                        <Columns>
                            ...
                            <ItemTemplate>
                             ...
                             <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton ID="imgEliminar" runat="server" CommandName="Select" ImageUrl="~/Imagenes/delete.png" OnClientClick="if(!confirm('¿Está Seguro en eliminar este registro?')){ return false; };" Height="20px" Width="20px" OnClick="DeleteButton_Click" />
                            </ItemTemplate>
                            </asp:TemplateField>
