...
public partial class confiespaciodeapropiacion : System.Web.UI.Page
{
    ...
    protected void lnkEvidenciasIns_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionregevidenciasinsc.aspx?cod=" + codredtematica + "&coddep=" + coddepartamento);
    }
    ...
    protected void lnkEvidencias_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionregevidencias.aspx?cod=" + codredtematica);
    }
    ...
    protected void btnAgregarEstudiantes_Click(object sender, EventArgs e)
    {
            ...
            int val = 0;
            int val2 = 0;
            DataRow feriam = est.agregarFeriaMunicipalxRegional(dropDepartamento.SelectedValue, nombreferiamunicipal.Text, numeroasistentes.Text, numerogrupos.Text, numerodocentes.Text, fechaelaboracion.Text, horaferia.SelectedValue, horaferiafinal.SelectedValue, fechaelaboracioncierre.Text, horaferiacierre.SelectedValue, horaferiafinalcierre.SelectedValue);
            ...
            if (val > 0 && val2 > 0)
            {
                ...
                string script = @"<script type='text/javascript'>$('#CrearRed').hide(),$('#VerRed').fadeIn(500), alert('Feria Regional creada exitosamente');
                     </script>";
            ...
            else if (val == 0 && val2 > 0)
            {
                ...
                string script = @"<script type='text/javascript'>$('#CrearRed').hide(),$('#VerRed').fadeIn(500),alert('Feria Regional creada exitosamente, pero no se agregaron los municipios');
                     </script>";
    ...
    private void cargarFeriasMunicipales()
    {
        ...
        DataTable datos = estr.cargarFeriasRegionalesMaferpi();
    ...
    protected void lnkEliminarRedTematica_Click(object sender, EventArgs e)
    {
        ...
        est.eliminarferiaregional(codferiamunicipal);
    ...
    protected void lnkEditarRed_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacioneditarreg.aspx");
    }
    ...
    protected void lnkApropiacionMaestros_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiapropiaciondptal.aspx?tipo=r" + cod);
    }
}