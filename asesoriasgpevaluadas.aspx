<%@ Page Title="Asesorías a los grupos infantiles y juveniles evaluadas y subidas a la plataforma de Ciclón" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="asesoriasgpetapa5.aspx.cs" Inherits="asesoriasgpetapa5" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/asesoriasGPevaluadas',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriasgpetapa5.aspx/realizarBusquedaasesoriasGPevaluadas',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Asesorías a los grupos infantiles y juveniles evaluadas y subidas a la plataforma de Ciclón</h4>
    <p>Mide la cantidad de evaluaciones de la asesoría a los grupos de investigación infantil y juvenil inscritos en Ciclón</p>
    <br />
