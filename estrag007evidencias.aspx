<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag007evidencias.aspx.cs" Inherits="estrag007evidencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
  <h2>Estrategia No 1 - Cargue de evidencias Soporte presupuesto</h2>
        ...
        <section class="sectionpopup">
         ...
         <asp:Panel runat="server" ID="PanelMomento0" Visible="true">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Primer Segmento o Trayecto</asp:ListItem>  
                    <asp:ListItem>Segundo Segmento o Trayecto</asp:ListItem>
                    <asp:ListItem>Tercer Segmento o Trayecto</asp:ListItem>
