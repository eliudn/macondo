<%@ Page Title="Sedes con bitacora 2" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesdesarrollo.aspx.cs" Inherits="detallesdesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            $("#tableList tbody").html('<td colspan="5" style="text-align:center;">Cargando...</td>');
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/totalSedesGPTenganPreguntas',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/realizarBusquedatotalSedesGPTenganPreguntas',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4>Sedes educativas con grupos de investigación infantiles y juveniles que formularon preguntas de investigación en la convocatoria de Ciclón</h4>
    <p>Miden el número de sedes educativas en las que los grupos de investigación infantiles y juveniles inscritos en Ciclón formularon preguntas de investigación y diligenciaron la bitácora 02</p>
    <br />
