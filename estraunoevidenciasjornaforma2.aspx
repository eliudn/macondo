<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciasjornaforma2.aspx.cs" Inherits="estraunoevidenciasjornaforma2" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 1 - Jornada de formación: La ruta metodológica <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
    ...
    <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="40">Asistencia a eventos</asp:ListItem>
                        <asp:ListItem Value="41">Registro de asesoría</asp:ListItem>
                        <asp:ListItem Value="42">Evaluación eventos de formación</asp:ListItem>
                     </asp:RadioButtonList>
