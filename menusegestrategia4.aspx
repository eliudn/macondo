<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="menusegestrategia4.aspx.cs" Inherits="menusegestrategia4" %>
    ...
    <%--<script src="Scripts/pruebas.js"></script>--%>
     ...
     <script>
         ...
         function cargardatos() {
             ...
             $.ajax({
                 type: 'POST',
                 url: 'menusegestrategia4.aspx/cargardatos',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <br /><br />
    ...
    <fieldset>
        ...
        Exportar a 
        <a href="javascript:void(0);" class="btn btn-success" style="padding: 5px 12px;" onclick="exportarExcel('tableList','Estrategia No. 4')">Excel</a>
        <br />
        <br />
