...
public partial class indicadoresmaestros : System.Web.UI.Page
{
    ...
    public static string cargarSedesxInstitucion(string codInstitucion, string codSede)
    {
        ...
        if (datos != null && datos.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < datos.Rows.Count; i++)
            {
                if (codSede != "null" && (codSede == datos.Rows[i]["cod"].ToString()))
                {
                    ca += "<option value='" + datos.Rows[i]["cod"].ToString() + "' selected >" + datos.Rows[i]["nombre"].ToString() + "</option>";
                }
                else
    ...
    public static string realizarBusquedaloadreport(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        ...
        DataRow loadTotalesIndicadoresxSede = ins.loadTotalesIndicadoresxSedeMaestrosSUM(coddepartamento, codmuncipio, codinstitucion, codsede);
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td>Maestros y maestras matriculados en la estrategia  No. 2 de autoformación, formación de saber y conocimiento y apropiación en los lineamientos del Programa Ciclón y su propuesta metodológica </td>";
        ...
        DataTable dtm = est.maestrosmatriculadosestra2Det(coddepartamento,codmuncipio,codinstitucion,codsede,"2");
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td >Maestros y maestras acompañantes / investigadores matriculados en la estrategia  No. 2 de autoformación, formación de saber y conocimiento y apropiación en los lineamientos del Programa Ciclón y su propuesta metodológica</td>";
        ca += "<td  class='center'>" + totaldocinsc + "</td>";
        ca += "<td class='center' >" + countdocinsc + "</td>";
        ca += "<td  class='center'>" + metadocinsc + "%</td>";
        ca += "<td  class='center'>" + pesodocinsc + " de " + pesototaldocinsc + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros y maestras coinvestigadores que se forman en la estrategia No. 2 de autoformación, formación de saber y conocimiento y apropiación en los lineamientos del Programa Ciclón y su propuesta metodológica</td>";
        ca += "<td class='center'>" + dtm2.Rows.Count + "</td>";
        ca += "<td  class='center'>" + dtm2.Rows.Count + "</td>";
        ca += "<td  class='center'>" + metadocinsc2 + "%</td>";
        ca += "<td  class='center'>" + pesodocinsc2 + " de " + pesototaldocinsc2 + "</td>";
        ...
        //DataTable dtm3 = null;
        DataTable dtm3 = c.cargarDocentesInscritosComitesEspApro(coddepartamento, codmuncipio, codinstitucion, codsede);
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros y maestras inscritos en los comités  de  los espacios de apropiacion social institucionales que se forman en estrategia  No. 2 de autoformación, formación de saber y conocimiento y apropiación en los lineamientos del Programa Ciclón y su propuesta metodológica</td>";
        ca += "<td class='center'>" + dtm3.Rows.Count + "</td>";
        ca += "<td class='center'>" + dtm3.Rows.Count + "</td>";
        ca += "<td class='center'>" + metadocinsc3 + "%</td>";
        ca += "<td  class='center'>" + pesodocinsc3 + " de " + pesototaldocinsc3 + "</td>";
        ca += "</tr>";
        ...
        DataTable maestrosredestematicas2 = est.maestrosredestematicasIndicador5(coddepartamento, codmuncipio, codinstitucion, codsede);
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros y maestras lideres de las redes temáticas formados en la estrategia  No. 2 de autoformación, formación de saber y conocimiento y apropiación en los lineamientos del Programa Ciclón y su propuesta metodológica.</td>";
        ca += "<td class='center'>" + countdocred + "</td>";
        ca += "<td class='center'>" + countdocred + "</td>";
        ca += "<td class='center'>" + metadocred + "%</td>";
        ca += "<td  class='center'>" + pesodocred + " de " + pesototaldocred + "</td>";
        ca += "</tr>";
        ...
        */
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Producción de saber y conocimiento - Relatorias institucionales elaboradas y subidas a la plataforma Ciclón (2 horas).</td>";
        ca += "<td class='center'>" + totalses1 + "</td>";
        ca += "<td class='center'>" + countses1 + "</td>";
        ca += "<td class='center'>" + metases1 + "%</td>";
        ca += "<td class='center'>" + pesoses1 + " de " + pesototalses1 + "</td>";
        ca += "</tr>";
        ...
        */
        ...
        ca += "<td class='center'>" + pesoses2 + " de " + pesototalses2 + "</td>";
        ca += "</tr>";
        ...
        // ca += "<td class='center'>" + pesosfe2 + " de " + pesototalsfe2 + "</td>";
        //----------------------------------------------
        ...
        */
        ...
        ca += "<td class='center'>" + pesoses3 + " de " + pesototalses3 + "</td>";
        ca += "</tr>";
        ...
        */
        ...
        ca += "<td class='center'>" + pesoses4 + " de " + pesototalses4 + "</td>";
        ca += "</tr>";
        ...
        */
        ...
        ca += "<td class='center'>" + pesoses5 + " de " + pesototalses5 + "</td>";
        ca += "</tr>";
        ...
        */
        ...
        ca += "<td class='center'>" + pesoses6 + " de " + pesototalses6 + "</td>";
        ca += "</tr>";
        ...
        */
        ...
        ca += "<td class='center'>" + pesoses7 + " de " + pesototalses7 + "</td>";
        ca += "</tr>";
       ...
       int total24 = Convert.ToInt32(loadTotalesIndicadoresxSede["totalmaestros"].ToString());
        ...
        ca += "<td class='center'>" + pesoses8 + " de " + pesototalses8 + "</td>";
        ca += "</tr>";
        ...
        double meta60_f = 0;
        int count60_f = 0;
        DataTable proyectosinvestigacionfinanciado = c.totalgruposinvestigacionfinanciados(coddepartamento, codmuncipio, codinstitucion, codsede);
        int total60_f = 0;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + "</b></td><td> Grupos de Investigación Financiados</td>";
        ca += "<td class='center'>" + total60_f + "</td>";
        ca += "<td class='center'>" + count60_f + "</td>";
        ca += "<td class='center'>" + meta60_f + "%</td>";
        ca += "<td class='center'>" + pesoAct60_f + " de " + peso60_f + "</td>";
        ca += "</tr>";
        ...
        DataTable introiep = c.cargarInstrmentoS003(coddepartamento, codmuncipio, codinstitucion, codsede);
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Documentos de introducción de la IEP apoyada en TIC en los currículos de las sedes educativas.</td>";
        ca += "<td class='center' >" + totaliep + "</td>";
        ca += "<td class='center'>" + countiep + "</td>";
        ca += "<td class='center'>" + metaiep + "%</td>";
        ca += "<td class='center'>" + pesoiep + " de " + pesototaliep + "</td>";
        ca += "</tr>";
        ...
        DataTable docenteapropiacion = c.cargarApropiacionDocentesEncabezado(coddepartamento, codmuncipio, codinstitucion, codsede);
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Espacios de reflexión, producción y apropiación de maestros que aprenden de maestros, denominados: “El maestro tiene la palabra”.</td>";
        ca += "<td class='center' >" + totalapro + "</td>";
        ca += "<td class='center'>" + countapro + "</td>";
        ca += "<td class='center'>" + metaapro + "</td>";
        ca += "<td class='center'>" + pesoapro + " de " + pesototalapro + "</td>";
        ca += "</tr>";

        //Ponencias de maestros y maestras inscritas para participación en ferias.
        DataTable docenteapropiacion2 = c.cargarApropiacionDocentesSeleccionados(coddepartamento, codmuncipio, codinstitucion, codsede);
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Ponencias realizadas.</td>";
        ca += "<td class='center' >" + countapro2 + "</td>";
        ca += "<td class='center'>" + countapro2 + "</td>";
        ca += "<td class='center'>" + metaapro2 + "%</td>";
        ca += "<td class='center'>" + pesoapro2 + " de " + pesototalapro2 + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Ejemplares de la caja de herramientas  que soporta la formación de maestros(as)  del Proyecto Ciclón, entregadas.</td>";
        ca += "<td class='center' >" + totalcajah + "</td>";
        ca += "<td class='center'>" + countcajah + "</td>";
        ca += "<td class='center'>" + metacajah + "%</td>";
        ca += "<td class='center'>" + pesocajah + " de " + pesototalcajah + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Sistematizaciones y/o Investigaciones de grupos de maestros(as) acompañantes investigadores terminadas.</td>";
        ca += "<td class='center' >" + totals003 + "</td>";
        ca += "<td class='center'>" + counts003 + "</td>";
        ca += "<td class='center'>" + metas003 + "</td>";
        ca += "<td class='center'>" + pesos003 + " de " + pesototals003 + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Publicaciones impresas y/o digitales de los procesos y resultados de los equipos pedagógicos institucionales y grupos de investigación de los maestros y maestras.</td>";
        ca += "<td class='center' >" + totalpub + "</td>";
        ca += "<td class='center'>" + countpub + "</td>";
        ca += "<td class='center'>" + metapub + "</td>";
        ca += "<td class='center'>" + pesopub + " de " + pesototalpub + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Contenidos educativos digitales para introducir la investigación en cada una de las 6 areas del curriculo para 10 niveles escolares. Contrapartida CUC.</td>";
        ca += "<td class='center' >" + totaldg + "</td>";
        ca += "<td class='center'>" + countdg + "</td>";
        ca += "<td class='center'>" + metadg + "</td>";
        ca += "<td class='center'>" + pesodg + " de " + pesototaldg + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros y maestras acompañantes de los grupos de investigación infantiles y juveniles que no están en la estrategia No 2. de formación.</td>";
        ca += "<td class='center'>" + totald + "</td>";
        ca += "<td class='center'>" + countd + "</td>";
        ca += "<td class='center'>100%</td>";
        ca += "<td class='center'>" + pesod + " de " + pesototald + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros y maestras  acompañantes de las redes temáticas infantiles y juveniles que no están en la estrategia No 2. de formación.</td>";
        ca += "<td class='center'>" + totald2 + "</td>";
        ca += "<td class='center'>" + countd2 + "</td>";
        ca += "<td class='center'>100%</td>";
        ca += "<td class='center'>" + pesod2 + " de " + pesototald2 + "</td>";
        ca += "</tr>";
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros y maestras  acompañantes de procesos de apropiación social que no están en la estrategia No 2. de formación.</td>";
        ca += "<td class='center'>" + countd3 + "</td>";
        ca += "<td class='center'>" + countd3 + "</td>";
        ca += "<td class='center'>100%</td>";
        ca += "<td class='center'>" + pesod3 + " de " + pesototald3 + "</td>";
        ca += "</tr>";
        
                //maestros formados
                DataTable acompanante5 = est.cargardocentesformados();

        double metad5 = 0;
        int countd5 = 0;
        int totald5 = 60;
        double pesototald5 = 1.7100;
        double pesod5 = 0;
        if ((acompanante3 != null && acompanante5.Rows.Count > 0))
        {
            countd3 = acompanante5.Rows.Count;
            metad3 = ((double)countd5 / (double)totald5) * 100;
            metad3 = Math.Round(metad5, 2);
            //if (meta1 > 100)
            //{
            //    meta1 = 100;
            //}

            pesod5 = ((double)countd5 / (double)totald5) * pesototald5;
            pesod5 = Math.Round(pesod5, 4);
            if (pesod5 > pesototald5)
            {
                pesod5 = pesototald5;
            }
            //pesototal = pesototal + pesod3;
        ...
        num++;
        ca += "<tr>";
        ca += "<td><b>" + num + ".</b></td><td> Maestros Formados.</td>";
        ca += "<td class='center'>" + countd5 + "</td>";
        ca += "<td class='center'>" + countd5 + "</td>";
        ca += "<td class='center'>100%</td>";
        ca += "<td class='center'>" + pesod5 + " de " + pesototald5 + "</td>";
        ca += "</tr>";
        ...
        DataRow loadTotalesIndicadoresxSedeE = ins.loadTotalesIndicadoresxSedeSUM(coddepartamento, codmuncipio, codinstitucion, codsede);
