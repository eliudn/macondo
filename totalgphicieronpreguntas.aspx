<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesdesarrollo.aspx.cs" Inherits="detallesdesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/totalGPHicieronPreguntas',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/realizarBusquedatotalGPHicieronPreguntas',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4>Sedes educativas con grupos de investigación infantiles y juveniles con problemas de investigación planteados en la Convocatoria de Ciclón </h4>
    <p>Miden el número de sedes educativas en las que los grupos de investigación infantiles y juveniles inscritos en Ciclón plantean problemas de investigación y diligenciaron la bitácora 03</p>
    <br />
