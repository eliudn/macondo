<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradossecretariaedu_evi.aspx.cs" Inherits="estradossecretariaedu_evi" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategia No. 2: Acta Secretaria de Educación Departamental - Carga de Evidencias</h2>
     ...
     <fieldset>
                <legend>Actividades</legend>
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="Acta de entrega de materiales SED">Acta de entrega de materiales</asp:ListItem>
                     </asp:RadioButtonList>
