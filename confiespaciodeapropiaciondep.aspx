<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confiespaciodeapropiaciondep.aspx.cs" Inherits="confiespaciodeapropiacion" %>
   ...
   <ContentTemplate>
    <div class="header">
        <div style="float: left;margin-right: 15px;">
            <h2>Conformación de las Ferias Departamentales</h2>
        </div>
       ...
       <div id="VerRed">
            ...
            <asp:GridView ID="GridFeria" runat="server" CellPadding="4" 
                    ...
                    EmptyDataText="No existen Ferias Departamentales."
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="codferiamunicipal" HeaderText="codigo" HeaderStyle-CssClass="ocultarcell">
                         ...
                         <asp:BoundField DataField="nomferiamunicipal" HeaderText="Nombre Feria Departamental">
...
<div id="CrearRed" style="display:none;">
    ...
    <table>
       ...
       <table align="center">
           <tr>
           <td>
           <asp:Button runat="server" ID="btnAgregarEstudiantes" ValidationGroup="addestudiantes"  visible="true" CssClass="btn btn-success" Text="Crear Feria Departamental" OnClick="btnAgregarEstudiantes_Click" />
           </td>
           </tr>
       </table>
