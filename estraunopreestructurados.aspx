<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunopreestructurados.aspx.cs" Inherits="estraunopreestructurados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        function listarPreesctructurados() {
            $("#form").hide();
            $("#table").fadeIn(500);

            $.ajax({
                type: 'POST',
                url: 'estraunopreestructurados.aspx/listarPreesctructurados',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="table">
     <a href="#" class="btn btn-primary" style="float:right;" onclick="nuevaBitacora()">Nuevo Preestructurado</a>
      <br />
      <br />
     <fieldset >
