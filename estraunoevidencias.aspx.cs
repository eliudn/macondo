...
public partial class estraunoevidencias : System.Web.UI.Page
{
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            if (lblMomento.Text == "0")
            {
                if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, rbtActividades.SelectedValue, "1"))
                {
                    gvCargarEvidencias();
            ...
            else if (lblMomento.Text == "1")
            {
                ...
                if(lblActividad.Text == "7")
                {
                    if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, "7", "1"))
                    {
                        rbtValideActividades.Visible = false;
                        rbtValideMomento1.Visible = true;
                        rbtValideMomento2.Visible = true;
                ...
                else if (lblActividad.Text == "8")
                {
                    if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, "8", "1"))
                    {
                        rbtValideActividades.Visible = false;
                        rbtValideMomento1.Visible = true;
                        rbtValideMomento2.Visible = true;
            ...
            {
                if (lblActividad.Text == "9")
                {
                    if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, "9", "1"))
                    {
                        rbtValideActividades.Visible = false;
                        rbtValideMomento1.Visible = true;
                        rbtValideMomento2.Visible = true;
                ...
                else if (lblActividad.Text == "10")
                {
                    if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, "10", "1"))
                    {
                        rbtValideActividades.Visible = false;
                        rbtValideMomento1.Visible = true;
                        rbtValideMomento2.Visible = true;
            ...
            {
                if (lblActividad.Text == "11")
                {
                    if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, "11", "1"))
                    {
                        rbtValideActividades.Visible = false;
                        rbtValideMomento1.Visible = true;
                        rbtValideMomento2.Visible = true;
                ...
                else if (lblActividad.Text == "12")
                {
                    if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, "12", "1"))
                    {
                        rbtValideActividades.Visible = false;
                        rbtValideMomento1.Visible = true;
                        rbtValideMomento2.Visible = true;
            ...
            {
                if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text,"0", rbtMomento5.SelectedValue, "1"))
                {
                    gvCargarEvidencias();
                    //lblCodImgPerfil.Text = "1";
                    trepador.PostedFile.SaveAs(variables[6]);
            ...
            {
                if (usu.agregarArchivoRespositorioEstrategia(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), lblMomento.Text, lblSesion.Text, rbtMomento2.SelectedValue, "1"))
                {
                    gvCargarEvidencias();
                    //lblCodImgPerfil.Text = "1";
                    trepador.PostedFile.SaveAs(variables[6]);
    ...
    {
        if (lblActividad.Text == "7" || lblActividad.Text == "8" || lblActividad.Text == "9" || lblActividad.Text == "10" || lblActividad.Text == "11" || lblActividad.Text == "12")
        {
             DataTable datos = est.cargarEvidenciasEstrategiaConActividad(lblMomento.Text, "0", "1",lblActividad.Text, lblCodUsuario.Text);
        ...
        {
            DataTable datos2 = est.cargarEvidenciasEstrategia(lblMomento.Text, "0", "1",lblCodUsuario.Text);
