<%@ Page Title="Docentes que participaron en la evaluación intermedia según último nivel educativo aprobado" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detalleInstitucionIntermedia.aspx.cs" Inherits="detalleDocenteInteermedia" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detalleInstitucionIntermedia.aspx/rectorEvaluacionIntermedia_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        // realizar busqueda
         function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detalleInstitucionIntermedia.aspx/busquedaInstitucionIntermedia_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
