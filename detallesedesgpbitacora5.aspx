<%@ Page Title="Sedes educativas con Grupos de Investigación con Bitaácora 05" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesedesgpbitacora4.aspx.cs" Inherits="detallesedesgpbitacora4" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesedesgpbitacora4.aspx/sedesGPBitacora5',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesedesgpbitacora4.aspx/realizarBusquedasedesGPBitacora5',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Sedes educativas con grupos de investigación infantiles y juveniles que diligenciaron la Bitácora 05: Trayectorias de indagación </h4>
    <p>Mide la cantidad de sedes educativas con grupos de investigación infantiles y juveniles que diligencian la bitácora 05 de trayectorias de indagación  y la han cargado en la plataforma de Ciclón</p>
