...
public partial class estras004SedesEvidencia : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        lblCodAsesorCoordinador.Text = HttpUtility.UrlDecode(HttpContext.Current.Request.QueryString["ac"]);
    ...
    {
        DataTable datos = est.cargarEvidenciasEstrategiaS004Sedes(lblCodInstrumento.Text);
    ...
    {
        if (Session["codrol"].ToString() == "2" || Session["codrol"].ToString() == "9")//Coordinador y Supervisor CUC
            Response.Redirect("estras004SedesReporte.aspx?e=" + Session["e"].ToString() + "&m=" + Session["m"].ToString() + "&s=" + Session["s"].ToString() + "&j=" + Session["j"].ToString() + "&ac=" + lblCodAsesorCoordinador.Text + "&a=" + lblCodAnio.Text);
        else
