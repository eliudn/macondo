<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraevidenciasinfotecnico5.aspx.cs" Inherits="estraevidenciasinfotecnico5" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Informes técnicos de avances - Cargar Evidencias</h2>
    ...
    <asp:Label ID="lblEstrategia" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
              ...
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem >Informe de avances 2016</asp:ListItem>
                    <asp:ListItem >Informe de avances 2017</asp:ListItem>
                    <asp:ListItem >Informe de avances 2018</asp:ListItem>
                    <asp:ListItem >Informe de avances 2019</asp:ListItem>
