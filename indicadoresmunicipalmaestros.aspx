<%@ Page Title="Indicadores Municipales " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="indicadoresmunicipalmaestros.aspx.cs" Inherits="indicadoresmunicipalmaestros" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresmunicipalmaestros.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    //$("#institucion").html("");
                    //$("#municipio").html("");
                    var jsondata = "{'codMunicipio': '" + $.get("mun") + "', 'codDepartamento': '" + $.get("dep") + "'}";
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresmunicipalmaestros.aspx/cargarInsMun',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
                            ...
                            if (resp[0] == "municipio") {
                                ...
                                $("#title-report").html("Maestros y maestras participantes del Municipio: " + $("#municipio option:selected").text());
            ...
            $("#departamento").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'indicadoresmunicipalmaestros.aspx/cargarMunicipios',
                    data: jsondata,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
            ...
            //    $.ajax({
            //        type: 'POST',
            //        url: 'indicadoresmunicipalmaestros.aspx/cargarInstituciones',
            //        data: jsondata,
            //        contentType: "application/json; charset=utf-8",
            //        dataType: "json",
            //        //data:frmserialize,
        ...
        function floadDetalles() {
            //$.ajax({
            //    type: 'POST',
            //    url: 'indicadoresmunicipalmaestros.aspx/loadreport',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'JSON',
            //    success: function (response) {
            //        //var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresmunicipalmaestros.aspx/realizarBusquedaloadreport',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    ...
                    if (resp[0] == "lleno") {
                        ...
                        Highcharts.chart('container', {
                            ...
                            title: {
                                text: 'Porcentaje de ejecución '+por.toFixed(1)+' <br/> <span><b>Maestros y maestras inscritos: </b> ' + resp[4] + ' <br/> <b>Maestros y maestras en formación:</b> ' + resp[3] + '</span>'
                            },
                            tooltip: {
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "indicadoresmunicipalmaestros",
                filename: "indicadoresmunicipalmaestros",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
                ...
                <th style="width: 20%;">Maestros y maestras inscritos</th>
                <th>Ejecución</th>
                <th>% Ejecución</th>
         ...
         <tbody>
             <tr>
                 <td colspan="8" style="text-align:center;">Seleccione municipio</td>
             </tr>
