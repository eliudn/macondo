<%@ Page Title="Instituciones educativas que desde el PEI promueve la investigación de los estudiantes" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="institucionespromueveinvestigacionestudiantes.aspx.cs" Inherits="institucionespromueveinvestigacionestudiantes" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'institucionespromueveinvestigacionestudiantes.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'institucionespromueveinvestigacionestudiantes.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'institucionespromueveinvestigacionestudiantes.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'institucionespromueveinvestigacionestudiantes.aspx/institucionespromueveinvestigacionestudiantes_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            var respuesta = $("#respuesta").val();
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmunicipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "', 'respuesta' : '"+respuesta+"'}";
            $.ajax({
                type: 'POST',
                url: 'institucionespromueveinvestigacionestudiantes.aspx/realizarBusquedainstitucionespromueveinvestigacionestudiantes_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
