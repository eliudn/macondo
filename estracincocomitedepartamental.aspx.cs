...
public partial class estracincocomitedepartamental : System.Web.UI.Page
{
    ...
    public static string listar()
    {
        ...
        DataTable datos = inst.cargarListadoSesionComiteDepartamental();
    ...
    public static string encabezado(string codmunicipio, string fecha, string lugar, string hora, string participantes, string entidades, string objetivo, string desarrollo)
    {
        ...
        DataRow dato = inst.insertcomitedepartamental(codmunicipio, fecha, lugar, hora, participantes, entidades, objetivo, desarrollo ,coor);
    ...
    public static string delete(string codigo)
    {
        ...
        inst.eliminarevidenciaporcodcomitedepartamental(codigo);
        inst.eliminarincomitedepartamental(codigo);
    ...
    public static string load(string codigo)
    {
        ...
        DataRow dat = inst.buscarSesionComiteDepartamental(codigo);
    ...
    public static string update(string codigo, string codmunicipio, string fecha, string lugar, string hora, string participantes, string entidades, string objetivo, string desarrollo)
    {
        ...
        if (inst.actualizarcomitedepartamental(codigo, codmunicipio, fun.convertFechaAño(fecha), lugar, hora, participantes, entidades, objetivo, desarrollo))
        {
            ca = "true_update@";
        }
        else
