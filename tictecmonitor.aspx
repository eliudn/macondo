<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="tictecmonitor.aspx.cs" Inherits="tictecmonitor" %>
        ...
        <fieldset>
            ...
            <asp:GridView ID="GridTickets" runat="server" CellPadding="4" DataKeyNames="cod" CssClass="mGridTesoreria"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="cod" HeaderText="CodIncidencia" HeaderStyle-CssClass="ocultarcell">
