<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="bienvenidaprueba.aspx.cs" Inherits="bienvenida" %>
...
<!--JAVASCRIPT -->
    <script type="text/javascript">
        ...
        function descargaEv() {
           ...
           $.ajax({
                  type: 'POST',
                  url: 'bienvenidaprueba.aspx/descarEvi',
