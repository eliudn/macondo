<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag006.aspx.cs" Inherits="estrag006" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#departamento").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006.aspx/cargarMunicipioMagdalena',
                    data: jsondata,
            ...
            $("#institucion").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006.aspx/cargarsedes',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
        ...
        function cargarDepartamento()
        {
            $.ajax({
                type: 'POST',
                url: 'estrag006.aspx/cargarDepartamentoMagdalena',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function cargarListadoMateriales()
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006.aspx/cargarListadoMaterialesAsesor',
                //data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: "json",
                success: function (response) {
        ...
        function cargarinstituciones(codMunicipio) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006.aspx/cargarInstituciones',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function finsertMaterial() {
            ...
            $.ajax({
                ...
                complete: function () {
                    ...
                    window.location.href = "estrag006.aspx";
                    $('#btn-guardar').attr('value', 'Actualizar');
                    $('#btn-guardar').attr('onclick', 'enviarestrag006(\'update\')');
                }
            });
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro? Recuerde que perderá las evidencias que tenga cargadas')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006.aspx/deleteestrag006',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
        ...
        function eliminarEvidencias(codigo) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006.aspx/eliminarEvidenciasEntregaMaterial',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData
                });
        ...
        <table width="100%" class="border">
            ...
            <tr>
                <td colspan="2" align="right">
                    ...
                    <a href="estrag006.aspx" class="btn btn-primary">Volver</a>
