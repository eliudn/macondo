...
public partial class detalleEncuestaEstudiante : System.Web.UI.Page
{
    ...
    public void obtenerGET()
    {
        ...
        titulo.Text = "Encuesta de estudiates ";
        subtitulo.Text = "Indicador: Total encuesta de estudiantes por institucion. ";
        descripcion.Text = "";
  ...
  for (int i = 0; i < datos.Rows.Count; i++)
    ...
    {
        detalleEncuestaEstudiante d = new detalleEncuestaEstudiante();
        string ca = "";
        ...
        DataTable instituEvaluacionInter = lb.detalleEstudiantes();
        ...
        if (instituEvaluacionInter != null && instituEvaluacionInter.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < instituEvaluacionInter.Rows.Count; i++)
            {
                ...
                ca += "<td>" + instituEvaluacionInter.Rows[i]["count"].ToString() + " </td>";
    ...
    public static string busquedaInstitucionIntermedia_(string coddepartamento, string codmunicipio, string codinstitucion)
    {
        string ca = "";
        var lb = new LineaBase();
        DataTable instituEvaluacionInter = lb.busquedadetalleEstudiantes(coddepartamento, codmunicipio, codinstitucion);
