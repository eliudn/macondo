...
public partial class estra2mesastrabajoconstituidas : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra2mesastrabajoconstituidas_()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = estra2mesastrabajoconstituidas.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra2mesastrabajoconstituidas.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra2mesastrabajoconstituidas.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra2mesastrabajoconstituidas.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra2mesastrabajoconstituidas.Rows[i]["dane"].ToString() + " - " + estra2mesastrabajoconstituidas.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + estra2mesastrabajoconstituidas.Rows[i]["danesede"].ToString() + " - " + estra2mesastrabajoconstituidas.Rows[i]["nombresede"].ToString() + " </td>";
                ca += "<td>" + estra2mesastrabajoconstituidas.Rows[i]["nombregrupo"].ToString() +" </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra2mesastrabajoconstituidas_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2mesastrabajoconstituidas = est.estra2MesasTrabajoConstituidas(coddepartamento, codmuncipio, codinstitucion, codsede);
