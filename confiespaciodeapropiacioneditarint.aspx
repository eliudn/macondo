<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confiespaciodeapropiacioneditarint.aspx.cs" Inherits="confiespaciodeapropiacioneditar" %>
...
<h2 >Editar Ferias Internacionales</h2>
...
<div id="ver">
   ...
   <table>
                <tr>
                    ...
                    <td>
                         <asp:TextBox ID="lugar" runat="server" CssClass="TextBox"></asp:TextBox>
                    </td>
                </tr>
    ...
    <table>
                <tr>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Fecha Incorrecta: dd-MM-yyyy" Display="None"
                        ...
                        ValidationExpression="(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d" 
                        style="color: #FF0000"></asp:RegularExpressionValidator>    
                 <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender7" 
                        runat="server" Enabled="True" TargetControlID="REVfechaelaboracion" 
                        HighlightCssClass="Highlight" PopupPosition="BottomLeft" 
                        Width="250px" WarningIconImageUrl="Imagenes/error3.png" CssClass="CustomValidatorCalloutStyle">
                    </ajx:ValidatorCalloutExtender>    
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="None" ErrorMessage="Digite Fecha de Inicio del Periodo" 
                        ControlToValidate="fechaelaboracion" Text="*" ValidationGroup="Agregar"></asp:RequiredFieldValidator>
                    <ajx:ValidatorCalloutExtender ID="ValidatorCalloutExtender8" runat="server" TargetControlID="RFVfechaelaboracion"
                        HighlightCssClass="Highlight" PopupPosition="BottomLeft" Enabled="True" 
                        Width="250px" WarningIconImageUrl="Imagenes/error3.png" CssClass="CustomValidatorCalloutStyle">
                    </ajx:ValidatorCalloutExtender>
                         </td>
    ...
    <fieldset style="display:none;">
        <legend>Grupos de investigación agregados</legend>
       ...
       <table align="center"><tr>
           ...
           <td>
               <asp:Button runat="server" ID="btnAgregarEstudiantes" ValidationGroup="addestudiantes" Visible="true" CssClass="btn btn-success" Text="Actualizar Feria Internacional" OnClick="btnAgregarEstudiantes_Click" />
           </td>
              </tr></table>
