<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag006_estrategia4.aspx.cs" Inherits="estrag006_estrategia4" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#departamento").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006_estrategia4.aspx/cargarMunicipioMagdalena',
                    data: jsondata,
            ...
            $("#institucion").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006_estrategia4.aspx/cargarsedes',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
        ...
        function cargarDepartamento()
        {
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/cargarDepartamentoMagdalena',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function cargarListadoMateriales()
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/cargarListadoMaterialesAsesor',
                //data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: "json",
                success: function (response) {
        ...
        function cargarinstituciones(codMunicipio) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/cargarInstituciones',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function reset() {
            ...
            $("#fechaentrega").val('');
            $("#nombre").val('');
            $('#btn-guardar').attr('onclick', 'enviarestrag006_estrategia4(\'insert\')');
            //html = '<tr>';
        ...
        function enviarestrag006_estrategia4(event) {
        ...
        function finsertInstrumento(fechaentregamaterial, codsede, nombrequienrecibe) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/insertInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function fupdateInstrumento(fechaentregamaterial, nombrequienrecibe, codigoinstrumento) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/updateInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function loadInstrumento(codigogrupo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/loadInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        $('#btn-guardar').attr('onclick', 'enviarestrag006_estrategia4(\'update\')');
        ...
        function finsertMaterial() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/deleteMaterial',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
                    ...
                    if (resp[0] === "true") {
                        ...
                        for (var i = 1; i <= 22; i++) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'estrag006_estrategia4.aspx/insertMaterial',
                                data: jsonData,
                                contentType: "application/json; charset=utf-8",
                                dataType: "json",
                                success: function (data) {
                ...
                complete: function () {
                    ...
                    window.location.href = "estrag006_estrategia4.aspx";
        ...
        function floadMaterial(codigoinstrumento) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/loadMaterial',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function loadSelectInstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006_estrategia4.aspx/loadSelectInstrumento',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro? Recuerde que perderá las evidencias que tenga cargadas')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006_estrategia4.aspx/deleteestrag006',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
        ...
        function eliminarEvidencias(codigo) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006_estrategia4.aspx/eliminarEvidenciasEntregaMaterial',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData
                });
        ...
        <table width="100%" class="border">
            ...
            <tr>
                <td colspan="2" align="right">
                    <input type="button" id="btn-guardar" value="Guardar" onclick="enviarestrag006_estrategia4('insert')" class="btn btn-success">
                    <a id="btn-volver" href="estrag006_estrategia4.aspx" class="btn btn-primary">Volver</a>
