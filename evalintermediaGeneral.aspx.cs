...
public partial class evalintermediaGeneral : System.Web.UI.Page
{
    ...
    private string MenuAcordeonVisores()
    {
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------------1
        ca += "<h3>Docentes beneficiados por el Proyecto que participan en la evaluación intermedia</h3>";
        ca += "<div>";
        ca += "<ul>";
        ca += "<li style='list-style-type: square;'><a href='javascript:void(0)' onclick='docentesbeneficiados()'>Total Personal docente y directivo beneficiado por el proyecto que participa en la evaluación intermedia.</a></li>";
        ca += "<li style='list-style-type: square;'><a href='javascript:void(0)' onclick='docentesEvaluacionintermedia()'>Total de docentes que participaron en la evaluación intermedia según último nivel educativo aprobado.</a></li>";
        ca += "</ul>";
        ca += "</div>";
        //___________________________________________________________________________________________________________________________________
        //---------------------------------------------------------------------------------------------------------------------------------------------2
        ...
        ca += "<li style='list-style-type: square;'><a href='javascript:void(0)' onclick='usoconectividadformacionestudiantes()'>Uso de conectividad para el trabajo del grupo de investigación de estudiantes.</a></li>";
    ...
    public static void Encode(string path)
{
    ...
    public override void VerifyRenderingInServerForm(Control control)
   {
    ...
    public static string docentesbeneficiados()
    {
        ...
        DataTable datos = lb.totalIntermedia("","","","");
        DataRow totalRector = lb.totalRectoresIntermedia();
        evalintermediaGeneral eig = new evalintermediaGeneral();

        string total = totalRector["count"].ToString();
        ...
        if (datos != null && datos.Rows.Count > 0)
        {
            ...
            ca += "<td align='right'><a href='detalleDocenteInteermedia.aspx'>ver detalles</a></td>";
            ca += "</tr>";
            ...
            ca += "<td align='right'><a href='detalleInstitucionIntermedia.aspx'>ver detalles</a></td>";
            ca += "</tr>";
        }
        else
        {
    ...
    public static string inventariotabletasentregadas()
    {
        ...
        {
            sumtotal += Convert.ToInt32(datos.Rows[i]["total"].ToString());
        }
        ...
        ca += "<td rowspan='3' style='font-weight:bold;'><a href='inventabletaentre.aspx'>Ver detalles</a></td>";
        ca += "</tr>";
        ...
        ca += "<br>";
        /**
         * Total de tableta  estudiantes
         */
        ca += "<table class='mGridTesoreria'>";
        ca += "<tr>";
        ca += "<th colspan='3' >Total de tableta estudiantes</th>";
        ca += "</tr>";

        ca += "<tr>";
        ca += "<th>Numero de tabletas</th>";
        ca += "<th>Numero de estudiantes beneficiado</th>";
        ca += "<th>Detalle</th>";
        ...
        ca += "<tr>";
        ca += "<td>"+sumtotal+"</td>";
        ca += "<td align='right'>" + sumtotal + "</td>";
        ca += "<td ><a href='estracuatroentregatablets.aspx'>Ver detalles</a></td>";
        ca += "</tr></table>";
        ...
        /**
         * total tableta docente
         */
        ca += "<table class='mGridTesoreria'>";
        ca += "<tr>";
        ca += "<th colspan='3' >Total tableta docentes</th>";
        ca += "</tr>";

        ca += "<tr>";
        ca += "<th>Numero de tabletas</th>";
        ca += "<th>Numero de docencia beneficiado</th>";
        ca += "<th>Detalle</th>";
        ...
        ca += "<td></td>";
        ca += "<td align='right'>" + totalEntregadas["total"].ToString() + "</td>";
        ca += "<td ><a href='inventariotabletasentregadas.aspx'>Ver detalles</a></td>";
        ca += "</tr></table>";
    ...
    [WebMethod(EnableSession = true)]
    public static string usoconectividadformacionestudiantes()
    {
        string ca = "";
        LineaBase lb = new LineaBase();

        DataRow totalFrecuenciaSiempre = lb.totalUsoconectividadformacionestudiantesxFrecuencia("Siempre");
        DataRow totalFrecuenciaCasiSiempre = lb.totalUsoconectividadformacionestudiantesxFrecuencia("Casi Siempre");
        DataRow totalFrecuenciaAlgunasVeces = lb.totalUsoconectividadformacionestudiantesxFrecuencia("Algunas Veces");
        DataRow totalFrecuenciaMuyPocasVeces = lb.totalUsoconectividadformacionestudiantesxFrecuencia("Muy pocas Veces");
        DataRow totalFrecuenciaNunca = lb.totalUsoconectividadformacionestudiantesxFrecuencia("Nunca");
        ...
        var porcentajeSiempre = (((double)Convert.ToInt32(totalFrecuenciaSiempre["total"].ToString()) / (double)total) * 100);
        ca += "<td align='right'>" + Math.Round(porcentajeSiempre, 2) + "% </td>";
        ca += "<td align='right'> <a href='usoconectividadformacionestudintes.aspx?resp=Siempre'>Ver detalle </a></td>";
        ca += "</tr>";
        ...
        var porcentajeCasiSiempre = (((double)Convert.ToInt32(totalFrecuenciaCasiSiempre["total"].ToString()) / (double)total) * 100);
        ca += "<td align='right'>" + Math.Round(porcentajeCasiSiempre, 2) + "% </td>";
        ca += "<td align='right'> <a href='usoconectividadformacionestudintes.aspx?resp=Casi Siempre'>Ver detalle </a></td>";
        ca += "</tr>";
        ...
        var porcentajeAlgunasVeces = (((double)Convert.ToInt32(totalFrecuenciaAlgunasVeces["total"].ToString()) / (double)total) * 100);
        ca += "<td align='right'>" + Math.Round(porcentajeAlgunasVeces, 2) + "% </td>";
        ca += "<td align='right'> <a href='usoconectividadformacionestudintes.aspx?resp=Algunas Veces'>Ver detalle </a></td>";
        ca += "</tr>";
        ...
        var porcentajeMuyPocasVeces = (((double)Convert.ToInt32(totalFrecuenciaMuyPocasVeces["total"].ToString()) / (double)total) * 100);
        ca += "<td align='right'>" + Math.Round(porcentajeMuyPocasVeces, 2) + "% </td>";
        ca += "<td align='right'> <a href='usoconectividadformacionestudintes.aspx?resp=Muy pocas Veces'>Ver detalle </a></td>";
        ca += "</tr>";
        ...
        var porcentajeNunca = (((double)Convert.ToInt32(totalFrecuenciaNunca["total"].ToString()) / (double)total) * 100);
        ca += "<td align='right'>" + Math.Round(porcentajeNunca, 2) + "% </td>";
        ca += "<td align='right'> <a href='usoconectividadformacionestudintes.aspx?resp=Nunca'>Ver detalle </a></td>";
        ca += "</tr>";
    ...
    public static string modificacionescurriculosdirigidas()
    {
        ...
        var porcentajeSi = Math.Round((((double)Convert.ToInt32(totalConConexion["total"].ToString()) / (double)total) * 100), 2);
        ca += "<td align='right'>" + porcentajeSi + "% </td>";
        ca += "<td align='right'><a href='modificacionCorriculo.aspx?resp=si'>Ver detalle</a></td>";
        ca += "</tr>";
        ...
        var porcentajeNo = Math.Round((((double)Convert.ToInt32(totalSinConexion["total"].ToString()) / (double)total) * 100), 2);
        ca += "<td align='right'>" + porcentajeNo + "% </td>";
        ca += "<td align='right'><a href='modificacionCorriculo.aspx?resp=no'>Ver detalle</a></td>";
        ca += "</tr>";
