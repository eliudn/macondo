<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras004Evidencia.aspx.cs" Inherits="estras004Evidencia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Label Visible="false" runat="server" ID="lblMomento"></asp:Label>
    <asp:Label Visible="false" runat="server" ID="lblSesion"></asp:Label>

    <div id="mensaje" runat="server"></div><br /><br />
    <h2 >Estrategía No. 4 - Cargar Evidencias</h2>
     ...
     <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        ...
                        <asp:ListItem Value="Formatos de evaluación">2. Formatos de evaluación</asp:ListItem>
                        <asp:ListItem Value="Fotos">3. Fotos</asp:ListItem>
                        <asp:ListItem Value="Otras">4. Otras evidencias (Relatorías y demás soportes)</asp:ListItem>
                     </asp:RadioButtonList>
 ...
 <fieldset>
     ...
     <asp:DropDownList ID="dropListado" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dropListado_OnSelectedIndexChanged" CssClass="TextBox">
         <asp:ListItem Value="0">Seleccione</asp:ListItem>
           <asp:ListItem Value="Lista de Asistencia">Lista de Asistencia</asp:ListItem>
           <asp:ListItem Value="Formatos de evaluación">Formatos de evaluación</asp:ListItem>
           <asp:ListItem Value="Fotos">Fotos</asp:ListItem>
     </asp:DropDownList>
