<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag006Reporte.aspx.cs" Inherits="estrag006Reporte" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function cargarListadoAsesoresxCoordinador() {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estrag006Reporte.aspx/cargarListadoAsesoresxCoordinador',
        ...
        function cargarListadoMateriales(page, rows, codasesorcoordinador)
        {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006Reporte.aspx/cargarListadoMaterialesAsesor',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: "json",
                success: function (response) {
        ...
        $.ajax({
            type: 'POST',
            url: 'estrag006Reporte.aspx/cargarDepartamentoMagdalena',
            contentType: 'application/json; charset=utf-8',
            dataType: 'JSON',
            success: function (response) {
                var resp = response.d.split("@");
        ...
        $("#departamento").on("change", function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006Reporte.aspx/cargarMunicipioMagdalena',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        $("#institucion").change(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag006Reporte.aspx/cargarsedes',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
