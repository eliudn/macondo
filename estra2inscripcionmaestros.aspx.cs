...
public partial class estra2inscripcionmaestros : System.Web.UI.Page
{
    ...
    public static string loadReport()
    {
        ...
        {
            count1 = estra2LineasTematicas.Rows.Count;
        ...
        ca += "<tr>";
        ca += "<td><b>1.</b> Líneas temáticas, territoriales y de actores </td>";
        ca += "<td class='center'>" + count1 + " de " + total1 + "</td>";
        ca += "<td class='center'>" + meta1 + "%</td>";
        ca += "<td class='noExl center'><a href='estra2lineastematicas.aspx'><img src='images/detalles.png'>Ver</a></td>";//?fechaini=0&fechafin=0 <a href='detallejornadasformacion.aspx'><img src='images/detalles.png'></a>
        ca += "</tr>";
