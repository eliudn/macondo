...
public partial class estradoscontedigital : System.Web.UI.Page
{
    ...
    public static string listar()
    {
        ...
        DataTable datos = inst.cargarListadocontenidodigitalEstraDosActualizado();
        ...
        if (datos != null && datos.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < datos.Rows.Count; i++)
            {
                ...
                ca += "<td>" + datos.Rows[i]["coordinador"].ToString() + "</td>";
                ca += "<td>" + datos.Rows[i]["fecha"].ToString() + "</td>";
                ca += "<td>" + datos.Rows[i]["tematica"].ToString() + "</td>";
                //ca += "<td>" + datos.Rows[i]["sesion"].ToString() + "</td>";
                ca += "<td align='center'>" + datos.Rows[i]["anio"].ToString() + "</td>";
                ca += "<td align='center'><br /><a href='javascript:void(0)' onclick='loadinstrumento(\"" + datos.Rows[i]["codigo"].ToString() + "\")' class='btn btn-success'>Ver</a><br/><br /><a href='estradoscontedigital_evi.aspx?cod=" + datos.Rows[i]["codigo"].ToString() + "' class='btn btn-primary'>Evidencia</a><br/><br /><a href='javascript:void(0)' onclick='eliminar(\"" + datos.Rows[i]["codigo"].ToString() + "\")' class='btn btn-danger'>Eliminar</a><br /><br /></td>";
                ca += "</tr>";
            }
        }
        else
    ...
    public static string encabezado(string codanio, string tematica)
    {
        string ca = "";
        Institucion inst = new Institucion();
        ...
        DataRow introiep = inst.agregarcontenidodigitalActualizado(codanio, HttpContext.Current.Session["codestracoordinador"].ToString(), func.getFechaAñoHoraActual(), tematica);
        ...
        //    if (area != null)
        //    {
        //        DataRow introiep = inst.agregarcontenidodigital(codsede, HttpContext.Current.Session["codestracoordinador"].ToString(), func.getFechaAñoHoraActual(), area["codigo"].ToString(), "0");
        ...
        //else
        //{
        //    DataRow introiep = inst.agregarcontenidodigital(codsede, HttpContext.Current.Session["codestracoordinador"].ToString(), func.getFechaAñoHoraActual(), codintroieparea, "0");
    ...
    public static string inasistenciadocentes(string codencabezado, string codgradodocente)
    {
        ...
        inst.insertinasistenciadocentecontenidodigital(codgradodocente, codencabezado);
    ...
    public static string delete(string codigo)
    {
        ...
        inst.eliminarinasistenciasdetallecontenidodigital(codigo);
        inst.eliminarinasistenciacontenidodigital(codigo);
    ...
    public static string load(string codigo)
    {
        ...
        DataRow dat = inst.buscarcontenidodigitalEstraDos(codigo);
    ...
    public static string buscardocentes(string codigo)
    {
        ...
        DataTable dat = inst.buscardocentescontenidodigitalestrados(codigo);
