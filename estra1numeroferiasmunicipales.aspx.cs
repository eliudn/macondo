...
public partial class estra1numeroferiasmunicipales : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra1numeroferiasmunicipales_()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra1numeroferiasmunicipales = est.estra1numeroferiasmunicipales("", "");


        if (estra1numeroferiasmunicipales != null && estra1numeroferiasmunicipales.Rows.Count > 0)
        {
            int total = estra1numeroferiasmunicipales.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra1numeroferiasmunicipales.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra1numeroferiasmunicipales.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra1numeroferiasmunicipales.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra1numeroferiasmunicipales.Rows[i]["nombreferiamunicipal"].ToString() + " </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra1numeroferiasmunicipales_(string coddepartamento, string codmuncipio)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra1numeroferiasmunicipales = est.estra1numeroferiasmunicipales(coddepartamento, codmuncipio);
