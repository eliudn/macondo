<%@ Page Title="Acceso de las redes temáticas a las tabletas entregadas por el Proyecto a las sedes educativas beneficiadas" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="usoconectividadformacionestudintes.aspx.cs" Inherits="usoconectividadformacionestudintes" MaintainScrollPositionOnPostback="true" %>
    ...
    _utf8_decode : function (utftext) {
        ...
        return string;
         ...
         $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'usoconectividadformacionmaestros.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'usoconectividadformacionmaestros.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'usoconectividadformacionmaestros.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'usoconectividadformacionmaestros.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'usoconectividadformacionestudintes.aspx/usoconectividadformacionmaestros_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'usoconectividadformacionmaestros.aspx/realizarBusquedausoconectividadformacionmaestros_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                ...
                <tr>
                    ...
                    <td>
                        <select class="TextBox width-100" name="respuesta" id="respuesta" style="width: 250px">
                            ...
                            <option value="Muy pocas Veces">Muy pocas veces</option>
