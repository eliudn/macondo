<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confimesadetrabajoEvidencia.aspx.cs" Inherits="confimesadetrabajoEvidencia" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 2: Mesa de Trabajo - Carga de Evidencias</h2>
    ...
    <asp:Label ID="lblCodGradoDocente" runat="server" Visible="false" ></asp:Label>
    <asp:Label ID="lblCodMesaTrabajo" runat="server" Visible="false" ></asp:Label>
    <asp:Label ID="lblCoord" runat="server" Visible="false" ></asp:Label>
    ...
    <%-- <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        ...
                        <asp:ListItem Value="Relatoria institucional">3. Relatoría institucional</asp:ListItem>
                          <asp:ListItem Value="Fotos">4. Fotos</asp:ListItem>
                     </asp:RadioButtonList>
