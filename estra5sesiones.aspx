<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra5sesiones.aspx.cs" Inherits="estra5sesiones" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra5sesiones.aspx/loadReport',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 > <asp:Label runat="server" ID="sesion"></asp:Label> sesión: Formación en Ondas y la investigación como estrategia pedagógica   </h2>
