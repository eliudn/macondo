<%@ Page Title="Docentes con Grupos de Investigación" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detallesdesarrollo.aspx.cs" Inherits="detallesdesarrollo" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/totalDocenesMatriculadosGP',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detallesdesarrollo.aspx/realizarBusquedatotalDocenesMatriculadosGP',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4>Maestros y maestras  acompañantes de los grupos de investigación infantiles y juveniles inscritos en la convocatoria de Ciclón </h4>
    <p>Mide la cantidad de maestros y maestras acompañantes de los  grupos de investigación intantiles y juveniles que se han inscritos en la convocatoria del proyecto Ciclón</p>
    <br />
