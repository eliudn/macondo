...
public partial class estracincoevidenciasmatricula : System.Web.UI.Page
{
    ...
    protected void btnActualizarDatosTutoria_Click(object sender, EventArgs e)
    {
        ...
        else if (variables[0] == "exito")
        {
            ...
            //if (dato == null)
            //{
            if (usu.agregarArchivoRespositorioEstra5_Matricula(lblCodUsuario.Text, variables[2], variables[3], variables[4], variables[5], variables[7], Convert.ToInt32(variables[8]), fun.getFechaAñoHoraActual(), rbtActividades.SelectedValue, "5"))
                {
                    gvCargarEvidencias();
    ...
    {
        DataTable datos = est.cargarEvidenciasEstrategia5_Matricula(lblCodUsuario.Text, "5");
    ...
    {
        DataTable datos = est.cargarEvidenciasEstrategia5_Matricula("5");
        GridEvidencias.DataSource = datos;
        GridEvidencias.DataBind();
