<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracincocomitedepartamental.aspx.cs" Inherits="estracincocomitedepartamental" %>
    ...
    <script>
	    ...
	    $(document).ready(function () {
	        ...
	        $.ajax({
	            ...
	            type: 'POST',
	            url: 'estracincocomitedepartamental.aspx/cargarDepartamentoMagdalena',
	            ...
	            success: function (response) {
	                ...
	                $.ajax({
	                    type: 'POST',
	                    url: 'estracincocomitedepartamental.aspx/cargarMunicipios',
	                    data: jsondata,
	                    contentType: 'application/json; charset=utf-8',
	                    dataType: 'JSON',
	                    success: function (response) {
	        ...
	        //    $.ajax({
	        //        type: 'POST',
	        //        url: 'estracincocomitedepartamental.aspx/cargarInstituciones',
	        //        data: jsondata,
	        //        contentType: "application/json; charset=utf-8",
	        //        dataType: "json",
	        ...
	        //    $.ajax({
	        //        type: 'POST',
	        //        url: 'estracincocomitedepartamental.aspx/cargarSedesxInstitucion',
	        //        data: jsondata,
	        //        contentType: "application/json; charset=utf-8",
	        //        dataType: "json",
	        //        success: function (json) {
	    ...
	    function listar() {
	        $.ajax({
	            type: 'POST',
	            url: 'estracincocomitedepartamental.aspx/listar',
	            contentType: "application/json; charset=utf-8",
	            dataType: "json",
	            success: function (json) {
	    ...
	    //        $.ajax({
	    //            type: 'POST',
	    //            url: 'estracincocomitedepartamental.aspx/cargaranios',
	    //            contentType: "application/json; charset=utf-8",
	    //            dataType: "json",
	    //            success: function (json) {
	    //                var resp = json.d.split("@");
	    ...
	    //    $.ajax({
	    //        type: 'POST',
	    //        url: 'estracincocomitedepartamental.aspx/buscar',
	    //        contentType: "application/json; charset=utf-8",
	    //        dataType: "json",
	    //        data: jsonData,
	    //        success: function (json) {
        ...
        function btnguardar(event) {
            ...
            if (event == "insert") {
                if ($.trim($("#municipio").val()) == '') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estracincocomitedepartamental.aspx/encabezado',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: jsondata,
                        success: function (json) {
                ...
                var jsondata = "{'codigo': '" + codigoinstrumento + "', 'codmunicipio': '" + $("#municipio").val() + "', 'fecha': '" + $("#fecha").val() + "', 'lugar': '" + $("#lugar").val() + "', 'hora': '" + $("#hora").val() + "', 'participantes': '" + $("#participantes").val() + "', 'entidades': '" + $("#entidades").val() + "', 'objetivo': '" + objetivo + "', 'desarrollo': '" + desarrollo + "'}";
                    $.ajax({
                        type: 'POST',
                        url: 'estracincocomitedepartamental.aspx/update',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: jsondata,
                        success: function (json) {
        ...
        function loadinstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estracincocomitedepartamental.aspx/load',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estracincocomitedepartamental.aspx/delete',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
    <h2>Sesiones  Comité departamental <asp:Label runat="server" ID="lblSesion" Visible="false"> </asp:Label></h2>
