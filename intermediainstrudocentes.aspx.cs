...
public partial class intermediainstrudocentes : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardardatosabiertas(string codasesor, string preg1, string preg2, string preg3)
    {
        ...
        Docentes doc = new Docentes();
         ...
         if (coddocenteasesor != null)
         {
             ...
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "2", preg1, "2.1", "intermedia");
             lb.AgregarRespuestaAbierta_Fase(coddocenteasesor["codigo"].ToString(), "3", preg1, "2.1", "intermedia");
         }
         else//Asesor es cambio o nuevo para ingresar
         {
             DataRow docente = doc.buscarDocenteMatriculadoxID(HttpContext.Current.Session["identificacion"].ToString());
             ...
             if (docente != null)
             {
                 ...
                 if (docenteasesor != null)
                 {
                     ...
                     if (coddocenteasesor2 != null)
                     {
                         ...
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "2", preg1, "2.1", "intermedia");
                         lb.AgregarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), "3", preg1, "2.1", "intermedia");
                     }
                 }
