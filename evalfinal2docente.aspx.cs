...
public partial class evalfinal2docente : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardarpreguntascerradas(string codasesor, string respuesta, string pregunta, string subpregunta, string accion)
    {
        ...
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, "2.1", "impacto");
