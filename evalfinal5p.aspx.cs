...
public partial class evalfinal5p : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardarpreguntascerradas(string codasesor2, string codasesor, string respuesta, string pregunta, string subpregunta, string accion)
    {
        string ca = "";
        LineaBase lb = new LineaBase();
        evalfinal5p efd =new evalfinal5p();
        ...
        {  
         if (coddocenteasesor2 != null)
            ...
            //lb.eliminarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, subpregunta, "5", "impacto");
            lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, respuesta, "5", "impacto");
    ...
    public static string eliminarchk1(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", "5", "impacto");
        }
    ...
    public static string eliminarchk5(string codasesor)
    {
        ...
        if (coddocenteasesor != null)
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "3", "1", "5", "impacto");
        }
    ...
    public static string guardardatoschk1(string chk, string codasesor)
    {
        ...
        if (coddocenteasesor != null)
         {
             lb.AgregarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), "1", "0", chk, "5", "impacto");
         }
         //else
         //{
         //    Docentes doc = new Docentes();
         ...
         //         if (coddocenteasesor2 != null)
         //         {
         //             lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), "1", "0", chk, "5", "impacto");
         //         }
         //     }
    ...
    public static string cargarrespuestaspreguntacerrada_2(string codasesor, string pregunta, string subpregunta)
    {
        ...
        Asesores ase = new Asesores();
           ...
           if (coddocenteasesor != null)
           {
               DataTable dat7 = lb.cargarRespuestasCerradasxInstrumento02_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, "5", "impacto");
    ...
    /**
    *Metodo guardarPreguntaAbiertas2 de insercion y borrado de registro en la tabla lbase_respuestaabierta 
    */
     [WebMethod(EnableSession = true)]
    public static void guardarpreguntasabiertas2(string codasesor2, string codasesor, string respuesta, string pregunta, string accion){
        LineaBase lb = new LineaBase();
        Asesores ase = new Asesores();
        Docentes doc = new Docentes();
        ...
        if(coddocenteasesor != null){
            if(respuesta != null){
                lb.eliminarRespuestaAbierta_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, "5", "impacto");
    ...
    /***  metodo de  de carga de acesores **/
    ...
    [WebMethod(EnableSession = true)]
     public static string asesorescarg(){
        ...
        Asesores ase = new Asesores();
        DataTable datos = ase.cargarAsesores();
        DataRow datos2 = ase.cargarAsesorInstrumento2(HttpContext.Current.Session["identificacion"].ToString(),"impacto","5");
    ...
    public static string cargaAsesorActual1()
    {
       ...
       Asesores ase = new Asesores();
        DataRow datos = ase.cargarAsesorInstrumento2(HttpContext.Current.Session["identificacion"].ToString(),"impacto","5");
           if (datos != null)
        {
            ca = "true&"; 
