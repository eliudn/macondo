<%@ Page Title="Indicadores Municipales " Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="indicadoresmunicipal.aspx.cs" Inherits="indicadoresmunicipal" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresmunicipal.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'indicadoresmunicipal.aspx/cargarInsMun',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
                            ...
                            if (resp[0] == "municipio") {
                                ...
                                $("#title-report").html("Estudiantes participantes del Municipio: " + $("#municipio option:selected").text());
            ...
            $("#departamento").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'indicadoresmunicipal.aspx/cargarMunicipios',
                    data: jsondata,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
            ...
            //    $.ajax({
            //        type: 'POST',
            //        url: 'indicadoresmunicipal.aspx/cargarInstituciones',
            //        data: jsondata,
            //        contentType: "application/json; charset=utf-8",
            //        dataType: "json",
            //        //data:frmserialize,
        ...
        function floadDetalles() {
            //$.ajax({
            //    type: 'POST',
            //    url: 'indicadoresmunicipal.aspx/loadreport',
            //    contentType: 'application/json; charset=utf-8',
            //    dataType: 'JSON',
            //    success: function (response) {
            //        //var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'indicadoresmunicipal.aspx/realizarBusquedaloadreport',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
        ...
        function exportExcel() {
            ...
            $("#tableList").table2excel({
                exclude: ".noExl",
                name: "indicadoresmunicipal",
                filename: "indicadoresmunicipal",
                fileext: ".xls"//,
                //exclude_img: true,
                //exclude_links: true,
                //exclude_inputs: true
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
                ...
                <th style="width: 20%;">Estudiantes matriculados en redes</th>
                <th>Ejecución</th>
                <th>% Ejecución</th>
