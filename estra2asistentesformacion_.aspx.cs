...
public partial class estra2asistentesformacion_ : System.Web.UI.Page
{
                ...
                if (Session["s"].ToString() != null)
                {
                    if (Session["s"].ToString() == "2")
                    {
                        if (Session["j"].ToString() == "3")
                        {
                            ...
                            subtitulo.Text = "Asistentes a la sesión de formación 3";
                            descripcion.Text = "Conteo de asistentes";
                        }
                    }
                }
            }
            ...
            if (Session["m"].ToString() != null)
            {
                if (Session["m"].ToString() == "3")
                {
                    if (Session["s"].ToString() != null)
                    {
                        if (Session["s"].ToString() == "2")
                        {
                            if (Session["j"].ToString() == "4")
                            {
                                titulo.Text = "Sesión de formación No. 2. Contexto mundial de la educación";
                                subtitulo.Text = "Asistentes a la sesión de formación 4";
                                descripcion.Text = "Conteo de asistentes";
                            }
                        }
                    }
                    ...
                    if (Session["s"].ToString() != null)
                    {
                        if (Session["s"].ToString() == "3")
                        {
                            if (Session["j"].ToString() == "5")
                            {
                                ...
                                subtitulo.Text = "Asistentes a la sesión de formación 5";
                                descripcion.Text = "Conteo de asistentes";
                            }
                        }
                    }
            ...
            if (Session["m"].ToString() != null)
            {
                if (Session["m"].ToString() == "4")
                {
                    if (Session["s"].ToString() != null)
                    {
                        if (Session["s"].ToString() == "3")
                        {
                            if (Session["j"].ToString() == "6")
                            {
                                titulo.Text = "Sesión 3.";
                                subtitulo.Text = "Asistentes a la sesión de formación 6";
                                descripcion.Text = "Conteo de asistentes";
                            }
                        }
                    }
    ...
    [WebMethod(EnableSession = true)]
    public static string estra2asistentesformacion__()
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2asistentesformacion_ = est.estra2AsistentesFormacion_("", "", "", "", HttpContext.Current.Session["m"].ToString(), HttpContext.Current.Session["s"].ToString(), HttpContext.Current.Session["j"].ToString());


        if (estra2asistentesformacion_ != null && estra2asistentesformacion_.Rows.Count > 0)
        {
            int total = estra2asistentesformacion_.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra2asistentesformacion_.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra2asistentesformacion_.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra2asistentesformacion_.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra2asistentesformacion_.Rows[i]["dane"].ToString() + " - " + estra2asistentesformacion_.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + estra2asistentesformacion_.Rows[i]["danesede"].ToString() + " - " + estra2asistentesformacion_.Rows[i]["nombresede"].ToString() + " </td>";
                ca += "<td>" + estra2asistentesformacion_.Rows[i]["tema"].ToString() + " </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra2asistentesformacion__(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2asistentesformacion_ = est.estra2AsistentesFormacion_(coddepartamento, codmuncipio, codinstitucion, codsede, HttpContext.Current.Session["m"].ToString(), HttpContext.Current.Session["s"].ToString(), HttpContext.Current.Session["j"].ToString());
