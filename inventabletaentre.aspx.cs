  ...
  for (int i = 0; i < datos.Rows.Count; i++)
    ...
    public static string actualizacionpei_(string respuesta)
    {
       ...
       // DataTable actualizacionpei = lb.detalleActualizacionPEI("", "", "", respuesta1);
        DataTable actualizacionpei = lb.destalleSedetableta("", "", "", respuesta1);
        ...
        if (actualizacionpei != null && actualizacionpei.Rows.Count > 0)
        {
            ...
            for (int i = 0; i < actualizacionpei.Rows.Count; i++)
            {
                ...
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + actualizacionpei.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + actualizacionpei.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + actualizacionpei.Rows[i]["dane"].ToString() + " - " + actualizacionpei.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + actualizacionpei.Rows[i]["sededane"].ToString() + " - " + actualizacionpei.Rows[i]["sedenombre"].ToString() + " </td>";
                ca += "<td> " + actualizacionpei.Rows[i]["respuesta"].ToString() + "</td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
    ...
    public static string realizarBusquedaactualizacionpei_(string coddepartamento, string codmunicipio, string codinstitucion, string respuesta)
    {
        ...
        DataTable actualizacionpei = lb.destalleSedetableta(coddepartamento, codmunicipio, codinstitucion, respuesta);
