<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estras004_espavirt_coordinador.aspx.cs" Inherits="estras004_espavirt_coordinador" ValidateRequest="false" %>
  ...
  .pagination li.pages {
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004_espavirt_coordinador.aspx/cargarDepartamentoMagdalena',
            ...
            $("#departamento").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras004_espavirt_coordinador.aspx/cargarMunicipioMagdalena',
                    data: jsondata,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
            ...
            $("#institucion").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras004_espavirt_coordinador.aspx/cargarsedes',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
            ...
            $("#sede").change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estras004_espavirt_coordinador.aspx/cargarRedtematica',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
            ...
            $("#asesor").on("change", function () {
                ...
                cargarListadoMemorias($("#asesor").val(), "1");
            });
        ...
        function cargarAsesores() {
            $.ajax({
                url: 'estras004_espavirt_coordinador.aspx/cargarAsesores',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarAnios() {
            $.ajax({
                url: 'estras004_espavirt_coordinador.aspx/cargarAnios',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarTemas() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004_espavirt_coordinador.aspx/cargarTemas',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarListadoMemorias(codasesorcoordinador,page) {
            $("#infoListTable").html("<tr><td colspan='11' style='padding:10px;text-align:center;'><img src='images/loader.gif'></td></tr>")
            var jsondata = "{'page':'" + page + "', 'codasesorcoordinador':'" + codasesorcoordinador + "'}";

            $.ajax({
                type: 'POST',
                url: 'estras004_espavirt_coordinador.aspx/cargarListadoMemoriaAsesor',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function cargarinstituciones(codMunicipio) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004_espavirt_coordinador.aspx/cargarInstituciones',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
        ...
        function enviarestras004(event) {
            ...
            if (event == 'insert') {
                var jsonData = "{ 'redtematica':'" + $("#redtematica").val() + "', 'nombresesion':'" + $("#nombresesion").val() + "', 'temasesion':'" + $("#temasesion").val() + "', 'fechaelaboracion':'" + $("#fechaelaboracion").val() + "', 'nombrerelator':'" + $("#nombreapellidorelator").val() + "', 'horasesion':'" + $("#horasesion").val() + "', 'horasesionfinal':'" + $("#horasesionfinal").val() + "', 'acompanamiento':'" + acompanamiento + "', 'herramientas':'" + herramientas + "', 'evaluacionsesion':'" + evaluacionsesion + "'}";
        ...
        function loadInstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004_espavirt_coordinador.aspx/loadestras004',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function loadSelectInstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estras004_espavirt_coordinador.aspx/loadSelectInstrumento',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
     ...
     <script type="text/javascript">
         ...
         function eliminar(codigo) {
             if (confirm('¿Estás seguro de eliminar esta Memoria?')) {
                 ...
                 $.ajax({
                     type: 'POST',
                     url: 'estras004_espavirt_coordinador.aspx/deleteestras004',
                     contentType: "application/json; charset=utf-8",
                     dataType: "json",
                     data: jsonData,
                     success: function (json) {
        ...
        <br /><br /><br />
          <table>
                <tr>
                    ...
                    <%--<td><a class="btn btn-success" id="btn-buscar">Buscar Memorias</a></td>--%>
                </tr>
            </table>
            <br />
            <br />
