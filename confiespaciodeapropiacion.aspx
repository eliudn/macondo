<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confiespaciodeapropiacion.aspx.cs" Inherits="confiespaciodeapropiacion" %>
   ...
   <ContentTemplate>
    <div class="header">
        <div style="float: left;margin-right: 15px;">
            <h2>Conformación de las Ferias Municipales</h2>
        </div>
       ...
       <div id="VerRed">
            ...
            <asp:GridView ID="GridFeria" runat="server" CellPadding="4" 
                    ...
                    EmptyDataText="No existen Ferias Municipales."
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="codferiamunicipal" HeaderText="codigo" HeaderStyle-CssClass="ocultarcell">
                         ...
                         <asp:BoundField DataField="nomferiamunicipal" HeaderText="Nombre Feria Municipal">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                         <asp:BoundField DataField="asistentes" HeaderText="No. Asistentes">
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="nomdepartamento" HeaderText="Departamento">
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="lnkApropiacionMaestros" runat="server" CssClass="btn btn-success" Text="Apropiación maestros" OnClick="lnkApropiacionMaestros_Click"></asp:LinkButton> <br /><br />
...
<tr>
                     ...
                     <tr>
                         ...
                         <td>
                           <asp:TextBox ID="fechaelaboracion" runat="server" CssClass="TextBox" Width="90px" placeholder="dd-mm-aaaa"></asp:TextBox>
       ...
       <table align="center"><tr>
           <td>
               <asp:Button runat="server" ID="btnAgregarEstudiantes" ValidationGroup="addestudiantes" Visible="false" CssClass="btn btn-success" Text="Crear Feria Municipal" OnClick="btnAgregarEstudiantes_Click" />
           </td>
              </tr></table>
