...
public partial class estra5disenolineamientos : System.Web.UI.Page
{
    ...
    public static string loadReport()
    {
        ...
        ca += "<tr>";
        ca += "<td><b>1.</b> Lineamientos de formación en IEP diseñados y aprobados </td>";
        ca += "<td class='center'>" + count1 + " de " + total1 + "</td>";
        ca += "<td class='center'>" + meta1 + "%</td>";
        ca += "<td class='noExl center'><a href='estra5detallediseno.aspx'><img src='images/detalles.png'>Ver</a></td>";//?fechaini=0&fechafin=0 <a href='detallejornadasformacion.aspx'><img src='images/detalles.png'></a>
        ca += "</tr>";
