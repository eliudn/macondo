...
public partial class evalfinalins3 : System.Web.UI.Page
{
    ...
    public static string cargarsedesxcod(string codsede)
    {
     ...
     [WebMethod(EnableSession = true)]
     public static string cargarpreguntaNo1(string codsede, string pregunta)
     {
         string ca = "";
         ...
         DataRow sede = lb.buscarSedexInsasesor(codsede);
                 ...
                 {
                     ca = "true&";
                     DataTable equipamiento = lb.RespuestaInstrumento03TICS_Fase(sede["codigo"].ToString(), "3", pregunta, "impacto");
     ...
     [WebMethod(EnableSession = true)]
     public static string cargarpreguntaNo2(string codsede, string pregunta, string subpregunta)
     {
         string ca = "";
         ...
         DataRow dato = lb.cargarRespuestasCerradasInstrumento03_Fase(sede["codigo"].ToString(), "3", pregunta, subpregunta, "impacto");
         if (dato != null)
         {
             ca += "true&";
             ca += dato["respuesta"].ToString() + "&";
         }
         //else
         //{
         //    ca = "false&Error, esta sede debe diligenciar el instrumento C600B de la Linea Base";
     ...
     [WebMethod(EnableSession = true)]
     public static string cargarpreguntaNo3(string codsede, string pregunta, string subpregunta)
     {
         string ca = "";
         ...
         DataTable dat = lb.cargarRespuestasCerradasInstrumento03_FaseDT(sede["codigo"].ToString(), "3", pregunta, subpregunta, "impacto");
     ...
     [WebMethod(EnableSession = true)]
     public static string guardardatos(string tipo, string codinsasesor, string codsede, string txt1, string txt2, string txt3, string txt4, string txt5, string txt6, string txt7, string txt8, string pregunta)
     {
         string ca = "";
         ...
         DataRow sedeasesor = lb.buscarSedexInsasesor(codsede);
            ...
            if (txt1 == "" || txt1 == "undefined") { txt1 = "0"; }
            if (txt2 == "" || txt2 == "undefined") { txt2 = "0"; }
            if (txt3 == "" || txt3 == "undefined") { txt3 = "0"; }
            if (txt4 == "" || txt4 == "undefined") { txt4 = "0"; }
            if (txt5 == "" || txt5 == "undefined") { txt5 = "0"; }
            if (txt6 == "" || txt6 == "undefined") { txt6 = "0"; }
            if (txt7 == "" || txt7 == "undefined") { txt7 = "0"; }
            if (txt8 == "" || txt8 == "undefined") { txt8 = "0"; }
            ...
            switch (tipo)
            {
                case "docentes":
                    ...
                    if (sedeasesor != null)
                    {
                        ...
                        lb.eliminarRespuestasInstrumento03TICS_Fase(sedeasesor["codigo"].ToString(), "3", pregunta, "impacto");
                        if (lb.agregarRespuestaInstrumento03TICS_Fase(sedeasesor["codigo"].ToString(), "3", pregunta, "Docentes", txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8, "impacto")) { }
                    }
                    else
                    {
                        DataRow insert = lb.agregarSedeInsasesor(codsede, codinsasesor);
                        if (lb.agregarRespuestaInstrumento03TICS_Fase(insert["codigo"].ToString(), "3", pregunta, "Docentes", txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8, "impacto")) { }
                    }
                ...
                case "estudiantes":
                    ...
                    {
                        lb.editarsedeasesor(codinsasesor, codsede);
                        if (lb.agregarRespuestaInstrumento03TICS_Fase(sedeasesor["codigo"].ToString(), "3", pregunta, "Estudiantes", txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8, "impacto")) { }
                    }
                    else
                    {
                        DataRow insert = lb.agregarSedeInsasesor(codsede, codinsasesor);
                        if (lb.agregarRespuestaInstrumento03TICS_Fase(insert["codigo"].ToString(), "3", pregunta, "Estudiantes", txt1, txt2, txt3, txt4, txt5, txt6, txt7, txt8, "impacto")) { }
                    }
     ...
     [WebMethod(EnableSession = true)]
     public static string guardarpregunta2(string codinsasesor, string codsede, string usodotaciontabletg, string usodotaciontabletr, string usodotaciontabletm, string usodotaciontabletmf, string usodotaciontabletmpf, string usodotaciontabletmd)
     {
         string ca = "";
         ...
         if (sedeasesor != null)
         {
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", "3", "1", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", "3", "2", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", "3", "3", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", "3", "4", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", "3", "5", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", "3", "6", "impacto");


             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", usodotaciontabletg, "3", "1", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", usodotaciontabletr, "3", "2", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", usodotaciontabletm, "3", "3", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", usodotaciontabletmf, "3", "4", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", usodotaciontabletmpf, "3", "5", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "2", usodotaciontabletmd, "3", "6", "impacto");
         }
     ...
     [WebMethod(EnableSession = true)]
     public static string guardarpregunta4(string codinsasesor, string codsede, string usoconectividadtabletg, string usoconectividadtabletr, string usoconectividadtabletm, string usoconectividadtabletmff, string usoconectividadtabletmppf, string usoconectividadtabletmda)
     {
         string ca = "";
         ...
         if (sedeasesor != null)
         {
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", "3", "1", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", "3", "2", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", "3", "3", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", "3", "4", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", "3", "5", "impacto");
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", "3", "6", "impacto");


             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", usoconectividadtabletg, "3", "1", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", usoconectividadtabletr, "3", "2", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", usoconectividadtabletm, "3", "3", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", usoconectividadtabletmff, "3", "4", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", usoconectividadtabletmppf, "3", "5", "impacto");
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), "4", usoconectividadtabletmda, "3", "6", "impacto");
         }
     ...
     [WebMethod(EnableSession = true)]
     public static string eliminarpreguntaChk(string codinsasesor, string codsede, string pregunta)
     {
         string ca = "";
         ...
         if (sedeasesor != null)
         {
             lb.eliminarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), pregunta, "3", "0", "impacto");
         }
         else
         {
             DataRow insert = lb.agregarSedeInsasesor(codsede, codinsasesor);
             if (insert != null)
             {
                 lb.eliminarRespuestaCerradaSede_Fase(insert["codigo"].ToString(), pregunta, "0", "3", "impacto");
             }
         }
     ...
     [WebMethod(EnableSession = true)]
     public static string guardarpreguntaCerradaChk(string codinsasesor, string codsede, string respuesta, string pregunta, string subpregunta)
     {
         string ca = "";
         ...
         if (sedeasesor != null)
         {
             ...
             lb.AgregarRespuestaCerradaSede_Fase(sedeasesor["codigo"].ToString(), pregunta, respuesta, "3", subpregunta, "impacto");
         }
