...
public partial class estra2grupoinvestigacionmaestros : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra2grupoinvestigacionmaestros_()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = estra2grupoinvestigacionmaestros.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < estra2grupoinvestigacionmaestros.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + estra2grupoinvestigacionmaestros.Rows[i]["nombredepartamento"].ToString() + " </td>";
                ca += "<td>" + estra2grupoinvestigacionmaestros.Rows[i]["nombremunicipio"].ToString() + " </td>";
                ca += "<td>" + estra2grupoinvestigacionmaestros.Rows[i]["dane"].ToString() + " - " + estra2grupoinvestigacionmaestros.Rows[i]["nombreins"].ToString() + " </td>";
                ca += "<td>" + estra2grupoinvestigacionmaestros.Rows[i]["danesede"].ToString() + " - " + estra2grupoinvestigacionmaestros.Rows[i]["nombresede"].ToString() + " </td>";
                ca += "<td>" + estra2grupoinvestigacionmaestros.Rows[i]["nombregrupo"].ToString() +" </td>";
                ca += "</tr>";
            }
            ca += "@" + total;
        }
     ...
     [WebMethod(EnableSession = true)]
    public static string realizarBusquedaestra2grupoinvestigacionmaestros_(string coddepartamento, string codmuncipio, string codinstitucion, string codsede)
    {
        string ca = "";
        Estrategias est = new Estrategias();

        DataTable estra2grupoinvestigacionmaestros = est.estra2GrupoInvestigacionMaestros(coddepartamento, codmuncipio, codinstitucion, codsede);
