<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunoevidenciasplanoperativo.aspx.cs" Inherits="estraunoevidenciasplanoperativo" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 1 - Plan Operativo <asp:Label runat="server" ID="lblTitulo" Visible="true"></asp:Label></h2>
    ...
    <fieldset>
                ...
                <asp:Panel runat="server" ID="PanelMomento0" >
                     ...
                     <asp:RadioButtonList runat="server" ID="rbtActividades">
                        <asp:ListItem Value="10">Carga Plan Operativo</asp:ListItem>
                        <asp:ListItem Value="11">Actas de Aprobación Comité Técnico</asp:ListItem>
                        <asp:ListItem Value="12">Plan Operativo aprobado por Interventoría</asp:ListItem>
                     </asp:RadioButtonList>
