<%@ Page Title="Asesorías realizadas a los grupos de investigación" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="asesoriascpm3e1.aspx.cs" Inherits="asesoriascpm3e1" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriascpm3e1.aspx/cargarDepartamentoMagdalena',
                ...
                success: function (response) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'asesoriascpm3e1.aspx/cargarMunicipios',
                        data: jsondata,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
            ...
            $("#municipio").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'asesoriascpm3e1.aspx/cargarInstituciones',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    //data:frmserialize,
            ...
            $("#institucion").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'asesoriascpm3e1.aspx/cargarSedesxInstitucion',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
            ...
            $("#sede").on("change", function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'asesoriascpm3e1.aspx/cargarGruposInvestigacionxSede',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (json) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriascpm3e1.aspx/asesoriasGPm3e1',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    var resp = response.d.split("@");
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'asesoriascpm3e1.aspx/realizarBusquedaasesoriasGPm3e1',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h4 >Asesorías realizadas a los grupos de investigación infantiles y juveniles en el momento pedagógico 3, etapa 4</h4>
    <p>Mide la cantidad de asesorías a los grupos de investigación infantiles y juveniles registradas y cargadas en la plataforma de Ciclón en el momento pedagógico 3 etapa 4</p>
    <br />
