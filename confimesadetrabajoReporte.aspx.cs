...
public partial class confimesadetrabajoReporte : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            //if (Session["codasesorcoordinador"] != null)
            //{
            //    cargarGruposxAsesor(Session["codasesorcoordinador"].ToString());
    ...
    {
        drop.DataSource = ins.cargarListadoAsesoresxCoordinador("2");
    ...
    private void cargarGruposxSede(string codsede)
    {
        ...
        DataTable datos = estr.cargarMesadeTrabajoxAsesorxSede(codsede);
    ...
    private void cargarGruposxAsesor(string codasesorcoordinador)
    {

        //DataTable datos = estr.cargarMesadeTrabajoxAsesor(codasesorcoordinador);
        //GridGrupo.DataSource = datos;
        //GridGrupo.DataBind();
