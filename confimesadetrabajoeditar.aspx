<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="confimesadetrabajoeditar.aspx.cs" Inherits="confimesadetrabajoeditar" %>
                    ...
                    <tr>
                         ...
                         <td>
                               ...
                               <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                 <ContentTemplate>
                                     <asp:TextBox runat="server" ID="dropGrupoInvestigacion" CssClass="TextBox" UpdateMode="Conditional" ></asp:TextBox>
 ...
 <asp:Label runat="server" id="lblCodGrupoInvestigacion" Visible="false"></asp:Label>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="nombre"  HeaderText="Nombre" >
                             ...
                             <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                             <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Imagenes/upload.png" Height="20px" Width="20px" OnClick="UploadRepositorio_Click" />
                                 </ItemTemplate>
                            </asp:TemplateField>
  ...
  <asp:Panel runat="server" ID="PanelVerDocentes" Visible ="false">
    ...
    <fieldset>
        ...
        <br />
                 <asp:GridView ID="GridAsesor" runat="server" CellPadding="4" DataKeyNames="codmesadetrabajo" CssClass="mGridTesoreria"  UseAccessibleHeader="true" ClientIDMode="Static"
                        EmptyDataText="No se encontraron Datos" EmptyDataRowStyle-HorizontalAlign="Center" EmptyDataRowStyle-ForeColor="Red"
                        ForeColor="#333333"  AutoGenerateColumns="false" Style="margin: 0 auto" 
                        GridLines="None" >
                        <Columns>
