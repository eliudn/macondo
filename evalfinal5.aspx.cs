...
public partial class evalfinal4 : System.Web.UI.Page
{
    string codrol = "";
    ...
    public static string guardarpreguntascerradas(string codasesor, string respuesta, string pregunta, string subpregunta, string accion)
    {
        ...
        {
            lb.eliminarRespuestaCerrada_Fase(coddocenteasesor["codigo"].ToString(), pregunta, subpregunta, "5", "impacto");
        ...
        else//Asesor es cambio o nuevo para ingresar
        {
            ...
            if (docente != null)
            {
                ...
                {
                    lb.eliminarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), pregunta, subpregunta, "5", "impacto");
                    lb.AgregarRespuestaCerrada_Fase(docenteasesor["codigo"].ToString(), pregunta, subpregunta, respuesta, "5", "impacto");
                ...
                else
                {
                    ...
                    if (coddocenteasesor2 != null)
                    {
                        ...
                        lb.AgregarRespuestaCerrada_Fase(coddocenteasesor2["codigo"].ToString(), pregunta, subpregunta, respuesta, "5", "impacto");
                    }
                }
            }
        }
