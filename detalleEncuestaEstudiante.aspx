<%@ Page Title="Docentes que participaron en la evaluación intermedia según último nivel educativo aprobado" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="detalleEncuestaEstudiante.aspx.cs" Inherits="detalleEncuestaEstudiante" MaintainScrollPositionOnPostback="true" %>
...
var Url = {
    ...
    _utf8_decode : function (utftext) {
        ...
        function floadDetalles() {
            ...
            $.ajax({
                type: 'POST',
                url: 'detalleEncuestaEstudiante.aspx/detalleImpacto_',
                data: jsondata,
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        // realizar busqueda
         function filtro() {
            ...
            var jsondata = "{'coddepartamento':'" + codDepartamento + "', 'codmunicipio':'" + codMunicipio + "', 'codinstitucion':'" + codInstitucion + "'}";
             
            $.ajax({
                type: 'POST',
                url: 'detalleEncuestaEstudiante.aspx/busquedaInstitucionIntermedia_',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
     ...
     <table width="100%" class="border" id="tableList">
         <thead>
		    <tr>
                ...
                <th>Total encuesta por institucion</th>
