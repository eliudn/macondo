<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estradosintroiep.aspx.cs" Inherits="estradosintroiep" %>
    ...
    <script>
	    ...
	    $(document).ready(function () {
	        ...
	        $.ajax({
	            ...
	            type: 'POST',
	            url: 'estradosintroiep.aspx/cargarDepartamentoMagdalena',
	            ...
	            success: function (response) {
	                ...
	                $.ajax({
	                    type: 'POST',
	                    url: 'estradosintroiep.aspx/cargarMunicipios',
	                    data: jsondata,
	                    contentType: 'application/json; charset=utf-8',
	                    dataType: 'JSON',
	                    success: function (response) {
	        ...
	        $("#municipio").on("change", function () {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'estradosintroiep.aspx/cargarInstituciones',
	                data: jsondata,
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	        ...
	        $("#institucion").on("change", function () {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'estradosintroiep.aspx/cargarSedesxInstitucion',
	                data: jsondata,
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: function (json) {
	    ...
	    function listar() {
	        $.ajax({
	            type: 'POST',
	            url: 'estradosintroiep.aspx/listar',
	            contentType: "application/json; charset=utf-8",
	            dataType: "json",
	            success: function (json) {
	                $("#tbody").html(json.d);
	    ...
	    function cargaranio() {
	            $.ajax({
	                type: 'POST',
	                url: 'estradosintroiep.aspx/cargaranios',
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                success: function (json) {
	                    var resp = json.d.split("@");
	    ...
	    function areas() {
	        $.ajax({
	            type: 'POST',
	            url: 'estradosintroiep.aspx/cargarareas',
	            contentType: "application/json; charset=utf-8",
	            dataType: "json",
	            success: function (json) {
	                var resp = json.d.split("@");
	    ...
	    function btnbuscar() {
	        if ($.trim($("#areas").val()) == "") {
	            ...
	            $.ajax({
	                type: 'POST',
	                url: 'estradosintroiep.aspx/buscar',
	                contentType: "application/json; charset=utf-8",
	                dataType: "json",
	                data: jsonData,
	                success: function (json) {
        ...
        function btnguardar(event) {
                ...
                if (check != "") {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estradosintroiep.aspx/encabezado',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: jsonData,
                        success: function (json) {
                    ...
                    alert("Por favor, seleccione por lo menos un docente para continuar");
                }
       }
        ...
        function guardardetalle(codencabezado) {
            ...
            $("#docentes tbody tr").each(function (index, elem) {
                ...
                if ($("#chkdoc_" + i).is(':checked')) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'estradosintroiep.aspx/inasistenciadocentes',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        data: jsonData,
                        success: function (json) {
        ...
        function loadinstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estradosintroiep.aspx/load',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function buscardocentes(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estradosintroiep.aspx/buscardocentes',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
                success: function (json) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estradosintroiep.aspx/delete',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsonData,
                    success: function (json) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true"></asp:ScriptManager>
    ...
    <br /><br />
    <h2>Introducción de la IEP en el currículo</h2>
		...
		<fieldset>
         ...
         <fieldset>
            ...
            <%-- <table class="mGridTesoreria">
             ...
             <br />
             <center><input type="button" class="btn btn-success" id="btn-guardar" onclick="btnguardar('insert')" value="Guardar" style="display:none" /></center>
         </fieldset>
       </div>
