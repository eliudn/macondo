<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="verestras002.aspx.cs" Inherits="verestras002" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
	...
	<script>
	    ...
	    $(function () {
	        ...
	        /*//////////////////////////////////////////////////////////////////////////////////////////////////////*/
	        $.ajax({
	            url: 'verestras002.aspx/cargarDepartamentoMagdalena',
	            type: 'POST',
	        ...
	        $("#departamento").on('change', function () {
	            ...
	            $.ajax({
	                url: 'verestras002.aspx/cargarMunicipios',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#municipio").on('change', function () {
	            ...
	            $.ajax({
	                url: 'verestras002.aspx/cargarInstituciones',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#instituciones").on('change', function () {
	            ...
	            $.ajax({
	                url: 'verestras002.aspx/cargarSedesInstitucion',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#sedes").on("change", function () {
	            ...
	            $.ajax({
	                url: 'verestras002.aspx/cargarLineaInvestigacion',
	                type: 'POST',
	                data: data,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	        ...
	        $("#grupoInvestigacion").on("change", function () {
	            $.ajax({
	                url: 'verestras002.aspx/cargarAsesores',
	                type: 'POST',
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	                success: function (response) {
	    ...
	    function btnGuardar_Click(event) {
	        ...
	        if (event == "insert")
	        {
	            ...
	            $.ajax({
	                url: 'verestras002.aspx/encabezado',
	                type: 'POST',
	                data: jsonData,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	                success: function (response) {
	                    ...
	                    for (var i = 0; i < actividades.length; i++) {
	                        var jsonData = "{'codEstraS002': '" + response.d.toString() + "', 'actividad': '" + actividades[i].toString() + "', 'noactividad':'" + (i + 1) + "'}";
	                        $.ajax({
	                            url: 'verestras002.aspx/actividades',
	                            type: 'POST',
	                            data: jsonData,
	                            contentType: 'application/json; charset=utf-8',
	                            dataType: 'JSON'
	                    ...
	                    $.each(compromisos, function (index, element) {
	                        var jsonData = "{'codEstraS002': '" + response.d.toString() + "', 'compromiso': '" + element[0].toString() + "', 'fechaCumplimiento': '" + element[1].toString() + "', 'responsable': '" + element[2].toString() + "', 'nocompromiso':'" + x + "'}";
	                        $.ajax({
	                            url: 'verestras002.aspx/compromisos',
	                            type: 'POST',
	                            data: jsonData,
	                            contentType: 'application/json; charset=utf-8',
	                            dataType: 'JSON'
	        ...
	        else if(event == "update")
	        {
	            ...
	            $.ajax({
	                url: 'verestras002.aspx/updates002',
	                type: 'POST',
	                data: jsondata,
	                contentType: 'application/json; charset=utf-8',
	                dataType: 'JSON',
	                success: function (response) {
	                    ...
	                    if (resp[0] == "true")
	                    {
	                        ...
	                        $.ajax({
	                            type: 'POST',
	                            url: 'verestras002.aspx/deleteactividadess002',
	                            data: jsondata,
	                            contentType: 'application/json; charset=utf-8',
	                            dataType: 'JSON',
	                            success: function (response) {
	                                ...
	                                if(resp[0] == "true")
	                                {
	                                    for(var i = 0; i < actividades.length; i++)
	                                    {
	                                        var jsondata = "{'codEstraS002':'" + codestrategia + "', 'actividad':'" + actividades[i].toString() + "', 'noactividad':'" + (i + 1) + "'}";
	                                        $.ajax({
	                                            url: 'estras002.aspx/actividades',
	                                            type: 'POST',
	                                            data: jsondata,
	                                            contentType: 'application/json; charset=utf-8',
	                                            dataType: 'JSON'
	                        ...
	                        $.ajax({
	                            type: 'POST',
	                            url: 'verestras002.aspx/deletecompromisoss002',
	                            data: jsondata,
	                            contentType: 'application/json; charset=utf-8',
	                            dataType: 'JSON',
	                            success: function (response) {
	                                ...
	                                if (resp[0] == "true")
	                                {
	                                    var x = 1;
	                                    $.each(compromisos, function (index, element) {
	                                        var jsonData = "{'codEstraS002': '" + codestrategia + "', 'compromiso': '" + element[0].toString() + "', 'fechaCumplimiento': '" + element[1].toString() + "', 'responsable': '" + element[2].toString() + "', 'nocompromiso':'" + x + "'}";

	                                        $.ajax({
	                                            url: 'estras002.aspx/compromisos',
	                                            type: 'POST',
	                                            data: jsonData,
	                                            contentType: 'application/json; charset=utf-8',
	                                            dataType: 'JSON'
    ...
    <script>
        $(function () {
            ...
            $("#asesores").change(function () {
                ...
                listarInstrumentos002($("#asesores").val());
            });
        });

        function listarInstrumentos002(codasesorcoordinador) {
            total = 5;
            total1 = 1;
            $("#form").hide();
            ...
            $.ajax({
                type: 'POST',
                url: 'verestras002.aspx/listarInstrumentos002',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data:jsondata,
                success: function (response) {
        ...
        function loadSelectInstrumentos002(codProyecto) {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestras002.aspx/loadSelectInstrumentos002',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function cargarInstrumentos002(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestras002.aspx/cargarInstrumentos002',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function listaractividadess002(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'verestras002.aspx/listaractividadess002',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function listarcompromisoss002(codigo) {
            ...
            var jsondata = "{'codigo':'" + codigo + "'}";
                ...
                $.ajax({
                    type: 'POST',
                    url: 'verestras002.aspx/listarcompromisoss002',
                    data: jsondata,
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        /* 2016-10-28 3:49 pm */
            function btnActualizar() {
                ...
                $.ajax({
                    url: 'verestras002.aspx/actualizarEncabezados002',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
                        /*Recorrido actividades
                        for (var i = 0; i < actividades.length; i++) {
                            var jsonData = "{'codEstraS002': '" + response.d.toString() + "', 'actividad': '" + actividades[i].toString() + "'}";
                            $.ajax({
                                url: 'estras002.aspx/actividades',
                                type: 'POST',
                                data: jsonData,
                        ...
                        /*Recorrido compromisos
                        $.each(compromisos, function (index, element) {
                            var jsonData = "{'codEstraS002': '" + response.d.toString() + "', 'compromiso': '" + element[0].toString() + "', 'fechaCumplimiento': '" + element[1].toString() + "', 'responsable': '" + element[2].toString() + "'}";
                            $.ajax({
                                url: 'estras002.aspx/compromisos',
                                type: 'POST',
                                data: jsonData,
            ...
            function evidencias(codigo) {
                ...
                var jsonData = "{'codigo':'" + codigo + "'}";
                $.ajax({
                    url: 'verestras002.aspx/evidencias',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON'
...
<h2 >Estrategia Nro. <asp:label runat="server" ID="lblEstrategia" Visible="true"></asp:label> - S002: Registro de la asesoría</h2>
      ...
      <div id="table">
     <a href="#" class="btn btn-primary" style="float:right;display:none;" onclick="nuevaasesoria();">Nuevo registro asesoría</a>
      <br />
           <table>
                <tr>
                    <td>Asesor:</td>
            ...
            <table>
             ...
             <table>
                <tr>
                    ...
                    <td style="padding-left:10px;"><input type="text" id="noasistentes" class="TextBox"  style="width: 20%;"/></td>
                </tr>
            </table>
		    <table>
                <tr>
...
<br/>
	...
	<br />
		<%--<fieldset>
		    <table>
		    	<tr>
		    		<td>Nombre del asesor de  línea de ciclón: </td>
		    		<td><input type="text" name="nombreasesor" id="nombreasesor" class="TextBox"/></td>
		    	</tr>
		    	<tr>
		    	    <td>Fecha de diligenciamiento </td>
		    	    <td><input type="date" name="fechadiligenciamiento" id="fechadiligenciamiento" class="TextBox" /></td>
		    	</tr>
		    </table>
		</fieldset>--%>
    <br />
	<center>
        <input type="button" id="btn-guardar" class="btn btn-success" value="Guardar" onclick="btnGuardar_Click('insert');" style="display:none;" />
         <a href="#" onclick="btnRegresar();" class="btn btn-primary">Regresar</a>
         <%--<asp:Button ID="btnSubirFirmaPop" runat="server" Text="CargarEvidencia" CssClass="btn btn-danger" OnClick="btnSubirFirmaPop_Click" />--%>
   ...
   <%-- <asp:Panel ID="PanelEdicion" runat="server" CssClass="modalPopup">--%>
        ...
        <footer >
            <div style="text-align: center">
                <asp:Button ID="Button1" runat="server" Text="Subir Imagen" CssClass="btn btn-success" Visible="false" ValidationGroup="addEvidencia" OnClick="btnActualizarDatosTutoria_Click" />
