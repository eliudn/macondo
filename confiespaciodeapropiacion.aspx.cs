...
public partial class confiespaciodeapropiacion : System.Web.UI.Page
{
    ...
    protected void lnkEvidenciasIns_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionevidenciasinsc.aspx?cod=" + codredtematica + "&coddep=" + coddepartamento);
    }
    ...
    protected void lnkEvidencias_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionevidencias.aspx?cod=" + codredtematica);
    }
    ...
    protected void btnAgregarEstudiantes_Click(object sender, EventArgs e)
    {
            ...
            int val = 0;
            int val2 = 0;
            DataRow feriam = est.agregarFeriaMunicipalxMunicipio(dropDepartamento.SelectedValue, nombreferiamunicipal.Text, numeroasistentes.Text, numerogrupos.Text, fechaelaboracion.Text, horaferia.SelectedValue, horaferiafinal.SelectedValue);
            ...
            if (val > 0 && val2 > 0)
            {
                ...
                string script = @"<script type='text/javascript'>$('#CrearRed').hide(),$('#VerRed').fadeIn(500), alert('Feria Municipal creada exitosamente');
                     </script>";
            ...
            else if (val > 0 && val2 == 0)
            {
                ...
                string script = @"<script type='text/javascript'>$('#CrearRed').hide(),$('#VerRed').fadeIn(500),alert('Feria Municipal creada exitosamente, pero no se agregaron grupos de investagación');
                     </script>";
            ...
            {
                string script = @"<script type='text/javascript'>
                                alert('Error al crear Feria Municipal.');
                                $('#VerRed').hide(),$('#CrearRed').show();
                        </script>";
    ...
    private void cargarFeriasMunicipales()
    {
        ...
        DataTable datos = estr.cargarFeriasMunicipalesMaferpi();
    ...
    protected void lnkEliminarRedTematica_Click(object sender, EventArgs e)
    {
        ...
        est.eliminarferiamunicipal(codferiamunicipal);
    ...
    protected void lnkEditarRed_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacioneditar.aspx");
    }
    ...
    protected void lnkApropiacionMaestros_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("confiespaciodeapropiacionaprodoc.aspx?cod=" + cod);
    }
}