<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estrag001_estrategia4.aspx.cs" Inherits="estrag001_estrategia4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    <script>
        ...
        $(function () {
            ...
            /*//////////////////////////////////////////////////////////////////////////////////////////////////////
            $.ajax({
                url: 'estrag001_estrategia4.aspx/cargarInstituciones',
                type: 'POST',
            ...
            $("#instituciones").on('change', function () {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4.aspx/cargarSedesInstitucion',
                    type: 'POST',
                    data: data,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#sedes").on("change", function () {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4.aspx/cargarRedTematica',
                    type: 'POST',
                    data: data,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#redtematica").on("change", function () {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4.aspx/cargarEstudiantes',
                    type: 'POST',
                    data: data,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
        ...
        function cargarEncabezados() {
            $.ajax({
                type: 'POST',
                url: 'estrag001_estrategia4.aspx/cargarEncabezados',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (json) {
                    ...
                    if (resp[0] === "datosintrumento") {
                        ...
                        $("#txttActividad").val("Formación presencial");
                    } 
                }
            });
        }
        ...
        function btnGuardar_Click(event) {
            ...
            if (event == "insert") {
                ...
                if ($.trim($("#fecha").val()) == '' || $.trim($("#fecha").val()) == null) {
                    ...
                    var estrategia = 4;
                    var jsonData = "{'valFecha': '" + $("#fecha").val().toString() + "', 'valtActividad': '" + $("#txttActividad").val().toString() + "', 'valTema': '" + $("#txttema").val().toString() + "', 'valFacilitador': '" + $("#txtfacilitador").val().toString() + "', 'valhInicio': '" + $("#hInicio").val().toString() + "', 'valhFin': '" + $("#hFin").val().toString() + "', 'estrategia':'" + estrategia.toString() + "'}";
                    $.ajax({
                        url: 'estrag001_estrategia4.aspx/encabezado',
                        type: 'POST',
                        data: jsonData,
                        contentType: 'application/json; charset=utf-8',
                        dataType: 'JSON',
                        success: function (response) {
                            ...
                            for (var i = 0; i < dataTabla.length; i++) {
                                ...
                                $.ajax({
                                    url: 'estrag001_estrategia4.aspx/estudianteInasistente',
                                    type: 'POST',
                                    data: jsonData,
                                    contentType: 'application/json; charset=utf-8',
                                    dataType: 'JSON',
                ...
                var jsonData = "{'valFecha': '" + $("#fecha").val().toString() + "', 'valtActividad': '" + $("#txttActividad").val().toString() + "', 'valTema': '" + $("#txttema").val().toString() + "', 'valFacilitador': '" + $("#txtfacilitador").val().toString() + "', 'valhInicio': '" + $("#hInicio").val().toString() + "', 'valhFin': '" + $("#hFin").val().toString() + "', 'codigo':'" + codinstrumento + "'}";
                $.ajax({
                    url: 'estrag001_estrategia4.aspx/updateencabezado',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
                    success: function (response) {
                        ...
                        for (var i = 0; i < dataTabla.length; i++) {
                            console.log(dataTabla[i]);
                            var jsonData = "{'codInasistencia': '" + codinstrumento + "', 'codEstudiante': '" + dataTabla[i].toString() + "'}";
                            $.ajax({
                                url: 'estrag001_estrategia4.aspx/estudianteInasistente',
                                type: 'POST',
                                data: jsonData,
        ...
        function updateEstudiante(cod) {
            ...
            if ($.trim($("#nombreEst").val()) == '' || $.trim($("#nombreEst").val()) == null) {
                ...
                $.ajax({
                    url: 'estrag001_estrategia4.aspx/actualizarEstudiante',
                    type: 'POST',
                    data: jsonData,
                    contentType: 'application/json; charset=utf-8',
                    dataType: 'JSON',
            ...
            $("#dialog-confirm").dialog({
                ...
                buttons: {
                    Eliminar: function () {
                        ...
                        $.ajax({
                            url: 'estrag001_estrategia4.aspx/eliminarEstudiante',
                            type: 'POST',
                            data: data,
                            contentType: 'application/json; charset=utf-8',
                            dataType: 'JSON',
        ...
        function cargarAsistencias() {
            ...
            $.ajax({
                url: 'estrag001_estrategia4.aspx/cargarListadoAsistencias',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
        ...
        function loadinstrumento(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estrag001_estrategia4.aspx/loadinstrumento',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: data,
                success: function (json) {
                    ...
                    $("#agregar").fadeIn(500);
                    $('#btguardar').attr('value', 'Actualizar');
                    $('#btguardar').attr('onclick', 'btnGuardar_Click(\'update\')');
        ...
        function validacion() {
            ...
            $.ajax({
                url: 'estrag001_estrategia4.aspx/validarSesion',
                type: 'POST',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                success: function (response) {
                    if (response.d == "coordinador") {
                        $("#btnGuardar").hide();
                        $("#btnuevo").hide();
                    }
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro? Recuerde que perderá los datos asociados')) {
                var data = "{'codigo':'" + codigo + "'}";
                $.ajax({
                    type: 'POST',
                    url: 'estrag001_estrategia4.aspx/eliminar',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: data,
                    success: function (json) {
...
<div id="mensaje" runat="server"></div><br /><br />
    <h2 >Estrategía Nro. 4 - G001: Registro de Asistencia</h2><br />
    ...
    <br />
    <center>
        <input id="btguardar" type="button" class="btn btn-success" value="Guardar" onclick="btnGuardar_Click('insert');" />
    ...
    <div id="dialog-confirm" title="Eliminar estudiante de la red tematica" style="display:none;">
     ...
     <div id="list">
        <div style="float:right"><a href="#" id="btnuevo" class="btn btn-primary" onclick="btnNuevo_click()">Nuevo registro</a></div><br /><br />
        <table class="mGridTesoreria">
            <thead>
                <tr>
                    <th>No.</th>
