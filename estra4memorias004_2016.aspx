<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra4memorias004_2016.aspx.cs" Inherits="estra4memorias004_2016" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra4memorias004_2016.aspx/loadReport',
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 > Sesión 1: Conformación de la comunidad de estudiantes que se gozan la ciencia</h2>
