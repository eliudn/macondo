...
public partial class estra5sesionesrelatorias : System.Web.UI.Page
{
    ...
    [WebMethod(EnableSession = true)]
    public static string estra5relatorias()
    {
        string ca = "";
        Estrategias est = new Estrategias();
        ...
        {
            int total = relatoria.Rows.Count;
            ca = "lleno@";
            for (int i = 0; i < relatoria.Rows.Count; i++)
            {
                var f = i + 1;
                ca += "<tr>";
                //ca += "<td><b>" + f + ".</b> </td>";
                ca += "<td>" + relatoria.Rows[i]["actividad"].ToString() + " </td>";
                ca += "<td>" + relatoria.Rows[i]["fechacreado"].ToString() + " </td>";
                ca += "<td>" + relatoria.Rows[i]["nombrearchivo"].ToString() + " </td>";
                ca += "<td>" + relatoria.Rows[i]["ext"].ToString() + " </td>";
