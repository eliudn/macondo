...
public partial class estrag006_estrategia4 : System.Web.UI.Page
{
    ...
    protected void btnRegresar_Click(object sender, EventArgs e)
    {
        if (Session["e"].ToString() == "1")
            ...
            Response.Redirect("estracuatromomentos.aspx?m=" + lblMomento.Text + "&s=" + lblSesion.Text);
    }
    ...
    public static string cargarListadoMaterialesAsesor()
    {
        ...
        DataTable datosmateriales = inst.cargarListadoMaterialesxAsesorEstra4Todo(HttpContext.Current.Session["CodEstraCoordinador"].ToString());

        if (datosmateriales != null && datosmateriales.Rows.Count > 0)
        {
            DataTable datosCount = inst.cargarListadoMaterialesxAsesorCountEstra4(HttpContext.Current.Session["CodEstraCoordinador"].ToString());
    ...
    public static string loadSelectInstrumento(string codigo)
    {
        ...
        DataRow dato = estra.loadSelectInstrumentog006Estra4(codigo);
        if (dato != null)
        {
            ca += "loadSelect@";
    ...
    public static string insertInstrumento(string fechaentregamaterial, string codsede, string nombrequienrecibe)
    {
        ...
        DataRow insert = inst.procinsertIntrumentoEstra4(fun.convertFechaAño(fechaentregamaterial), codsede, nombrequienrecibe, coord);
        if (insert != null)
        {
            ca = "true@";
    ...
    public static string loadInstrumento(string codigo)
    {
        ...
        DataRow datosinstrumento = inst.cargarDatosInstrumentoEstra4(codigo);
    ...
    public static string updateInstrumento(string fechaentregamaterial, string nombrequienrecibe,string codigoinstrumento)
    {
        ...
        long update = inst.updateInstrumentoEstra4(fun.convertFechaAño(fechaentregamaterial), nombrequienrecibe, codigoinstrumento);
        if (update != -1)
        {
            ca = "true@";
    ...
    [WebMethod(EnableSession = true)]
    public static string insertMaterial(string codigoinstrumento, string nombrematerial, string cantidad, string estado, string orden)
    {

        Institucion inst = new Institucion();
        string ca = "";

        DataRow insert = inst.insertMaterialEstra4(codigoinstrumento, nombrematerial, cantidad, estado, orden);
        if (insert != null)
        {
            ca = "true@";
        }
    ...
    public static string deleteMaterial(string codigoinstrumento)
    {
        ...
        long delete = inst.deleteMaterialEstra4(codigoinstrumento);
        if (delete != -1)
        {
            ca = "true@";
        }
    ...
    public static string loadMaterial(string codigoinstrumento,int total)
    {
        ...
        DataTable datos = inst.procloadMaterialEstra4(codigoinstrumento);
    ...
    public static string deleteestrag006(string codigo)
    {
        ...
        if (inst.eliminarEncabezadoEntregaMaterialEstra4(codigo))
        {
            inst.eliminarDetalleMaterialEstra4(codigo);
            ca = "delete@";
        }
        else
        {
    ...
    public static string eliminarEvidenciasEntregaMaterial(string codigo)
    {
        ...
        if (inst.eliminarEvidenciasEntregaMaterialEstra4(codigo))
        {
