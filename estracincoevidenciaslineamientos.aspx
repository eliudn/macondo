<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estracincoevidenciaslineamientos.aspx.cs" Inherits="estracincoevidenciaslineamientos" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 >Estrategía No. 5 - Cargar Evidencias, Lineamientos de la formación</h2>
    ...
    <asp:Label ID="lblSubActividad" runat="server" Visible="False"></asp:Label>
    <asp:Label ID="lblSesion" runat="server" Visible="False"></asp:Label>
     ...
     <fieldset>
         ...
         <asp:Panel runat="server" ID="PanelSesionActividadUno" Visible="true">
              <asp:RadioButtonList runat="server" ID="rbtActividades">
                    <asp:ListItem>Diseño de lineamientos de la estrategia formación</asp:ListItem>
                    <asp:ListItem>Aprobación de los lineamientos de formación</asp:ListItem>
                </asp:RadioButtonList>
