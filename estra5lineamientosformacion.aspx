<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estra5lineamientosformacion.aspx.cs" Inherits="estra5lineamientosformacion" MaintainScrollPositionOnPostback="true" %>
    ...
    <style type="text/css">
     ...
     <script type="text/javascript">
        ...
        function floadReport() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra5lineamientosformacion.aspx/loadReport',
        ...
        function filtro() {
            ...
            $.ajax({
                type: 'POST',
                url: 'estra5lineamientosformacion.aspx/realizarbusqueda',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                data: jsonData,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <h2 > Formar a los funcionarios de la Gobernación </h2>
