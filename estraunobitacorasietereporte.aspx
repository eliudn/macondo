<%@ Page Title="" Language="C#" MasterPageFile="~/General.master" AutoEventWireup="true" CodeFile="estraunobitacorasietereporte.aspx.cs" Inherits="estraunobitacorasietereporte" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#asesores").change(function () {
                ...
                listarBitacoraSiete($("#asesores").val());
            });
        ...
        function cargarasesores() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'JSON',
                url: 'estraunobitacorasietereporte.aspx/cargarasesores',
        ...
        function cargarDepartamentoMagdalena() {
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/cargarDepartamentoMagdalena',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
        ...
        function cargarinstituciones() {
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/cargarInstituciones',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                //data:frmserialize,
                success: function (json) {
        ...
        function finsertInstrumento(codproyecto, proyeccion) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/insertInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function fupdateInstrumento(codproyecto, proyeccion, codigoinstrumento) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/updateInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        function loadInstrumentosSeis(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/loadInstrumento',
                data: jsonData,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
    ...
    <script>
        ...
        function listarBitacoraSiete(asesor) {
            $("#form").hide();
            $("#table").fadeIn(500);
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/listarBitacoraSiete',
                contentType: 'application/json; charset=utf-8',
                dataType: 'JSON',
                data: jsondata,
                success: function (response) {
        ...
        function loadSelectBitacoraSiete(codigo) {
            ...
            $.ajax({
                type: 'POST',
                url: 'estraunobitacorasietereporte.aspx/loadSelectBitacoraSiete',
                data: jsondata,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function eliminar(codigo) {
            if (confirm('¿Estás seguro de eliminar este registro?')) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'estraunobitacorasietereporte.aspx/eliminar',
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: jsondata,
                    success: function (json) {
